...
public class PastelSounds {
    ...
    private static final DeferredRegister<SoundEvent> REGISTER = DeferredRegister
        .create(
    ...
    public static final SoundEvent PEDESTAL_CRAFTING_FINISHED_AMETHYST = register(
        "pedestal_crafting_finished_amethyst"
    );
    ...
    public static final SoundEvent PEDESTAL_CRAFTING_FINISHED_MOONSTONE = register(
        "pedestal_crafting_finished_moonstone"
    );
    ...
    public static final SoundEvent HUMUS_AMBIENT = register("humus_ambient");
    ...
    public static final SoundEvent ENTITY_PRESERVATION_TURRET_HURT_CLOSED = register(
        "entity.preservation_turret.hurt_closed"
    );
    ...
    public static final SoundEvent ENTITY_EGG_LAYING_WOOLY_PIG_AMBIENT = register(
        "entity.egg_laying_wooly_pig.ambient"
    );
    ...
    private static SoundEvent register(String id) {
        ResourceLocation identifier = PastelCommon.locate(id);

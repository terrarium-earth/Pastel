...
public class BookConfirmationButtonPage extends BookTextPage {
    ...
    public BookConfirmationButtonPage(
        BookTextHolder title, BookTextHolder text, boolean useMarkdownInTitle, boolean showTitleSeparator,
        String anchor, BookCondition condition, ResourceLocation checkedAdvancement, BookTextHolder buttonText,
        BookTextHolder confirmedButtonText, String confirmationString
    ) {
    ...
    public static BookConfirmationButtonPage fromJson(
        ...
        var confirmedButtonText = BookGsonHelper.getAsBookTextHolder(
            json, "button_text_confirmed", BookTextHolder.EMPTY, provider);
        var confirmationString = GsonHelper.getAsString(json, "confirmation", "");
        return new BookConfirmationButtonPage(
            title, text, useMarkdownInTitle, showTitleSeparator, anchor, condition, checkedAdvancement, buttonText,
            confirmedButtonText, confirmationString
        );
    }

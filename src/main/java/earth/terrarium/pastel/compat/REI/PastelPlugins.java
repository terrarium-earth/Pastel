...
public class PastelPlugins {
	...
	public static final CategoryIdentifier<PedestalCraftingDisplay> PEDESTAL_CRAFTING = CategoryIdentifier.of(PastelCommon.locate("pedestal_crafting"));
	public static final CategoryIdentifier<AnvilCrushingDisplay> ANVIL_CRUSHING = CategoryIdentifier.of(PastelCommon.locate("anvil_crushing"));
	public static final CategoryIdentifier<FusionShrineDisplay> FUSION_SHRINE = CategoryIdentifier.of(PastelCommon.locate("fusion_shrine"));
	public static final CategoryIdentifier<NaturesStaffConversionsDisplay> NATURES_STAFF = CategoryIdentifier.of(PastelCommon.locate("natures_staff_conversions"));
	public static final CategoryIdentifier<EnchanterEnchantingDisplay> ENCHANTER_CRAFTING = CategoryIdentifier.of(PastelCommon.locate("enchanter"));
	public static final CategoryIdentifier<EnchantmentUpgradeDisplay> ENCHANTMENT_UPGRADE = CategoryIdentifier.of(PastelCommon.locate("enchantment_upgrade"));
	public static final CategoryIdentifier<PotionWorkshopBrewingDisplay> POTION_WORKSHOP_BREWING = CategoryIdentifier.of(PastelCommon.locate("potion_workshop_brewing"));
	...
	public static final CategoryIdentifier<HeatingDisplay> HEATING = CategoryIdentifier.of(PastelCommon.locate("heating"));
	public static final CategoryIdentifier<FreezingDisplay> FREEZING = CategoryIdentifier.of(PastelCommon.locate("freezing"));
	public static final CategoryIdentifier<InkConvertingDisplay> INK_CONVERTING = CategoryIdentifier.of(PastelCommon.locate("ink_converting"));
	public static final CategoryIdentifier<CrystallarieumDisplay> CRYSTALLARIEUM = CategoryIdentifier.of(PastelCommon.locate("crystallarieum"));
	public static final CategoryIdentifier<CinderhearthDisplay> CINDERHEARTH = CategoryIdentifier.of(PastelCommon.locate("cinderhearth"));
	public static final CategoryIdentifier<TitrationBarrelDisplay> TITRATION_BARREL = CategoryIdentifier.of(PastelCommon.locate("titration_barrel"));
	public static final CategoryIdentifier<PrimordialFireBurningDisplay> PRIMORDIAL_FIRE_BURNING = CategoryIdentifier.of(PastelCommon.locate("primordial_fire_burning"));

...
public class SmallDragonjagBlock extends BushBlock implements Dragonjag, BonemealableBlock {
    ...
    public static final MapCodec<SmallDragonjagBlock> CODEC = RecordCodecBuilder
        .mapCodec(
            i -> i
                .group(
                    propertiesCodec(),
                    Dragonjag.Variant.CODEC
                        .fieldOf("variant")
                        .forGetter(SmallDragonjagBlock::getVariant)
                )
                .apply(
                    i,
                    SmallDragonjagBlock::new
                )
        );
    ...
    public void performBonemeal(ServerLevel world, RandomSource random, BlockPos pos, BlockState state) {
        ...
        if (tallVariant
            .defaultBlockState()
            .canSurvive(world, pos) && world.isEmptyBlock(pos.above())) {

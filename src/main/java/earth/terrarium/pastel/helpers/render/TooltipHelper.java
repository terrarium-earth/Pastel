...
public class TooltipHelper {
        ...
        if (foodComponent != null) {
            buildEffectTooltipWithChance(
                ...
                stack.getUseAnimation() == UseAnim.DRINK
                    ? Component
                        .translatable(
                            "pastel.food.whenDrunk"
                        )
                    : Component.translatable("pastel.food.whenEaten"),
                updateTickRate
            );
        }
    }
    ...
    public static void buildEffectTooltipWithChance(
        List<Either<FormattedText, TooltipComponent>> tooltip,
        List<FoodProperties.PossibleEffect> entries,
        ...
        for (
            ...
            statusEffect
                ...
                .createModifiers(
                    ...
                    (attribute, modifier) -> modifiersList.add(new Pair<>(attribute.value(), modifier))
                );
        ...
        if (!modifiersList.isEmpty()) {
            ...
            for (
                var pair : modifiersList
            ) {
                var modifier = pair.getSecond();
                double d = modifier.amount();
                double e;
                if (modifier.operation() != AttributeModifier.Operation.ADD_MULTIPLIED_BASE && modifier
                        ...
                        .add(
                            Either
                                .left(
                                    (Component
                                        .translatable(
                                            "attribute.modifier.plus." + modifier
                                                .operation()
                                                .id(),
                                            ItemAttributeModifiers.ATTRIBUTE_MODIFIER_FORMAT
                                                .format(
                                                    e
                                                ),
                                            Component
                        ...
                        .add(
                            Either
                                .left(
                                    (Component
                                        .translatable(
                                            "attribute.modifier.take." + modifier
                                                .operation()
                                                .id(),
                                            ItemAttributeModifiers.ATTRIBUTE_MODIFIER_FORMAT
                                                .format(

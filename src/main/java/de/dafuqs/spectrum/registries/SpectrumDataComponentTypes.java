...
public class SpectrumDataComponentTypes {
	...
	public static final DataComponentType<BottomlessBundleItem.BottomlessStack> BOTTOMLESS_STACK = register("bottomless_stack", builder -> builder.persistent(BottomlessBundleItem.BottomlessStack.CODEC).networkSynchronized(BottomlessBundleItem.BottomlessStack.STREAM_CODEC));

...
public class PastelBannerPatterns {

    public static ResourceKey<BannerPattern> COLOR_THEORY = of("color_theory");
    ...
    private static ResourceKey<BannerPattern> of(String id) {
        return ResourceKey.create(Registries.BANNER_PATTERN, PastelCommon.locate(id));
    }

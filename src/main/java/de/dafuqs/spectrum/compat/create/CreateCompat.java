...
public class CreateCompat extends SpectrumIntegrationPacks.ModIntegrationPack {
	...
	public static Block PURE_ZINC_BLOCK = SpectrumBlocks.registerCustom("pure_zinc_block", new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK)), DyeColor.BROWN, SpectrumModelProvider::registerSimpleCubeAllBlockModel);

...
public class REIClientIntegration implements REIClientPlugin {
    ...
    public void registerCategories(CategoryRegistry registry) {
        ...
        EntryIngredient pedestals = EntryIngredient
            .of(
        ...
        registry
            .addWorkstations(
                PastelPlugins.ANVIL_CRUSHING,
                EntryStacks.of(Blocks.ANVIL),
                EntryStacks.of(PastelBlocks.BEDROCK_ANVIL.get()),
                EntryStacks.of(PastelBlocks.STRATINE_FLOATBLOCK.get()),
                EntryStacks.of(PastelBlocks.PALTAERIA_FLOATBLOCK.get())
            );
        registry
            .addWorkstations(
                PastelPlugins.FUSION_SHRINE,
                EntryIngredient
                    .of(
        ...
        registry
            .addWorkstations(
                PastelPlugins.LIQUID_CRYSTAL_CONVERTING,
                EntryStacks.of(PastelItems.LIQUID_CRYSTAL_BUCKET.get())
            );
        registry
            .addWorkstations(
                PastelPlugins.MIDNIGHT_SOLUTION_CONVERTING,
                EntryStacks.of(PastelItems.MIDNIGHT_SOLUTION_BUCKET.get())
            );
        registry
            .addWorkstations(
                PastelPlugins.DRAGONROT_CONVERTING,
                EntryStacks.of(PastelItems.DRAGONROT_BUCKET.get())
            );
        ...
        registry
            .addWorkstations(
                PastelPlugins.POTION_WORKSHOP_BREWING,
                EntryStacks.of(PastelBlocks.POTION_WORKSHOP.get())
            );
        registry
            .addWorkstations(
                PastelPlugins.POTION_WORKSHOP_CRAFTING,
                EntryStacks.of(PastelBlocks.POTION_WORKSHOP.get())
            );
        registry
            .addWorkstations(
                PastelPlugins.POTION_WORKSHOP_REACTING,
                EntryStacks.of(PastelBlocks.POTION_WORKSHOP.get())
            );
        ...
        registry
            .addWorkstations(
                PastelPlugins.PRIMORDIAL_FIRE_BURNING,
                EntryStacks.of(PastelItems.DOOMBLOOM_SEED.get()),
                EntryStacks.of(PastelItems.PRIMORDIAL_LIGHTER.get()),
                EntryStacks.of(PastelBlocks.INCANDESCENT_AMALGAM.get()),
                EntryStacks.of(PastelItems.PIPE_BOMB.get())
            );
    }
    ...
    public void registerDisplays(DisplayRegistry registry) {
        registry
            .registerRecipeFiller(
                AnvilCrushingRecipe.class,
                PastelRecipeTypes.ANVIL_CRUSHING,
                AnvilCrushingDisplay::new
            );
        registry.registerRecipeFiller(PedestalRecipe.class, PastelRecipeTypes.PEDESTAL, PedestalCraftingDisplay::new);
        registry
            .registerRecipeFiller(
                FusionShrineRecipe.class,
                PastelRecipeTypes.FUSION_SHRINE,
                FusionShrineDisplay::new
            );
        registry
            .registerRecipeFiller(
                EnchanterCraftingRecipe.class,
                PastelRecipeTypes.ENCHANTER,
                EnchanterEnchantingDisplay::new
            );
        registry
            .registerRecipeFiller(
                EnchantmentUpgradeRecipe.class,
                PastelRecipeTypes.ENCHANTMENT_UPGRADE,
                EnchantmentUpgradeDisplay::new
            );
        registry
            .registerRecipeFiller(
                PotionWorkshopBrewingRecipe.class,
                PastelRecipeTypes.POTION_WORKSHOP_BREWING,
                PotionWorkshopBrewingDisplay::new
            );
        registry
            .registerRecipeFiller(
                PotionWorkshopCraftingRecipe.class,
                PastelRecipeTypes.POTION_WORKSHOP_CRAFTING,
                PotionWorkshopCraftingDisplay::new
            );
        registry
            .registerRecipeFiller(
                SpiritInstillerRecipe.class,
                PastelRecipeTypes.SPIRIT_INSTILLING,
                SpiritInstillingDisplay::new
            );
        registry
            .registerRecipeFiller(
                HumusConvertingRecipe.class,
                PastelRecipeTypes.HUMUS_CONVERTING,
                HumusConvertingDisplay::new
            );
        registry
            .registerRecipeFiller(
                LiquidCrystalConvertingRecipe.class,
                PastelRecipeTypes.LIQUID_CRYSTAL_CONVERTING,
                LiquidCrystalConvertingDisplay::new
            );
        registry
            .registerRecipeFiller(
                MidnightSolutionConvertingRecipe.class,
                PastelRecipeTypes.MIDNIGHT_SOLUTION_CONVERTING,
                MidnightSolutionConvertingDisplay::new
            );
        registry
            .registerRecipeFiller(
                DragonrotConvertingRecipe.class,
                PastelRecipeTypes.DRAGONROT_CONVERTING,
                DragonrotConvertingDisplay::new
            );
        registry
            .registerRecipeFiller(
                InkConvertingRecipe.class,
                PastelRecipeTypes.INK_CONVERTING,
                InkConvertingDisplay::new
            );
        registry
            .registerRecipeFiller(
                PotionWorkshopReactingRecipe.class,
                PastelRecipeTypes.POTION_WORKSHOP_REACTING,
                PotionWorkshopReactingDisplay::new
            );
        registry
            .registerRecipeFiller(
                CrystallarieumRecipe.class,
                PastelRecipeTypes.CRYSTALLARIEUM,
                CrystallarieumDisplay::new
            );
        registry
            .registerRecipeFiller(
                CinderhearthRecipe.class,
                PastelRecipeTypes.CINDERHEARTH,
                CinderhearthDisplay::new
            );
        registry
            .registerRecipeFiller(
                ITitrationBarrelRecipe.class,
                PastelRecipeTypes.TITRATION_BARREL,
                TitrationBarrelDisplay::new
            );
        registry
            .registerRecipeFiller(
                PrimordialFireBurningRecipe.class,
                PastelRecipeTypes.PRIMORDIAL_FIRE_BURNING,
                PrimordialFireBurningDisplay::new
            );

        NaturesStaffConversionDataLoader.CONVERSIONS
            .forEach(
                (key, value) -> registry
                    .add(
                        new NaturesStaffConversionsDisplay(
                            EntryStacks.of(key),
                            EntryStacks.of(value.getBlock()),
                            NaturesStaffConversionDataLoader.UNLOCK_IDENTIFIERS
                                .getOrDefault(
                                    key,
                                    null
                                )
        ...
        FreezingIdolBlock.FREEZING_STATE_MAP
            .forEach(
                (key, value) -> registry
                    .add(
                        new FreezingDisplay(
        ...
        FreezingIdolBlock.FREEZING_MAP
            .forEach(
                (key, value) -> registry
                    .add(
                        new FreezingDisplay(
                            BlockToBlockWithChanceDisplay.blockToEntryStack(key),
                            BlockToBlockWithChanceDisplay
                                .blockToEntryStack(
                                    value
                                        .getA()
        ...
        FirestarterIdolBlock.BURNING_MAP
            .forEach(
                (key, value) -> registry
                    .add(
                        new HeatingDisplay(
        ...
        registry.registerVisibilityPredicate((category, display) -> {
            ...
            if (display instanceof GatedRecipeDisplay gatedRecipeDisplay) {
                if (!gatedRecipeDisplay
                    .isUnlocked() && (PastelCommon.CONFIG.REIListsRecipesAsNotUnlocked || gatedRecipeDisplay
                        .isSecret())) {
    ...
    public void registerScreens(ScreenRegistry registry) {
        ...
        registry
            .registerContainerClickArea(
                new Rectangle(89, 37, 10, 15),
                PedestalScreen.class,
                BuiltinPlugin.CRAFTING
            );
        registry
            .registerContainerClickArea(
                new Rectangle(100, 37, 11, 15),
                PedestalScreen.class,
                PastelPlugins.PEDESTAL_CRAFTING
            );

        registry
            .registerContainerClickArea(
                new Rectangle(28, 41, 10, 42),
                PotionWorkshopScreen.class,
                PastelPlugins.POTION_WORKSHOP_BREWING
            );
        registry
            .registerContainerClickArea(
        ...
        registry
            .registerContainerClickArea(
                new Rectangle(35, 33, 22, 15),
                CinderhearthScreen.class,
                PastelPlugins.CINDERHEARTH
            );
        registry
            .registerContainerClickArea(
                new Rectangle(35, 33, 22, 15),
                CinderhearthScreen.class,
                BuiltinPlugin.BLASTING
            );
    ...
    public void registerTransferHandlers(TransferHandlerRegistry registry) {
        ...
        registry
            .register(
                SimpleTransferHandlerExtension
                    .create(
                        PedestalScreenHandler.class,
                        PastelPlugins.PEDESTAL_CRAFTING,
                ...
                .register(
                    SimpleTransferHandlerExtension
                        .create(
                            ...
                            BuiltinPlugin.CRAFTING,
                            new SimpleTransferHandler.IntRange(0, 9),
                            new SimpleTransferHandler.IntRange(16, 52)
                        )
                );
        }
        registry
            .register(
                SimpleTransferHandlerExtension
                    .create(
                        CinderhearthScreenHandler.class,
                        PastelPlugins.CINDERHEARTH,
                        new SimpleTransferHandler.IntRange(2, 3),
                        new SimpleTransferHandler.IntRange(11, 47)
                    )
            );
        registry
            .register(
        ...
        registry
            .register(
                SimpleTransferHandlerExtension
                    .create(
                        PotionWorkshopScreenHandler.class,
                        PastelPlugins.POTION_WORKSHOP_BREWING,
                        new SimpleTransferHandler.IntRange(0, 9),
                        new SimpleTransferHandler.IntRange(21, 57)
                    )
            );
        registry
            .register(
        ...
        static <C extends AbstractContainerMenu, D extends Display> SimpleTransferHandler create(
            ...
            return new SimpleTransferHandler() {
                ...
                public ApplicabilityResult checkApplicable(Context context) {
                    if (!containerClass.isInstance(context.getMenu()) || !categoryIdentifier
                        .equals(
                            context
                                .getDisplay()
                ...
                public Iterable<SlotAccessor> getInputSlots(Context context) {
                    return context.getMenu().slots
                        .subList(inputSlots.min(), inputSlots.maxExclusive())
                        .stream()
                ...
                public Iterable<SlotAccessor> getInventorySlots(Context context) {
                    return context.getMenu().slots
                        .subList(inventorySlots.min(), inventorySlots.maxExclusive())
                        .stream()
                        .map(SlotAccessor::fromSlot)
                        .toList();
                }
        ...
        static <C extends AbstractContainerMenu, D extends Display> SimpleTransferHandler create(
            ...
            return new SimpleTransferHandler() {
                ...
                public Iterable<SlotAccessor> getInventorySlots(Context context) {
                    ...
                    for (
                        SimpleTransferHandler.IntRange range : inventorySlotsRanges
                    ) {
                        s = Stream
                            .concat(
                                s,
                                context.getMenu().slots
                                    .subList(range.min(), range.maxExclusive())
                                    .stream()
                                    .map(SlotAccessor::fromSlot)
                            );
                    }

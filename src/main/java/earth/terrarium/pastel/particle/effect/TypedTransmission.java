...
public class TypedTransmission extends SimpleTransmission {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, TypedTransmission> STREAM_CODEC = StreamCodec
        .composite(
            ...
            ByteBufCodecs.INT,
            c -> c.arrivalInTicks,
            PacketCodecHelper.enumOf(Variant::values),
            c -> c.variant,
            TypedTransmission::new
        );

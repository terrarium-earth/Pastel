...
public class CookingRecipes {
    private record CookingPrefixes(
        ...
        public void recipe(int flags, String name, Ingredient input, RecipeCategory category, ItemLike result, float xp, Consumer<SimpleCookingRecipeBuilder> appender) {
            if ((flags & SMELTING) != 0) {
                var builder =
            ...
            if ((flags & CAMPFIRE) != 0) {
                ...
                appender.accept(builder);
                campfireCooking.generateRecipe(
                        name,
                        builder
                );
            }
        ...
        public void recipe(int flags, Ingredient input, RecipeCategory category, ItemLike result, float xp, Consumer<SimpleCookingRecipeBuilder> appender) {
    ...
    private static void food(CookingPrefixes pfxs) {
        pfxs.recipe(
                ...
                Ingredient.of(LIZARD_MEAT),
                RecipeCategory.FOOD,
                COOKED_LIZARD_MEAT,
                0.35f,
                it -> it.unlockedBy("has_input", RecipeUtil.has(LIZARD_MEAT))
        );
    }
    ...
    private static final List<OreRecipe> ORES =
            List.of(
                    ...
                    new OreRecipe("shimmerstone_ores", PastelItemTags.SHIMMERSTONE_ORES, PastelItems.SHIMMERSTONE_GEM.asItem(), 0.1f),
    ...
    private static final List<OreRecipe> BLACKSLAG_ORE =
            List.of(
    ...
    private static final Map<DeferredItem<?>, ItemLike> PURE_RESOURCES =
            Map.ofEntries(
                    entry(PURE_COAL, Items.COAL),
                    entry(PURE_COPPER, Items.COPPER_INGOT),
                    entry(PURE_DIAMOND, Items.DIAMOND),
                    entry(PURE_ECHO, Items.ECHO_SHARD),
                    entry(PURE_EMERALD, Items.EMERALD),
                    entry(PURE_GLOWSTONE, Items.GLOWSTONE_DUST),
                    entry(PURE_GOLD, Items.GOLD_INGOT),
                    entry(PURE_IRON, Items.IRON_INGOT),
                    entry(PURE_LAPIS, Items.LAPIS_LAZULI),
                    entry(PURE_NETHERITE_SCRAP, Items.NETHERITE_SCRAP),
                    entry(PURE_PRISMARINE, Items.PRISMARINE_CRYSTALS),
                    entry(PURE_QUARTZ, Items.QUARTZ),
                    entry(PURE_REDSTONE, Items.REDSTONE)
            );
    ...
    private static void root(CookingPrefixes pfxs) {
        ...
        unsmeltConversion(pfxs, PastelBlocks.POLISHED_BASAL_MARBLE,
        ...
        unsmeltConversion(pfxs, PastelBlocks.POLISHED_BASALT,
        ...
        unsmeltConversion(pfxs, PastelBlocks.POLISHED_CALCITE,
        ...
        unsmeltConversion(pfxs, PastelBlocks.POLISHED_BLACKSLAG,
        ...
        unsmeltConversion(pfxs, PastelBlocks.POLISHED_SHALE_CLAY,
    ...
    private static void simpleConversion(CookingPrefixes pfxs, String name, Either<TagKey<Item>, Item> input, ItemLike output) {

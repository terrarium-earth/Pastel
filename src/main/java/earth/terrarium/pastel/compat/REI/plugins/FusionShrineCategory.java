...
public class FusionShrineCategory extends GatedDisplayCategory<FusionShrineDisplay> {
    ...
    private static final EntryIngredient FUSION_SHRINE_BASALT = EntryIngredients
        .of(
    ...
    public void setupWidgets(
        ...
        Rectangle bounds,
        List<Widget> widgets,
        @NotNull FusionShrineDisplay display
    ) {
        ...
        if (!inputs
            ...
            widgets
                .add(
                    Widgets
                        .createSlot(new Point(startPoint.x + 10, startPoint.y - 7 + 35))
            ...
            widgets
                .add(
                    Widgets
                        .createSlot(new Point(startPoint.x + 30, startPoint.y - 7 + 35))
                        .markInput()
            ...
            widgets
                .add(
                    Widgets
                        .createSlot(new Point(startPoint.x + 20, startPoint.y - 7 + 35))
                        .entries(FUSION_SHRINE_BASALT)
                        .disableBackground()
                );
        }
        ...
        for (
            ...
            widgets
                .add(
                    Widgets
                        .createSlot(new Point(startPoint.x + startX + i * 20, startPoint.y - 7 + 9))
                        .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 95, startPoint.y - 7 + 35))
                    .markOutput()
                    .disableBackground()
                    .entries(
                        display
        ...
        if (display
            ...
            widgets
                .add(
                    Widgets
                        .createLabel(new Point(startPoint.x - 10, startPoint.y - 13 + 65), description)
                        .leftAligned()
                        .color(0x3f3f3f)
                        .noShadow()
                );
        ...
        widgets
            .add(
                Widgets
                    .createLabel(new Point(startPoint.x - 10, startPoint.y - 13 + 75), text)
                    .leftAligned()
                    .color(0x3f3f3f)
                    .noShadow()
            );

...
import static earth.terrarium.pastel.registries.PastelItems.ALOE_LEAF;
...
import static earth.terrarium.pastel.registries.PastelItems.BITTER_OILS;
...
import static earth.terrarium.pastel.registries.PastelItems.BRISTLE_MEAD;
import static earth.terrarium.pastel.registries.PastelItems.CITRINE_POWDER;
...
import static earth.terrarium.pastel.registries.PastelItems.EVERNECTAR;
import static earth.terrarium.pastel.registries.PastelItems.FADED_KOI;
import static earth.terrarium.pastel.registries.PastelItems.FISSURE_PLUM;
import static earth.terrarium.pastel.registries.PastelItems.FREIGEIST;
...
import static earth.terrarium.pastel.registries.PastelItems.LE_FISHE_AU_CHOCOLAT;
...
import static earth.terrarium.pastel.registries.PastelItems.MORCHELLA;
...
import static earth.terrarium.pastel.registries.PastelItems.NIGHT_SALTS;
...
import static earth.terrarium.pastel.registries.PastelItems.PURE_ALCOHOL;
...
import static earth.terrarium.pastel.registries.PastelItems.REPRISE;
import static earth.terrarium.pastel.registries.PastelItems.SAWBLADE_HOLLY_BERRY;
...
import static earth.terrarium.pastel.registries.PastelItems.SURSTROMMING;

public class TitrationBarrelRecipes {
    private static final String INFUSED_BEVERAGES = "infused_beverages";

    private static final TagKey<Item> RICE = TagKey
        .create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "foods/rices"));

    private static FermentationStatusEffectEntry overdose(Holder<MobEffect> effect, float minAlc, float minThickness) {
        return FermentationStatusEffectEntryBuilder
            .of(effect, 600)
            .potencyAlc(0, minAlc)
        ...
        sakePfx
            .generateAutoNamedRecipe(
                TitrationBarrelRecipeBuilder
                    ...
                    .neoCondition(
                        // ???
                        new PastelLoadConditions.PastelTagsPopulatedResourceCondition(
    ...
    private static void infusedBeverages(PrefixHelper pfx) {
        ...
        var gatorWineRecipe = infusedCommon(
            PastelFluids.LIQUID_CRYSTAL.get(),
        ...
        var swiftnessEffect = gatorWineRecipe
            .statusEffect(PastelMobEffects.SWIFTNESS, 9600)
            .simplePotencyEntry(0);
        var speedEffect = gatorWineRecipe.statusEffect(MobEffects.MOVEMENT_SPEED, 9600);
    ...
    private static TitrationBarrelRecipeBuilder simpleInfused(
        InfusedBeverageComponent component,
        Holder<MobEffect> primary
    ) {
        return infusedCommon(Fluids.WATER, component)
            .minFermentationTimeHours(4)
            .fermentationSpeedMod(0)
    ...
    private static TitrationBarrelRecipeBuilder infusedCommon(@Nullable Fluid fluid, InfusedBeverageComponent component) {
        ...
        return TitrationBarrelRecipeBuilder
            .infusedBeverage(
                ingredient,
                component,
                4

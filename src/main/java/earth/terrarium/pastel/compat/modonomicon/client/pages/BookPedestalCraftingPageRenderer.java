...
public class BookPedestalCraftingPageRenderer
    extends
    BookGatedRecipePageRenderer<PedestalRecipe, BookGatedRecipePage<PedestalRecipe>> {

    private static final ResourceLocation BACKGROUND_TEXTURE1 = PastelCommon
        .locate(
            "textures/gui/modonomicon/pedestal_crafting1.png"
        );

    private static final ResourceLocation BACKGROUND_TEXTURE2 = PastelCommon
        .locate(
            "textures/gui/modonomicon/pedestal_crafting2.png"
        );

    private static final ResourceLocation BACKGROUND_TEXTURE3 = PastelCommon
        .locate(
            "textures/gui/modonomicon/pedestal_crafting3.png"
        );

    private static final ResourceLocation BACKGROUND_TEXTURE4 = PastelCommon
        .locate(
    ...
    protected void drawRecipe(
        ...
        RecipeHolder<PedestalRecipe> recipeEntry,
        int recipeX,
        int recipeY,
        int mouseX,
        int mouseY,
        ...
        drawContext
            .blit(
                getBackgroundTextureForTier(recipe.getTier()),
                recipeX - 2,
                recipeY - 2,
                0,
                0,
    ...
    private void drawGemstonePowderSlots(
        ...
        int h = 0;
        for (
            GemstoneColor color : colors
        ) {
            int amount = recipe
                .getPowderInputs()
                .getOrDefault(color, 0);
            if (amount > 0) {
                ItemStack stack = color
                    .getPowder()
                    .getDefaultInstance();

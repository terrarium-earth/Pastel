...
public class GemstoneBlockModels {
    ...
    public static void generateItemModels(ItemModelGenerators generators){
        ...
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.MEDIUM_TOPAZ_BUD,PastelClusterBlock.GrowthStage.MEDIUM);
        PastelModelHelper.ITEM.cluster(generators, PastelBlocks.SMALL_TOPAZ_BUD, PastelClusterBlock.GrowthStage.SMALL);

        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.CITRINE_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_CITRINE_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.MEDIUM_CITRINE_BUD,PastelClusterBlock.GrowthStage.MEDIUM);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_CITRINE_BUD,PastelClusterBlock.GrowthStage.SMALL);
        ...
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.MOONSTONE_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_MOONSTONE_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.MEDIUM_MOONSTONE_BUD,PastelClusterBlock.GrowthStage.MEDIUM);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_MOONSTONE_BUD,PastelClusterBlock.GrowthStage.SMALL);

        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.BISMUTH_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_BISMUTH_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_BISMUTH_BUD,PastelClusterBlock.GrowthStage.SMALL);
        ...
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_DIAMOND_BUD,PastelClusterBlock.GrowthStage.SMALL);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_DIAMOND_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.DIAMOND_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_EMERALD_BUD,PastelClusterBlock.GrowthStage.SMALL);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_EMERALD_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.EMERALD_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_REDSTONE_BUD,PastelClusterBlock.GrowthStage.SMALL);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_REDSTONE_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.REDSTONE_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        ...
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_NETHERITE_SCRAP_BUD,PastelClusterBlock.GrowthStage.SMALL);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_NETHERITE_SCRAP_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.NETHERITE_SCRAP_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        ...
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_GLOWSTONE_BUD,PastelClusterBlock.GrowthStage.SMALL);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_GLOWSTONE_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.GLOWSTONE_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_PRISMARINE_BUD,PastelClusterBlock.GrowthStage.SMALL);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_PRISMARINE_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.PRISMARINE_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);

        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.AZURITE_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_AZURITE_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_AZURITE_BUD,PastelClusterBlock.GrowthStage.SMALL);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.MALACHITE_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_MALACHITE_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_MALACHITE_BUD,PastelClusterBlock.GrowthStage.SMALL);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.BLOODSTONE_CLUSTER,PastelClusterBlock.GrowthStage.CLUSTER);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.LARGE_BLOODSTONE_BUD,PastelClusterBlock.GrowthStage.LARGE);
        PastelModelHelper.ITEM.cluster(generators,PastelBlocks.SMALL_BLOODSTONE_BUD,PastelClusterBlock.GrowthStage.SMALL);
    }
}

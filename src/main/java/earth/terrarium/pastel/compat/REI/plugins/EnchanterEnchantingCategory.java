...
public class EnchanterEnchantingCategory extends EnchanterCategory<EnchanterEnchantingDisplay> {
    ...
    public void setupWidgets(
        Point startPoint, Rectangle bounds, List<Widget> widgets, @NotNull EnchanterEnchantingDisplay display) {
        ...
        widgets.add(Widgets.createSlot(new Point(startPoint.x - 8 + 111, startPoint.y - 7 + 14))
                           .markInput()
        ...
        // center input slot
        widgets.add(Widgets.createSlot(new Point(startPoint.x - 8 + 31, startPoint.y - 7 + 40))
                           .markInput()
        ...
        widgets.add(Widgets.createSlot(new Point(startPoint.x - 8 + 111, startPoint.y - 7 + 40))
                           .markOutput()
                           .disableBackground()
                           .entries(output.get(0)));

        widgets.add(Widgets.createLabel(
                               new Point(startPoint.x - 11 + 70, startPoint.y - 11 + 85), getDescriptionText(display))
                           .leftAligned()
                           .color(0x3f3f3f)
                           .noShadow());
    }

...
public class PastelRenderHelper {
    ...
    private static void renderBeamVertex(
        ...
        vertices
            .addVertex(positionMatrix, (float) transform.x, (float) transform.y, (float) transform.z)
    ...
    private static Vec3 transform(final Vec3 vec, final double[] mat) {
        final double x = mat[matIndex(0, 0)] * vec.x + mat[matIndex(0, 1)] * vec.y + mat[matIndex(
            0,
            2
        )] * vec.z + mat[matIndex(0, 3)];
        final double y = mat[matIndex(1, 0)] * vec.x + mat[matIndex(1, 1)] * vec.y + mat[matIndex(
            1,
            2
        )] * vec.z + mat[matIndex(1, 3)];
        final double z = mat[matIndex(2, 0)] * vec.x + mat[matIndex(2, 1)] * vec.y + mat[matIndex(
            2,
            2
        )] * vec.z + mat[matIndex(2, 3)];

...
@OnlyIn(Dist.CLIENT)
public class GuardianHeadModel extends PastelSkullModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild(
            PartNames.EYES, CubeListBuilder.create()
                                           .texOffs(8, 0)
                                           .addBox(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F),
            PartPose.offset(0.0F, -24.0F, -8.25F)
        );

        PartDefinition spikes = head.addOrReplaceChild(
            "spikes", CubeListBuilder.create(), PartPose.offset(0.0F, -8.0F, 0.0F));
        spikes.addOrReplaceChild(
            "spike_r1", CubeListBuilder.create()
                                       .texOffs(0, 0)
                                       .addBox(-1.0F, -17.0F, -1.0F, 2.0F, 9.0F, 2.0F),
            PartPose.rotation(0.0F, 0.0F, -0.7854F)
        );
        spikes.addOrReplaceChild(
            "spike_r2", CubeListBuilder.create()
                                       .texOffs(0, 0)
                                       .addBox(-1.0F, -17.0F, -1.0F, 2.0F, 9.0F, 2.0F),
            PartPose.rotation(0.7854F, 0.0F, 0.0F)
        );
        spikes.addOrReplaceChild(
            "spike_r3", CubeListBuilder.create()
                                       .texOffs(0, 0)
                                       .addBox(-1.0F, -17.0F, -1.0F, 2.0F, 9.0F, 2.0F),
            PartPose.rotation(2.3562F, 0.0F, 0.0F)
        );
        spikes.addOrReplaceChild(
            "spike_r4", CubeListBuilder.create()
                                       .texOffs(0, 0)
                                       .addBox(-1.0F, -17.0F, -1.0F, 2.0F, 9.0F, 2.0F),
            PartPose.rotation(0.0F, 0.0F, 2.3562F)
        );
        spikes.addOrReplaceChild(
            "spike_r5", CubeListBuilder.create()
                                       .texOffs(0, 0)
                                       .addBox(-1.0F, -17.0F, -1.0F, 2.0F, 9.0F, 2.0F),
            PartPose.rotation(0.0F, 0.0F, -2.3562F)
        );
        spikes.addOrReplaceChild(
            "spike_r6", CubeListBuilder.create()
                                       .texOffs(0, 0)
                                       .addBox(-1.0F, -17.0F, -1.0F, 2.0F, 9.0F, 2.0F),
            PartPose.rotation(-2.3562F, 0.0F, 0.0F)
        );
        spikes.addOrReplaceChild(
            "spike_r7", CubeListBuilder.create()
                                       .texOffs(0, 0)
                                       .addBox(-1.0F, -17.0F, -1.0F, 2.0F, 9.0F, 2.0F),
            PartPose.rotation(-0.7854F, 0.0F, 0.0F)
        );
        spikes.addOrReplaceChild(
            "spike_r8", CubeListBuilder.create()
                                       .texOffs(0, 0)
                                       .addBox(-1.0F, -17.0F, -1.0F, 2.0F, 9.0F, 2.0F),
            PartPose.rotation(0.0F, 0.0F, 0.7854F)
        );

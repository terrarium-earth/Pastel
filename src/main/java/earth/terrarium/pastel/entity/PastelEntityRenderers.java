...
import earth.terrarium.pastel.entity.render.EnderCanvasEntityRenderer;
...
import earth.terrarium.pastel.entity.render.WireHookEntityRenderer;
...
public class PastelEntityRenderers {
    ...
    public static void registerClient(FMLClientSetupEvent event) {
        ...
        register(PastelEntityTypes.DARK_STAKE.get(), ThrownItemRenderer::new);
    }

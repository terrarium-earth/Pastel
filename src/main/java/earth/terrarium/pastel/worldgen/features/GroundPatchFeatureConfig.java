...
public record GroundPatchFeatureConfig(
    TagKey<Block> replaceable, BlockStateProvider groundState,
    ...
    public static final Codec<GroundPatchFeatureConfig> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
                                                                                                                    ...
                                                                                                                    PlacedFeature.CODEC.fieldOf("vegetation_feature")
                                                                                                                                       .forGetter((config) -> config.vegetationFeature),
                                                                                                                    CaveSurface.CODEC.fieldOf("surface")
                                                                                                                                     .forGetter((config) -> config.surface),
                                                                                                                    IntProvider.codec(1, 128)
                                                                                                                               .fieldOf("depth")
                                                                                                                    ...
                                                                                                                    IntProvider.CODEC.fieldOf("xz_radius")

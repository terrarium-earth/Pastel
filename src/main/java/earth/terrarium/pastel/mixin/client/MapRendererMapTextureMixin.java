...
@Mixin(
    MapRenderer.MapInstance.class
)
public class MapRendererMapTextureMixin {

    @WrapOperation(
        method = "draw", at = @At(
            value = "INVOKE", target = "Lcom/mojang/blaze3d/vertex/PoseStack;scale(FFF)V"
        )
    )
    public void scaleDecorations(
        ...
        float scale = (float) ((int) ((MapDecorationInjector) (Object) decoration).getScale() + 128) / 128;

...
public class ParticleSpawnerScreen extends AbstractContainerScreen<ParticleSpawnerScreenHandler> {
    ...
    protected static final ResourceLocation GUI_TEXTURE = PastelCommon.locate(
        "textures/gui/container/particle_spawner.png");
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        if (focusedElement instanceof EditBox focusedTextFieldWidget) {
            if (keyCode == GLFW.GLFW_KEY_TAB) {
                ...
                if (modifiers == 1) {
                    setFocused(selectableWidgets.get(
                        (selectableWidgets.size() + currentIndex - 1) % selectableWidgets.size()));
                } else {
                    setFocused(selectableWidgets.get((currentIndex + 1) % selectableWidgets.size()));
                }
            }
            return focusedElement.keyPressed(keyCode, scanCode, modifiers) || super.keyPressed(
    ...
    protected void renderLabels(GuiGraphics drawContext, int mouseX, int mouseY) {
        ...
        drawContext.drawString(
            tr, Component.literal("C")
                         .withStyle(ChatFormatting.AQUA), 7, 54, TEXT_COLOR, false
        );
        drawContext.drawString(
            tr, Component.literal("M")
                         .withStyle(ChatFormatting.LIGHT_PURPLE), 47, 54, TEXT_COLOR, false
        );
        drawContext.drawString(
            tr, Component.literal("Y")
                         .withStyle(ChatFormatting.GOLD), 90, 54, TEXT_COLOR, false
        );
		/*  this still uses the old color format, since it is easier to read on the background
		drawContext.drawText(tr, Text.literal("C").setStyle(Style.EMPTY.withColor(InkColors.CYAN_COLOR)), 7, 54,
		TEXT_COLOR, false);
		drawContext.drawText(tr, Text.literal("M").setStyle(Style.EMPTY.withColor(InkColors.MAGENTA_COLOR)), 47, 54,
		TEXT_COLOR, false);
		drawContext.drawText(tr, Text.literal("Y").setStyle(Style.EMPTY.withColor(InkColors.YELLOW_COLOR)), 90, 54,
		TEXT_COLOR, false);
		 */
        ...
        int offset = 23;
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.particle_count"), 10, 53 + offset, TEXT_COLOR,
            false
        );
        ...
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.offset"), 10, 78 + offset, TEXT_COLOR, false);
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.variance"), 21, 97 + offset, TEXT_COLOR, false);
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.velocity"), 10, 117 + offset, TEXT_COLOR, false);
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.variance"), 21, 137 + offset, TEXT_COLOR, false);
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.scale"), 10, 161 + offset, TEXT_COLOR, false);
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.variance"), 91, 161 + offset, TEXT_COLOR, false);
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.duration"), 10, 181 + offset, TEXT_COLOR, false);
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.variance"), 91, 181 + offset, TEXT_COLOR, false);
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.gravity"), 10, 201 + offset, TEXT_COLOR, false);
        drawContext.drawString(
            tr, Component.translatable("block.pastel.particle_spawner.collisions"), 90, 201 + offset, TEXT_COLOR,
            false
        );
    }
    ...
    protected void renderBg(GuiGraphics drawContext, float delta, int mouseX, int mouseY) {
        ...
        if (particleSelectionIndex / PARTICLES_PER_PAGE == activeParticlePage) {
            drawContext.blit(
                GUI_TEXTURE, x + 27 + (20 * (particleSelectionIndex % PARTICLES_PER_PAGE)), y + 19, 192, 0, 22, 22);
        }
        ...
        for (int j = 0; j < PARTICLES_PER_PAGE; j++) {
            ...
            TextureAtlasSprite particleSprite = spriteAtlasTexture.getSprite(displayedParticleEntries.get(spriteIndex)
                                                                                                     .textureIdentifier());
            SpriteContents contents = particleSprite.contents();
            drawContext.blit(
                x + 38 + j * 20 - contents.width() / 2, y + 31 - contents.height() / 2, 0, contents.width(),
                contents.height(), particleSprite
            );
        }
    }
    ...
    protected void setupInputFields(ParticleSpawnerBlockEntity blockEntity) {
        ...
        cyanField = addTextFieldWidget(
            startX + 16, startY + 51, Component.literal("Cyan"), String.valueOf(configuration.cmyColor()
                                                                                             .getX()),
            this::isPositiveDecimalNumber100
        );
        magentaField = addTextFieldWidget(
            startX + 57, startY + 51, Component.literal("Magenta"), String.valueOf(configuration.cmyColor()
                                                                                                .getY()),
            this::isPositiveDecimalNumber100
        );
        yellowField = addTextFieldWidget(
            startX + 97, startY + 51, Component.literal("Yellow"), String.valueOf(configuration.cmyColor()
                                                                                               .getZ()),
            this::isPositiveDecimalNumber100
        );
        ...
        int offset = 23;
        amountField = addTextFieldWidget(
            startX + 110, startY + 50 + offset, Component.literal("Particles per Second"),
            String.valueOf(configuration.particlesPerSecond()), this::isPositiveDecimalNumberUnderThousand
        );
        positionXField = addTextFieldWidget(
            startX + 61, startY + 74 + offset, Component.literal("X Position"),
            String.valueOf(configuration.sourcePosition().x), this::isAbsoluteDecimalNumberThousand
        );
        positionYField = addTextFieldWidget(
            startX + 96, startY + 74 + offset, Component.literal("Y Position"),
            String.valueOf(configuration.sourcePosition().y), this::isAbsoluteDecimalNumberThousand
        );
        positionZField = addTextFieldWidget(
            startX + 131, startY + 74 + offset, Component.literal("Z Position"),
            String.valueOf(configuration.sourcePosition().z), this::isAbsoluteDecimalNumberThousand
        );
        positionXVarianceField = addTextFieldWidget(
            startX + 69, startY + 94 + offset, Component.literal("X Position Variance"),
            String.valueOf(configuration.sourcePositionVariance().x), this::isAbsoluteDecimalNumberThousand
        );
        positionYVarianceField = addTextFieldWidget(
            startX + 104, startY + 94 + offset, Component.literal("Y Position Variance"),
            String.valueOf(configuration.sourcePositionVariance().y), this::isAbsoluteDecimalNumberThousand
        );
        positionZVarianceField = addTextFieldWidget(
            startX + 140, startY + 94 + offset, Component.literal("Z Position Variance"),
            String.valueOf(configuration.sourcePositionVariance().z), this::isAbsoluteDecimalNumberThousand
        );
        velocityXField = addTextFieldWidget(
            startX + 61, startY + 114 + offset, Component.literal("X Velocity"),
            String.valueOf(configuration.velocity().x), this::isAbsoluteDecimalNumberThousand
        );
        velocityYField = addTextFieldWidget(
            startX + 96, startY + 114 + offset, Component.literal("Y Velocity"),
            String.valueOf(configuration.velocity().y), this::isAbsoluteDecimalNumberThousand
        );
        velocityZField = addTextFieldWidget(
            startX + 131, startY + 114 + offset, Component.literal("Z Velocity"),
            String.valueOf(configuration.velocity().z), this::isAbsoluteDecimalNumberThousand
        );
        velocityXVarianceField = addTextFieldWidget(
            startX + 69, startY + 134 + offset, Component.literal("X Velocity Variance"),
            String.valueOf(configuration.velocityVariance().x), this::isAbsoluteDecimalNumberThousand
        );
        velocityYVarianceField = addTextFieldWidget(
            startX + 104, startY + 134 + offset, Component.literal("Y Velocity Variance"),
            String.valueOf(configuration.velocityVariance().y), this::isAbsoluteDecimalNumberThousand
        );
        velocityZVarianceField = addTextFieldWidget(
            startX + 140, startY + 134 + offset, Component.literal("Z Velocity Variance"),
            String.valueOf(configuration.velocityVariance().z), this::isAbsoluteDecimalNumberThousand
        );
        scale = addTextFieldWidget(
            startX + 55, startY + 158 + offset, Component.literal("Scale"), String.valueOf(configuration.scale()),
            this::isPositiveDecimalNumberUnderTen
        );
        scaleVariance = addTextFieldWidget(
            startX + 139, startY + 158 + offset, Component.literal("Scale Variance"),
            String.valueOf(configuration.scaleVariance()), this::isPositiveDecimalNumberUnderTen
        );
        duration = addTextFieldWidget(
            startX + 55, startY + 178 + offset, Component.literal("Duration"),
            String.valueOf(configuration.lifetimeTicks()), this::isPositiveWholeNumberUnderThousand
        );
        durationVariance = addTextFieldWidget(
            startX + 139, startY + 178 + offset, Component.literal("Duration Variance"),
            String.valueOf(configuration.lifetimeVariance()), this::isPositiveWholeNumberUnderThousand
        );
        gravity = addTextFieldWidget(
            startX + 55, startY + 198 + offset, Component.literal("Gravity"), String.valueOf(configuration.gravity()),
            this::isBetweenZeroAndOne
        );

        collisionsButton = Button.builder(
                                     Component.translatable("gui.pastel.button.collisions"),
                                     this::collisionButtonPressed)
        ...
        forwardButton = Button.builder(
                                  Component.translatable("gui.pastel.button.forward"), this::navigationButtonPressed)
                              .size(12, 14)
    ...
    private @NotNull EditBox addTextFieldWidget(
        int x, int y, Component text, String defaultText, Predicate<String> textPredicate) {
    ...
    private @NotNull Button addParticleButton(int x, int y) {
        Button button = Button.builder(
                                  Component.translatable("gui.pastel.button.particles"), this::particleButtonPressed)
                              .size(20, 20)
                              .pos(x, y)
                              .build();
        addWidget(button);
    ...
    private void onValuesChanged() {
        try {
            ParticleSpawnerConfiguration configuration = new ParticleSpawnerConfiguration(
                displayedParticleEntries.get(particleSelectionIndex)
                                        .particleType(),
                selectedParticleSupportsColoring ? new Vec3i(
                    Math.round(Float.parseFloat(cyanField.getValue())),
                    Math.round(Float.parseFloat(magentaField.getValue())),
                    Math.round(Float.parseFloat(yellowField.getValue()))
                ) : new Vec3i(0, 0, 0),
                glowing,
                Float.parseFloat(amountField.getValue()),
                new Vec3(
                    Double.parseDouble(positionXField.getValue()), Double.parseDouble(positionYField.getValue()),
                    Double.parseDouble(positionZField.getValue())
                ),
                new Vec3(
                    Double.parseDouble(positionXVarianceField.getValue()),
                    Double.parseDouble(positionYVarianceField.getValue()),
                    Double.parseDouble(positionZVarianceField.getValue())
                ),
                new Vec3(
                    Double.parseDouble(velocityXField.getValue()), Double.parseDouble(velocityYField.getValue()),
                    Double.parseDouble(velocityZField.getValue())
                ),
                new Vec3(
                    Double.parseDouble(velocityXVarianceField.getValue()),
                    Double.parseDouble(velocityYVarianceField.getValue()),
                    Double.parseDouble(velocityZVarianceField.getValue())
                ),

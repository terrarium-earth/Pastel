...
public class ColoredBlockModels {
    ...
    public static void generateBlockModels(BlockModelGenerators generators) {
        ...
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.BROWN_CUSHION, PastelTexturedModels.TINTED_CUSHION);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.GREEN_CUSHION, PastelTexturedModels.TINTED_CUSHION);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.RED_CUSHION, PastelTexturedModels.TINTED_CUSHION);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.BLACK_CUSHION, PastelTexturedModels.TINTED_CUSHION);

        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.BLACK_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.BLUE_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.BROWN_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.CYAN_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.GRAY_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.GREEN_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.LIGHT_BLUE_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.LIGHT_GRAY_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.LIME_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.MAGENTA_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.ORANGE_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.PINK_SAPLING);
        PastelModelHelper.BLOCK.cross(generators, PastelBlocks.PURPLE_SAPLING);
        ...
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_BROWN_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_CYAN_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_GRAY_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_GREEN_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_LIGHT_BLUE_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_LIGHT_GRAY_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_LIME_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_MAGENTA_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_ORANGE_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_PINK_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_PURPLE_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_RED_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_WHITE_SAPLING, false);
        PastelModelHelper.BLOCK.pottedPlant(generators, PastelBlocks.POTTED_YELLOW_SAPLING, false);

        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_BLACK_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_BLUE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_BROWN_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_CYAN_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_GRAY_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_GREEN_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_LIGHT_BLUE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_LIGHT_GRAY_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_LIME_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_MAGENTA_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_ORANGE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_PINK_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_PURPLE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_RED_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_WHITE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.STRIPPED_YELLOW_LOG);

        PastelModelHelper.BLOCK.log(generators, PastelBlocks.BLACK_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.BLUE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.BROWN_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.CYAN_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.GRAY_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.GREEN_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.LIGHT_BLUE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.LIGHT_GRAY_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.LIME_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.MAGENTA_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.ORANGE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.PINK_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.PURPLE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.RED_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.WHITE_LOG);
        PastelModelHelper.BLOCK.log(generators, PastelBlocks.YELLOW_LOG);

        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.BLACK_WOOD, PastelBlocks.BLACK_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.BLUE_WOOD, PastelBlocks.BLUE_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.BROWN_WOOD, PastelBlocks.BROWN_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.CYAN_WOOD, PastelBlocks.CYAN_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.GRAY_WOOD, PastelBlocks.GRAY_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.GREEN_WOOD, PastelBlocks.GREEN_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.LIGHT_BLUE_WOOD, PastelBlocks.LIGHT_BLUE_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.LIGHT_GRAY_WOOD, PastelBlocks.LIGHT_GRAY_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.LIME_WOOD, PastelBlocks.LIME_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.MAGENTA_WOOD, PastelBlocks.MAGENTA_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.ORANGE_WOOD, PastelBlocks.ORANGE_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.PINK_WOOD, PastelBlocks.PINK_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.PURPLE_WOOD, PastelBlocks.PURPLE_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.RED_WOOD, PastelBlocks.RED_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.WHITE_WOOD, PastelBlocks.WHITE_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.YELLOW_WOOD, PastelBlocks.YELLOW_LOG);

        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.STRIPPED_BLACK_WOOD, PastelBlocks.STRIPPED_BLACK_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.STRIPPED_BLUE_WOOD, PastelBlocks.STRIPPED_BLUE_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.STRIPPED_BROWN_WOOD, PastelBlocks.STRIPPED_BROWN_LOG);
        ...
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.STRIPPED_PINK_WOOD, PastelBlocks.STRIPPED_PINK_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.STRIPPED_PURPLE_WOOD, PastelBlocks.STRIPPED_PURPLE_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.STRIPPED_RED_WOOD, PastelBlocks.STRIPPED_RED_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.STRIPPED_WHITE_WOOD, PastelBlocks.STRIPPED_WHITE_LOG);
        PastelModelHelper.BLOCK.wood(generators, PastelBlocks.STRIPPED_YELLOW_WOOD, PastelBlocks.STRIPPED_YELLOW_LOG);

        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.BLACK_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.BLUE_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.BROWN_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.CYAN_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.GRAY_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.GREEN_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.LIGHT_BLUE_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.LIGHT_GRAY_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.LIME_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.MAGENTA_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.ORANGE_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.PINK_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.PURPLE_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.RED_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.WHITE_LEAVES, TexturedModel.LEAVES);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.YELLOW_LEAVES, TexturedModel.LEAVES);

        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.BLACK_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.BLUE_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.BROWN_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.CYAN_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.GRAY_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.GREEN_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.LIGHT_BLUE_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.LIGHT_GRAY_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.LIME_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.MAGENTA_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.ORANGE_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.PINK_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.PURPLE_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.RED_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.WHITE_GLOWBLOCK);
        PastelModelHelper.BLOCK.simple(generators, PastelBlocks.YELLOW_GLOWBLOCK);

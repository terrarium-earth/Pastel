...
public class InkConvertingDisplay extends PastelDisplay {
    ...
    public InkConvertingDisplay(@NotNull RecipeHolder<InkConvertingRecipe> recipe) {
        super(recipe, EntryIngredients.ofIngredients(recipe.value()
                                                           .getIngredients()), List.of()
        );
        this.color = recipe.value()
                           .getInkColor();
        this.amount = recipe.value()
                            .getInkAmount();
    }
    ...
    public boolean isUnlocked() {
        ...
        return AdvancementHelper.hasAdvancement(client.player, InkConvertingRecipe.UNLOCK_IDENTIFIER) &&
               super.isUnlocked();
    }

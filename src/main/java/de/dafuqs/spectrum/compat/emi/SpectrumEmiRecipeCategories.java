...
public class SpectrumEmiRecipeCategories {
	...
	public static final EmiRecipeCategory FUSION_SHRINE = new SpectrumCategory(SpectrumCommon.locate("fusion_shrine"), EmiStack.of(SpectrumBlocks.FUSION_SHRINE_CALCITE), "block.pastel.fusion_shrine");
	...
	public static final EmiRecipeCategory ENCHANTER = new SpectrumCategory(SpectrumCommon.locate("enchanter"), EmiStack.of(SpectrumBlocks.ENCHANTER), "container.pastel.rei.enchanting.title");
	public static final EmiRecipeCategory ENCHANTMENT_UPGRADE = new SpectrumCategory(SpectrumCommon.locate("enchantment_upgrade"), EmiStack.of(SpectrumBlocks.ENCHANTER), "container.pastel.rei.enchantment_upgrading.title");
	...
	public static final EmiRecipeCategory DRAGONROT_CONVERTING = new SpectrumCategory(SpectrumCommon.locate("dragonrot_converting"), EmiStack.of(SpectrumItems.DRAGONROT_BUCKET), "container.pastel.rei.dragonrot_converting.title");
	...
	public static final EmiRecipeCategory CRYSTALLARIEUM = new SpectrumCategory(SpectrumCommon.locate("crystallarieum"), EmiStack.of(SpectrumBlocks.CRYSTALLARIEUM), "block.pastel.crystallarieum");
	...
	public static final EmiRecipeCategory PRIMORDIAL_FIRE_BURNING = new SpectrumCategory(SpectrumCommon.locate("primordial_fire_burning"), EmiStack.of(SpectrumItems.DOOMBLOOM_SEED), "container.pastel.rei.primordial_fire_burning.title");

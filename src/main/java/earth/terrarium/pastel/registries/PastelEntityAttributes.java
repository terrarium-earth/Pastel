...
public class PastelEntityAttributes {
    ...
    private static final DeferredRegister<Attribute> REGISTER = DeferredRegister
        .create(
     ...
     */
    public static final Holder<Attribute> MENTAL_PRESENCE = REGISTER
        .register(
            "mental_presence",
            () -> new RangedAttribute(
                "attribute.name.pastel.mental_presence",
                1.0,
                0,
                1024
            )

...
public class SpectrumItemGroups {
	...
	public static final ResourceLocation INSTRUMENTS_ID = SpectrumCommon.locate("instruments");
	public static final ResourceLocation TOOLS_ID = SpectrumCommon.locate("tools");
	public static final ResourceLocation NATURAL_BLOCKS_ID = SpectrumCommon.locate("natural_blocks");
	public static final ResourceLocation CUISINE_ID = SpectrumCommon.locate("cuisine");
	public static final ResourceLocation RESOURCES_ID = SpectrumCommon.locate("resources");
	public static final ResourceLocation DECORATION_ID = SpectrumCommon.locate("decoration");
	public static final ResourceLocation HEADS_ID = SpectrumCommon.locate("heads");
	...
	public static void registerSpawnEggs(BuildCreativeModeTabContentsEvent event) {
		...
		event.accept(SpectrumItems.EGG_LAYING_WOOLY_PIG_SPAWN_EGG.toStack(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
		event.accept(SpectrumItems.PRESERVATION_TURRET_SPAWN_EGG.toStack(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
		event.accept(SpectrumItems.KINDLING_SPAWN_EGG.toStack(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
		event.accept(SpectrumItems.LIZARD_SPAWN_EGG.toStack(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
		event.accept(SpectrumItems.ERASER_SPAWN_EGG.toStack(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
		event.accept(SpectrumItems.BUCKET_OF_ERASER.toStack(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
	}

	public static final CreativeModeTab INSTRUMENTS = CreativeModeTab.builder()
			.icon(SpectrumBlocks.PEDESTAL_BASIC_TOPAZ::toStack)
	...
	public static final CreativeModeTab TOOLS = CreativeModeTab.builder()
			.icon(SpectrumItems.PAINTBRUSH::toStack)
	...
	public static final CreativeModeTab NATURAL_BLOCKS = CreativeModeTab.builder()
			.icon(SpectrumBlocks.WEEPING_GALA_SPRIG::toStack)
	...
	public static final CreativeModeTab CUISINE = CreativeModeTab.builder()
			.icon(SpectrumItems.DEMON_TEA::toStack)
	...
	public static final CreativeModeTab RESOURCES = CreativeModeTab.builder()
			.icon(SpectrumItems.TOPAZ_SHARD::toStack)
	...
	public static final CreativeModeTab DECORATION = CreativeModeTab.builder()
			.icon(SpectrumBlocks.CHISELED_POLISHED_BASALT::toStack)
	...
	public static final CreativeModeTab HEADS = CreativeModeTab.builder()
			.icon(() -> SpectrumSkullBlock.MOB_HEADS.get(SpectrumSkullType.EGG_LAYING_WOOLY_PIG).asItem().getDefaultInstance())

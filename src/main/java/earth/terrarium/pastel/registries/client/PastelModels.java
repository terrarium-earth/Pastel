...
public class PastelModels {
    ...
    public static final ModelTemplate CLUSTER_ITEM = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates_item/cluster")),
        Optional.empty(),
        LAYER0
    );

    public static final ModelTemplate LARGE_BUD_ITEM = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates_item/large_bud")),
        Optional.empty(),
        LAYER0
    );

    public static final ModelTemplate MEDIUM_BUD_ITEM = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates_item/medium_bud")),
        Optional.empty(),
        LAYER0
    );

    public static final ModelTemplate SMALL_BUD_ITEM = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates_item/small_bud")),
        Optional.empty(),
        LAYER0
    );
    ...
    public static final ModelTemplate SHIMMERSTONE_LIGHT = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/shimmerstone_light")),
        Optional.empty(),
        INNER,
        OUTER,
        PARTICLE
    ...
    public static final ModelTemplate SHIMMERSTONE_LIGHT_MIRRORED = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/shimmerstone_light_mirrored")),
        Optional.empty(),
        INNER,
        OUTER,
        PARTICLE
    ...
    public static final ModelTemplate BASE_PYLON_BODY = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/base_pylon_body")),
        Optional.empty(),
        SIDE,
        END
    );
    ...
    public static final ModelTemplate BASE_TRANS_LIGHT_CORE = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/base_trans_light_core")),
        Optional.empty(),
        GLASS,
        CASE,
        BASE,
    ...
    public static final ModelTemplate BOWL = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/base_bowl")),
        Optional.empty(),
        SIDE,
        TOP,
        BOTTOM,
    ...
    public static final ModelTemplate CHIME = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/chime")),
        Optional.empty(),
        BASE,
        GEMSTONE
    );
    ...
    public static final ModelTemplate CUSHION = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/cushion")),
        Optional.empty(),
        SIDE,
        TOP,
        BOTTOM
    ...
    public static final ModelTemplate COLORED_LAMP_ON = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/colored_lamp_on")),
        Optional.empty(),
        INNER,
        OUTER
    );
    ...
    public static final ModelTemplate COMPLEX_ORIENTABLE = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/complex_orientable")),
        Optional.empty(),
        SIDE,
        TOP,
        BOTTOM,
    ...
    public static final ModelTemplate CRYSTALLARIEUM_FARMABLE = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/crystallarieum_farmable")),
        Optional.empty(),
        CROSS
    );

    public static final ModelTemplate DOUBLE_CROSS = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/double_cross")),
        Optional.empty(),
        CROSS
    );

    public static final ModelTemplate FUSION_SHRINE = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/base_fusion_shrine")),
        Optional.empty(),
        SHRINE,
        PARTICLE
    );
    ...
    public static final ModelTemplate JADE_VINE_BULB = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/jade_vine_bulb")),
        Optional.empty(),
        FLOWER,
        PARTICLE
    );
    ...
    public static final ModelTemplate JADE_VINE_ROOTS = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/jade_vine_roots")),
        Optional.empty(),
        FLOWER,
        PARTICLE
    );
    ...
    public static final ModelTemplate MOONSTONE_CHISELED = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/moonstone_chiseled")),
        Optional.empty(),
        SIDE,
        LINE
    );
    ...
    public static final ModelTemplate MOONSTONE_CHISELED_DOWN = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/moonstone_chiseled_down")),
        Optional.empty(),
        SIDE,
        LINE
    );
    ...
    public static final ModelTemplate MULTILAYER_LIGHT = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/multilayer_light")),
        Optional.empty(),
        SIDE,
        TOP,
        INSIDE
    ...
    public static final ModelTemplate OVERGROWN = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/overgrown")),
        Optional.empty(),
        SIDE,
        TOP,
        BOTTOM,
    ...
    public static final ModelTemplate PARTICLE_SPAWNER = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/particle_spawner")),
        Optional.empty(),
        TOP
    );

    public static final ModelTemplate PEDESTAL = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/pedestal")),
        Optional.empty(),
        PastelTextureKeys.PEDESTAL,
        PARTICLE
    );

    public static final ModelTemplate PRESENT = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/present")),
        Optional.empty(),
        TEXTURE,
        PARTICLE
    );
    ...
    public static final ModelTemplate REDSTONE_TIMER = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/redstone_timer_base")),
        Optional.empty(),
        LIGHT
    );

    public static final ModelTemplate REDSTONE_TRANSCEIVER_CHANNEL = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/redstone_transceiver_channel_base")),
        Optional.empty(),
        ALL
    );

    public static final ModelTemplate REDSTONE_TRANSCEIVER_SENDER = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/redstone_transceiver_sender_base")),
        Optional.empty(),
        LIGHT
    );

    public static final ModelTemplate REDSTONE_TRANSCEIVER_RECEIVER = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/redstone_transceiver_receiver_base")),
        Optional.empty(),
        LIGHT
    );

    public static final ModelTemplate ROUNDEL = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/base_roundel")),
        Optional.empty(),
        ALL
    );

    public static final ModelTemplate SHOOTING_STAR = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/shooting_star")),
        Optional.empty(),
        SIDE,
        CORE
    );
    ...
    public static final ModelTemplate SLAB_DETECTOR = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/slab_detector")),
        Optional.empty(),
        TOP,
        SIDE
    );
    ...
    public static final ModelTemplate TRANSLUCENT_OUTER1 = new ModelTemplate(
        Optional.of(PastelCommon.locate("templates/translucent_outer1")),
        Optional.empty(),
        TEXTURE
    );
    ...
    public static ModelTemplate noxwoodLantern(String suffix) {
        return new ModelTemplate(
            Optional.of(PastelCommon.locate("templates/noxwood_lamp" + suffix)),
            Optional.empty(),
            ALL
        );
    }
    ...
    public static ModelTemplate sugarStick(int age) {
        return new ModelTemplate(
            Optional.of(PastelCommon.locate("templates/sugar_stick" + age)),
            Optional.empty(),
            KEY0,
            KEY1,
            PARTICLE
    ...
    public static ModelTemplate jadeVines(JadeVinePlantBlock.JadeVinesPlantPart part) {
        return new ModelTemplate(
            Optional.of(PastelCommon.locate("templates/jade_vines_" + part.getSerializedName())),
            Optional.empty(),
            FLOWER,
            PARTICLE
        );
    ...
    public static final ModelTemplate DAYLIGHT_DETECTOR = new ModelTemplate(
        Optional.of(ResourceLocation.withDefaultNamespace("block/template_daylight_detector")),
        Optional.empty(),
        SIDE,
        TOP
    );
    ...
    public static final ModelTemplate FIRE_FLOOR = new ModelTemplate(
        Optional.of(ResourceLocation.withDefaultNamespace("block/template_fire_floor")),
        Optional.empty(),
        FIRE
    );

    public static final ModelTemplate FIRE_SIDE = new ModelTemplate(
        Optional.of(ResourceLocation.withDefaultNamespace("block/template_fire_side")),
        Optional.empty(),
        FIRE
    );

    public static final ModelTemplate FIRE_SIDE_ALT = new ModelTemplate(
        Optional.of(ResourceLocation.withDefaultNamespace("block/template_fire_side_alt")),
        Optional.empty(),
        FIRE
    );

    public static final ModelTemplate FIRE_UP = new ModelTemplate(
        Optional.of(ResourceLocation.withDefaultNamespace("block/template_fire_up")),
        Optional.empty(),
        FIRE
    );

    public static final ModelTemplate FIRE_UP_ALT = new ModelTemplate(
        Optional.of(ResourceLocation.withDefaultNamespace("block/template_fire_up_alt")),
        Optional.empty(),
        FIRE
    );

    public static final ModelTemplate SPORE_BLOSSOM = new ModelTemplate(
        Optional.of(ResourceLocation.withDefaultNamespace("block/spore_blossom")),
        Optional.empty(),
        FLOWER,
        PARTICLE
    );

...
public class StoneLikeBlockModels {
    public static void generateBlockModels(BlockModelGenerators generators) {
        ...
        PastelModelHelper.BLOCK
            .parented(generators, PastelBlocks.INFESTED_BLACKSLAG.get(), PastelBlocks.BLACKSLAG.get());
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
            ...
            .axisRotated(
                ...
                PastelTexturedModels
                    .cubeColumn(
                        b -> b,
                        "_side",
                        b -> PastelBlocks.PYRITE_TUBING.get(),
                        "_top"
                    )
            );
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.PYRITE_RIPPER.get())
                    .with(
                        PropertyDispatch
                            .properties(
        ...
        PastelModelHelper.BLOCK
            .snowy(
                generators,
                PastelBlocks.OVERGROWN_BLACKSLAG,
                PastelTexturedModels
                    .overgrown(
                        b -> b,
                        "_side",

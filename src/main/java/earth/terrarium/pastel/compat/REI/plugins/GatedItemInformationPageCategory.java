...
public abstract class GatedItemInformationPageCategory extends GatedDisplayCategory<PastelItemInformationDisplay> {
    ...
    public void setupWidgets(
        ...
        Rectangle bounds,
        List<Widget> widgets,
        @NotNull PastelItemInformationDisplay display
    ) {
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 5, startPoint.y + 3))
                    .entries(
                        display
                            .getInputEntries()
                            .get(0)
        ...
        widgets
            .add(
                Widgets
                    .createLabel(new Point(startPoint.x + 15, startPoint.y + 7), item.getDescription())
                    .leftAligned()
                    .color(0x000000)
                    .noShadow()
            );
        ...
        Rectangle rectangle = new Rectangle(
            bounds.getCenterX() - (bounds.width / 2),
            bounds.y + 30,
            bounds.width,
            bounds.height - 30
        );
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 112, startPoint.y + 70))

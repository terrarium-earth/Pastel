...
@OnlyIn(Dist.CLIENT)
public class RabbitHeadModel extends PastelSkullModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition head = modelPartData.addOrReplaceChild(
            PartNames.HEAD, CubeListBuilder.create()
                                           .texOffs(32, 0)
                                           .addBox(
                                               -2.5F, -4.0F, -2.5F, 5.0F, 4.0F, 5.0F), PartPose.ZERO
        );
        head.addOrReplaceChild(
            "nose", CubeListBuilder.create()
                                   .texOffs(32, 9)
                                   .addBox(-0.5F, -2.5F, -3.0F, 1.0F, 1.0F, 1.0F), PartPose.ZERO
        );
        head.addOrReplaceChild(

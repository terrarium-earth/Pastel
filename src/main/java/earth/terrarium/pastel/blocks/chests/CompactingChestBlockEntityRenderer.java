...
public class CompactingChestBlockEntityRenderer implements BlockEntityRenderer<CompactingChestBlockEntity> {
    ...
    private static final Material SPRITE_IDENTIFIER = new Material(
        InventoryMenu.BLOCK_ATLAS, PastelCommon.locate("block/compacting_chest"));
    ...
    public static @NotNull LayerDefinition getTexturedModelData() {
        ...
        PartDefinition root = modelPartData.addOrReplaceChild(
            "root", CubeListBuilder.create()
                                   .texOffs(81, 44)
                                   .addBox(-1.5F, -10.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
                                   .texOffs(0, 0)
                                   .addBox(-7.0F, -11.0F, -7.0F, 14.0F, 10.0F, 14.0F, new CubeDeformation(0.0F))
                                   .texOffs(0, 60)
                                   .addBox(-5.0F, -11.0F, -5.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F))
                                   .texOffs(0, 43)
                                   .addBox(-7.5F, -2.0F, -7.5F, 15.0F, 2.0F, 15.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 24.0F, 0.0F)
        );

        PartDefinition driver = root.addOrReplaceChild(
            "driver", CubeListBuilder.create()
                                     .texOffs(53, 38)
                                     .addBox(
                                         -3.5F, -36.0F, -3.5F, 7.0F, 11.0F, 7.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 21.0F, 0.0F)
        );

        PartDefinition piston = root.addOrReplaceChild(
            "piston", CubeListBuilder.create()
                                     .texOffs(89, 17)
                                     .addBox(-3.5F, 7.0F, -3.5F, 7.0F, 14.0F, 7.0F, new CubeDeformation(0.0F))
                                     .texOffs(45, 13)
                                     .addBox(-5.5F, 7.0F, -5.5F, 11.0F, 14.0F, 11.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition cap = root.addOrReplaceChild(
            "cap", CubeListBuilder.create()
                                  .texOffs(0, 24)
                                  .addBox(-7.5F, -36.0F, -7.5F, 15.0F, 4.0F, 15.0F, new CubeDeformation(0.0F))
                                  .texOffs(40, 65)
                                  .addBox(-5.5F, -36.0F, -5.5F, 11.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 21.0F, 0.0F)
        );
    ...
    @Override
    public void render(
        CompactingChestBlockEntity chest, float tickDelta, PoseStack poseStack, MultiBufferSource vertexConsumers,
        int light, int overlay
    ) {
        if (chest.animator == null || chest.getLevel() == null)
            return;

        chest.animator.animate(
            tickDelta, chest.getLevel()
                            .getGameTime() % 100000
        );

        poseStack.pushPose();
        float f = chest.getBlockState()

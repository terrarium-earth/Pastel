...
public class ColoredSparkleRisingParticleEffect implements ParticleOptions {
    ...
    public static final MapCodec<ColoredSparkleRisingParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
        (instance) -> instance.group(
                                  ExtraCodecs.VECTOR3F.fieldOf("color")
                                                      .forGetter((effect) -> effect.color)
                              )
                              .apply(instance, ColoredSparkleRisingParticleEffect::new));
    public static final StreamCodec<RegistryFriendlyByteBuf, ColoredSparkleRisingParticleEffect> STREAM_CODEC

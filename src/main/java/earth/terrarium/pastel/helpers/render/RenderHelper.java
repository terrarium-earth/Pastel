...
public class RenderHelper {
    ...
    public static void fillTriangle(
        ...
        builder
            .addVertex(matrix, p1x, p1y, 0F)
            .setColor(red, green, blue, alpha);
        builder
            .addVertex(matrix, p2x, p2y, 0F)
            .setColor(red, green, blue, alpha);
        builder
            .addVertex(matrix, p3x, p3y, 0F)
            .setColor(red, green, blue, alpha);
    ...
    public static void fillQuad(PoseStack matrices, int x, int y, int height, int width, Vector3f color) {
        ...
        builder
            ...
            .setColor(red, green, blue, alpha);
        builder
            .addVertex(matrix, x, y + height, 0F)
            .setColor(red, green, blue, alpha);
        builder
            .addVertex(matrix, x + width, y + height, 0F)
            .setColor(red, green, blue, alpha);
        builder
            .addVertex(matrix, x + width, y, 0F)
            .setColor(red, green, blue, alpha);
        BufferUploader.drawWithShader(builder.buildOrThrow());
        RenderSystem.disableBlend();
    }

...
import static earth.terrarium.pastel.imbrifer.EnvironmentalOverride.NOOP;
...
public class EnvironmentalOverrides {
    ...
    public static void init() {
            ...
            .register(
                new EnvironmentalOverride(
                    ...
                    new EnvironmentalOverride.ColorData(
                        ColorHelper.colorIntToVec(PastelMobEffects.ETERNAL_SLUMBER_COLOR),
                        0.575F
                    ),
        ...
        EnvironmentalOverride
            .register(
                new EnvironmentalOverride(
                    entity -> entity instanceof LivingEntity l && l.hasEffect(PastelMobEffects.FRENZY) && (l
                        .hasEffect(PastelMobEffects.ETERNAL_SLUMBER) || l
                            .hasEffect(

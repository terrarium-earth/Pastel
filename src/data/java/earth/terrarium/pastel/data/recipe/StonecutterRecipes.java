...
public class StonecutterRecipes {
    ...
    private static void basalMarble(PrefixHelper pfx) {
        ...
        pfx.generateDynamicRecipe(
                ...
                new StonecutterRecipe("", Ingredient.of(PastelBlocks.POLISHED_BASAL_MARBLE), new ItemStack(PastelBlocks.BASAL_MARBLE_PILLAR))
        );

        SubFamilyGeneratorBind.generateFrom(
                pfx,
    ...
    private record SubFamilyGeneratorBind(FamilyGeneratorBind inner, Item parent) {
        ...
        void generateAll(BlockFamily family) {
            inner.pfx.generateDynamicRecipe(
    ...
    private static void shaleClay(PrefixHelper pfx) {
        ...
        SubFamilyGeneratorBind.generateFrom(pfx, PastelBlockFamilies.SHALE_CLAY_BRICKS.get(), PastelBlocks.POLISHED_SHALE_CLAY.asItem());
        SubFamilyGeneratorBind.generateFrom(pfx, PastelBlockFamilies.WEATHERED_SHALE_CLAY_BRICKS.get(), PastelBlocks.WEATHERED_POLISHED_SHALE_CLAY.asItem());
        SubFamilyGeneratorBind.generateFrom(pfx, PastelBlockFamilies.EXPOSED_SHALE_CLAY_BRICKS.get(), PastelBlocks.EXPOSED_POLISHED_SHALE_CLAY.asItem());

        SubFamilyGeneratorBind.generateFrom(pfx, PastelBlockFamilies.SHALE_CLAY_TILES.get(), PastelBlocks.POLISHED_SHALE_CLAY.asItem());
        SubFamilyGeneratorBind.generateFrom(pfx, PastelBlockFamilies.WEATHERED_SHALE_CLAY_TILES.get(), PastelBlocks.WEATHERED_POLISHED_SHALE_CLAY.asItem());
        SubFamilyGeneratorBind.generateFrom(pfx, PastelBlockFamilies.EXPOSED_SHALE_CLAY_TILES.get(), PastelBlocks.EXPOSED_POLISHED_SHALE_CLAY.asItem());
    }
    ...
    private static void dragonbone(PrefixHelper pfx) {
        ...
        SubFamilyGeneratorBind.generateFrom(pfx, PastelBlockFamilies.BONE_ASH_BRICKS.get(), PastelBlocks.POLISHED_BONE_ASH.asItem());
        SubFamilyGeneratorBind.generateFrom(pfx, PastelBlockFamilies.BONE_ASH_TILES.get(), PastelBlocks.POLISHED_BONE_ASH.asItem());

        generateStonecutter(pfx, PastelBlocks.POLISHED_BONE_ASH.asItem(), 1, PastelBlocks.POLISHED_BONE_ASH_PILLAR.get());
    }
    ...
    private static void blackslag(PrefixHelper pfx) {
        ...
        SubFamilyGeneratorBind.generateFrom(pfx, PastelBlockFamilies.BLACKSLAG_BRICKS.get(), PastelBlocks.POLISHED_BLACKSLAG.asItem());

...
public record WorkstaffComponent(boolean canTill, boolean canShoot, int fortuneLevel) {
    ...
    public static final Codec<WorkstaffComponent> CODEC = RecordCodecBuilder
        .create(
            i -> i
                .group(
                    Codec.BOOL
                        ...
                        .forGetter(c -> c.canTill),
                    Codec.BOOL
                        .fieldOf(
                            "can_shoot"
                        )
                        .forGetter(c -> c.canShoot),
                    Codec.INT
                        .fieldOf(
                            "fortune_level"
                        )
                        .forGetter(c -> c.fortuneLevel)
                )
                .apply(
                    i,
    ...
    public static final StreamCodec<ByteBuf, WorkstaffComponent> STREAM_CODEC = StreamCodec
        .composite(
            ByteBufCodecs.BOOL,
            c -> c.canTill,
            ByteBufCodecs.BOOL,

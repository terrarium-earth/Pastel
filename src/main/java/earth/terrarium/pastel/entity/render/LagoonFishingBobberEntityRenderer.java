...
public class LagoonFishingBobberEntityRenderer extends PastelFishingBobberEntityRenderer {
    ...
    protected final ResourceLocation TEXTURE = PastelCommon.locate(
        "textures/entity/fishing_hooks/lagoon_fishing_hook.png");
    protected final ResourceLocation TEXTURE_OPEN_WATERS = PastelCommon.locate(
        "textures/entity/fishing_hooks/lagoon_fishing_hook_open_waters.png");

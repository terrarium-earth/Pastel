...
public class PastelLootPoolModifiers {
	...
	private static final Map<ResourceKey<LootTable>, TreasureHunterDropDefinition> treasureHunterLootPools = new HashMap<>() {{
		...
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/sheep")), new TreasureHunterDropDefinition(PastelSkullType.SHEEP, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/bat")), new TreasureHunterDropDefinition(PastelSkullType.BAT, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/blaze")), new TreasureHunterDropDefinition(PastelSkullType.BLAZE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/cat")), new TreasureHunterDropDefinition(PastelSkullType.CAT, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/cave_spider")), new TreasureHunterDropDefinition(PastelSkullType.CAVE_SPIDER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/chicken")), new TreasureHunterDropDefinition(PastelSkullType.CHICKEN, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/cow")), new TreasureHunterDropDefinition(PastelSkullType.COW, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/donkey")), new TreasureHunterDropDefinition(PastelSkullType.DONKEY, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/drowned")), new TreasureHunterDropDefinition(PastelSkullType.DROWNED, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/elder_guardian")), new TreasureHunterDropDefinition(PastelSkullType.ELDER_GUARDIAN, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/enderman")), new TreasureHunterDropDefinition(PastelSkullType.ENDERMAN, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/endermite")), new TreasureHunterDropDefinition(PastelSkullType.ENDERMITE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/evoker")), new TreasureHunterDropDefinition(PastelSkullType.EVOKER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/ghast")), new TreasureHunterDropDefinition(PastelSkullType.GHAST, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/guardian")), new TreasureHunterDropDefinition(PastelSkullType.GUARDIAN, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/hoglin")), new TreasureHunterDropDefinition(PastelSkullType.HOGLIN, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/horse")), new TreasureHunterDropDefinition(PastelSkullType.HORSE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/husk")), new TreasureHunterDropDefinition(PastelSkullType.HUSK, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/illusioner")), new TreasureHunterDropDefinition(PastelSkullType.ILLUSIONER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/iron_golem")), new TreasureHunterDropDefinition(PastelSkullType.IRON_GOLEM, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/llama")), new TreasureHunterDropDefinition(PastelSkullType.LLAMA, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/magma_cube")), new TreasureHunterDropDefinition(PastelSkullType.MAGMA_CUBE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/mule")), new TreasureHunterDropDefinition(PastelSkullType.MULE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/ocelot")), new TreasureHunterDropDefinition(PastelSkullType.OCELOT, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/panda")), new TreasureHunterDropDefinition(PastelSkullType.PANDA, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/phantom")), new TreasureHunterDropDefinition(PastelSkullType.PHANTOM, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/pig")), new TreasureHunterDropDefinition(PastelSkullType.PIG, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/polar_bear")), new TreasureHunterDropDefinition(PastelSkullType.POLAR_BEAR, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/pufferfish")), new TreasureHunterDropDefinition(PastelSkullType.PUFFERFISH, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/rabbit")), new TreasureHunterDropDefinition(PastelSkullType.RABBIT, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/ravager")), new TreasureHunterDropDefinition(PastelSkullType.RAVAGER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/salmon")), new TreasureHunterDropDefinition(PastelSkullType.SALMON, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/silverfish")), new TreasureHunterDropDefinition(PastelSkullType.SILVERFISH, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/slime")), new TreasureHunterDropDefinition(PastelSkullType.SLIME, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/snow_golem")), new TreasureHunterDropDefinition(PastelSkullType.SNOW_GOLEM, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/spider")), new TreasureHunterDropDefinition(PastelSkullType.SPIDER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/squid")), new TreasureHunterDropDefinition(PastelSkullType.SQUID, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/stray")), new TreasureHunterDropDefinition(PastelSkullType.STRAY, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/strider")), new TreasureHunterDropDefinition(PastelSkullType.STRIDER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/trader_llama")), new TreasureHunterDropDefinition(PastelSkullType.LLAMA, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/turtle")), new TreasureHunterDropDefinition(PastelSkullType.TURTLE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/vex")), new TreasureHunterDropDefinition(PastelSkullType.VEX, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/villager")), new TreasureHunterDropDefinition(PastelSkullType.VILLAGER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/vindicator")), new TreasureHunterDropDefinition(PastelSkullType.VINDICATOR, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/wandering_trader")), new TreasureHunterDropDefinition(PastelSkullType.WANDERING_TRADER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/witch")), new TreasureHunterDropDefinition(PastelSkullType.WITCH, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/adder")), new TreasureHunterDropDefinition(PastelSkullType.WITHER, 0.15F)); // he has 3 heads, after all!
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/wolf")), new TreasureHunterDropDefinition(PastelSkullType.WOLF, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/zoglin")), new TreasureHunterDropDefinition(PastelSkullType.ZOGLIN, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/zombie_villager")), new TreasureHunterDropDefinition(PastelSkullType.ZOMBIE_VILLAGER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/zombified_piglin")), new TreasureHunterDropDefinition(PastelSkullType.ZOMBIFIED_PIGLIN, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/bee")), new TreasureHunterDropDefinition(PastelSkullType.BEE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/tropical_fish")), new TreasureHunterDropDefinition(PastelSkullType.TROPICAL_FISH, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/goat")), new TreasureHunterDropDefinition(PastelSkullType.GOAT, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/glow_squid")), new TreasureHunterDropDefinition(PastelSkullType.GLOW_SQUID, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/warden")), new TreasureHunterDropDefinition(PastelSkullType.WARDEN, 0.2F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/tadpole")), new TreasureHunterDropDefinition(PastelSkullType.TADPOLE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/allay")), new TreasureHunterDropDefinition(PastelSkullType.ALLAY, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/camel")), new TreasureHunterDropDefinition(PastelSkullType.CAMEL, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/sniffer")), new TreasureHunterDropDefinition(PastelSkullType.SNIFFER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/skeleton_horse")), new TreasureHunterDropDefinition(PastelSkullType.SKELETON_HORSE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/zombie_horse")), new TreasureHunterDropDefinition(PastelSkullType.ZOMBIE_HORSE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/dolphin")), new TreasureHunterDropDefinition(PastelSkullType.DOLPHIN, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/pillager")), new TreasureHunterDropDefinition(PastelSkullType.PILLAGER, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/armadillo")), new TreasureHunterDropDefinition(PastelSkullType.ARMADILLO, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/breeze")), new TreasureHunterDropDefinition(PastelSkullType.BREEZE, 0.02F));
		put(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/bogged")), new TreasureHunterDropDefinition(PastelSkullType.BOGGED, 0.02F));

		// TODO: ...ooooor we could simply put them in the json loot table
		put(ResourceKey.create(Registries.LOOT_TABLE, PastelCommon.locate("entities/egg_laying_wooly_pig")), new TreasureHunterDropDefinition(PastelSkullType.EGG_LAYING_WOOLY_PIG, 0.1F));
		put(ResourceKey.create(Registries.LOOT_TABLE, PastelCommon.locate("entities/kindling")), new TreasureHunterDropDefinition(PastelSkullType.KINDLING, 0.1F));
		put(ResourceKey.create(Registries.LOOT_TABLE, PastelCommon.locate("entities/preservation_turret")), new TreasureHunterDropDefinition(PastelSkullType.PRESERVATION_TURRET, 0.1F));
		put(ResourceKey.create(Registries.LOOT_TABLE, PastelCommon.locate("entities/eraser")), new TreasureHunterDropDefinition(PastelSkullType.ERASER, 0.1F));
	}};
	...
	public static void loadLootTable(LootTableLoadEvent event) {
		...
		if (treasureHunterLootPools.containsKey(key)) {
		...
		} else if (key.equals(ResourceKey.create(Registries.LOOT_TABLE, PastelCommon.locate("entities/lizard")))) {
			Holder.Reference<Enchantment> enchant = getTreasureHunter(wrapperLookup);
			...
			if (key.equals(PastelLootTables.LAVA_FISHING)) {
				for (LootPool pool : table.pools) {
			...
			} else if (key.equals(PastelLootTables.END_FISHING)) {
				for (LootPool pool : table.pools) {
			...
			} else if (key.equals(PastelLootTables.DEEPER_DOWN_FISHING)) {
                for (LootPool pool : table.pools) {
			...
			} else if (key.equals(PastelLootTables.LIQUID_CRYSTAL_FISHING)) {
                for (LootPool pool : table.pools) {
				    addEntry(pool, NestedLootTable.lootTableReference(GoFishCompat.DEFAULT_CRATES_LOOT_TABLE_ID).setWeight(5).setQuality(2).when(LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, new EntityPredicate.Builder().subPredicate(FishingHookPredicate.inOpenWater(true)).build())));
				}
			} else if (key.equals(PastelLootTables.MIDNIGHT_SOLUTION_FISHING)) {
                for (LootPool pool : table.pools) {
                    addEntry(pool, NestedLootTable.lootTableReference(GoFishCompat.DEFAULT_CRATES_LOOT_TABLE_ID).setWeight(5).setQuality(2).when(LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, new EntityPredicate.Builder().subPredicate(FishingHookPredicate.inOpenWater(true)).build())));
                }
			}

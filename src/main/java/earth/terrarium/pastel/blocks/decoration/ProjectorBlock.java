...
public class ProjectorBlock extends Block implements EntityBlock {
    ...
    public static final MapCodec<ProjectorBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
                                                                                               ...
                                                                                               Codec.FLOAT.fieldOf(
                                                                                                   "heightOffset")
                                                                                                          .forGetter(b -> b.heightOffset),
                                                                                               Codec.FLOAT.fieldOf(
                                                                                                   "bobMultiplier")
                                                                                                          .forGetter(b -> b.bobMultiplier),
                                                                                               Codec.FLOAT.fieldOf(
                                                                                                   "scaling")
                                                                                                          .forGetter(b -> b.scaling)
                                                                                           )
                                                                                           .apply(
                                                                                               i,
                                                                                               ProjectorBlock::new
    ...
    public ProjectorBlock(
        Properties settings, String path, double width, double height, float heightOffset, float bobMultiplier,
        float scaling
    ) {
        this(
            settings, PastelCommon.locate("textures/block/" + path + ".png"), width, height, heightOffset,
            bobMultiplier, scaling
        );
    }

    public ProjectorBlock(
        Properties settings, ResourceLocation texture, double width, double height, float heightOffset,
        float bobMultiplier, float scaling
    ) {
        super(settings);

...
public enum PastelNodeType implements StringRepresentable {
    ...
    STORAGE(
        List.of(
            Component.translatable("block.pastel.storage_node.tooltip")
                     .withStyle(ChatFormatting.WHITE),
            Component.translatable("block.pastel.pastel_network_nodes.tooltip.placing")
                     .withStyle(ChatFormatting.GRAY)
        ), true, true
    ),
    BUFFER(
        List.of(
            Component.translatable("block.pastel.buffer_node.tooltip")
                     .withStyle(ChatFormatting.WHITE),
            Component.translatable("block.pastel.pastel_network_nodes.tooltip.placing")
                     .withStyle(ChatFormatting.GRAY)
        ), true, true
    ...
    PROVIDER(
        List.of(
            Component.translatable("block.pastel.provider_node.tooltip")
                     .withStyle(ChatFormatting.WHITE),
            Component.translatable("block.pastel.pastel_network_nodes.tooltip.placing")
                     .withStyle(ChatFormatting.GRAY)
        ), false, true
    ...
    SENDER(
        List.of(
            Component.translatable("block.pastel.sender_node.tooltip")
                     .withStyle(ChatFormatting.WHITE),
            Component.translatable("block.pastel.pastel_network_nodes.tooltip.placing")
                     .withStyle(ChatFormatting.GRAY)
        ), false, true
    ...
    GATHER(
        List.of(
            Component.translatable("block.pastel.gather_node.tooltip")
                     .withStyle(ChatFormatting.WHITE),
            Component.translatable("block.pastel.pastel_network_nodes.tooltip.placing")
                     .withStyle(ChatFormatting.GRAY)
        ), true, false

...
public record FermentationStatusEffectEntry(
    ...
    public static final Codec<FermentationStatusEffectEntry> CODEC = RecordCodecBuilder
        .create(
            i -> i
                .group(
                    ...
                    Codec.INT
                        .optionalFieldOf("base_duration", 1200)
                        .forGetter(FermentationStatusEffectEntry::baseDuration),
                    StatusEffectPotencyEntry.CODEC
                        .listOf()
    ...
    public record StatusEffectPotencyEntry(float minAlcPercent, float minThickness, int potency) {
        ...
        public static final StreamCodec<ByteBuf, StatusEffectPotencyEntry> STREAM_CODEC = StreamCodec
            .composite(
                ByteBufCodecs.FLOAT,
                StatusEffectPotencyEntry::minAlcPercent,
                ByteBufCodecs.FLOAT,
                StatusEffectPotencyEntry::minThickness,
                ByteBufCodecs.VAR_INT,
                StatusEffectPotencyEntry::potency,
                StatusEffectPotencyEntry::new
            );

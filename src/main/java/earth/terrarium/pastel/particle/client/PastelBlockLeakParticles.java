...
public class PastelBlockLeakParticles {
	...
	public static class LandingLiquidCrystalFactory implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
			DripParticle blockLeakParticle = new DripParticle.DripLandParticle(clientWorld, d, e, f, PastelFluids.LIQUID_CRYSTAL.get());
			blockLeakParticle.setColor(PastelFluids.LIQUID_CRYSTAL_COLOR_VEC.x(), PastelFluids.LIQUID_CRYSTAL_COLOR_VEC.y(), PastelFluids.LIQUID_CRYSTAL_COLOR_VEC.z());
			blockLeakParticle.pickSprite(this.spriteProvider);
			return blockLeakParticle;
		}
	}
	...
	public static class FallingLiquidCrystalFactory implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
			DripParticle blockLeakParticle = new DripParticle.FallAndLandParticle(clientWorld, d, e, f, PastelFluids.LIQUID_CRYSTAL.get(), PastelParticleTypes.LANDING_LIQUID_CRYSTAL);
			blockLeakParticle.setColor(PastelFluids.LIQUID_CRYSTAL_COLOR_VEC.x(), PastelFluids.LIQUID_CRYSTAL_COLOR_VEC.y(), PastelFluids.LIQUID_CRYSTAL_COLOR_VEC.z());
			blockLeakParticle.pickSprite(this.spriteProvider);
			return blockLeakParticle;
		}
	...
	public static class DrippingLiquidCrystalFactory implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
			DripParticle blockLeakParticle = new DripParticle.DripHangParticle(clientWorld, d, e, f, PastelFluids.LIQUID_CRYSTAL.get(), PastelParticleTypes.FALLING_LIQUID_CRYSTAL);
			blockLeakParticle.setColor(PastelFluids.LIQUID_CRYSTAL_COLOR_VEC.x(), PastelFluids.LIQUID_CRYSTAL_COLOR_VEC.y(), PastelFluids.LIQUID_CRYSTAL_COLOR_VEC.z());
			blockLeakParticle.pickSprite(this.spriteProvider);
			return blockLeakParticle;
		}
	...
	public static class LandingMidnightSolutionFactory implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
			DripParticle blockLeakParticle = new DripParticle.DripLandParticle(clientWorld, d, e, f, PastelFluids.MIDNIGHT_SOLUTION.get());
			blockLeakParticle.setColor(PastelFluids.MIDNIGHT_SOLUTION_COLOR_VEC.x(), PastelFluids.MIDNIGHT_SOLUTION_COLOR_VEC.y(), PastelFluids.MIDNIGHT_SOLUTION_COLOR_VEC.z());
			blockLeakParticle.pickSprite(this.spriteProvider);
			return blockLeakParticle;
		}
	}
	...
	public static class FallingMidnightSolutionFactory implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
			DripParticle blockLeakParticle = new DripParticle.FallAndLandParticle(clientWorld, d, e, f, PastelFluids.MIDNIGHT_SOLUTION.get(), PastelParticleTypes.LANDING_MIDNIGHT_SOLUTION);
			blockLeakParticle.setColor(PastelFluids.MIDNIGHT_SOLUTION_COLOR_VEC.x(), PastelFluids.MIDNIGHT_SOLUTION_COLOR_VEC.y(), PastelFluids.MIDNIGHT_SOLUTION_COLOR_VEC.z());
			blockLeakParticle.pickSprite(this.spriteProvider);
			return blockLeakParticle;
		}
	...
	public static class DrippingMidnightSolutionFactory implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
			DripParticle blockLeakParticle = new DripParticle.DripHangParticle(clientWorld, d, e, f, PastelFluids.MIDNIGHT_SOLUTION.get(), PastelParticleTypes.FALLING_MIDNIGHT_SOLUTION);
			blockLeakParticle.setColor(PastelFluids.MIDNIGHT_SOLUTION_COLOR_VEC.x(), PastelFluids.MIDNIGHT_SOLUTION_COLOR_VEC.y(), PastelFluids.MIDNIGHT_SOLUTION_COLOR_VEC.z());
			blockLeakParticle.pickSprite(this.spriteProvider);
			return blockLeakParticle;
		}
	...
	public static class LandingDragonrotFactory implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
			DripParticle blockLeakParticle = new DripParticle.DripLandParticle(clientWorld, d, e, f, PastelFluids.DRAGONROT.get());
			blockLeakParticle.setColor(PastelFluids.DRAGONROT_COLOR_VEC.x(), PastelFluids.DRAGONROT_COLOR_VEC.y(), PastelFluids.DRAGONROT_COLOR_VEC.z());
			blockLeakParticle.pickSprite(this.spriteProvider);
			return blockLeakParticle;
		}
	}
	...
	public static class FallingDragonrotFactory implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
			DripParticle blockLeakParticle = new DripParticle.FallAndLandParticle(clientWorld, d, e, f, PastelFluids.DRAGONROT.get(), PastelParticleTypes.LANDING_DRAGONROT);
			blockLeakParticle.setColor(PastelFluids.DRAGONROT_COLOR_VEC.x(), PastelFluids.DRAGONROT_COLOR_VEC.y(), PastelFluids.DRAGONROT_COLOR_VEC.z());
			blockLeakParticle.pickSprite(this.spriteProvider);
			return blockLeakParticle;
		}
	...
	public static class DrippingDragonrotFactory implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
			DripParticle blockLeakParticle = new DripParticle.DripHangParticle(clientWorld, d, e, f, PastelFluids.DRAGONROT.get(), PastelParticleTypes.FALLING_DRAGONROT);
			blockLeakParticle.setColor(PastelFluids.DRAGONROT_COLOR_VEC.x(), PastelFluids.DRAGONROT_COLOR_VEC.y(), PastelFluids.DRAGONROT_COLOR_VEC.z());
			blockLeakParticle.pickSprite(this.spriteProvider);
			return blockLeakParticle;
		}

...
public class BalciteBlockModels {
    public static void generateBlockModels(BlockModelGenerators generators) {
        ...
        PastelModelHelper.BLOCK
            .simple(
                generators,
                PastelBlocks.TOPAZ_CHISELED_BASALT,
                PastelBlocks.AMETHYST_CHISELED_BASALT,
                PastelBlocks.CITRINE_CHISELED_BASALT,
                PastelBlocks.ONYX_CHISELED_BASALT
            );
        PastelModelHelper.BLOCK
            .simple(
                generators,
                PastelBlocks.TOPAZ_CHISELED_CALCITE,
                PastelBlocks.AMETHYST_CHISELED_CALCITE,
                PastelBlocks.CITRINE_CHISELED_CALCITE,
                PastelBlocks.ONYX_CHISELED_CALCITE
            );
        PastelModelHelper.BLOCK
            .moonstoneChiseled(
                generators,
                PastelBlocks.MOONSTONE_CHISELED_BASALT,
                PastelTextures.BASALT_CAP
            );
        PastelModelHelper.BLOCK
            .moonstoneChiseled(
                generators,
                PastelBlocks.MOONSTONE_CHISELED_CALCITE,
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.TOPAZ_BASALT_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.AMETHYST_BASALT_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.CITRINE_BASALT_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.ONYX_BASALT_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.MOONSTONE_BASALT_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.TOPAZ_CALCITE_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.AMETHYST_CALCITE_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.CITRINE_CALCITE_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.ONYX_CALCITE_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(
        ...
        PastelModelHelper.BLOCK
            .axisRotated(
                generators,
                PastelBlocks.MOONSTONE_CALCITE_LIGHT,
                TexturedModel
                    .createDefault(
                        block -> PastelTextureMaps
                            .sideTopInside(

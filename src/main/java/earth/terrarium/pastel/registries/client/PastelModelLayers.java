...
public class PastelModelLayers {
    ...
    public static final ModelLayerLocation KINDLING_SADDLE = new ModelLayerLocation(
        PastelCommon.locate("kindling_saddle"), "main");
    public static final ModelLayerLocation KINDLING_ARMOR = new ModelLayerLocation(
        PastelCommon.locate("kindling_armor"), "main");
    ...
    public static final ModelLayerLocation CAVE_SPIDER_HEAD = new ModelLayerLocation(
        PastelCommon.locate("cave_spider_head"), "main");
    public static final ModelLayerLocation CHICKEN_HEAD = new ModelLayerLocation(
        PastelCommon.locate("chicken_head"), "main");
    ...
    public static void register(FMLClientSetupEvent event) {
        ...
        ClientHooks.registerLayerDefinition(
            TROPICAL_FISH_HEAD_PATTERN, TropicalFishHeadModel::getTexturedModelDataPattern);
        ...
        ClientHooks.registerLayerDefinition(
            EGG_LAYING_WOOLY_PIG_HEAD, EggLayingWoolyPigHeadModel::getTexturedModelData);
        ...
        ClientHooks.registerLayerDefinition(
            PRESERVATION_TURRET_HEAD, PreservationTurretHeadModel::getTexturedModelData);

        ClientHooks.registerLayerDefinition(
            MAIN_BEDROCK_LAYER, () -> LayerDefinition.create(BedrockArmorModel.getModelData(), 128, 128));
    }

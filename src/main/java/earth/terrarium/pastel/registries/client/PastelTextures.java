...
public class PastelTextures {
    ...
    public static final ResourceLocation JADE_VINE_PLANT_BLOOMING = PastelCommon
        .locate(
            "block/jade_vine_plant_blooming"
        );

    public static final ResourceLocation JADE_VINE_PLANT_BREAKING = PastelCommon
        .locate(
            "block/jade_vine_plant_breaking"
        );
    ...
    public static final ResourceLocation JADE_VINE_PLANT_RIPE_BREAKING = PastelCommon
        .locate(
            "block/jade_vine_plant_ripe_breaking"
        );

    public static final ResourceLocation JADE_VINE_PLANT_RIPE_BULB = PastelCommon
        .locate(
            "block/jade_vine_plant_ripe_bulb"
        );

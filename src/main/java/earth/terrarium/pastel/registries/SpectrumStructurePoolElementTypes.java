...
public class SpectrumStructurePoolElementTypes {
	...
	private static final DeferredRegister<StructurePoolElementType<?>> REGISTER = DeferredRegister.create(Registries.STRUCTURE_POOL_ELEMENT, SpectrumCommon.MOD_ID);

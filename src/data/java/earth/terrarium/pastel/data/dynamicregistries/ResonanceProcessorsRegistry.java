...
public class ResonanceProcessorsRegistry {
    ...
    public static void registerResonanceProcessors(
        ...
        bootstrap.register(
            PastelResonanceProcessors.PURE_RESONANCES_FROM_ORE, ModifyDropsResonanceProcessor.builder(
                                                                                                 BrokenBlockPredicate.Builder.create()
        ...
        registerDropSelf(
            bootstrap, PastelResonanceProcessors.BLACK_MATERIA, PastelBlocks.BLACK_MATERIA.get(), builder -> builder);

        registerDropSelf(
            bootstrap, PastelResonanceProcessors.BRUSHABLE_BLOCKS, PastelBlockTags.C_BRUSHABLE_BLOCKS,
            builder -> builder.copyNbt("LootTable", "LootTableSeed", "item")
        );

        registerDropSelf(
            bootstrap, PastelResonanceProcessors.BUDDING_BLOCKS, Tags.Blocks.BUDDING_BLOCKS,
            builder -> builder
        );
        ...
        registerDropSelf(
            bootstrap, PastelResonanceProcessors.COMPOSTER, Blocks.COMPOSTER, builder -> builder.copyState("level"));

        registerDropSelf(bootstrap, PastelResonanceProcessors.FROGSPAWN, Blocks.FROGSPAWN, builder -> builder);

        registerDropSelf(
            bootstrap, PastelResonanceProcessors.GILDED_BLACKSTONE, Blocks.GILDED_BLACKSTONE, builder -> builder);

        registerDropSelf(
            bootstrap, PastelResonanceProcessors.INFESTED_BLOCKS, PastelBlockTags.C_INFESTED_BLOCKS,
            builder -> builder
        );

        registerDropSelf(
            bootstrap, PastelResonanceProcessors.REINFORCED_DEEPSLATE, Blocks.REINFORCED_DEEPSLATE, builder -> builder);

        registerDropSelf(
            bootstrap, PastelResonanceProcessors.RESPAWN_ANCHOR, Blocks.RESPAWN_ANCHOR,
            builder -> builder.copyState("charges")
        );

        registerDropSelf(
            bootstrap, PastelResonanceProcessors.SCULK_SHRIEKER, Blocks.SCULK_SHRIEKER,
            builder -> builder.copyState("can_summon")
        );

        registerDropSelf(
            bootstrap, PastelResonanceProcessors.SIGNS, BlockTags.ALL_SIGNS,
            builder -> builder.copyNbt("front_text", "back_text", "is_waxed")
        );

        registerDropSelf(
            bootstrap, PastelResonanceProcessors.SPAWNER, Blocks.SPAWNER, builder -> builder.copyNbt(
    ...
    public static void registerDropSelf(
        BootstrapContext<ResonanceProcessor> bootstrap,
        ResourceKey<ResonanceProcessor> key, Block block,
        UnaryOperator<DropSelfResonanceProcessor.Builder> builder
    ) {
        bootstrap.register(
            key, builder.apply(DropSelfResonanceProcessor.builder(BrokenBlockPredicate.Builder.create()
                                                                                              .blocks(block)
                                                                                              .build()))
                        .build()
        );
    ...
    public static void registerDropSelf(
        BootstrapContext<ResonanceProcessor> bootstrap, ResourceKey<ResonanceProcessor> key, TagKey<Block> tag,
        UnaryOperator<DropSelfResonanceProcessor.Builder> builder
    ) {
        bootstrap.register(
            key, builder.apply(DropSelfResonanceProcessor.builder(BrokenBlockPredicate.Builder.create()

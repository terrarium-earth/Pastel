...
public class PastelFluids {
    ...
    // LIQUID CRYSTAL
    public static final DeferredHolder<FluidType, FluidType> LIQUID_CRYSTAL_TYPE = TYPE_REGISTER.register(
        "liquid_crystal", () -> new FluidType(FluidType.Properties.create()));
    public static final DeferredHolder<Fluid, PastelFluid> LIQUID_CRYSTAL = FLUID_REGISTER.register(
        "liquid_crystal", LiquidCrystalFluid.Still::new);
    public static final DeferredHolder<Fluid, PastelFluid> FLOWING_LIQUID_CRYSTAL = FLUID_REGISTER.register(
        "flowing_liquid_crystal", LiquidCrystalFluid.Flowing::new);
    ...
    // HUMUS
    public static final DeferredHolder<FluidType, FluidType> HUMUS_TYPE = TYPE_REGISTER.register(
        "humus", () -> new FluidType(FluidType.Properties.create()));
    public static final DeferredHolder<Fluid, PastelFluid> HUMUS = FLUID_REGISTER.register(
        "humus", HumusFluid.StillHumus::new);
    public static final DeferredHolder<Fluid, PastelFluid> FLOWING_HUMUS = FLUID_REGISTER.register(
        "flowing_humus", HumusFluid.FlowingHumus::new);
    ...
    // MIDNIGHT SOLUTION
    public static final DeferredHolder<FluidType, FluidType> MIDNIGHT_SOLUTION_TYPE = TYPE_REGISTER.register(
        "midnight_solution", () -> new FluidType(FluidType.Properties.create()));
    public static final DeferredHolder<Fluid, PastelFluid> MIDNIGHT_SOLUTION = FLUID_REGISTER.register(
        "midnight_solution", MidnightSolutionFluid.Still::new);
    public static final DeferredHolder<Fluid, PastelFluid> FLOWING_MIDNIGHT_SOLUTION = FLUID_REGISTER.register(
        "flowing_midnight_solution", MidnightSolutionFluid.Flowing::new);
    ...
    // DRAGONROT
    public static final DeferredHolder<FluidType, FluidType> DRAGONROT_TYPE = TYPE_REGISTER.register(
        "dragonrot", () -> new FluidType(FluidType.Properties.create()));
    public static final DeferredHolder<Fluid, PastelFluid> DRAGONROT = FLUID_REGISTER.register(
        "dragonrot", DragonrotFluid.Still::new);
    public static final DeferredHolder<Fluid, PastelFluid> FLOWING_DRAGONROT = FLUID_REGISTER.register(
        "flowing_dragonrot", DragonrotFluid.Flowing::new);
    ...
    public static void registerClient(RegisterClientExtensionsEvent event) {
        setupFluidRendering(
            event, LIQUID_CRYSTAL_TYPE.get(), "liquid_crystal", LIQUID_CRYSTAL_TINT, LIQUID_CRYSTAL_OVERLAY_ALPHA);
        setupFluidRendering(event, HUMUS_TYPE.get(), "humus", HUMUS_TINT, HUMUS_OVERLAY_ALPHA);
        setupFluidRendering(
            event, MIDNIGHT_SOLUTION_TYPE.get(), "midnight_solution", MIDNIGHT_SOLUTION_TINT,

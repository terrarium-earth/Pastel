...
public class PastelS2CPackets {
    ...
    public static void register(PayloadRegistrar registrar) {
        registrar.playToClient(
            PlayParticleWithRandomOffsetAndVelocityPayload.ID, PlayParticleWithRandomOffsetAndVelocityPayload.CODEC,
            PlayParticleWithRandomOffsetAndVelocityPayload::execute
        );
        registrar.playToClient(
            PlayParticleWithExactVelocityPayload.ID, PlayParticleWithExactVelocityPayload.CODEC,
            PlayParticleWithExactVelocityPayload::execute
        );
        registrar.playToClient(
            PlayParticleWithPatternAndVelocityPayload.ID, PlayParticleWithPatternAndVelocityPayload.CODEC,
            PlayParticleWithPatternAndVelocityPayload::execute
        );
        registrar.playToClient(
            PlayParticleAroundBlockSidesPayload.ID, PlayParticleAroundBlockSidesPayload.CODEC,
            PlayParticleAroundBlockSidesPayload::execute
        );
        registrar.playToClient(
            StartSkyLerpingPayload.ID, StartSkyLerpingPayload.CODEC, StartSkyLerpingPayload::execute);
        registrar.playToClient(
            PlayPedestalCraftingFinishedParticlePayload.ID, PlayPedestalCraftingFinishedParticlePayload.CODEC,
            PlayPedestalCraftingFinishedParticlePayload::execute
        );
        registrar.playToClient(
            PlayShootingStarParticlesPayload.ID, PlayShootingStarParticlesPayload.CODEC,
            PlayShootingStarParticlesPayload::execute
        );
        registrar.playToClient(
            PlayFusionCraftingInProgressParticlePayload.ID, PlayFusionCraftingInProgressParticlePayload.CODEC,
            PlayFusionCraftingInProgressParticlePayload::execute
        );
        registrar.playToClient(
            PlayFusionCraftingFinishedParticlePayload.ID, PlayFusionCraftingFinishedParticlePayload.CODEC,
        ...
        registrar.playToClient(
            ParticleSpawnerConfigurationS2CPayload.ID, ParticleSpawnerConfigurationS2CPayload.CODEC,
            ParticleSpawnerConfigurationS2CPayload::execute
        );
        registrar.playToClient(
            PastelTransmissionPayload.ID, PastelTransmissionPayload.CODEC, PastelTransmissionPayload::execute);
        registrar.playToClient(
            TypedTransmissionPayload.ID, TypedTransmissionPayload.CODEC, TypedTransmissionPayload::execute);
        registrar.playToClient(
            ColorTransmissionPayload.ID, ColorTransmissionPayload.CODEC, ColorTransmissionPayload::execute);
        registrar.playToClient(
            PlayBlockBoundSoundInstancePayload.ID, PlayBlockBoundSoundInstancePayload.CODEC,
            PlayBlockBoundSoundInstancePayload::execute
        );
        registrar.playToClient(
            PlayTakeOffBeltSoundInstancePayload.ID, PlayTakeOffBeltSoundInstancePayload.CODEC,
            PlayTakeOffBeltSoundInstancePayload::execute
        );
        registrar.playToClient(
            UpdateBlockEntityInkPayload.ID, UpdateBlockEntityInkPayload.CODEC, UpdateBlockEntityInkPayload::execute);
        registrar.playToClient(
            InkColorSelectedS2CPayload.ID, InkColorSelectedS2CPayload.CODEC, InkColorSelectedS2CPayload::execute);
        registrar.playToClient(
            PlayPresentOpeningParticlesPayload.ID, PlayPresentOpeningParticlesPayload.CODEC,
            PlayPresentOpeningParticlesPayload::execute
        );
        registrar.playToClient(
            PlayAscensionAppliedEffectsPayload.ID, PlayAscensionAppliedEffectsPayload.CODEC,
            PlayAscensionAppliedEffectsPayload::execute
        );
        registrar.playToClient(
            PlayDivinityAppliedEffectsPayload.ID, PlayDivinityAppliedEffectsPayload.CODEC,
        ...
        registrar.playToClient(
            SyncArtisansAtlasPayload.ID, SyncArtisansAtlasPayload.CODEC, SyncArtisansAtlasPayload::execute);
        registrar.playToClient(
            SyncMentalPresencePayload.ID, SyncMentalPresencePayload.CODEC, SyncMentalPresencePayload::execute);
        registrar.playToClient(
            CompactingChestStatusUpdatePayload.ID, CompactingChestStatusUpdatePayload.CODEC,
            CompactingChestStatusUpdatePayload::execute
        );
        registrar.playToClient(
            FabricationChestStatusUpdatePayload.ID, FabricationChestStatusUpdatePayload.CODEC,
            FabricationChestStatusUpdatePayload::execute
        );
        registrar.playToClient(
            BlackHoleChestStatusUpdatePayload.ID, BlackHoleChestStatusUpdatePayload.CODEC,
            BlackHoleChestStatusUpdatePayload::execute
        );
        registrar.playToClient(
            PastelNodeStatusUpdatePayload.ID, PastelNodeStatusUpdatePayload.CODEC,
            PastelNodeStatusUpdatePayload::execute
        );
        registrar.playToClient(
            PastelNetworkEdgeSyncPayload.ID, PastelNetworkEdgeSyncPayload.CODEC, PastelNetworkEdgeSyncPayload::execute);
        registrar.playToClient(
            PastelNetworkRemovedPayload.ID, PastelNetworkRemovedPayload.CODEC, PastelNetworkRemovedPayload::execute);
        ...
        // SavedData stuff
        registrar.playToClient(
            HardcoreDeathTracker.SyncPayload.TYPE, HardcoreDeathTracker.SyncPayload.CODEC,

...
/**
 * A flywheel object containing all the static animation data for a field. This acts as parent and manager for
 * {@link FlowData} objects.
 * <p><p>
 * DataSignatures are tied to classes, and are called upon whenever a {@link FlowAnimator} for its respective object
 * is created to instantiate FlowData.

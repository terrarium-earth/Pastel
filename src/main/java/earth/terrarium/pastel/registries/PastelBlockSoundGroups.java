...
public class PastelBlockSoundGroups {
    ...
    public static final SoundType CITRINE_BLOCK = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_CITRINE_BLOCK_BREAK,
        PastelSounds.BLOCK_CITRINE_BLOCK_STEP,
        PastelSounds.BLOCK_CITRINE_BLOCK_PLACE,
    ...
    public static final SoundType CITRINE_CLUSTER = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_CITRINE_CLUSTER_BREAK,
        PastelSounds.BLOCK_CITRINE_CLUSTER_STEP,
        PastelSounds.BLOCK_CITRINE_CLUSTER_PLACE,
    ...
    public static final SoundType SMALL_CITRINE_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_SMALL_CITRINE_BUD_BREAK,
        PastelSounds.BLOCK_CITRINE_CLUSTER_STEP,
        PastelSounds.BLOCK_SMALL_CITRINE_BUD_PLACE,
        PastelSounds.BLOCK_CITRINE_CLUSTER_HIT,
        PastelSounds.BLOCK_CITRINE_CLUSTER_FALL
    );
    ...
    public static final SoundType MEDIUM_CITRINE_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_MEDIUM_CITRINE_BUD_BREAK,
        PastelSounds.BLOCK_CITRINE_CLUSTER_STEP,
        PastelSounds.BLOCK_MEDIUM_CITRINE_BUD_PLACE,
        PastelSounds.BLOCK_CITRINE_CLUSTER_HIT,
        PastelSounds.BLOCK_CITRINE_CLUSTER_FALL
    );
    ...
    public static final SoundType LARGE_CITRINE_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_LARGE_CITRINE_BUD_BREAK,
        PastelSounds.BLOCK_CITRINE_CLUSTER_STEP,
        PastelSounds.BLOCK_LARGE_CITRINE_BUD_PLACE,
        PastelSounds.BLOCK_CITRINE_CLUSTER_HIT,
        PastelSounds.BLOCK_CITRINE_CLUSTER_FALL
    );
    ...
    public static final SoundType TOPAZ_BLOCK = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_TOPAZ_BLOCK_BREAK,
        PastelSounds.BLOCK_TOPAZ_BLOCK_STEP,
        PastelSounds.BLOCK_TOPAZ_BLOCK_PLACE,
    ...
    public static final SoundType TOPAZ_CLUSTER = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_BREAK,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_STEP,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_PLACE,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_HIT,
    ...
    public static final SoundType SMALL_TOPAZ_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_SMALL_TOPAZ_BUD_BREAK,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_STEP,
        PastelSounds.BLOCK_SMALL_TOPAZ_BUD_PLACE,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_HIT,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_FALL
    );
    ...
    public static final SoundType MEDIUM_TOPAZ_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_MEDIUM_TOPAZ_BUD_BREAK,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_STEP,
        PastelSounds.BLOCK_MEDIUM_TOPAZ_BUD_PLACE,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_HIT,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_FALL
    );
    ...
    public static final SoundType LARGE_TOPAZ_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_LARGE_TOPAZ_BUD_BREAK,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_STEP,
        PastelSounds.BLOCK_LARGE_TOPAZ_BUD_PLACE,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_HIT,
        PastelSounds.BLOCK_TOPAZ_CLUSTER_FALL
    );
    ...
    public static final SoundType ONYX_BLOCK = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_ONYX_BLOCK_BREAK,
        PastelSounds.BLOCK_ONYX_BLOCK_STEP,
        PastelSounds.BLOCK_ONYX_BLOCK_PLACE,
    ...
    public static final SoundType ONYX_CLUSTER = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_ONYX_CLUSTER_BREAK,
        PastelSounds.BLOCK_ONYX_CLUSTER_STEP,
        PastelSounds.BLOCK_ONYX_CLUSTER_PLACE,
        PastelSounds.BLOCK_ONYX_CLUSTER_HIT,
    ...
    public static final SoundType SMALL_ONYX_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_SMALL_ONYX_BUD_BREAK,
        PastelSounds.BLOCK_ONYX_CLUSTER_STEP,
        PastelSounds.BLOCK_SMALL_ONYX_BUD_PLACE,
        PastelSounds.BLOCK_ONYX_CLUSTER_HIT,
        PastelSounds.BLOCK_ONYX_CLUSTER_FALL
    );
    ...
    public static final SoundType MEDIUM_ONYX_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_MEDIUM_ONYX_BUD_BREAK,
        PastelSounds.BLOCK_ONYX_CLUSTER_STEP,
        PastelSounds.BLOCK_MEDIUM_ONYX_BUD_PLACE,
        PastelSounds.BLOCK_ONYX_CLUSTER_HIT,
        PastelSounds.BLOCK_ONYX_CLUSTER_FALL
    );
    ...
    public static final SoundType LARGE_ONYX_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_LARGE_ONYX_BUD_BREAK,
        PastelSounds.BLOCK_ONYX_CLUSTER_STEP,
        PastelSounds.BLOCK_LARGE_ONYX_BUD_PLACE,
        PastelSounds.BLOCK_ONYX_CLUSTER_HIT,
        PastelSounds.BLOCK_ONYX_CLUSTER_FALL
    );
    ...
    public static final SoundType MOONSTONE_BLOCK = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_MOONSTONE_BLOCK_BREAK,
        PastelSounds.BLOCK_MOONSTONE_BLOCK_STEP,
        PastelSounds.BLOCK_MOONSTONE_BLOCK_PLACE,
    ...
    public static final SoundType MOONSTONE_CLUSTER = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_BREAK,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_STEP,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_PLACE,
    ...
    public static final SoundType SMALL_MOONSTONE_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_SMALL_MOONSTONE_BUD_BREAK,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_STEP,
        PastelSounds.BLOCK_SMALL_MOONSTONE_BUD_PLACE,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_HIT,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_FALL
    );
    ...
    public static final SoundType MEDIUM_MOONSTONE_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_MEDIUM_MOONSTONE_BUD_BREAK,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_STEP,
        PastelSounds.BLOCK_MEDIUM_MOONSTONE_BUD_PLACE,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_HIT,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_FALL
    );
    ...
    public static final SoundType LARGE_MOONSTONE_BUD = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.BLOCK_LARGE_MOONSTONE_BUD_BREAK,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_STEP,
        PastelSounds.BLOCK_LARGE_MOONSTONE_BUD_PLACE,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_HIT,
        PastelSounds.BLOCK_MOONSTONE_CLUSTER_FALL
    );

    public static final PastelGemstoneColorCollection<SoundType> GEMSTONE_BLOCKS = new PastelGemstoneColorCollection<>(
        TOPAZ_BLOCK,
        SoundType.AMETHYST,
        CITRINE_BLOCK,
        ONYX_BLOCK,
    ...
    public static final PastelGemstoneColorCollection<SoundType> SMALL_GEMSTONE_BUDS = new PastelGemstoneColorCollection<>(
        SMALL_TOPAZ_BUD,
    ...
    public static final PastelGemstoneColorCollection<SoundType> MEDIUM_GEMSTONE_BUDS = new PastelGemstoneColorCollection<>(
        MEDIUM_TOPAZ_BUD,
    ...
    public static final PastelGemstoneColorCollection<SoundType> LARGE_GEMSTONE_BUDS = new PastelGemstoneColorCollection<>(
        LARGE_TOPAZ_BUD,
    ...
    public static final PastelGemstoneColorCollection<SoundType> GEMSTONE_CLUSTERS = new PastelGemstoneColorCollection<>(
        TOPAZ_CLUSTER,
    ...
    public static final SoundType SPECTRAL_BLOCK = new SoundType(
        1.0F,
        1.0F,
        PastelSounds.SPECTRAL_BLOCK_BREAK,
        PastelSounds.SPECTRAL_BLOCK_STEP,
        PastelSounds.SPECTRAL_BLOCK_PLACE,
        PastelSounds.SPECTRAL_BLOCK_HIT,

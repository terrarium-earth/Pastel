...
public class SpectrumItemGroups {
	...
	public static final ItemSubGroup EQUIPMENT = new ItemSubGroup.Builder(MAIN, ItemGroupIDs.SUBTAB_EQUIPMENT, Text.translatable("itemGroup.spectrum.equipment"))
			...
			.entries((displayContext, entries) -> {
				...
				entries.add(SpectrumEnchantmentHelper.getEnchantedStack(displayContext.lookup(), SpectrumItems.TAKE_OFF_BELT, Map.of(Enchantments.POWER, 5, Enchantments.FEATHER_FALLING, 4)));
				...
				entries.add(SpectrumEnchantmentHelper.getEnchantedStack(displayContext.lookup(), SpectrumItems.GLEAMING_PIN, Map.of(SpectrumEnchantments.SNIPING, 2)));
				...
				entries.add(SpectrumEnchantmentHelper.getEnchantedStack(displayContext.lookup(), SpectrumItems.NATURES_STAFF, Map.of(Enchantments.EFFICIENCY, 5)));

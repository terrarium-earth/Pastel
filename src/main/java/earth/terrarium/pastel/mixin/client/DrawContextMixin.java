...
public abstract class DrawContextMixin {
    ...
    @WrapWithCondition(
        ...
        at = @At(value = "INVOKE",
                 target = "net/minecraft/client/gui/GuiGraphics.fill (Lnet/minecraft/client/renderer/RenderType;" +
                          "IIIII)V",
                 ordinal = 0))
    protected boolean disableVanillaBackground(
        GuiGraphics instance, RenderType layer, int x1, int y1, int x2, int y2, int color,

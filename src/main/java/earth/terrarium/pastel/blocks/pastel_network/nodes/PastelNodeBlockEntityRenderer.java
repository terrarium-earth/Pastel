...
public class PastelNodeBlockEntityRenderer implements BlockEntityRenderer<PastelNodeBlockEntity> {
    ...
    private static final Crystal CONNECTION = new Crystal(
        PastelItems.CONNECTION_NODE_CRYSTAL
            .get()
            .getDefaultInstance(),
        0.25,
        false
    ...
    private static final Crystal PROVIDER = new Crystal(
        PastelItems.PROVIDER_NODE_CRYSTAL
            .get()
            .getDefaultInstance(),
        0.1,
        true
    ...
    private static final Crystal SENDER = new Crystal(
        PastelItems.SENDER_NODE_CRYSTAL
            .get()
            .getDefaultInstance(),
        0.1,
        true
    ...
    private static final Crystal STORAGE = new Crystal(
        PastelItems.STORAGE_NODE_CRYSTAL
            .get()
            .getDefaultInstance(),
        0.15,
        true
    ...
    private static final Crystal BUFFER = new Crystal(
        PastelItems.BUFFER_NODE_CRYSTAL
            .get()
            .getDefaultInstance(),
        0.1,
        true
    ...
    private static final Crystal GATHER = new Crystal(
        PastelItems.GATHER_NODE_CRYSTAL
            .get()
            .getDefaultInstance(),
        0.1,
        false
    ...
    private static final ResourceLocation INNER_RING = PastelCommon
        .locate(
            "textures/block/pastel_node_inner_ring_blank.png"
        );

    private static final ResourceLocation OUTER_RING = PastelCommon
        .locate(
            "textures/block/pastel_node_outer_ring_blank.png"
        );

    private static final ResourceLocation REDSTONE_RING = PastelCommon
        .locate(
        ...
        modelPartData
            .addOrReplaceChild(
                ...
                CubeListBuilder
                    .create()
                    .texOffs(6, 0)
                    .addBox(-1.0F, 1.1F, -1.0F, 2.0F, 0.0F, 2.0F),
                PartPose.ZERO
            );
        modelPartData
            .addOrReplaceChild(
    ...
    public void render(
        ...
        if (node
            ...
            RenderHelper
                .renderFlatTransWithZYOffsetAndColor(
                    matrices,
                    innerRing,
                    true,
                    3.75F + ringHeight / 2F,
        ...
        var redstoneRing = vertexConsumers
            .getBuffer(
                RenderType
                    .entityTranslucent(
                        node
        ...
        if (node
            ...
            RenderHelper
                .renderFlatTransWithZYOffset(
                    ...
                    5F + ringHeight,
                    15F,
                    node.ringAlpha * node.getRedstoneAlphaMult(),
                    1F,
                    overlay
                );
        } else {

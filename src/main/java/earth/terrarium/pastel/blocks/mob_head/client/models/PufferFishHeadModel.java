...
@OnlyIn(Dist.CLIENT)
public class PufferFishHeadModel extends PastelSkullModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild(
            "bottom_front_fin", CubeListBuilder.create()
                                               .texOffs(15, 20)
                                               .addBox(-4.0F, 0.0F, 0.0F, 8.0F, 1.0F, 0.0F),
            PartPose.offsetAndRotation(0.0F, 0.0F, -4.0F, (-(float) Math.PI / 4F), 0.0F, 0.0F)
        );
        head.addOrReplaceChild(
            "bottom_middle_fin", CubeListBuilder.create()
                                                .texOffs(15, 20)
                                                .addBox(-4.0F, 0.0F, 0.0F, 8.0F, 1.0F, 0.0F),
            PartPose.offset(0.0F, 0.0F, 0.0F)
        );
        head.addOrReplaceChild(
            "bottom_back_fin", CubeListBuilder.create()
                                              .texOffs(15, 20)
                                              .addBox(-4.0F, 0.0F, 0.0F, 8.0F, 1.0F, 0.0F),
            PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, ((float) Math.PI / 4F), 0.0F, 0.0F)
        );
        head.addOrReplaceChild(
            "right_back_fin", CubeListBuilder.create()
                                             .texOffs(9, 17)
                                             .addBox(-1.0F, -8.0F, 0.0F, 1.0F, 8.0F, 0.0F),
            PartPose.offsetAndRotation(-4.0F, 0.0F, 4.0F, 0.0F, ((float) Math.PI / 4F), 0.0F)
        );
        head.addOrReplaceChild(
            "left_back_fin", CubeListBuilder.create()
                                            .texOffs(9, 17)
                                            .addBox(0.0F, -8.0F, 0.0F, 1.0F, 8.0F, 0.0F),
            PartPose.offsetAndRotation(4.0F, 0.0F, 4.0F, 0.0F, (-(float) Math.PI / 4F), 0.0F)
        );

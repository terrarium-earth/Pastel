...
public class DivinityTickCriterion extends SimpleCriterionTrigger<DivinityTickCriterion.Conditions> {
    ...
    public record Conditions(
            ...
            .create(
                instance -> instance
                    .group(
                        ...
                        Codec.BOOL
                            .optionalFieldOf("isAlive")
                            .forGetter(Conditions::isAlive),
                        MinMaxBounds.Doubles.CODEC
                            .optionalFieldOf("healthRange", MinMaxBounds.Doubles.ANY)
        ...
        public boolean matches(boolean isPlayerAlive, float health) {
            return this.isAlive.isPresent() && (isPlayerAlive == this.isAlive.get()) && this.healthRange
                .matches(
                    health
                );
        }

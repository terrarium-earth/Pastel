...
public record RandomBlockProximityPatchFeatureConfig(
    ...
    Integer xzSpread,
    Integer ySpread,
    HolderSet<Block> blocksToCheckFor,
    Integer blockScanRange,
    Holder<PlacedFeature> closeToBlockFeature,
    Holder<PlacedFeature> fallbackFeature
) implements FeatureConfiguration {

    public static final Codec<RandomBlockProximityPatchFeatureConfig> CODEC = RecordCodecBuilder
        .create(
            (instance) -> instance
                .group(
                    ...
                    ExtraCodecs.NON_NEGATIVE_INT
                        .fieldOf("block_scan_range")
                        .orElse(1)
                        .forGetter(RandomBlockProximityPatchFeatureConfig::ySpread),
                    PlacedFeature.CODEC
                        .fieldOf("close_to_block_feature")
                        .forGetter(RandomBlockProximityPatchFeatureConfig::closeToBlockFeature),
                    PlacedFeature.CODEC
                        .fieldOf("fallback_feature")

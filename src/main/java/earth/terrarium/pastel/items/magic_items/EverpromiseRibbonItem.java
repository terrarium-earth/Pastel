...
public class EverpromiseRibbonItem extends Item implements PrioritizedEntityInteraction {
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag type) {
		...
		tooltip.add(Component.translatable("item.pastel.everpromise_ribbon.tooltip").withStyle(ChatFormatting.GRAY));
		tooltip.add(Component.translatable("item.pastel.everpromise_ribbon.tooltip2").withStyle(ChatFormatting.GRAY));
	}

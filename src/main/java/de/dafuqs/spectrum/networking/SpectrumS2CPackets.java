...
public class SpectrumS2CPackets {
	...
	public static void register() {
		...
		register(PastelNetworkEdgeSync.ID, PastelNetworkEdgeSync.CODEC);
		register(PastelNetworkRemoved.ID, PastelNetworkRemoved.CODEC);
	}
	...
	public static void registerS2CReceivers() {
		...
		register(PastelNetworkEdgeSync.ID, PastelNetworkEdgeSync::execute);
		register(PastelNetworkRemoved.ID, PastelNetworkRemoved::execute);
	}

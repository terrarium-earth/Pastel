...
public class InkColors {
    ...
    public static final InkColor PURPLE = register(
        "purple", new InkColor(DyeColor.PURPLE, PURPLE_COLOR, BASE_ADVANCEMENT_ID));
    public static final InkColor MAGENTA = register(
        "magenta", new InkColor(DyeColor.MAGENTA, MAGENTA_COLOR, BASE_ADVANCEMENT_ID));
    ...
    public static final InkColor ORANGE = register(
        "orange", new InkColor(DyeColor.ORANGE, ORANGE_COLOR, BASE_ADVANCEMENT_ID));
    public static final InkColor YELLOW = register(
        "yellow", new InkColor(DyeColor.YELLOW, YELLOW_COLOR, BASE_ADVANCEMENT_ID));
    ...
    public static final InkColor GREEN = register(
        "green", new InkColor(DyeColor.GREEN, GREEN_COLOR, BASE_ADVANCEMENT_ID));
    public static final InkColor BROWN = register(
        "brown", new InkColor(DyeColor.BROWN, BROWN_COLOR, BLACK_ADVANCEMENT_ID));
    public static final InkColor BLACK = register(
        "black", new InkColor(DyeColor.BLACK, BLACK_COLOR, BLACK_TEXT_COLOR, BLACK_ADVANCEMENT_ID));
    ...
    public static final InkColor LIGHT_GRAY = register(
        "light_gray", new InkColor(DyeColor.LIGHT_GRAY, LIGHT_GRAY_COLOR, WHITE_ADVANCEMENT_ID));
    public static final InkColor WHITE = register(
        "white", new InkColor(DyeColor.WHITE, WHITE_COLOR, WHITE_ADVANCEMENT_ID));
    ...
    public static List<InkColor> elementals() {
        return PastelRegistries.INK_COLOR.getTag(InkColorTags.ELEMENTAL_COLORS)
    ...
    public static List<InkColor> compounds() {
        return PastelRegistries.INK_COLOR.getTag(InkColorTags.COMPOUND_COLORS)
                                         .map(entries -> entries.stream()
                                                                .map(Holder::value)
                                                                .toList())
                                         .orElseGet(
                                             () -> List.of(
                                                 LIGHT_BLUE, BLUE, PURPLE, PINK, RED, ORANGE, LIME, GREEN, BROWN, GRAY,
                                                 LIGHT_GRAY
                                             ));
    }

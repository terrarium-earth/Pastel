...
public class PastelRecipeSerializers {
    ...
    private static final DeferredRegister<RecipeSerializer<?>> REGISTRAR = DeferredRegister
        .create(
    ...
    public static final RecipeSerializer<ClearPotionFillableRecipe> CLEAR_POTION_FILLABLE_SERIALIZER = register(
        ...
        new EmptyRecipeSerializer<>(ClearPotionFillableRecipe::new)
    );
    ...
    public static final RecipeSerializer<ClearCraftingTabletRecipe> CLEAR_CRAFTING_TABLET_SERIALIZER = register(
        ...
        new EmptyRecipeSerializer<>(ClearCraftingTabletRecipe::new)
    );
    ...
    public static final RecipeSerializer<PotionWorkshopReactingRecipe> POTION_WORKSHOP_REACTING_SERIALIZER = register(
        ...
        new PotionWorkshopReactingRecipe.Serializer()
    );

    // Fluid converting
    public static final FluidConvertingRecipe.Serializer<HumusConvertingRecipe> HUMUS_CONVERTING_SERIALIZER = register(
        "humus_converting",
        new FluidConvertingRecipe.Serializer<>(HumusConvertingRecipe::new)
    );

    public static final FluidConvertingRecipe.Serializer<LiquidCrystalConvertingRecipe> LIQUID_CRYSTAL_CONVERTING_SERIALIZER = register(
        "liquid_crystal_converting",
        new FluidConvertingRecipe.Serializer<>(LiquidCrystalConvertingRecipe::new)
    );

    public static final FluidConvertingRecipe.Serializer<MidnightSolutionConvertingRecipe> MIDNIGHT_SOLUTION_CONVERTING_SERIALIZER = register(
        "midnight_solution_converting",
        new FluidConvertingRecipe.Serializer<>(MidnightSolutionConvertingRecipe::new)
    );
    ...
    public static final RecipeSerializer<SpiritInstillerRecipe> SPIRIT_INSTILLING_SERIALIZER = register(
        "spirit_instiller",
        new SpiritInstillerRecipe.Serializer()
    );

    public static final RecipeSerializer<SpawnerCreatureChangeRecipe> SPIRIT_INSTILLER_SPAWNER_CREATURE_CHANGE = register(
        "spirit_instiller_spawner_creature_change",
        new EmptyRecipeSerializer<>(SpawnerCreatureChangeRecipe::new)
    );

    public static final RecipeSerializer<SpawnerMaxNearbyEntitiesChangeRecipe> SPIRIT_INSTILLER_SPAWNER_MAX_NEARBY_ENTITIES_CHANGE = register(
        "spirit_instiller_spawner_max_nearby_entities_change",
        new EmptyRecipeSerializer<>(SpawnerMaxNearbyEntitiesChangeRecipe::new)
    );

    public static final RecipeSerializer<SpawnerRequiredPlayerRangeChangeRecipe> SPIRIT_INSTILLER_SPAWNER_SPAWNER_PLAYER_RANGE_CHANGE = register(
        "spirit_instiller_spawner_spawner_player_range_change",
        new EmptyRecipeSerializer<>(SpawnerRequiredPlayerRangeChangeRecipe::new)
    );

    public static final RecipeSerializer<SpawnerSpawnCountChangeRecipe> SPIRIT_INSTILLER_SPAWNER_SPAWN_COUNT_CHANGE = register(
        "spirit_instiller_spawner_spawn_count_change",
        new EmptyRecipeSerializer<>(SpawnerSpawnCountChangeRecipe::new)
    );

    public static final RecipeSerializer<SpawnerSpawnDelayChangeRecipe> SPIRIT_INSTILLER_SPAWNER_SPAWN_DELAY_CHANGE = register(
        "spirit_instiller_spawner_spawn_delay_change",
        new EmptyRecipeSerializer<>(SpawnerSpawnDelayChangeRecipe::new)
    );

    public static final RecipeSerializer<HardcorePlayerRevivalRecipe> SPIRIT_INSTILLER_HARDCORE_PLAYER_REVIVAL = register(
        "spirit_instiller_hardcore_player_revival",
        new EmptyRecipeSerializer<>(HardcorePlayerRevivalRecipe::new)
    );

    public static final RecipeSerializer<MemoryToHeadRecipe> SPIRIT_INSTILLER_MEMORY_TO_HEAD = register(
        "spirit_instiller_memory_to_head",
        new EmptyRecipeSerializer<>(MemoryToHeadRecipe::new)
    );

    // Color Picker
    public static final RecipeSerializer<InkConvertingRecipe> INK_CONVERTING_RECIPE_SERIALIZER = register(
        "ink_converting",
        new InkConvertingRecipe.Serializer()
    );

    // Crystallarieum
    public static final RecipeSerializer<CrystallarieumRecipe> CRYSTALLARIEUM_RECIPE_SERIALIZER = register(
        "crystallarieum_growing",
        new CrystallarieumRecipe.Serializer()
    );

    // Cinderhearth
    public static final RecipeSerializer<CinderhearthRecipe> CINDERHEARTH_RECIPE_SERIALIZER = register(
        "cinderhearth",
        new CinderhearthRecipe.Serializer()
    );

    // Titration Barrel
    public static final RecipeSerializer<TitrationBarrelRecipe> TITRATION_BARREL = register(
        "titration_barrel",
        new TitrationBarrelRecipe.Serializer()
    );

    public static final RecipeSerializer<JadeWineRecipe> TITRATION_BARREL_JADE_WINE = register(
        "titration_barrel_jade_wine",
        new EmptyRecipeSerializer<>(JadeWineRecipe::new)
    );

    public static final RecipeSerializer<AquaRegiaRecipe> TITRATION_BARREL_AQUA_REGIA = register(
        "titration_barrel_aqua_regia",
        new EmptyRecipeSerializer<>(AquaRegiaRecipe::new)
    );

    public static final RecipeSerializer<NecteredViognierRecipe> TITRATION_BARREL_NECTERED_VIOGNIER = register(
        "titration_barrel_nectered_viognier",
        new EmptyRecipeSerializer<>(NecteredViognierRecipe::new)
    );

    public static final RecipeSerializer<SuspiciousBrewRecipe> TITRATION_BARREL_SUSPICIOUS_BREW = register(
        "titration_barrel_suspicious_brew",
        new EmptyRecipeSerializer<>(SuspiciousBrewRecipe::new)
    );

    public static final RecipeSerializer<CheongRecipe> TITRATION_BARREL_CHEONG = register(
        "titration_barrel_cheong",
        new EmptyRecipeSerializer<>(CheongRecipe::new)
    );

    // Primordial Fire
    public static final RecipeSerializer<PrimordialFireBurningRecipe> PRIMORDIAL_FIRE_BURNING_RECIPE_SERIALIZER = register(
        "primordial_fire_burning",
        new PrimordialFireBurningRecipe.Serializer()
    );

    public static final RecipeSerializer<MemoryDementiaRecipe> MEMORY_DEMENTIA = register(
        "memory_dementia",
        new EmptyRecipeSerializer<>(MemoryDementiaRecipe::new)
    );
    ...
    public static final RecipeSerializer<EnchantedBookUnsoulingRecipe> ENCHANTED_BOOK_UNSOULING = register(
        ...
        new EnchantedBookUnsoulingRecipe.Serializer()
    );

    // Ink Cantrips
    public static final RecipeSerializer<HealingRecipe> CANTRIP_HEALING_RECIPE_SERIALIZER = register(
        "cantrip_healing",
        new HealingRecipe.Serializer()
    );

    public static final RecipeSerializer<DegradingRecipe> CANTRIP_DEGRADING_RECIPE_SERIALIZER = register(
        "cantrip_degrading",
        new DegradingRecipe.Serializer()
    );

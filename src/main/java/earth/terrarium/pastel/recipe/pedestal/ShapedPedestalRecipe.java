...
public class ShapedPedestalRecipe extends PedestalRecipe {
    ...
    public ShapedPedestalRecipe(
        ...
        super(
            group, secret, requiredAdvancementIdentifier, tier, rawShapedRecipe.getIngredients(), gemstonePowderInputs,
            output, experience, craftingTime, skipRecipeRemainders, noBenefitsFromYieldUpgrades
        );
    ...
    public void consumeIngredients(PedestalBlockEntity pedestal) {
        ...
        boolean mirrored = rawShapedRecipe.matches(
            pedestal.createRecipeInput()
                    .getCraftingGridInput(), true
        );
            ...
            for (int y = 0; y < this.height; y++) {
                ...
                if (!ingredientStackAtPos.test(slotStack)) {
                    PastelCommon.logError(
                        "Looks like DaFuqs or Electro fucked up Spectrums Pedestal recipe matching. Go open up a " +
                        "report with the recipe that was crafted and an image of the pedestals contents, please! :)");
                }
    ...
    public static class Serializer implements RecipeSerializer<ShapedPedestalRecipe> {
        ...
        public static final MapCodec<ShapedPedestalRecipe> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
                                                                                                         ...
                                                                                                         PedestalRecipeTier.CODEC.optionalFieldOf("tier", PedestalRecipeTier.BASIC)
                                                                                                                                 .forGetter(recipe -> recipe.tier),
                                                                                                         RawShapedPedestalRecipe.CODEC.forGetter(recipe -> recipe.rawShapedRecipe),
                                                                                                         CodecHelper.registryMap(PastelRegistries.GEMSTONE_COLOR, Codec.INT)
                                                                                                                    .fieldOf("colors")
                                                                                                         ...
                                                                                                         Codec.BOOL.optionalFieldOf("skip_recipe_remainders", false)
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, ShapedPedestalRecipe> STREAM_CODEC
            ...
            ByteBufCodecs.map(
                HashMap::new, ByteBufCodecs.registry(PastelRegistries.GEMSTONE_COLOR.key()), ByteBufCodecs.VAR_INT),

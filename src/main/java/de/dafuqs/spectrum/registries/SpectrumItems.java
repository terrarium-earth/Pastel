...
public class SpectrumItems {
	...
	// Preenchanted tools
	public static final PreenchantedMultiToolItem MULTITOOL = register(handheld(item("multitool", new PreenchantedMultiToolItem(Tiers.IRON, 2, -2.4F, IS.of(Rarity.UNCOMMON).durability(Tiers.IRON.getUses())), InkColors.BROWN)));
	public static final GlintlessPickaxe TENDER_PICKAXE = register(handheld(item("tender_pickaxe", new GlintlessPickaxe(SpectrumToolMaterial.LOW_HEALTH, IS.of(Rarity.UNCOMMON).durability(SpectrumToolMaterial.LOW_HEALTH.getUses()).attributes(PickaxeItem.createAttributes(SpectrumToolMaterial.LOW_HEALTH, 1, -2.8F))) {
		@Override
		public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
			return Map.of(Enchantments.SILK_TOUCH, 1);
		}
	}, InkColors.BLUE)));
	public static final GlintlessPickaxe LUCKY_PICKAXE = register(handheld(item("lucky_pickaxe", new GlintlessPickaxe(SpectrumToolMaterial.LOW_HEALTH, IS.of(Rarity.UNCOMMON).durability(SpectrumToolMaterial.LOW_HEALTH.getUses()).attributes(PickaxeItem.createAttributes(SpectrumToolMaterial.LOW_HEALTH, 1, -2.8F))) {
		@Override
		public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
	...
	public static final LagoonRodItem LAGOON_ROD = register(item("lagoon_rod", new LagoonRodItem(IS.of().durability(256)), InkColors.LIGHT_BLUE));
	public static final MoltenRodItem MOLTEN_ROD = register(item("molten_rod", new MoltenRodItem(IS.of().durability(256)), InkColors.ORANGE));
	...
	public static final BedrockSwordItem BEDROCK_SWORD = register(item("bedrock_sword", new BedrockSwordItem(SpectrumToolMaterial.BEDROCK, IS.of(Rarity.UNCOMMON).attributes(SwordItem.createAttributes(SpectrumToolMaterial.BEDROCK, 4, -2.4F)).fireResistant().durability(SpectrumToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK));
	...
	public static final BedrockBowItem BEDROCK_BOW = register(item("bedrock_bow", new BedrockBowItem(IS.of(Rarity.UNCOMMON).fireResistant().durability(SpectrumToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK));
	public static final BedrockCrossbowItem BEDROCK_CROSSBOW = register(item("bedrock_crossbow", new BedrockCrossbowItem(IS.of(Rarity.UNCOMMON).fireResistant().durability(SpectrumToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK));
	public static final BedrockShearsItem BEDROCK_SHEARS = register(simple(item("bedrock_shears", new BedrockShearsItem(IS.of(Rarity.UNCOMMON).fireResistant().durability(SpectrumToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).component(DataComponents.TOOL, ShearsItem.createToolProperties())), InkColors.BLACK)));
	public static final BedrockFishingRodItem BEDROCK_FISHING_ROD = register(item("bedrock_fishing_rod", new BedrockFishingRodItem(IS.of(Rarity.UNCOMMON).fireResistant().durability(SpectrumToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK));
	...
	public static final GlassCrestCrossbowItem GLASS_CREST_CROSSBOW = register(item("glass_crest_crossbow", new GlassCrestCrossbowItem(IS.of(1, Rarity.UNCOMMON).fireResistant().durability(SpectrumToolMaterial.GLASS_CREST.getUses())), InkColors.WHITE));
	public static final FerociousBidentItem FEROCIOUS_GLASS_CREST_BIDENT = register(item("ferocious_glass_crest_bident", new FerociousBidentItem(IS.of(1, Rarity.UNCOMMON).durability(SpectrumToolMaterial.GLASS_CREST.getUses()), -2.2, 13, 0.33F, 0.33F), InkColors.WHITE));
	public static final FractalBidentItem FRACTAL_GLASS_CREST_BIDENT = register(item("fractal_glass_crest_bident", new FractalBidentItem(IS.of(1, Rarity.UNCOMMON).durability(SpectrumToolMaterial.GLASS_CREST.getUses()), -2.4, 6.5, 0.25F, 0.25F), InkColors.WHITE));
	...
	public static final Item OMNI_ACCELERATOR = register(item("omni_accelerator", new OmniAcceleratorItem(IS.of(1, Rarity.UNCOMMON).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)), InkColors.YELLOW));
	...
	public static final Item BLOODSTONE_GLASS_AMPOULE = register(simple(item("bloodstone_glass_ampoule", new BloodstoneGlassAmpouleItem(IS.of(Rarity.UNCOMMON).attributes(BloodstoneGlassAmpouleItem.createAttributeModifiers())), InkColors.RED)));
	...
	public static final NightfallsBladeItem NIGHTFALLS_BLADE = register(item("nightfalls_blade", new NightfallsBladeItem(Tiers.DIAMOND, 3, -2.4F, IS.of(1, Rarity.UNCOMMON)), InkColors.GRAY).withItemModel((ctx, item) -> SpectrumModelHelper.registerLayeredItemModel(ctx, item, SpectrumModels.HANDHELD_THREE_LAYERS, "", "_tint", "_overlay")));
	...
	public static final DragonTalonItem DRAGON_TALON = register(item("dragon_talon", new DragonTalonItem(SpectrumToolMaterial.DRACONIC, -3.0, -1.0, IS.of(1, Rarity.RARE).durability(SpectrumToolMaterial.DRACONIC.getUses())), InkColors.YELLOW));
	public static final LightGreatswordItem KNOTTED_SWORD = register(item("knotted_sword", new LightGreatswordItem(SpectrumToolMaterial.VERDIGRIS, 3, -2.4F, 0.25F, 0.5F, 0xFFd4d6ff, IS.of(1, Rarity.UNCOMMON).durability(SpectrumToolMaterial.VERDIGRIS.getUses())), InkColors.GREEN));
	public static final NectarLanceItem NECTAR_LANCE = register(item("nectar_lance", new NectarLanceItem(SpectrumToolMaterial.NECTAR, 0, -2.4F, 0.5F, 1.5F, 0xFFf8e8ff, IS.of(1, Rarity.EPIC).durability(SpectrumToolMaterial.NECTAR.getUses())), InkColors.PURPLE));
	
	// Bedrock Armor
	public static final BedrockArmorItem BEDROCK_HELMET = register(simple(item("bedrock_helmet", new BedrockArmorItem(SpectrumArmorMaterials.BEDROCK, ArmorItem.Type.HELMET, IS.of(Rarity.UNCOMMON).fireResistant().durability(70 * 13).component(DataComponents.UNBREAKABLE, new Unbreakable(false))) {
		@Override
		public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
			return Map.of(Enchantments.PROJECTILE_PROTECTION, 5);
		}
	}, InkColors.BLACK)));
	public static final BedrockArmorItem BEDROCK_CHESTPLATE = register(simple(item("bedrock_chestplate", new BedrockArmorItem(SpectrumArmorMaterials.BEDROCK, ArmorItem.Type.CHESTPLATE, IS.of(Rarity.UNCOMMON).fireResistant().durability(70 * 15).component(DataComponents.UNBREAKABLE, new Unbreakable(false))) {
		@Override
		public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
			return Map.of(Enchantments.PROTECTION, 5);
		}
	}, InkColors.BLACK)));
	public static final BedrockArmorItem BEDROCK_LEGGINGS = register(simple(item("bedrock_leggings", new BedrockArmorItem(SpectrumArmorMaterials.BEDROCK, ArmorItem.Type.LEGGINGS, IS.of(Rarity.UNCOMMON).fireResistant().durability(70 * 16).component(DataComponents.UNBREAKABLE, new Unbreakable(false))) {
		@Override
		public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
			return Map.of(Enchantments.BLAST_PROTECTION, 5);
		}
	}, InkColors.BLACK)));
	public static final BedrockArmorItem BEDROCK_BOOTS = register(simple(item("bedrock_boots", new BedrockArmorItem(SpectrumArmorMaterials.BEDROCK, ArmorItem.Type.BOOTS, IS.of(Rarity.UNCOMMON).fireResistant().durability(70 * 11).component(DataComponents.UNBREAKABLE, new Unbreakable(false))) {
		@Override
		public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
	...
	// Armor
	public static final GemstoneArmorItem FETCHLING_HELMET = register(simple(item("fetchling_helmet", new GemstoneArmorItem(SpectrumArmorMaterials.GEMSTONE, ArmorItem.Type.HELMET, IS.of(Rarity.UNCOMMON).durability(9 * 13)), InkColors.BLUE)));
	public static final GemstoneArmorItem FEROCIOUS_CHESTPLATE = register(simple(item("ferocious_chestplate", new GemstoneArmorItem(SpectrumArmorMaterials.GEMSTONE, ArmorItem.Type.CHESTPLATE, IS.of(Rarity.UNCOMMON).durability(9 * 15)), InkColors.BLUE)));
	public static final GemstoneArmorItem SYLPH_LEGGINGS = register(simple(item("sylph_leggings", new GemstoneArmorItem(SpectrumArmorMaterials.GEMSTONE, ArmorItem.Type.LEGGINGS, IS.of(Rarity.UNCOMMON).durability(9 * 16)), InkColors.BLUE)));
	public static final GemstoneArmorItem OREAD_BOOTS = register(simple(item("oread_boots", new GemstoneArmorItem(SpectrumArmorMaterials.GEMSTONE, ArmorItem.Type.BOOTS, IS.of(Rarity.UNCOMMON).durability(9 * 11)), InkColors.BLUE)));
	...
	// Decay bottles
	public static final Item BOTTLE_OF_FADING = register(simple(item("bottle_of_fading", new DecayPlacerItem(SpectrumBlocks.FADING.get(), IS.of(16), List.of(Component.translatable("item.pastel.bottle_of_fading.tooltip"))), InkColors.GRAY)));
	public static final Item BOTTLE_OF_FAILING = register(simple(item("bottle_of_failing", new DecayPlacerItem(SpectrumBlocks.FAILING.get(), IS.of(16), List.of(Component.translatable("item.pastel.bottle_of_failing.tooltip"))), InkColors.GRAY)));
	public static final Item BOTTLE_OF_RUIN = register(simple(item("bottle_of_ruin", new DecayPlacerItem(SpectrumBlocks.RUIN.get(), IS.of(16), List.of(Component.translatable("item.pastel.bottle_of_ruin.tooltip"))), InkColors.GRAY)));
	public static final Item BOTTLE_OF_FORFEITURE = register(simple(item("bottle_of_forfeiture", new DecayPlacerItem(SpectrumBlocks.FORFEITURE.get(), IS.of(16), List.of(CreativeOnlyItem.DESCRIPTION, Component.translatable("item.pastel.bottle_of_forfeiture.tooltip"))), InkColors.GRAY)));
	public static final Item BOTTLE_OF_DECAY_AWAY = register(simple(item("bottle_of_decay_away", new DecayPlacerItem(SpectrumBlocks.DECAY_AWAY.get(), IS.of(16), List.of(Component.translatable("item.pastel.bottle_of_decay_away.tooltip"))), InkColors.PINK)));
	
	// Resources
	public static final Item SHIMMERSTONE_GEM = register(simple(item("shimmerstone_gem", new CloakedItemWithLoomPattern(IS.of(), ((RevelationAware) SpectrumBlocks.SHIMMERSTONE_ORE.get()).getCloakAdvancementIdentifier(), YELLOW_DYE, SpectrumBannerPatterns.SHIMMERSTONE), InkColors.YELLOW)));
	public static final Item RAW_AZURITE = register(simple(item("raw_azurite", new CloakedItemWithLoomPattern(IS.of(), ((AzuriteOreBlock) SpectrumBlocks.AZURITE_ORE.get()).getCloakAdvancementIdentifier(), BLUE_DYE, SpectrumBannerPatterns.RAW_AZURITE), InkColors.BLUE)));
	public static final Item PURE_AZURITE = register(simple(item("pure_azurite", new CloakedItem(IS.of(), ((AzuriteOreBlock) SpectrumBlocks.AZURITE_ORE.get()).getCloakAdvancementIdentifier(), BLUE_DYE), InkColors.BLUE)));
	public static final CloakedFloatItem PALTAERIA_FRAGMENTS = register(simple(item("paltaeria_fragments", new CloakedFloatItem(IS.of(), 0.00125F, ((RevelationAware) SpectrumBlocks.PALTAERIA_ORE.get()).getCloakAdvancementIdentifier(), CYAN_DYE), InkColors.LIGHT_BLUE)));
	public static final CloakedFloatItem PALTAERIA_GEM = register(simple(item("paltaeria_gem", new CloakedFloatItem(IS.of(16), 0.01F, ((RevelationAware) SpectrumBlocks.PALTAERIA_ORE.get()).getCloakAdvancementIdentifier(), CYAN_DYE), InkColors.LIGHT_BLUE)));
	public static final CloakedFloatItem STRATINE_FRAGMENTS = register(simple(item("stratine_fragments", new CloakedFloatItem(IS.of().fireResistant(), -0.00125F, ((RevelationAware) SpectrumBlocks.STRATINE_ORE.get()).getCloakAdvancementIdentifier(), RED_DYE), InkColors.RED)));
	public static final CloakedFloatItem STRATINE_GEM = register(simple(item("stratine_gem", new CloakedFloatItem(IS.of(16).fireResistant(), -0.01F, ((RevelationAware) SpectrumBlocks.STRATINE_ORE.get()).getCloakAdvancementIdentifier(), RED_DYE), InkColors.RED)));
	...
	public static final Item AETHER_VESTIGES = register(simple(item("aether_vestiges", new AetherVestigesItem(IS.of(1, Rarity.EPIC).fireResistant(), "item.pastel.aether_vestiges.tooltip"), InkColors.WHITE)));
	...
	public static final Item MERMAIDS_GEM = register(simple(item("mermaids_gem", new MermaidsGemItem(SpectrumBlocks.MERMAIDS_BRUSH.get(), IS.of()), InkColors.YELLOW)));
	...
	public static final Item HIBERNATING_JADE_VINE_BULB = register(simple(item("hibernating_jade_vine_bulb", new ItemWithTooltip(IS.of(16), "item.pastel.hibernating_jade_vine_bulb.tooltip"), InkColors.GRAY)));
	...
	public static final Item JADE_JELLY = register(simple(item("jade_jelly", new ItemWithTooltip(IS.of().food(SpectrumFoodComponents.JADE_JELLY), "item.pastel.jade_jelly.tooltip"), InkColors.LIME)));
	public static final Item GLASS_PEACH = register(simple(item("glass_peach", new ItemWithTooltip(IS.of().food(SpectrumFoodComponents.GLASS_PEACH), "item.pastel.glass_peach.tooltip"), InkColors.PINK)));
	public static final Item FISSURE_PLUM = register(simple(item("fissure_plum", new AliasedTooltipItem(SpectrumBlocks.ABYSSAL_VINES.get(), IS.of().food(SpectrumFoodComponents.FISSURE_PLUM), "item.pastel.fissure_plum.tooltip"), InkColors.BROWN)));
	public static final Item NIGHTDEW_SPROUT = register(simple(item("nightdew_sprout", new AliasedTooltipItem(SpectrumBlocks.NIGHTDEW.get(), IS.of().food(SpectrumFoodComponents.NIGHTDEW_SPROUT), "item.pastel.nightdew_sprout.tooltip"), InkColors.PURPLE)));
	public static final Item NECTARDEW_BURGEON = register(simple(item("nectardew_burgeon", new NectardewBurgeonItem(IS.of().food(SpectrumFoodComponents.NECTARDEW_BURGEON), "item.pastel.nectardew_burgeon.tooltip", SpectrumAdvancements.COLLECT_NECTARDEW, SpectrumItems.NIGHTDEW_SPROUT), InkColors.PURPLE)));
	...
	public static final Item CLOTTED_CREAM = register(simple(item("clotted_cream", new ClottedCreamItem(IS.of().food(SpectrumFoodComponents.CLOTTED_CREAM), new String[]{"item.pastel.clotted_cream.tooltip", "item.pastel.clotted_cream.tooltip2"}), InkColors.PINK)));
	...
	public static final Item CHEONG = register(layered(item("cheong", new ItemWithTooltip(IS.of().food(SpectrumFoodComponents.CHEONG), "item.pastel.cheong.tooltip"), InkColors.PINK), "", "_overlay", "_cap"));
	...
	public static final Item MERMAIDS_POPCORN = register(simple(item("mermaids_popcorn", new ItemWithTooltip(IS.of().food(SpectrumFoodComponents.MERMAIDS_POPCORN), "item.pastel.mermaids_popcorn.tooltip"), InkColors.PINK)));
...
//	public static final Item VITTORIAS_ROAST = register(simple(item("vittorias_roast", new Item(IS.of().food(SpectrumFoodComponents.VITTORIAS_ROAST)), InkColors.PINK)));
	...
	public static final Item ALOE_LEAF = register(simple(item("aloe_leaf", new ItemNameBlockItem(SpectrumBlocks.ALOE.get(), IS.of().food(SpectrumFoodComponents.ALOE_LEAF)), InkColors.PINK)));
	public static final Item SAWBLADE_HOLLY_BERRY = register(simple(item("sawblade_holly_berry", new ItemNameBlockItem(SpectrumBlocks.SAWBLADE_HOLLY_BUSH.get(), IS.of().food(Foods.SWEET_BERRIES)), InkColors.PINK)));
	...
	public static final Item DOOMBLOOM_SEED = register(simple(item("doombloom_seed", new ItemNameBlockItem(SpectrumBlocks.DOOMBLOOM.get(), IS.of().fireResistant()), InkColors.BLACK)));
	...
	public static final Item AMARANTH_GRAINS = register(simple(item("amaranth_grains", new ItemNameBlockItem(SpectrumBlocks.AMARANTH.get(), IS.of()), InkColors.LIME)));
	
	// Cookbooks
	public static final Item MELOCHITES_COOKBOOK_VOL_1 = register(simple(item("melochites_cookbook_vol_1", new CookbookItem(IS.of().stacksTo(1).rarity(Rarity.UNCOMMON), GuidebookItem.addressOf(GuidebookItem.CUISINE_CATEGORY_ID, locate("cuisine/cookbooks/melochites_cookbook_vol_1"))), InkColors.PURPLE)));
	public static final Item MELOCHITES_COOKBOOK_VOL_2 = register(simple(item("melochites_cookbook_vol_2", new CookbookItem(IS.of().stacksTo(1).rarity(Rarity.UNCOMMON), GuidebookItem.addressOf(GuidebookItem.CUISINE_CATEGORY_ID, locate("cuisine/cookbooks/melochites_cookbook_vol_2"))), InkColors.PURPLE)));
	public static final Item IMBRIFER_COOKBOOK = register(simple(item("imbrifer_cookbook", new CookbookItem(IS.of().stacksTo(1).rarity(Rarity.UNCOMMON), GuidebookItem.addressOf(GuidebookItem.CUISINE_CATEGORY_ID, locate("cuisine/cookbooks/imbrifer_cookbook"))), InkColors.PURPLE)));
	public static final Item IMPERIAL_COOKBOOK = register(simple(item("imperial_cookbook", new CookbookItem(IS.of().stacksTo(1).rarity(Rarity.UNCOMMON), GuidebookItem.addressOf(GuidebookItem.CUISINE_CATEGORY_ID, locate("cuisine/cookbooks/imperial_cookbook"))), InkColors.PURPLE)));
	...
	public static final Item POISONERS_HANDBOOK = register(simple(item("poisoners_handbook", new CookbookItem(IS.of().stacksTo(1).rarity(Rarity.EPIC), GuidebookItem.addressOf(GuidebookItem.CUISINE_CATEGORY_ID, locate("dimension/lore/poisoners_handbook")), SpectrumStatusEffects.ETERNAL_SLUMBER_COLOR), InkColors.PURPLE)));
	...
	public static final Item RABBIT_CREAM_PIE = register(simple(item("rabbit_cream_pie", new ItemWithTooltip(IS.of().food(SpectrumFoodComponents.RABBIT_CREAM_PIE), "item.pastel.rabbit_cream_pie.tooltip"), InkColors.PINK)));
	public static final Item SEDATIVES = register(simple(item("sedatives", new SedativesItem(IS.of().food(SpectrumFoodComponents.SEDATIVES), "item.pastel.sedatives.tooltip"), InkColors.PINK)));
	public static final Item SLUSHSLIDE = register(simple(item("slushslide", new DrinkItem(IS.of(16).food(SpectrumFoodComponents.SLUSHSLIDE), "item.pastel.slushslide.tooltip"), InkColors.PINK)));
	...
	public static final Item EVERNECTAR = register(simple(item("evernectar", new EvernectarItem(IS.of(1, Rarity.EPIC).food(SpectrumFoodComponents.EVERNECTAR).craftRemainder(GLASS_BOTTLE), "item.pastel.evernectar.tooltip"), InkColors.LIME)));
	...
	public static final Item CRESCENT_CLOCK = register(item("crescent_clock", new ItemWithTooltip(IS.of(1), "item.pastel.crescent_clock.tooltip"), InkColors.MAGENTA));
	...
	public static final Item ASHEN_CIRCLET = register(item("ashen_circlet", new AshenCircletItem(IS.of(1, Rarity.UNCOMMON).fireResistant()), InkColors.ORANGE));
	...
	public static final Item PURE_NETHERITE_SCRAP = register(simple(item("pure_netherite_scrap", new Item(IS.of().fireResistant()), InkColors.BROWN)));

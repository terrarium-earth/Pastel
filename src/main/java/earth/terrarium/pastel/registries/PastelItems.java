...
import earth.terrarium.pastel.blocks.conditional.MermaidsGemItem;
...
public class PastelItems {
    ...
    // Structure placers
    public static final DeferredItem<Item> PEDESTAL_TIER_1_STRUCTURE_PLACER = register(simple(item("pedestal_tier_1_structure_placer", () -> new StructurePlacerItem(IS.of(1), PastelMultiblocks.PEDESTAL_SIMPLE), InkColors.WHITE)));
    public static final DeferredItem<Item> PEDESTAL_TIER_2_STRUCTURE_PLACER = register(simple(item("pedestal_tier_2_structure_placer", () -> new StructurePlacerItem(IS.of(1), PastelMultiblocks.PEDESTAL_ADVANCED), InkColors.WHITE)));
    public static final DeferredItem<Item> PEDESTAL_TIER_3_STRUCTURE_PLACER = register(simple(item("pedestal_tier_3_structure_placer", () -> new StructurePlacerItem(IS.of(1), PastelMultiblocks.PEDESTAL_COMPLEX), InkColors.WHITE)));
    public static final DeferredItem<Item> FUSION_SHRINE_STRUCTURE_PLACER = register(simple(item("fusion_shrine_structure_placer", () -> new StructurePlacerItem(IS.of(1), PastelMultiblocks.FUSION_SHRINE), InkColors.WHITE)));
    public static final DeferredItem<Item> ENCHANTER_STRUCTURE_PLACER = register(simple(item("enchanter_structure_placer", () -> new StructurePlacerItem(IS.of(1), PastelMultiblocks.ENCHANTER), InkColors.WHITE)));
    public static final DeferredItem<Item> SPIRIT_INSTILLER_STRUCTURE_PLACER = register(simple(item("spirit_instiller_structure_placer", () -> new StructurePlacerItem(IS.of(1), PastelMultiblocks.SPIRIT_INSTILLER), InkColors.WHITE)));
    public static final DeferredItem<Item> CINDERHEARTH_STRUCTURE_PLACER = register(simple(item("cinderhearth_structure_placer", () -> new StructurePlacerItem(IS.of(1), PastelMultiblocks.CINDERHEARTH), InkColors.WHITE)));
    ...
    public static final DeferredItem<GlintlessPickaxe> TENDER_PICKAXE = register(handheld(item("tender_pickaxe", () -> new GlintlessPickaxe(PastelToolMaterial.LOW_HEALTH, IS.of(Rarity.UNCOMMON).durability(PastelToolMaterial.LOW_HEALTH.getUses()).attributes(PickaxeItem.createAttributes(PastelToolMaterial.LOW_HEALTH, 1, -2.8F))) {
        @Override
        public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
            return Map.of(Enchantments.SILK_TOUCH, 1);
        }
    }, InkColors.BLUE)));
    public static final DeferredItem<GlintlessPickaxe> LUCKY_PICKAXE = register(handheld(item("lucky_pickaxe", () -> new GlintlessPickaxe(PastelToolMaterial.LOW_HEALTH, IS.of(Rarity.UNCOMMON).durability(PastelToolMaterial.LOW_HEALTH.getUses()).attributes(PickaxeItem.createAttributes(PastelToolMaterial.LOW_HEALTH, 1, -2.8F))) {
        @Override
        public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
            return Map.of(Enchantments.FORTUNE, 3);
        }
    }, InkColors.LIGHT_BLUE)));
    public static final DeferredItem<RazorFalchionItem> RAZOR_FALCHION = register(handheld(item("razor_falchion", () -> new RazorFalchionItem(PastelToolMaterial.LOW_HEALTH, IS.of(Rarity.UNCOMMON).durability(PastelToolMaterial.LOW_HEALTH.getUses()).attributes(SwordItem.createAttributes(PastelToolMaterial.LOW_HEALTH, 4, -2.2F))), InkColors.RED)));
    public static final DeferredItem<OblivionPickaxeItem> OBLIVION_PICKAXE = register(handheld(item("oblivion_pickaxe", () -> new OblivionPickaxeItem(PastelToolMaterial.VOIDING, IS.of(Rarity.UNCOMMON).durability(PastelToolMaterial.VOIDING.getUses()).attributes(PickaxeItem.createAttributes(PastelToolMaterial.VOIDING, 1, -2.8F))), InkColors.GRAY)));
    public static final DeferredItem<GlintlessPickaxe> RESONANT_PICKAXE = register(handheld(item("resonant_pickaxe", () -> new GlintlessPickaxe(PastelToolMaterial.LOW_HEALTH_MINING_LEVEL_4, IS.of(Rarity.UNCOMMON).durability(PastelToolMaterial.LOW_HEALTH.getUses()).attributes(PickaxeItem.createAttributes(PastelToolMaterial.LOW_HEALTH_MINING_LEVEL_4, 1, -2.8F))) {
        @Override
        public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
            return Map.of(PastelEnchantments.RESONANCE, 1);
        }
    }, InkColors.WHITE)));
    public static final DeferredItem<GlintlessPickaxe> DRAGONRENDING_PICKAXE = register(handheld(item("dragonrending_pickaxe", () -> new GlintlessPickaxe(PastelToolMaterial.DRACONIC, IS.of(Rarity.UNCOMMON).durability(PastelToolMaterial.DRACONIC.getUses()).attributes(PickaxeItem.createAttributes(PastelToolMaterial.DRACONIC, 1, -2.8F))) {
        @Override
        public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
    ...
    // Bedrock Tools
    public static final DeferredItem<PastelPickaxeItem> BEDROCK_PICKAXE = register(handheld(item("bedrock_pickaxe", () -> new PastelPickaxeItem(PastelToolMaterial.BEDROCK, IS.of(Rarity.UNCOMMON).attributes(PickaxeItem.createAttributes(PastelToolMaterial.BEDROCK, 1, -2.8F)).fireResistant().durability(PastelToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))) {
        @Override
        public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
            return Map.of(Enchantments.SILK_TOUCH, 1);
        }
    }, InkColors.BLACK)));
    public static final DeferredItem<BedrockAxeItem> BEDROCK_AXE = register(item("bedrock_axe", () -> new BedrockAxeItem(PastelToolMaterial.BEDROCK, IS.of(Rarity.UNCOMMON).attributes(AxeItem.createAttributes(PastelToolMaterial.BEDROCK, 5, -3.0F)).fireResistant().durability(PastelToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK));
    public static final DeferredItem<BedrockShovelItem> BEDROCK_SHOVEL = register(handheld(item("bedrock_shovel", () -> new BedrockShovelItem(PastelToolMaterial.BEDROCK, IS.of(Rarity.UNCOMMON).attributes(ShovelItem.createAttributes(PastelToolMaterial.BEDROCK, 1, -3.0F)).fireResistant().durability(PastelToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK)));
    public static final DeferredItem<BedrockSwordItem> BEDROCK_SWORD = register(item("bedrock_sword", () -> new BedrockSwordItem(PastelToolMaterial.BEDROCK, IS.of(Rarity.UNCOMMON).attributes(SwordItem.createAttributes(PastelToolMaterial.BEDROCK, 4, -2.4F)).fireResistant().durability(PastelToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK));
    public static final DeferredItem<BedrockHoeItem> BEDROCK_HOE = register(handheld(item("bedrock_hoe", () -> new BedrockHoeItem(PastelToolMaterial.BEDROCK, IS.of(Rarity.UNCOMMON).attributes(HoeItem.createAttributes(PastelToolMaterial.BEDROCK, 2, -0.0F)).fireResistant().durability(PastelToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK)));
    public static final DeferredItem<BedrockBowItem> BEDROCK_BOW = register(item("bedrock_bow", () -> new BedrockBowItem(IS.of(Rarity.UNCOMMON).fireResistant().durability(PastelToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK));
    public static final DeferredItem<BedrockCrossbowItem> BEDROCK_CROSSBOW = register(item("bedrock_crossbow", () -> new BedrockCrossbowItem(IS.of(Rarity.UNCOMMON).fireResistant().durability(PastelToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK));
    public static final DeferredItem<BedrockShearsItem> BEDROCK_SHEARS = register(simple(item("bedrock_shears", () -> new BedrockShearsItem(IS.of(Rarity.UNCOMMON).fireResistant().durability(PastelToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).component(DataComponents.TOOL, ShearsItem.createToolProperties())), InkColors.BLACK)));
    public static final DeferredItem<BedrockFishingRodItem> BEDROCK_FISHING_ROD = register(item("bedrock_fishing_rod", () -> new BedrockFishingRodItem(IS.of(Rarity.UNCOMMON).fireResistant().durability(PastelToolMaterial.BEDROCK.getUses()).component(DataComponents.UNBREAKABLE, new Unbreakable(false))), InkColors.BLACK));

    public static final DeferredItem<WorkstaffItem> MALACHITE_WORKSTAFF = register(item("malachite_workstaff", () -> new WorkstaffItem(PastelToolMaterial.MALACHITE, 1, -3.2F, IS.of(1, Rarity.UNCOMMON)), InkColors.GREEN));
    public static final DeferredItem<GreatswordItem> MALACHITE_ULTRA_GREATSWORD = register(item("malachite_ultra_greatsword", () -> new GreatswordItem(PastelToolMaterial.MALACHITE, 7, -2.8F, 1.0F, IS.of(1, Rarity.UNCOMMON)), InkColors.GREEN));
    public static final DeferredItem<MalachiteCrossbowItem> MALACHITE_CROSSBOW = register(item("malachite_crossbow", () -> new MalachiteCrossbowItem(IS.of(1, Rarity.UNCOMMON).fireResistant().durability(PastelToolMaterial.MALACHITE.getUses())), InkColors.GREEN));
    public static final DeferredItem<MalachiteBidentItem> MALACHITE_BIDENT = register(item("malachite_bident", () -> new MalachiteBidentItem(IS.active(1, Rarity.UNCOMMON).durability(PastelToolMaterial.MALACHITE.getUses()), -2.4, 9, 0.25F, 0F), InkColors.GREEN));

    // variants by socketing a moonstone core
    public static final DeferredItem<GlassCrestWorkstaffItem> GLASS_CREST_WORKSTAFF = register(item("glass_crest_workstaff", () -> new GlassCrestWorkstaffItem(PastelToolMaterial.GLASS_CREST, 1, -2.8F, IS.of(1, Rarity.UNCOMMON)), InkColors.WHITE));
    public static final DeferredItem<GlassCrestGreatswordItem> GLASS_CREST_ULTRA_GREATSWORD = register(item("glass_crest_ultra_greatsword", () -> new GlassCrestGreatswordItem(PastelToolMaterial.GLASS_CREST, 5, -2.8F, 1.0F, IS.of(1, Rarity.UNCOMMON)), InkColors.WHITE));
    public static final DeferredItem<GlassCrestCrossbowItem> GLASS_CREST_CROSSBOW = register(item("glass_crest_crossbow", () -> new GlassCrestCrossbowItem(IS.of(1, Rarity.UNCOMMON).fireResistant().durability(PastelToolMaterial.GLASS_CREST.getUses())), InkColors.WHITE));
    public static final DeferredItem<FerociousBidentItem> FEROCIOUS_GLASS_CREST_BIDENT = register(item("ferocious_glass_crest_bident", () -> new FerociousBidentItem(IS.active(1, Rarity.UNCOMMON).durability(PastelToolMaterial.GLASS_CREST.getUses()), -2.2, 13, 0.33F, 0.33F), InkColors.WHITE));
    public static final DeferredItem<FractalBidentItem> FRACTAL_GLASS_CREST_BIDENT = register(item("fractal_glass_crest_bident", () -> new FractalBidentItem(IS.active(1, Rarity.UNCOMMON).durability(PastelToolMaterial.GLASS_CREST.getUses()), -2.4, 6.5, 0.25F, 0.25F), InkColors.WHITE));
    ...
    public static final DeferredItem<DreamflayerItem> DREAMFLAYER = register(item("dreamflayer", () -> new DreamflayerItem(PastelToolMaterial.DREAMFLAYER, 3, -1.8F, IS.of(1, Rarity.UNCOMMON)), InkColors.RED));
    public static final DeferredItem<NightfallsBladeItem> NIGHTFALLS_BLADE = register(item("nightfalls_blade", () -> new NightfallsBladeItem(Tiers.DIAMOND, 3, -2.4F, IS.of(1, Rarity.UNCOMMON)), InkColors.GRAY).withItemModel((ctx, item) -> PastelModelHelper.registerLayeredItemModel(ctx, item, PastelModels.HANDHELD_THREE_LAYERS, "", "_tint", "_overlay")));
    public static final DeferredItem<DraconicTwinswordItem> DRACONIC_TWINSWORD = register(item("draconic_twinsword", () -> new DraconicTwinswordItem(PastelToolMaterial.DRACONIC, 6, -3.0F, IS.of(1, Rarity.RARE)), InkColors.YELLOW));
    public static final DeferredItem<DragonTalonItem> DRAGON_TALON = register(item("dragon_talon", () -> new DragonTalonItem(PastelToolMaterial.DRACONIC, -3.0, -1.0, IS.of(1, Rarity.RARE).durability(PastelToolMaterial.DRACONIC.getUses())), InkColors.YELLOW));
    public static final DeferredItem<LightGreatswordItem> KNOTTED_SWORD = register(item("knotted_sword", () -> new LightGreatswordItem(PastelToolMaterial.VERDIGRIS, 3, -2.4F, 0.25F, 0.5F, 0xFFd4d6ff, IS.of(1, Rarity.UNCOMMON).durability(PastelToolMaterial.VERDIGRIS.getUses())), InkColors.GREEN));
    public static final DeferredItem<NectarLanceItem> NECTAR_LANCE = register(item("nectar_lance", () -> new NectarLanceItem(PastelToolMaterial.NECTAR, 0, -2.4F, 0.5F, 1.5F, 0xFFf8e8ff, IS.of(1, Rarity.EPIC).durability(PastelToolMaterial.NECTAR.getUses())), InkColors.PURPLE));

    // Bedrock Armor
    public static final DeferredItem<BedrockArmorItem> BEDROCK_HELMET = register(simple(item("bedrock_helmet", () -> new BedrockArmorItem(PastelArmorMaterials.BEDROCK, ArmorItem.Type.HELMET, IS.of(Rarity.UNCOMMON).fireResistant().durability(70 * 13).component(DataComponents.UNBREAKABLE, new Unbreakable(false))) {
        @Override
        public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
            return Map.of(Enchantments.PROJECTILE_PROTECTION, 5);
        }
    }, InkColors.BLACK)));
    public static final DeferredItem<BedrockArmorItem> BEDROCK_CHESTPLATE = register(simple(item("bedrock_chestplate", () -> new BedrockArmorItem(PastelArmorMaterials.BEDROCK, ArmorItem.Type.CHESTPLATE, IS.of(Rarity.UNCOMMON).fireResistant().durability(70 * 15).component(DataComponents.UNBREAKABLE, new Unbreakable(false))) {
        @Override
        public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
            return Map.of(Enchantments.PROTECTION, 5);
        }
    }, InkColors.BLACK)));
    public static final DeferredItem<BedrockArmorItem> BEDROCK_LEGGINGS = register(simple(item("bedrock_leggings", () -> new BedrockArmorItem(PastelArmorMaterials.BEDROCK, ArmorItem.Type.LEGGINGS, IS.of(Rarity.UNCOMMON).fireResistant().durability(70 * 16).component(DataComponents.UNBREAKABLE, new Unbreakable(false))) {
        @Override
        public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
            return Map.of(Enchantments.BLAST_PROTECTION, 5);
        }
    }, InkColors.BLACK)));
    public static final DeferredItem<BedrockArmorItem> BEDROCK_BOOTS = register(simple(item("bedrock_boots", () -> new BedrockArmorItem(PastelArmorMaterials.BEDROCK, ArmorItem.Type.BOOTS, IS.of(Rarity.UNCOMMON).fireResistant().durability(70 * 11).component(DataComponents.UNBREAKABLE, new Unbreakable(false))) {
        @Override
        public Map<ResourceKey<Enchantment>, Integer> getDefaultEnchantments() {
    ...
    // Armor
    public static final DeferredItem<GemstoneArmorItem> FETCHLING_HELMET = register(simple(item("fetchling_helmet", () -> new GemstoneArmorItem(PastelArmorMaterials.GEMSTONE, ArmorItem.Type.HELMET, IS.of(Rarity.UNCOMMON).durability(9 * 13)), InkColors.BLUE)));
    public static final DeferredItem<GemstoneArmorItem> FEROCIOUS_CHESTPLATE = register(simple(item("ferocious_chestplate", () -> new GemstoneArmorItem(PastelArmorMaterials.GEMSTONE, ArmorItem.Type.CHESTPLATE, IS.of(Rarity.UNCOMMON).durability(9 * 15)), InkColors.BLUE)));
    public static final DeferredItem<GemstoneArmorItem> SYLPH_LEGGINGS = register(simple(item("sylph_leggings", () -> new GemstoneArmorItem(PastelArmorMaterials.GEMSTONE, ArmorItem.Type.LEGGINGS, IS.of(Rarity.UNCOMMON).durability(9 * 16)), InkColors.BLUE)));
    ...
    // Decay bottles
    public static final DeferredItem<Item> BOTTLE_OF_FADING = register(simple(item("bottle_of_fading", () -> new DecayPlacerItem(PastelBlocks.FADING.get(), IS.of(16), List.of(Component.translatable("item.pastel.bottle_of_fading.tooltip"))), InkColors.GRAY)));
    public static final DeferredItem<Item> BOTTLE_OF_FAILING = register(simple(item("bottle_of_failing", () -> new DecayPlacerItem(PastelBlocks.FAILING.get(), IS.of(16), List.of(Component.translatable("item.pastel.bottle_of_failing.tooltip"))), InkColors.GRAY)));
    public static final DeferredItem<Item> BOTTLE_OF_RUIN = register(simple(item("bottle_of_ruin", () -> new DecayPlacerItem(PastelBlocks.RUIN.get(), IS.of(16), List.of(Component.translatable("item.pastel.bottle_of_ruin.tooltip"))), InkColors.GRAY)));
    public static final DeferredItem<Item> BOTTLE_OF_FORFEITURE = register(simple(item("bottle_of_forfeiture", () -> new DecayPlacerItem(PastelBlocks.FORFEITURE.get(), IS.of(16), List.of(CreativeOnlyItem.DESCRIPTION, Component.translatable("item.pastel.bottle_of_forfeiture.tooltip"))), InkColors.GRAY)));
    ...
    // Food & drinks
    public static final DeferredItem<Item> MOONSTRUCK_NECTAR = register(simple(item("moonstruck_nectar", () -> new MoonstruckNectarItem(IS.of(Rarity.UNCOMMON).food(PastelFoodComponents.MOONSTRUCK_NECTAR).craftRemainder(GLASS_BOTTLE)), InkColors.LIME)));
    public static final DeferredItem<Item> JADE_JELLY = register(simple(item("jade_jelly", () -> new ItemWithTooltip(IS.of().food(PastelFoodComponents.JADE_JELLY), "item.pastel.jade_jelly.tooltip"), InkColors.LIME)));
    ...
    public static final DeferredItem<Item> MERMAIDS_JAM = register(simple(item("mermaids_jam", () -> new Item(IS.of().food(PastelFoodComponents.MERMAIDS_JAM)), InkColors.PINK)));
    public static final DeferredItem<Item> MERMAIDS_POPCORN = register(simple(item("mermaids_popcorn", () -> new ItemWithTooltip(IS.of().food(PastelFoodComponents.MERMAIDS_POPCORN), "item.pastel.mermaids_popcorn.tooltip"), InkColors.PINK)));
    public static final DeferredItem<Item> LE_FISHE_AU_CHOCOLAT = register(simple(item("le_fishe_au_chocolat", () -> new Item(IS.of().food(PastelFoodComponents.LE_FISHE_AU_CHOCOLAT)), InkColors.PINK)));
//	public static final Item STUFFED_PETALS = register(simple(item("stuffed_petals", () -> new Item(IS.of().food(PastelFoodComponents.STUFFED_PETALS)), InkColors.PINK)));
//	public static final Item PASTICHE = register(simple(item("pastiche", () -> new Item(IS.of().food(PastelFoodComponents.PASTICHE)), InkColors.PINK)));
//	public static final Item VITTORIAS_ROAST = register(simple(item("vittorias_roast", () -> new Item(IS.of().food(PastelFoodComponents.VITTORIAS_ROAST)), InkColors.PINK)));

    //	public static final Item VITTORIAS_ROAST = register(simple(item("vittorias_roast", () -> new Item(IS.of().food(PastelFoodComponents.VITTORIAS_ROAST)), InkColors.PINK)));

    public static final DeferredItem<Item> INFUSED_BEVERAGE = register(layered(item("infused_beverage", () -> new BeverageItem(IS.of(16).food(PastelFoodComponents.BEVERAGE).craftRemainder(GLASS_BOTTLE).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(PastelDataComponentTypes.INFUSED_BEVERAGE, InfusedBeverageComponent.DEFAULT)), InkColors.PINK), "", "_highlight"));
    public static final DeferredItem<Item> SUSPICIOUS_BREW = register(simple(item("suspicious_brew", () -> new SuspiciousBrewItem(IS.of(16).food(PastelFoodComponents.BEVERAGE).craftRemainder(GLASS_BOTTLE)), InkColors.LIME)));
    public static final DeferredItem<Item> REPRISE = register(simple(item("reprise", () -> new RepriseItem(IS.of(16).food(PastelFoodComponents.BEVERAGE).craftRemainder(GLASS_BOTTLE)), InkColors.PINK)));
    public static final DeferredItem<Item> PURE_ALCOHOL = register(simple(burnable(item("pure_alcohol", () -> new DrinkItem(IS.of(16, Rarity.UNCOMMON).food(PastelFoodComponents.PURE_ALCOHOL).craftRemainder(GLASS_BOTTLE)), InkColors.WHITE), 16000)));
    public static final DeferredItem<Item> JADE_WINE = register(simple(item("jade_wine", () -> new JadeWineItem(IS.of(16, Rarity.UNCOMMON).food(PastelFoodComponents.BEVERAGE).craftRemainder(GLASS_BOTTLE)), InkColors.LIME)));
    public static final DeferredItem<Item> CHRYSOCOLLA = register(simple(burnable(item("chrysocolla", () -> new DrinkItem(IS.of(16, Rarity.UNCOMMON).food(PastelFoodComponents.PURE_ALCOHOL).craftRemainder(GLASS_BOTTLE)), InkColors.LIME), 16000)));

    public static final DeferredItem<Item> HONEY_PASTRY = register(simple(item("honey_pastry", () -> new Item(IS.of().food(PastelFoodComponents.HONEY_PASTRY)), InkColors.PINK)));
    public static final DeferredItem<Item> LUCKY_ROLL = register(simple(item("lucky_roll", () -> new Item(IS.of(16).food(PastelFoodComponents.LUCKY_ROLL)), InkColors.PINK)));
    public static final DeferredItem<Item> TRIPLE_MEAT_POT_PIE = register(simple(item("triple_meat_pot_pie", () -> new Item(IS.of(8).food(PastelFoodComponents.TRIPLE_MEAT_POT_PIE)), InkColors.PINK)));
    public static final DeferredItem<Item> GLISTERING_JELLY_TEA = register(simple(item("glistering_jelly_tea", () -> new DrinkItem(IS.of(16).food(PastelFoodComponents.GLISTERING_JELLY_TEA).craftRemainder(GLASS_BOTTLE).component(PastelDataComponentTypes.PAIRED_FOOD_COMPONENT, teaSconeBonus(PastelFoodComponents.GLISTERING_JELLY_TEA_SCONE_BONUS))), InkColors.PINK)));
    public static final DeferredItem<Item> FREIGEIST = register(simple(item("freigeist", () -> new FreigeistItem(IS.of(16).food(PastelFoodComponents.FREIGEIST).craftRemainder(GLASS_BOTTLE)), InkColors.RED)));
    public static final DeferredItem<Item> DIVINATION_HEART = register(simple(item("divination_heart", () -> new Item(IS.of().food(PastelFoodComponents.DIVINATION_HEART)), InkColors.RED)));

    public static final DeferredItem<Item> STAR_CANDY = register(simple(item("star_candy", () -> new StarCandyItem(IS.of(Rarity.UNCOMMON).food(PastelFoodComponents.STAR_CANDY)), InkColors.PINK)));
    public static final DeferredItem<Item> ENCHANTED_STAR_CANDY = register(simple(item("enchanted_star_candy", () -> new EnchantedStarCandyItem(IS.of(Rarity.UNCOMMON).food(PastelFoodComponents.ENCHANTED_STAR_CANDY)), InkColors.PINK)));

    public static final DeferredItem<Item> ENCHANTED_GOLDEN_CARROT = register(parented(item("enchanted_golden_carrot", () -> new ItemWithGlint(IS.of(Rarity.EPIC).food(PastelFoodComponents.ENCHANTED_GOLDEN_CARROT)), InkColors.PINK), GOLDEN_CARROT));
    public static final DeferredItem<Item> JARAMEL = register(simple(item("jaramel", () -> new Item(IS.of().food(PastelFoodComponents.JARAMEL)), InkColors.PINK)));

    public static final DeferredItem<Item> JARAMEL_TART = register(simple(item("jaramel_tart", () -> new Item(IS.of().food(PastelFoodComponents.JARAMEL_TART)), InkColors.PINK)));
    public static final DeferredItem<Item> SALTED_JARAMEL_TART = register(simple(item("salted_jaramel_tart", () -> new Item(IS.of().food(PastelFoodComponents.SALTED_JARAMEL_TART)), InkColors.PINK)));
    public static final DeferredItem<Item> ASHEN_TART = register(simple(item("ashen_tart", () -> new Item(IS.of().food(PastelFoodComponents.ASHEN_TART)), InkColors.PINK)));
    public static final DeferredItem<Item> WEEPING_TART = register(simple(item("weeping_tart", () -> new Item(IS.of().food(PastelFoodComponents.WEEPING_TART)), InkColors.PINK)));
    public static final DeferredItem<Item> WHISPY_TART = register(simple(item("whispy_tart", () -> new Item(IS.of().food(PastelFoodComponents.WHISPY_TART)), InkColors.PINK)));
    public static final DeferredItem<Item> PUFF_TART = register(simple(item("puff_tart", () -> new Item(IS.of().food(PastelFoodComponents.PUFF_TART)), InkColors.PINK)));

    public static final DeferredItem<Item> JARAMEL_TRIFLE = register(simple(item("jaramel_trifle", () -> new Item(IS.of().food(PastelFoodComponents.JARAMEL_TRIFLE)), InkColors.PINK)));
    public static final DeferredItem<Item> SALTED_JARAMEL_TRIFLE = register(simple(item("salted_jaramel_trifle", () -> new Item(IS.of().food(PastelFoodComponents.SALTED_JARAMEL_TRIFLE)), InkColors.PINK)));
    ...
    public static final DeferredItem<Item> ALOE_LEAF = register(simple(item("aloe_leaf", () -> new ItemNameBlockItem(PastelBlocks.ALOE.get(), IS.of().food(PastelFoodComponents.ALOE_LEAF)), InkColors.PINK)));
    public static final DeferredItem<Item> SAWBLADE_HOLLY_BERRY = register(simple(item("sawblade_holly_berry", () -> new ItemNameBlockItem(PastelBlocks.SAWBLADE_HOLLY_BUSH.get(), IS.of().food(Foods.SWEET_BERRIES)), InkColors.PINK)));
    public static final DeferredItem<Item> PRICKLY_BAYLEAF = register(simple(item("prickly_bayleaf", () -> new Item(IS.of().food(PastelFoodComponents.PRICKLY_BAYLEAF)), InkColors.PINK)));
    public static final DeferredItem<Item> TRIPLE_MEAT_POT_STEW = register(simple(item("triple_meat_pot_stew", () -> new StackableStewItem(IS.of(8).food(PastelFoodComponents.TRIPLE_MEAT_POT_STEW)), InkColors.PINK)));
    public static final DeferredItem<Item> DRAGONBONE_BROTH = register(simple(item("dragonbone_broth", () -> new StackableStewItem(IS.of(8).food(PastelFoodComponents.DRAGONBONE_BROTH)), InkColors.GRAY)));
    public static final DeferredItem<Item> DOOMBLOOM_SEED = register(simple(item("doombloom_seed", () -> new ItemNameBlockItem(PastelBlocks.DOOMBLOOM.get(), IS.of().fireResistant()), InkColors.BLACK)));

    public static final ResourceKey<Item> GLISTERING_MELON_SEEDS = simple(new ItemRegistrar<>("glistering_melon_seeds").withItem(() -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(PastelBlocks.GLISTERING_MELON_STEM), IS.of()), InkColors.LIME)).itemKey();
    public static final DeferredItem<Item> AMARANTH_GRAINS = register(simple(item("amaranth_grains", () -> new ItemNameBlockItem(PastelBlocks.AMARANTH.get(), IS.of()), InkColors.LIME)));
    ...
    //public static final Item VARIA_COOKBOOK = register(simple(item("varia_cookbook", () -> new CookbookItem(IS.of().maxCount(1).rarity(Rarity.UNCOMMON), GuidebookItem.addressOf(GuidebookItem.CUISINE_CATEGORY_ID, PastelCommon.locate("cuisine/cookbooks/varia_cookbook"))), InkColors.PURPLE)));
    public static final DeferredItem<Item> POISONERS_HANDBOOK = register(simple(item("poisoners_handbook", () -> new CookbookItem(IS.of().stacksTo(1).rarity(Rarity.EPIC), GuidebookItem.addressOf(GuidebookItem.CUISINE_CATEGORY_ID, locate("dimension/lore/poisoners_handbook")), PastelMobEffects.ETERNAL_SLUMBER_COLOR), InkColors.PURPLE)));

    public static final DeferredItem<Item> AQUA_REGIA = register(simple(item("aqua_regia", () -> new JadeWineItem(IS.of(16).food(PastelFoodComponents.AQUA_REGIA)), InkColors.PINK)));
    public static final DeferredItem<Item> BAGNUN = register(simple(item("bagnun", () -> new Item(IS.of().food(PastelFoodComponents.BAGNUN)), InkColors.PINK)));
    public static final DeferredItem<Item> BANYASH = register(simple(item("banyash", () -> new Item(IS.of().food(PastelFoodComponents.BANYASH)), InkColors.PINK)));
    public static final DeferredItem<Item> BERLINER = register(simple(item("berliner", () -> new Item(IS.of().food(PastelFoodComponents.BERLINER)), InkColors.PINK)));
    public static final DeferredItem<Item> BRISTLE_MEAD = register(simple(item("bristle_mead", () -> new BeverageItem(IS.of(16).food(PastelFoodComponents.BEVERAGE).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY)), InkColors.PINK)));
    public static final DeferredItem<Item> CHAUVE_SOURIS_AU_VIN = register(simple(item("chauve_souris_au_vin", () -> new Item(IS.of().food(PastelFoodComponents.CHAUVE_SOURIS_AU_VIN)), InkColors.PINK)));
    public static final DeferredItem<Item> CRAWFISH = register(simple(item("crawfish", () -> new Item(IS.of().food(PastelFoodComponents.CRAWFISH)), InkColors.PINK)));
    public static final DeferredItem<Item> CRAWFISH_COCKTAIL = register(simple(item("crawfish_cocktail", () -> new Item(IS.of().food(PastelFoodComponents.CRAWFISH_COCKTAIL)), InkColors.PINK)));
    public static final DeferredItem<Item> CREAM_PASTRY = register(simple(item("cream_pastry", () -> new Item(IS.of().food(PastelFoodComponents.CREAM_PASTRY)), InkColors.PINK)));
    public static final DeferredItem<Item> FADED_KOI = register(simple(item("faded_koi", () -> new Item(IS.of().food(PastelFoodComponents.FADED_KOI)), InkColors.PINK)));
    public static final DeferredItem<Item> FISHCAKE = register(simple(item("fishcake", () -> new Item(IS.of().food(PastelFoodComponents.FISHCAKE)), InkColors.PINK)));
    public static final DeferredItem<Item> LIZARD_MEAT = register(simple(item("lizard_meat", () -> new Item(IS.of().food(PastelFoodComponents.LIZARD_MEAT)), InkColors.PINK)));
    public static final DeferredItem<Item> COOKED_LIZARD_MEAT = register(simple(item("cooked_lizard_meat", () -> new Item(IS.of().food(PastelFoodComponents.COOKED_LIZARD_MEAT)), InkColors.PINK)));
    public static final DeferredItem<Item> GOLDEN_BRISTLE_TEA = register(simple(item("golden_bristle_tea", () -> new DrinkItem(IS.of(16).food(PastelFoodComponents.GOLDEN_BRISTLE_TEA).component(PastelDataComponentTypes.PAIRED_FOOD_COMPONENT, teaSconeBonus(PastelFoodComponents.GOLDEN_BRISTLE_TEA_SCONE_BONUS))), InkColors.PINK)));
    public static final DeferredItem<Item> HARE_ROAST = register(simple(item("hare_roast", () -> new Item(IS.of().food(PastelFoodComponents.HARE_ROAST)), InkColors.PINK)));
    public static final DeferredItem<Item> JUNKET = register(simple(item("junket", () -> new Item(IS.of().food(PastelFoodComponents.JUNKET)), InkColors.PINK)));
    public static final DeferredItem<Item> KOI = register(simple(item("koi", () -> new Item(IS.of().food(PastelFoodComponents.KOI)), InkColors.PINK)));
    public static final DeferredItem<Item> MEATLOAF = register(simple(item("meatloaf", () -> new Item(IS.of().food(PastelFoodComponents.MEATLOAF)), InkColors.PINK)));
    public static final DeferredItem<Item> MEATLOAF_SANDWICH = register(simple(item("meatloaf_sandwich", () -> new Item(IS.of().food(PastelFoodComponents.MEATLOAF_SANDWICH)), InkColors.PINK)));
    public static final DeferredItem<Item> MELLOW_SHALLOT_SOUP = register(simple(item("mellow_shallot_soup", () -> new Item(IS.of().food(PastelFoodComponents.MELLOW_SHALLOT_SOUP)), InkColors.PINK)));
    public static final DeferredItem<Item> MORCHELLA = register(simple(item("morchella", () -> new BeverageItem(IS.of(16).food(PastelFoodComponents.BEVERAGE).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY)), InkColors.PINK)));
    public static final DeferredItem<Item> NECTERED_VIOGNIER = register(simple(item("nectered_viognier", () -> new JadeWineItem(IS.of(16).food(PastelFoodComponents.NECTERED_VIOGNIER)), InkColors.PINK)));
    public static final DeferredItem<Item> PEACHES_FLAMBE = register(simple(item("peaches_flambe", () -> new Item(IS.of().food(PastelFoodComponents.PEACHES_FLAMBE)), InkColors.PINK)));
    public static final DeferredItem<Item> PEACH_CREAM = register(simple(item("peach_cream", () -> new DrinkItem(IS.of(16).food(PastelFoodComponents.PEACH_CREAM).component(PastelDataComponentTypes.PAIRED_FOOD_COMPONENT, teaSconeBonus(PastelFoodComponents.PEACH_CREAM_SCONE_BONUS))), InkColors.PINK)));
    public static final DeferredItem<Item> PEACH_JAM = register(simple(item("peach_jam", () -> new Item(IS.of().food(PastelFoodComponents.PEACH_JAM)), InkColors.PINK)));
    public static final DeferredItem<Item> RABBIT_CREAM_PIE = register(simple(item("rabbit_cream_pie", () -> new ItemWithTooltip(IS.of().food(PastelFoodComponents.RABBIT_CREAM_PIE), "item.pastel.rabbit_cream_pie.tooltip"), InkColors.PINK)));
    public static final DeferredItem<Item> SEDATIVES = register(simple(item("sedatives", () -> new SedativesItem(IS.of().food(PastelFoodComponents.SEDATIVES), "item.pastel.sedatives.tooltip"), InkColors.PINK)));
    public static final DeferredItem<Item> SLUSHSLIDE = register(simple(item("slushslide", () -> new DrinkItem(IS.of(16).food(PastelFoodComponents.SLUSHSLIDE), "item.pastel.slushslide.tooltip"), InkColors.PINK)));
    public static final DeferredItem<Item> SURSTROMMING = register(simple(item("surstromming", () -> new Item(IS.of().food(PastelFoodComponents.SURSTROMMING)), InkColors.PINK)));
    public static final DeferredItem<Item> EVERNECTAR = register(simple(item("evernectar", () -> new EvernectarItem(IS.of(1, Rarity.EPIC).food(PastelFoodComponents.EVERNECTAR).craftRemainder(GLASS_BOTTLE), "item.pastel.evernectar.tooltip"), InkColors.LIME)));

    // Banner Patterns
    public static final DeferredItem<Item> LOGO_BANNER_PATTERN = register(banner(item("logo_banner_pattern", () -> new BannerPatternItem(PastelBannerPatternTags.SPECTRUM_LOGO_TAG, IS.of(1, Rarity.UNCOMMON)), InkColors.LIGHT_BLUE)));
    public static final DeferredItem<Item> AMETHYST_SHARD_BANNER_PATTERN = register(banner(item("amethyst_shard_banner_pattern", () -> new BannerPatternItem(PastelBannerPatternTags.AMETHYST_SHARD_TAG, IS.of(1)), InkColors.LIGHT_BLUE)));
    public static final DeferredItem<Item> AMETHYST_CLUSTER_BANNER_PATTERN = register(banner(item("amethyst_cluster_banner_pattern", () -> new BannerPatternItem(PastelBannerPatternTags.AMETHYST_CLUSTER_TAG, IS.of(1)), InkColors.LIGHT_BLUE)));
    public static final DeferredItem<Item> ASTROLOGER_BANNER_PATTERN = register(banner(item("astrologer_banner_pattern", () -> new BannerPatternItem(PastelBannerPatternTags.ASTROLOGER_TAG, IS.of(1, Rarity.UNCOMMON)), InkColors.LIGHT_BLUE)));
    public static final DeferredItem<Item> VELVET_ASTROLOGER_BANNER_PATTERN = register(banner(item("velvet_astrologer_banner_pattern", () -> new BannerPatternItem(PastelBannerPatternTags.VELVET_ASTROLOGER_TAG, IS.of(1, Rarity.UNCOMMON)), InkColors.LIGHT_BLUE)));
    public static final DeferredItem<Item> POISONBLOOM_BANNER_PATTERN = register(banner(item("poisonbloom_banner_pattern", () -> new BannerPatternItem(PastelBannerPatternTags.POISONBLOOM_TAG, IS.of(1, Rarity.RARE)), InkColors.LIGHT_BLUE)));
    public static final DeferredItem<Item> DEEP_LIGHT_BANNER_PATTERN = register(banner(item("deep_light_banner_pattern", () -> new BannerPatternItem(PastelBannerPatternTags.DEEP_LIGHT_TAG, IS.of(1, Rarity.RARE)), InkColors.LIGHT_BLUE)));

    // Spawning items
    public static final DeferredItem<Item> BUCKET_OF_ERASER = register(simple(item("bucket_of_eraser", () -> new EmptyFluidEntityBucketItem(PastelEntityTypes.ERASER.get(), Fluids.EMPTY, SoundEvents.BUCKET_EMPTY, IS.of()), InkColors.PINK)));
    public static final DeferredItem<Item> EGG_LAYING_WOOLY_PIG_SPAWN_EGG = register(parented(item("egg_laying_wooly_pig_spawn_egg", () -> new SpawnEggItem(PastelEntityTypes.EGG_LAYING_WOOLY_PIG.get(), 0x3a2c38, 0xfff2e0, IS.of()), InkColors.WHITE), PastelModels.SPAWN_EGG));
    public static final DeferredItem<Item> PRESERVATION_TURRET_SPAWN_EGG = register(parented(item("preservation_turret_spawn_egg", () -> new SpawnEggItem(PastelEntityTypes.PRESERVATION_TURRET.get(), 0xf3f6f8, 0xc8c5be, IS.of()), InkColors.WHITE), PastelModels.SPAWN_EGG));
    public static final DeferredItem<Item> KINDLING_SPAWN_EGG = register(parented(item("kindling_spawn_egg", () -> new SpawnEggItem(PastelEntityTypes.KINDLING.get(), 0xda4261, 0xffd452, IS.of()), InkColors.WHITE), PastelModels.SPAWN_EGG));
    public static final DeferredItem<Item> LIZARD_SPAWN_EGG = register(parented(item("lizard_spawn_egg", () -> new SpawnEggItem(PastelEntityTypes.LIZARD.get(), 0x896459, 0x503a40, IS.of()), InkColors.WHITE), PastelModels.SPAWN_EGG));
    public static final DeferredItem<Item> ERASER_SPAWN_EGG = register(parented(item("eraser_spawn_egg", () -> new SpawnEggItem(PastelEntityTypes.ERASER.get(), 0x200d29, 0xc83e93, IS.of()), InkColors.WHITE), PastelModels.SPAWN_EGG));
    ...
    public static final DeferredItem<Item> MUSIC_DISC_CREDITS = register(simple(item("music_disc_credits", () -> new Item(IS.of(1, Rarity.RARE).jukeboxPlayable(PastelJukeboxSongs.CREDITS)), InkColors.GREEN)));
    public static final DeferredItem<Item> MUSIC_DISC_DIVINITY = register(simple(item("music_disc_divinity", () -> new Item(IS.of(1, Rarity.RARE).jukeboxPlayable(PastelJukeboxSongs.DIVINITY)), InkColors.GREEN)));

    // Item Frames
    public static final DeferredItem<Item> PHANTOM_FRAME = register(simple(item("phantom_frame", () -> new PhantomFrameItem(PastelEntityTypes.PHANTOM_FRAME.get(), IS.of()), InkColors.YELLOW)));
    ...
    public static final DeferredItem<Item> AZURE_DIKE_BELT = register(simple(item("azure_dike_belt", () -> new AzureDikeBeltItem(IS.of(1, Rarity.UNCOMMON), PastelAdvancements.UNLOCK_AZURE_DIKE_BELT), InkColors.BLUE)));
    public static final DeferredItem<Item> AZURE_DIKE_RING = register(simple(item("azure_dike_ring", () -> new AzureDikeRingItem(IS.of(1, Rarity.UNCOMMON), PastelAdvancements.UNLOCK_AZURE_DIKE_RING), InkColors.BLUE)));
    public static final DeferredItem<Item> AZURESQUE_DIKE_CORE = register(simple(item("azuresque_dike_core", () -> new AzureDikeCoreItem(IS.of(1, Rarity.EPIC), PastelAdvancements.UNLOCK_AZURESQUE_DIKE_CORE), InkColors.WHITE)));
    public static final DeferredItem<InkDrainTrinketItem> SHIELDGRASP_AMULET = register(simple(item("shieldgrasp_amulet", () -> new AzureDikeAmuletItem(IS.of(1, Rarity.UNCOMMON), PastelAdvancements.UNLOCK_SHIELDGRASP_AMULET), InkColors.BLUE)));
    ...
    public static final DeferredItem<CreativeInkAssortmentItem> CREATIVE_INK_ASSORTMENT = register(parented(item("creative_ink_assortment", () -> new CreativeInkAssortmentItem(IS.of(1, Rarity.EPIC)), InkColors.WHITE), PastelItems.INK_ASSORTMENT));
    ...
    public static final DeferredItem<Item> LESSER_POTION_PENDANT = register(layered(item("lesser_potion_pendant", () -> new PotionPendantItem(IS.of(1, Rarity.UNCOMMON), 1, CONFIG.MaxLevelForEffectsInLesserPotionPendant - 1, PastelAdvancements.UNLOCK_LESSER_POTION_PENDANT), InkColors.PINK), "_base", "_overlay"));
    public static final DeferredItem<Item> GREATER_POTION_PENDANT = register(layered(item("greater_potion_pendant", () -> new PotionPendantItem(IS.of(1, Rarity.UNCOMMON), 3, CONFIG.MaxLevelForEffectsInGreaterPotionPendant - 1, PastelAdvancements.UNLOCK_GREATER_POTION_PENDANT), InkColors.PINK), "_base", "_overlay_1", "_overlay_2", "_overlay_3"));
    ...
    public static final DeferredItem<Item> PUFF_CIRCLET = register(simple(item("puff_circlet", () -> new PuffCircletItem(IS.of(1, Rarity.UNCOMMON), PastelAdvancements.UNLOCK_PUFF_CIRCLET), InkColors.WHITE)));
    ...
    public static final DeferredItem<Item> AETHER_GRACED_NECTAR_GLOVES = register(simple(item("aether_graced_nectar_gloves", () -> new AetherGracedNectarGlovesItem(IS.of(1, Rarity.EPIC), PastelAdvancements.UNLOCK_AETHER_GRACED_NECTAR_GLOVES), InkColors.PURPLE)));
    ...
    public static <T extends Item> ItemRegistrar<T> handheld(ItemRegistrar<T> registrar) {
        return registrar.withItemModel((ctx, item) -> PastelModelHelper.registerItemModel(ctx, item, ModelTemplates.FLAT_HANDHELD_ITEM));
    }

    public static <T extends Item> ItemRegistrar<T> layered(ItemRegistrar<T> registrar, String suffix0, String suffix1) {
        return registrar.withItemModel((ctx, item) -> PastelModelHelper.registerLayeredItemModel(ctx, item, ModelTemplates.TWO_LAYERED_ITEM, suffix0, suffix1));
    }
    ...
    public static <T extends Item> ItemRegistrar<T> layered(ItemRegistrar<T> registrar, String suffix0, String suffix1, String suffix2) {
        return registrar.withItemModel((ctx, item) -> PastelModelHelper.registerLayeredItemModel(ctx, item, ModelTemplates.THREE_LAYERED_ITEM, suffix0, suffix1, suffix2));
    }
    ...
    public static <T extends Item> ItemRegistrar<T> layered(ItemRegistrar<T> registrar, String suffix0, String suffix1, String suffix2, String suffix3) {
        return registrar.withItemModel((ctx, item) -> PastelModelHelper.registerLayeredItemModel(ctx, item, PastelModels.GENERATED_FOUR_LAYERS, suffix0, suffix1, suffix2, suffix3));
    }

    public static <T extends Item> ItemRegistrar<T> parented(ItemRegistrar<T> registrar, ItemLike parent) {
        return registrar.withItemModel((ctx, item) -> PastelModelHelper.registerParentedItemModel(ctx, item, parent.asItem()));
    }

    public static <T extends Item> ItemRegistrar<T> parented(ItemRegistrar<T> registrar, ResourceLocation parentModelId) {
        return registrar.withItemModel((ctx, item) -> PastelModelHelper.registerParentedItemModel(ctx, item, parentModelId));
    }

...
public class DumpTagsCommand {
    ...
    private static int execute(CommandSourceStack source) {
        File baseDir = FMLPaths.GAMEDIR.get()
                                       .resolve("tag_dump")
                                       .toFile();
        baseDir.mkdirs();
        ...
        source.registryAccess()
              ...
              .forEach(registry -> {
                  ...
                  registry.value()
                          .getTags()
                          .forEach(pair -> {
                              ResourceLocation registryId = pair.getSecond()
                                                                .key()
                                                                .registry()
                                                                .location();
                              ResourceLocation tagId = pair.getSecond()
                                                           .key()
                                                           .location();

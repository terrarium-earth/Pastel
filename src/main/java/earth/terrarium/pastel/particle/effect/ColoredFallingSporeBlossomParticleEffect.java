...
public class ColoredFallingSporeBlossomParticleEffect implements ParticleOptions {
    ...
    public static final ColoredFallingSporeBlossomParticleEffect LIGHT_BLUE
        = new ColoredFallingSporeBlossomParticleEffect(InkColors.LIGHT_BLUE_COLOR);
    public static final ColoredFallingSporeBlossomParticleEffect LIGHT_GRAY
        = new ColoredFallingSporeBlossomParticleEffect(InkColors.LIGHT_GRAY_COLOR);
    ...
    public static final MapCodec<ColoredFallingSporeBlossomParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ColoredFallingSporeBlossomParticleEffect> STREAM_CODEC

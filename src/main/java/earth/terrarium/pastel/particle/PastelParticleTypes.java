...
public class PastelParticleTypes {
    ...
    private static final DeferredRegister<ParticleType<?>> REGISTRAR = DeferredRegister.create(
        Registries.PARTICLE_TYPE, PastelCommon.MOD_ID);

    public static final ParticleType<TransmissionParticleEffect> ITEM_TRANSMISSION = register(
        "item_transmission", false, type -> TransmissionParticleEffect.CODEC,
        type -> TransmissionParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<TransmissionParticleEffect> EXPERIENCE_TRANSMISSION = register(
        "experience_transmission", false, type -> TransmissionParticleEffect.CODEC,
        type -> TransmissionParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<TransmissionParticleEffect> WIRELESS_REDSTONE_TRANSMISSION = register(
        "wireless_redstone_transmission", false, type -> TransmissionParticleEffect.CODEC,
        type -> TransmissionParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<ColoredTransmissionParticleEffect> COLORED_TRANSMISSION = register(
        "colored_transmission", false, type -> ColoredTransmissionParticleEffect.CODEC,
        type -> ColoredTransmissionParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<TransmissionParticleEffect> BLOCK_POS_EVENT_TRANSMISSION = register(
        "block_pos_event_transmission", false, type -> TransmissionParticleEffect.CODEC,
        type -> TransmissionParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<PastelTransmissionParticleEffect> PASTEL_TRANSMISSION = register(
        "pastel_transmission", false, type -> PastelTransmissionParticleEffect.CODEC,
        type -> PastelTransmissionParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<TransmissionParticleEffect> HUMMINGSTONE_TRANSMISSION = register(
        "hummingstone_transmission", false, type -> TransmissionParticleEffect.CODEC,
        type -> TransmissionParticleEffect.STREAM_CODEC
    );
    ...
    public static final ParticleType<ColoredFallingSporeBlossomParticleEffect> COLORED_FALLING_SPORE_BLOSSOM = register(
        "colored_falling_spore_blossom", false, (type) -> ColoredFallingSporeBlossomParticleEffect.CODEC,
        (type) -> ColoredFallingSporeBlossomParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<ColoredSporeBlossomAirParticleEffect> COLORED_SPORE_BLOSSOM_AIR = register(
        "colored_spore_blossom_air", false, (type) -> ColoredSporeBlossomAirParticleEffect.CODEC,
        (type) -> ColoredSporeBlossomAirParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<ColoredCraftingParticleEffect> COLORED_CRAFTING = register(
        "colored_crafting", false, (type) -> ColoredCraftingParticleEffect.CODEC,
        (type) -> ColoredCraftingParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<ColoredFluidRisingParticleEffect> COLORED_FLUID_RISING = register(
        "colored_fluid_rising", false, (type) -> ColoredFluidRisingParticleEffect.CODEC,
        (type) -> ColoredFluidRisingParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<ColoredSparkleRisingParticleEffect> COLORED_SPARKLE_RISING = register(
        "colored_sparkle_rising", false, (type) -> ColoredSparkleRisingParticleEffect.CODEC,
        (type) -> ColoredSparkleRisingParticleEffect.STREAM_CODEC
    );
    public static final ParticleType<ColoredExplosionParticleEffect> COLORED_EXPLOSION = register(
        "colored_explosion", true, (type) -> ColoredExplosionParticleEffect.CODEC,
        (type) -> ColoredExplosionParticleEffect.STREAM_CODEC
    );
    ...
    public static final ParticleType<DynamicParticleEffect> DYNAMIC = register(
        "particle_spawner", false, type -> DynamicParticleEffect.CODEC, type -> DynamicParticleEffect.STREAM_CODEC);
    public static final ParticleType<DynamicParticleEffect> DYNAMIC_ALWAYS_SHOW = register(
        "particle_spawner_always_show", true, type -> DynamicParticleEffect.CODEC,
        type -> DynamicParticleEffect.STREAM_CODEC
    );

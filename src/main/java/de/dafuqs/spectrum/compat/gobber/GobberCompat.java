...
public class GobberCompat extends SpectrumIntegrationPacks.ModIntegrationPack {
	...
	public static Block PURE_GLOBETTE_BLOCK = SpectrumBlocks.registerSimple("pure_globette_block", new Block(AbstractBlock.Settings.copy(Blocks.QUARTZ_BLOCK)), DyeColor.BLUE);
	public static Block PURE_GLOBETTE_NETHER_BLOCK = SpectrumBlocks.registerSimple("pure_globette_nether_block", new Block(AbstractBlock.Settings.copy(Blocks.QUARTZ_BLOCK)), DyeColor.RED);
	public static Block PURE_GLOBETTE_END_BLOCK = SpectrumBlocks.registerSimple("pure_globette_end_block", new Block(AbstractBlock.Settings.copy(Blocks.QUARTZ_BLOCK)), DyeColor.GREEN);

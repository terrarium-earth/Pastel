...
public class EnchanterEnchantingCategory extends EnchanterCategory<EnchanterEnchantingDisplay> {
    ...
    public void setupWidgets(
        ...
        Rectangle bounds,
        List<Widget> widgets,
        @NotNull EnchanterEnchantingDisplay display
    ) {
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 111, startPoint.y - 7 + 14))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 31, startPoint.y - 7 + 40))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 111, startPoint.y - 7 + 40))
                    .markOutput()
                    .disableBackground()

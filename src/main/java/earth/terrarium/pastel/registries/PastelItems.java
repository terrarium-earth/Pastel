...
public class PastelItems {
    ...
    public static final DeferredItem<Item> AMETHYST_POWDER = register(item(
        "amethyst_powder", () -> new GemstonePowderItem(IS.of(), PastelGemstoneColor.MAGENTA), InkColors.MAGENTA));
    ...
    public static final DeferredItem<Item> LIGHT_BLUE_PIGMENT = register(item(
    ...
    public static final DeferredItem<Item> LIGHT_GRAY_PIGMENT = register(item(
    ...
    // Preenchanted tools
    public static final DeferredItem<PreenchantedMultiToolItem> MULTITOOL = register(item(
        "multitool", () -> new PreenchantedMultiToolItem(
            Tiers.IRON, 2, -2.4F, IS.of(Rarity.UNCOMMON)
                                    .durability(Tiers.IRON.getUses())
        ), InkColors.BROWN
    ));
    public static final DeferredItem<GlintlessPickaxe> TENDER_PICKAXE = register(item(
    ...
    public static final DeferredItem<GlintlessPickaxe> LUCKY_PICKAXE = register(item(
    ...
    public static final DeferredItem<RazorFalchionItem> RAZOR_FALCHION = register(item(
    ...
    public static final DeferredItem<OblivionPickaxeItem> OBLIVION_PICKAXE = register(item(
    ...
    public static final DeferredItem<GlintlessPickaxe> RESONANT_PICKAXE = register(item(
    ...
    public static final DeferredItem<GlintlessPickaxe> DRAGONRENDING_PICKAXE = register(item(
    ...
    // Bedrock Tools
    public static final DeferredItem<PastelPickaxeItem> BEDROCK_PICKAXE = register(item(
    ...
    public static final DeferredItem<BedrockShovelItem> BEDROCK_SHOVEL = register(item(
    ...
    public static final DeferredItem<BedrockHoeItem> BEDROCK_HOE = register(item(
    ...
    public static final DeferredItem<BedrockShearsItem> BEDROCK_SHEARS = register(item(
    ...
    public static final DeferredItem<WorkstaffItem> MALACHITE_WORKSTAFF = register(item(
        "malachite_workstaff",
        () -> new WorkstaffItem(PastelToolMaterial.MALACHITE, 1, -3.2F, IS.of(1, Rarity.UNCOMMON)), InkColors.GREEN
    ));
    ...
    public static final DeferredItem<Item> MALACHITE_GLASS_ARROW = register(item(
    ...
    public static final DeferredItem<Item> TOPAZ_GLASS_ARROW = register(item(
        "topaz_glass_arrow", () -> new GlassArrowItem(
            IS.of(Rarity.UNCOMMON), GlassArrowVariant.TOPAZ,
            ColoredCraftingParticleEffect.CYAN
        ), InkColors.CYAN
    ));
    public static final DeferredItem<Item> AMETHYST_GLASS_ARROW = register(item(
    ...
    public static final DeferredItem<Item> CITRINE_GLASS_ARROW = register(item(
    ...
    public static final DeferredItem<Item> ONYX_GLASS_ARROW = register(item(
        "onyx_glass_arrow", () -> new GlassArrowItem(
            IS.of(Rarity.UNCOMMON), GlassArrowVariant.ONYX,
            ColoredCraftingParticleEffect.BLACK
        ), InkColors.BLACK
    ));
    public static final DeferredItem<Item> MOONSTONE_GLASS_ARROW = register(item(
    ...
    public static final DeferredItem<DreamflayerItem> DREAMFLAYER = register(item(
        "dreamflayer", () -> new DreamflayerItem(PastelToolMaterial.DREAMFLAYER, 3, -1.8F, IS.of(1, Rarity.UNCOMMON)),
        InkColors.RED
    ));
    ...
    public static final DeferredItem<LightGreatswordItem> KNOTTED_SWORD = register(item(
        "knotted_sword", () -> new LightGreatswordItem(
            PastelToolMaterial.VERDIGRIS, 3, -2.4F, 0.25F, 0.5F, 0xFFd4d6ff, new ColorGradient(
            new Color(139, 255, 213), new Color(0, 178, 183)).fadeAlpha(1, 0)
                                                             .fadeAlpha(0, 0, 1, 0.05f), IS.of(1, Rarity.UNCOMMON)
                                                                                           .durability(
    ...
    public static final DeferredItem<NectarLanceItem> NECTAR_LANCE = register(item(
        "nectar_lance", () -> new NectarLanceItem(
            PastelToolMaterial.NECTAR, 0, -2.4F, 0.5F, 1.5F, 0xFFf8e8ff, new ColorGradient(
            new Color(246, 192, 255), new Color(155, 0, 204)).fadeAlpha(1, 0)
                                                             .fadeAlpha(0, 0, 1, 0.05f), IS.of(1, Rarity.EPIC)
                                                                                           .durability(
    ...
    public static final DeferredItem<BedrockArmorItem> BEDROCK_CHESTPLATE = register(item(
    ...
    public static final DeferredItem<BedrockArmorItem> BEDROCK_LEGGINGS = register(item(
    ...
    public static final DeferredItem<BedrockArmorItem> BEDROCK_BOOTS = register(item(
    ...
    // Decay drops
    public static final DeferredItem<Item> VEGETAL = register(burnable(
    ...
    public static final DeferredItem<Item> NEOLITH = register(
        item(
            "neolith", () -> new ItemWithLoomPattern(IS.of(Rarity.UNCOMMON), PastelBannerPatterns.NEOLITH),
            InkColors.PINK
        ));
    public static final DeferredItem<Item> BEDROCK_DUST = register(
        item(
            "bedrock_dust", () -> new ItemWithLoomPattern(IS.of(Rarity.UNCOMMON), PastelBannerPatterns.BEDROCK_DUST),
            InkColors.BLACK
        ));
    ...
    // Fluid Buckets
    public static final DeferredItem<Item> LIQUID_CRYSTAL_BUCKET = register(item(
        "liquid_crystal_bucket", () -> new BucketItem(
            PastelFluids.LIQUID_CRYSTAL.get(), IS.of(1)
                                                 .craftRemainder(BUCKET)
        ), InkColors.LIGHT_GRAY
    ));
    public static final DeferredItem<Item> HUMUS_BUCKET = register(item(
        "humus_bucket", () -> new BucketItem(
            PastelFluids.HUMUS.get(), IS.of(1)
                                        .craftRemainder(BUCKET)
        ), InkColors.BROWN
    ));
    public static final DeferredItem<Item> MIDNIGHT_SOLUTION_BUCKET = register(item(
        "midnight_solution_bucket", () -> new BucketItem(
            PastelFluids.MIDNIGHT_SOLUTION.get(), IS.of(1)
                                                    .craftRemainder(BUCKET)
        ), InkColors.GRAY
    ));
    public static final DeferredItem<Item> DRAGONROT_BUCKET = register(item(
    ...
    // Decay bottles
    public static final DeferredItem<Item> BOTTLE_OF_FADING = register(item(
        "bottle_of_fading", () -> new DecayPlacerItem(
            PastelBlocks.FADING.get(), IS.of(16),
            List.of(Component.translatable("item.pastel.bottle_of_fading.tooltip"))
        ), InkColors.GRAY
    ));
    public static final DeferredItem<Item> BOTTLE_OF_FAILING = register(item(
        "bottle_of_failing",
        () -> new DecayPlacerItem(
            PastelBlocks.FAILING.get(), IS.of(16),
            List.of(Component.translatable("item.pastel.bottle_of_failing.tooltip"))
        ), InkColors.GRAY
    ));
    public static final DeferredItem<Item> BOTTLE_OF_RUIN = register(item(
    ...
    public static final DeferredItem<Item> BOTTLE_OF_FORFEITURE = register(item(
        "bottle_of_forfeiture", () -> new DecayPlacerItem(
            PastelBlocks.FORFEITURE.get(), IS.of(16),
            List.of(CreativeOnlyItem.DESCRIPTION, Component.translatable("item.pastel.bottle_of_forfeiture.tooltip"))
        ), InkColors.GRAY
    ));
    public static final DeferredItem<Item> BOTTLE_OF_DECAY_AWAY = register(item(
        "bottle_of_decay_away",
        () -> new DecayPlacerItem(
            PastelBlocks.DECAY_AWAY.get(), IS.of(16),
            List.of(Component.translatable("item.pastel.bottle_of_decay_away.tooltip"))
        ), InkColors.PINK
    ));

    // Resources
    public static final DeferredItem<Item> SHIMMERSTONE_GEM = register(item(
        "shimmerstone_gem", () -> new ItemWithLoomPattern(IS.of(), PastelBannerPatterns.SHIMMERSTONE),
        InkColors.YELLOW
    ));
    ...
    public static final DeferredItem<FloatItem> STRATINE_FRAGMENTS = register(item(
        "stratine_fragments", () -> new FloatItem(
            IS.of()
              .fireResistant(), -0.00125F
        ), InkColors.RED
    ));
    public static final DeferredItem<FloatItem> STRATINE_GEM = register(item(
    ...
    public static final DeferredItem<Item> AETHER_VESTIGES = register(item(
    ...
    public static final DeferredItem<Item> MERMAIDS_GEM = register(item(
    ...
    public static final DeferredItem<Item> HIBERNATING_JADE_VINE_BULB = register(item(
    ...
    public static final DeferredItem<Item> JADE_PETALS = register(item(
    ...
    public static final DeferredItem<Item> BLOODBOIL_SYRUP = register(item(
    ...
    // Food & drinks
    public static final DeferredItem<Item> MOONSTRUCK_NECTAR = register(item(
    ...
    public static final DeferredItem<Item> NIGHTDEW_SPROUT = register(item(
    ...
    public static final DeferredItem<Item> NECTARDEW_BURGEON = register(item(
    ...
    public static final DeferredItem<Item> RESTORATION_TEA = register(item(
    ...
    public static final DeferredItem<Item> CLOTTED_CREAM = register(item(
    ...
    public static final DeferredItem<Item> FRESH_CHOCOLATE = register(item(
        "fresh_chocolate", () -> new Item(IS.of()
                                            .food(PastelFoodComponents.FRESH_CHOCOLATE)), InkColors.PINK
    ));
    public static final DeferredItem<Item> HOT_CHOCOLATE = register(item(
    ...
    public static final DeferredItem<Item> KARAK_CHAI = register(item(
    ...
    public static final DeferredItem<Item> AZALEA_TEA = register(item(
    ...
    public static final DeferredItem<Item> BODACIOUS_BERRY_BAR = register(item(
        "bodacious_berry_bar", () -> new Item(IS.of()
                                                .food(PastelFoodComponents.BODACIOUS_BERRY_BAR)), InkColors.PINK
    ));
    public static final DeferredItem<Item> DEMON_TEA = register(item(
...
//	(PastelFoodComponents.VITTORIAS_ROAST)), InkColors.PINK)));
    ...
    public static final DeferredItem<Item> INFUSED_BEVERAGE = register(item(
    ...
    public static final DeferredItem<Item> SUSPICIOUS_BREW = register(item(
        "suspicious_brew", () -> new SuspiciousBrewItem(IS.of(16)
                                                          .food(PastelFoodComponents.BEVERAGE)
                                                          .craftRemainder(GLASS_BOTTLE)), InkColors.LIME
    ));
    public static final DeferredItem<Item> REPRISE = register(item(
        "reprise", () -> new RepriseItem(IS.of(16)
                                           .food(PastelFoodComponents.BEVERAGE)
                                           .craftRemainder(GLASS_BOTTLE)), InkColors.PINK
    ));
    public static final DeferredItem<Item> PURE_ALCOHOL = register(burnable(
        item(
    ...
    public static final DeferredItem<Item> JADE_WINE = register(item(
        "jade_wine", () -> new JadeWineItem(IS.of(16, Rarity.UNCOMMON)
                                              .food(PastelFoodComponents.BEVERAGE)
                                              .craftRemainder(GLASS_BOTTLE)), InkColors.LIME
    ));
    public static final DeferredItem<Item> CHRYSOCOLLA = register(burnable(
        item(
    ...
    public static final DeferredItem<Item> HONEY_PASTRY = register(item(
        "honey_pastry", () -> new Item(IS.of()
                                         .food(PastelFoodComponents.HONEY_PASTRY)), InkColors.PINK
    ));
    public static final DeferredItem<Item> LUCKY_ROLL = register(item(
        "lucky_roll", () -> new Item(IS.of(16)
                                       .food(PastelFoodComponents.LUCKY_ROLL)), InkColors.PINK
    ));
    public static final DeferredItem<Item> TRIPLE_MEAT_POT_PIE = register(item(
        "triple_meat_pot_pie", () -> new Item(IS.of(8)
                                                .food(PastelFoodComponents.TRIPLE_MEAT_POT_PIE)), InkColors.PINK
    ));
    public static final DeferredItem<Item> GLISTERING_JELLY_TEA = register(item(
    ...
    public static final DeferredItem<Item> GLISTERING_MELON_SEEDS = register(
        item(
            "glistering_melon_seeds", () -> new ItemNameBlockItem(PastelBlocks.GLISTERING_MELON_STEM.get(), IS.of()),
            InkColors.LIME
        ));
    ...
    // Cookbooks
    public static final DeferredItem<Item> MELOCHITES_COOKBOOK_VOL_1 = register(item(
    ...
    public static final DeferredItem<Item> MELOCHITES_COOKBOOK_VOL_2 = register(item(
    ...
    public static final DeferredItem<Item> IMBRIFER_COOKBOOK = register(item(
        "imbrifer_cookbook", () -> new CookbookItem(
            IS.of()
              .stacksTo(1)
              .rarity(Rarity.UNCOMMON),
            GuidebookItem.addressOf(GuidebookItem.CUISINE_CATEGORY_ID, locate("cuisine/cookbooks/imbrifer_cookbook"))
        ), InkColors.PURPLE
    ));
    public static final DeferredItem<Item> IMPERIAL_COOKBOOK = register(item(
        "imperial_cookbook", () -> new CookbookItem(
            IS.of()
              .stacksTo(1)
              .rarity(Rarity.UNCOMMON),
            GuidebookItem.addressOf(GuidebookItem.CUISINE_CATEGORY_ID, locate("cuisine/cookbooks/imperial_cookbook"))
        ), InkColors.PURPLE
    ));
    public static final DeferredItem<Item> BREWERS_HANDBOOK = register(item(
    ...
    public static final DeferredItem<Item> POISONERS_HANDBOOK = register(item(
    ...
    public static final DeferredItem<Item> AMETHYST_CLUSTER_BANNER_PATTERN = register(item(
    ...
    public static final DeferredItem<Item> ASTROLOGER_BANNER_PATTERN = register(item(
        "astrologer_banner_pattern",
        () -> new BannerPatternItem(PastelBannerPatternTags.ASTROLOGER_TAG, IS.of(1, Rarity.UNCOMMON)),
        InkColors.LIGHT_BLUE
    ));
    public static final DeferredItem<Item> VELVET_ASTROLOGER_BANNER_PATTERN = register(item(
    ...
    public static final DeferredItem<Item> POISONBLOOM_BANNER_PATTERN = register(item(
    ...
    public static final DeferredItem<Item> BITTER_OILS = register(item(
        "bitter_oils", () -> new DrinkItem(IS.of(16)
                                             .food(PastelFoodComponents.BITTER_OILS)), InkColors.BLUE
    ));

    public static final DeferredItem<Item> INCANDESCENT_ESSENCE = register(burnable(
        item(
            "incandescent_essence", () -> new Item(IS.of()
    ...
    public static final DeferredItem<Item> CELESTIAL_POCKETWATCH = register(item(
    ...
    public static final DeferredItem<Item> AZURE_DIKE_BELT = register(item(
        "azure_dike_belt",
        () -> new AzureDikeBeltItem(IS.of(1, Rarity.UNCOMMON), PastelAdvancements.Unlocks.Trinkets.AZURE_DIKE_BELT),
        InkColors.BLUE
    ));
    public static final DeferredItem<Item> AZURE_DIKE_RING = register(item(
        "azure_dike_ring",
        () -> new AzureDikeRingItem(IS.of(1, Rarity.UNCOMMON), PastelAdvancements.Unlocks.Trinkets.AZURE_DIKE_RING),
        InkColors.BLUE
    ));
    public static final DeferredItem<Item> AZURESQUE_DIKE_CORE = register(item(
        "azuresque_dike_core",
    ...
    public static final DeferredItem<InkDrainTrinketItem> SHIELDGRASP_AMULET = register(
        item(
            "shieldgrasp_amulet", () -> new AzureDikeAmuletItem(
                IS.of(1, Rarity.UNCOMMON), PastelAdvancements.Unlocks.Trinkets.SHIELDGRASP_AMULET), InkColors.BLUE
        ));
    ...
    public static final DeferredItem<PigmentPaletteItem> PIGMENT_PALETTE = register(item(
        "pigment_palette", () -> new PigmentPaletteItem(IS.of(1, Rarity.UNCOMMON), 64 * 64 * 100), InkColors.WHITE));
    public static final DeferredItem<ArtistsPaletteItem> ARTISTS_PALETTE = register(item(
    ...
    public static final DeferredItem<Item> LESSER_POTION_PENDANT = register(item(
    ...
    public static final DeferredItem<Item> GREATER_POTION_PENDANT = register(item(
    ...
    public static final DeferredItem<Item> PUFF_CIRCLET = register(item(
        "puff_circlet",
    ...
    public static final DeferredItem<Item> AETHER_GRACED_NECTAR_GLOVES = register(item(
    ...
    public static final DeferredItem<Item> PURE_NETHERITE_SCRAP = register(item(

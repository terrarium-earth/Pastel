...
public class ColoredTransmission extends SimpleTransmission {
    ...
    public static final Codec<ColoredTransmission> CODEC = RecordCodecBuilder
        .create(
            (instance) -> instance
                .group(
                    Vec3.CODEC
                        .fieldOf("origin")
                        .forGetter(c -> c.origin),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ColoredTransmission> STREAM_CODEC = StreamCodec
        .composite(

        ...
        source
            ...
            .forEach(registry -> {
                ...
                registry
                    ...
                    .getTags()
                    .forEach(pair -> {
                        ResourceLocation registryId = pair
                            .getSecond()
                            .key()
                            .registry()
                            .location();
                        ResourceLocation tagId = pair
                            .getSecond()
                            .key()
                            .location();
                        File tagFile = new File(
                            baseDir,
                            tagId.getNamespace() + "/" + registryId.getPath() + "/" + tagId.getPath() + ".txt"
                        );

...
public class FunctionalBlockModels {
    public static void generateBlockModels(BlockModelGenerators generators) {
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.PRESENT.get())
                    .with(
                        PropertyDispatch
                            .property(PresentBlock.VARIANT)
                            .generate(
                                variant -> PastelModelHelper
                                    .createModelVariant(
                                        PastelModels.PRESENT
                                            .createWithSuffix(
                                                PastelBlocks.PRESENT.get(),
                                                "_" + variant.getSerializedName(),
                                                new TextureMapping()
                                                    .put(
                                                        TextureSlot.TEXTURE,
                                                        TextureMapping
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.BOTTOMLESS_BUNDLE.get())
                    .with(
                        PastelModelHelper
        ...
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.SHIMMERSTONE_LIGHT,
                PastelTexturedModels.particle(PastelTextures.SHIMMERSTONE_LIGHT)
            );
        PastelModelHelper.BLOCK
            .parented(
                generators,
                PastelBlocks.TEMPORAL_SHIMMERSTONE_LIGHT.get(),
                PastelBlocks.SHIMMERSTONE_LIGHT.get()
            );
        PastelModelHelper.BLOCK
            .parented(
                generators,
                PastelBlocks.ENERGETIC_MOTE.get(),
                PastelBlocks.SHIMMERSTONE_LIGHT.get()
            );
        PastelModelHelper.BLOCK
            .parented(
                generators,
                PastelBlocks.TEMPORARY_PLATFORM.get(),
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.PARTICLE_SPAWNER.get())
                    .with(
                        PastelModelHelper
                            .createBooleanModelMap(
                                BlockStateProperties.POWERED,
                                PastelModels.PARTICLE_SPAWNER
                                    .create(
        ...
        PastelModelHelper.BLOCK
            .defaultSouthHorizontalFacing(
                generators,
                PastelBlocks.BEDROCK_ANVIL,
                ModelLocationUtils::getModelLocation
            );
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.BLOCK_DETECTOR.get())
                    .with(
                        PastelModelHelper.createUpNorthDefaultOrientationVariantMap()
                    )
                    .with(
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.IMBRIFER_PORTAL.get())
                    .with(
                        PastelModelHelper
                            .createBooleanModelMap(
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.ENDER_GLASS.get())
                    .with(
                        PropertyDispatch
                            .property(
                            ...
                            .generate(
                                transparency -> PastelModelHelper
                                    .createModelVariant(
                                        PastelTexturedModels
                                            .cubeAll(
                                                b -> b,
                                                "_" + transparency.getSerializedName()
                                            )
                                            .createWithSuffix(
    ...
    public static void generatePrimfireModel(BlockModelGenerators generators) {
        ...
        TextureMapping fire0 = new TextureMapping()
            .put(
                TextureSlot.FIRE,
                TextureMapping.getBlockTexture(PastelBlocks.PRIMORDIAL_FIRE.get(), "_0")
            );
        TextureMapping fire1 = new TextureMapping()
            .put(
                TextureSlot.FIRE,
                TextureMapping.getBlockTexture(PastelBlocks.PRIMORDIAL_FIRE.get(), "_1")
            );
        ResourceLocation side0 = PastelModels.FIRE_SIDE
            .createWithSuffix(
                PastelBlocks.PRIMORDIAL_FIRE.get(),
                "_side0",
                fire0,
                generators.modelOutput
            );
        ResourceLocation side1 = PastelModels.FIRE_SIDE
            .createWithSuffix(
                PastelBlocks.PRIMORDIAL_FIRE.get(),
                "_side1",
                fire1,
        ...
        ResourceLocation sideAlt0 = PastelModels.FIRE_SIDE_ALT
            .createWithSuffix(
                PastelBlocks.PRIMORDIAL_FIRE.get(),
                "_side_alt0",
                fire0,
        ...
        ResourceLocation sideAlt1 = PastelModels.FIRE_SIDE_ALT
            .createWithSuffix(
                PastelBlocks.PRIMORDIAL_FIRE.get(),
                "_side_alt1",
                fire1,
        ...
        generators.blockStateOutput
            .accept(
                MultiPartGenerator
                    .multiPart(PastelBlocks.PRIMORDIAL_FIRE.get())
                    .with(
                        noSides,
                        PastelModelHelper
                            .createModelVariant(
                                PastelModels.FIRE_FLOOR
                                    .createWithSuffix(
                                        PastelBlocks.PRIMORDIAL_FIRE.get(),
                                        "_floor0",
                                        fire0,
                    ...
                    .with(
                        ...
                        PastelModelHelper
                            .createModelVariant(side0)
                            .with(
                                VariantProperties.Y_ROT,
                                VariantProperties.Rotation.R180
                            ),
                        PastelModelHelper
                            .createModelVariant(side1)
                            .with(
                                VariantProperties.Y_ROT,
                                VariantProperties.Rotation.R180
                            ),
    ...
    public static void generateRedstoneTimerModel(BlockModelGenerators generators) {
        ...
        ResourceLocation on = PastelModels.REDSTONE_TIMER
            .create(
        ...
        ResourceLocation off = PastelModels.REDSTONE_TIMER
            .createWithSuffix(
                PastelBlocks.REDSTONE_TIMER.get(),
                "_off",
                new TextureMapping()
                    .put(PastelTextureKeys.LIGHT, TextureMapping.getBlockTexture(REDSTONE_TORCH, "_off")),
                generators.modelOutput
            );
        for (
            ...
            for (
                RedstoneTimerBlock.TimingStep step : RedstoneTimerBlock.TimingStep.values()
            ) {
                rTimerMultipart
                    .with(
                        Condition
                            .condition()
                            .term(BlockStateProperties.HORIZONTAL_FACING, direction)
                            .term(RedstoneTimerBlock.ACTIVE_TIME, step),
                        PastelModelHelper
                            .createModelVariant(
                                PastelBlocks.REDSTONE_TIMER.get(),
                                "_left_" + step.ordinal()
                ...
                rTimerMultipart
                    .with(
                        Condition
                            .condition()
                            .term(BlockStateProperties.HORIZONTAL_FACING, direction)
                            .term(RedstoneTimerBlock.INACTIVE_TIME, step),
                        PastelModelHelper
                            .createModelVariant(
                                PastelBlocks.REDSTONE_TIMER.get(),
    ...
    public static void generateRedstoneTransceiverModel(BlockModelGenerators generators) {
        ...
        ResourceLocation senderOn = PastelModels.REDSTONE_TRANSCEIVER_SENDER
            .createWithSuffix(
        ...
        ResourceLocation senderOff = PastelModels.REDSTONE_TRANSCEIVER_SENDER
            .createWithSuffix(
                PastelBlocks.REDSTONE_TRANSCEIVER.get(),
                "_sender_off",
                new TextureMapping()
        ...
        ResourceLocation receiverOn = PastelModels.REDSTONE_TRANSCEIVER_RECEIVER
            .createWithSuffix(
                PastelBlocks.REDSTONE_TRANSCEIVER.get(),
                "_receiver",
                new TextureMapping().put(PastelTextureKeys.LIGHT, TextureMapping.getBlockTexture(REDSTONE_TORCH)),
        ...
        ResourceLocation receiverOff = PastelModels.REDSTONE_TRANSCEIVER_RECEIVER
            .createWithSuffix(
                PastelBlocks.REDSTONE_TRANSCEIVER.get(),
                "_receiver_off",
                new TextureMapping()
            ...
            rTransMultipart
                .with(
                    Condition
                        ...
                        .term(BlockStateProperties.POWERED, false),
                    PastelModelHelper
                        .createModelVariant(receiverOff)
                        .with(
                            VariantProperties.Y_ROT,
                            rotation
                        )
        ...
        for (
            ...
            ResourceLocation channel = PastelModels.REDSTONE_TRANSCEIVER_CHANNEL
                .createWithSuffix(
                    PastelBlocks.REDSTONE_TRANSCEIVER.get(),
                    "_channel_" + color.getSerializedName(),
            ...
            rTransMultipart
                .with(
                    Condition
                        .condition()
                        .term(RedstoneTransceiverBlock.CHANNEL, color),
                    PastelModelHelper.createModelVariant(channel)
                );
        }
            ...
            rCalcMultipart
                .with(
                    Condition
                        ...
                        .term(BlockStateProperties.POWERED, true),
                    PastelModelHelper
                        .createModelVariant(PastelBlocks.REDSTONE_CALCULATOR.get(), "_base")
            ...
            rCalcMultipart
                .with(
                    Condition
                        ...
                        .term(BlockStateProperties.POWERED, false),
                    PastelModelHelper
                        .createModelVariant(PastelBlocks.REDSTONE_CALCULATOR.get(), "_base_off")
                        .with(VariantProperties.Y_ROT, rotation)
                );
            for (
                RedstoneCalculatorBlock.CalculationMode mode : RedstoneCalculatorBlock.CalculationMode.values()
            ) {
                rCalcMultipart
                    .with(
                        Condition
    ...
    public static void decay(BlockModelGenerators generators, DeferredBlock<Block> block) {
        ResourceLocation none = ModelTemplates.CUBE_ALL
            .createWithSuffix(
                block.get(),
                "_none",
                PastelTextureMaps.all(block.get(), "_none"),
                generators.modelOutput
            );
        ResourceLocation def = ModelTemplates.CUBE_ALL
            .createWithSuffix(
                block.get(),
                "_default",
                PastelTextureMaps.all(block.get(), "_default"),
                generators.modelOutput
            );
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    ...
                    .with(
                        PropertyDispatch
                            .property(DecayBlock.CONVERSION)
                            .select(
    ...
    public static void generateItemModels(ItemModelGenerators generators) {
        ...
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.CRACKED_END_PORTAL_FRAME,
                PastelBlocks.CRACKED_END_PORTAL_FRAME.get(),
                "_none"
            );
        PastelModelHelper
        ...
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.TEMPORAL_SHIMMERSTONE_LIGHT,
                PastelBlocks.SHIMMERSTONE_LIGHT.get()
            );
        ...
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.WITHER_SKELETON_IDOL,

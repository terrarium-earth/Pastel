...
public class UnlockToastManager {
    ...
    public static final Map<ResourceLocation, Tuple<ItemStack, String>> MESSAGE_TOASTS = new HashMap<>() {{
        put(
            PastelAdvancements.UNLOCK_SHOOTING_STARS,
            new Tuple<>(Items.SPYGLASS.getDefaultInstance(), "shooting_stars_unlocked")
        );
        put(
            PastelAdvancements.OVERENCHANTING, new Tuple<>(
        ...
        put(
            PastelAdvancements.APPLY_CONFLICTING_ENCHANTMENTS, new Tuple<>(
                PastelBlocks.ENCHANTER.get()
                                      .asItem()
        ...
        put(
            PastelAdvancements.FOURTH_BREWING_SLOT, new Tuple<>(
        ...
        put(
            PastelAdvancements.MIDGAME, new Tuple<>(
        ...
        put(
            PastelAdvancements.LATEGAME, new Tuple<>(
        ...
        put(
            PastelAdvancements.VIVISECT_KINDLING, new Tuple<>(
                PastelItems.DIVINATION_HEART.get()
                                            .getDefaultInstance(), "vivisect_kindling"
            )
        );
        put(
            PastelAdvancements.PAINTBRUSH_COLORING, new Tuple<>(
                PastelItems.PAINTBRUSH.get()
                                      .getDefaultInstance(), "block_coloring_unlocked"
            )
        );
        put(
            PastelAdvancements.PAINTBRUSH_INK_SLINGING, new Tuple<>(
                PastelItems.PAINTBRUSH.get()
                                      .getDefaultInstance(), "ink_slinging_unlocked"
            )
        );
        put(
            PastelAdvancements.PASTEL_NODE_COLORING, new Tuple<>(
    ...
    public static void processAdvancements(Set<ResourceLocation> doneAdvancements) {
        ...
        for (ResourceLocation doneAdvancement : doneAdvancements) {
            ...
            Optional<PedestalRecipeTier> newlyUnlockedRecipeTier = PedestalRecipeTier.hasJustUnlockedANewRecipeTier(
                doneAdvancement);
    ...
    private static @NotNull List<PedestalRecipe> getRecipesForTierWithAllConditionsMet(
        PedestalRecipeTier pedestalRecipeTier, List<GatedRecipe<?>> pedestalRecipes) {
        Minecraft client = Minecraft.getInstance();

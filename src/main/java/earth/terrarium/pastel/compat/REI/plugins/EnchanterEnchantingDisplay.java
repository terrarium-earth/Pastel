...
public class EnchanterEnchantingDisplay extends EnchanterDisplay {
    ...
    private static List<EntryIngredient> buildIngredients(EnchanterCraftingRecipe recipe) {
        List<EntryIngredient> inputs = recipe
            .getIngredients()
            .stream()
    ...
    public boolean isUnlocked() {
        ...
        return DatabankUtils
            .hasAdvancement(client.player, EnchanterCraftingRecipe.UNLOCK_IDENTIFIER) && super.isUnlocked();
    }

...
public class EnchantmentUpgradeCategory extends EnchanterCategory<EnchantmentUpgradeDisplay> {
    ...
    public void setupWidgets(
        ...
        Rectangle bounds,
        List<Widget> widgets,
        @NotNull EnchantmentUpgradeDisplay display
    ) {
        boolean overUnlocked = DatabankUtils
            .hasAdvancement(
                ...
                .add(
                    Widgets
                        .withTooltip(
                            ...
                            Component
                                .translatable(EnchanterBlockEntity.OVERCHANTING_TOOLTIP)
        ...
        widgets
            .add(
                Widgets
                    .createButton(new Rectangle(startPoint.x - 8 + 84, startPoint.y + 20, 8, 8), Component.literal("-"))
                    .onClick(b -> display.index = Math.clamp(display.index - 1, 1, max - 1))
            ); // decrement
        widgets
            .add(
                Widgets
                    .createButton(new Rectangle(startPoint.x - 8 + 94, startPoint.y + 20, 8, 8), Component.literal("+"))
                    .onClick(b -> display.index = Math.clamp(display.index + 1, 1, max - 1))
            ); // increment
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 18, startPoint.y - 7 + 9))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 44, startPoint.y - 7 + 9))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 62, startPoint.y - 7 + 27))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 62, startPoint.y - 7 + 53))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 44, startPoint.y - 7 + 71))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 18, startPoint.y - 7 + 71))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8, startPoint.y - 7 + 53))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8, startPoint.y - 7 + 27))
                    .markInput()
        ...
        widgets
            .add(
                new IndexedEntryWidget(
                    new Point(startPoint.x - 8 + 111, startPoint.y - 7 + 14),
                    () -> display.index - 1
                )
                    .markInput()
                    .entries(
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 8 + 111, startPoint.y - 7 + 60))
                    .entries(ENCHANTER)
                    .disableBackground()
            );
        ...
        widgets
            .add(
                new IndexedEntryWidget(
                    new Point(startPoint.x - 8 + 31, startPoint.y - 7 + 40),
                    () -> display.index - 1
                )
                    .markInput()
                    .entries(
        ...
        widgets
            .add(
                Widgets
                    .createArrow(new Point(startPoint.x - 8 + 80, startPoint.y - 7 + 40))
        ...
        var outputSlot = new IndexedEntryWidget(
            new Point(startPoint.x - 8 + 111, startPoint.y - 7 + 40),
            () -> display.index - 1
        )
            .markOutput()
            .disableBackground()
        ...
        // labels
        var levelLabel = Widgets
            .createLabel(
                new Point(startPoint.x - 11 + 70, startPoint.y + 2),
        ...
        widgets
            .add(
                Widgets
                    .createLabel(new Point(startPoint.x - 7, startPoint.y + 2 + 82), display.transKey)
                    .color(NORMAL_COLOR)
                    .shadow(false)
                    .leftAligned()
            );

...
public class PastelPresentUnpackBehaviors {
    ...
    public static void register() {
        PresentBlock
            .registerBehavior(
                PastelItems.PIPE_BOMB.getId(),
                (stack, presentBlockEntity, world, pos, random) -> {
        ...
        PresentBlock
            .registerBehavior(
                PastelBlocks.INCANDESCENT_AMALGAM.getId(),
                (stack, presentBlockEntity, world, pos, random) -> {
                ...
                (stack, presentBlockEntity, world, pos, random) -> {
                    ...
                    for (
                        ...
                        FireworkRocketEntity fireworkRocketEntity = new FireworkRocketEntity(
                            ...
                            centerPos.x + 0.35 + random.nextFloat() * 0.3,
                            centerPos.y + 0.35 + random.nextFloat() * 0.3,
                            centerPos.z + 0.35 + random.nextFloat() * 0.3,
                            stack
                        );
        ...
        PresentBlock
            .registerBehavior(
                BuiltInRegistries.ITEM.getKey(Items.GOAT_HORN),
                (stack, presentBlockEntity, world, pos, random) -> {
                    Optional<Holder<Instrument>> optional = ((GoatHornItemAccessor) stack.getItem())
                        .invokeGetInstrument(
                            stack
                        );
        ...
        PresentBlock
            .registerBehavior(
                BuiltInRegistries.ITEM.getKey(Items.BELL),
                (stack, presentBlockEntity, world, pos, random) -> {
        ...
        PresentBlock
            .registerBehavior(
                BuiltInRegistries.ITEM.getKey(Items.TNT),
                (stack, presentBlockEntity, world, pos, random) -> {
                    if (stack.getCount() > 0) {
        ...
        PresentBlock
            .registerBehavior(
                BuiltInRegistries.ITEM.getKey(Items.EXPERIENCE_BOTTLE),
                (stack, presentBlockEntity, world, pos, random) -> {
                    int totalXP = 0;
                    for (
                        int i = 0;
                    ...
                    world
                        .levelEvent(
                            ...
                            pos,
                            new PotionContents(Potions.WATER).getColor()
                        );
        ...
        PresentBlock
            .registerBehavior(
                BuiltInRegistries.ITEM.getKey(Items.EGG),
                (stack, presentBlockEntity, world, pos, random) -> {

...
public record NephriteBlossomFeatureConfig(Boolean flowering) implements FeatureConfiguration {
    public static final Codec<NephriteBlossomFeatureConfig> CODEC = RecordCodecBuilder.create(
        (instance) -> instance.group(
                                  Codec.BOOL.fieldOf("flowering")
                                            .forGetter(NephriteBlossomFeatureConfig::flowering)
                              )

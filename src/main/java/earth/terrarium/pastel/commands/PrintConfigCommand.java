...
public class PrintConfigCommand {
    ...
    public static void register(LiteralCommandNode<CommandSourceStack> root) {
        LiteralCommandNode<CommandSourceStack> config = Commands.literal("config")
    ...
    private static int execute(CommandSourceStack source) {
        send(source,
             "EndermanHoldingEnderTreasureChance: " + PastelCommon.CONFIG.EndermanHoldingEnderTreasureChance + " (" +
             PastelCommon.CONFIG.EndermanHoldingEnderTreasureInEndChance + " in the End)"
        );
        ...
        send(source, "Decay tick rates: " + PastelCommon.CONFIG.FadingDecayTickRate + ", " +
                     PastelCommon.CONFIG.FailingDecayTickRate + ", " + PastelCommon.CONFIG.RuinDecayTickRate + ", " +
                     PastelCommon.CONFIG.ForfeitureDecayTickRate
        );
        send(source, "Decay pickup ability: " + PastelCommon.CONFIG.CanBottleUpFading + ", " +
                     PastelCommon.CONFIG.CanBottleUpFailing + ", " + PastelCommon.CONFIG.CanBottleUpRuin + ", " +
                     PastelCommon.CONFIG.CanBottleUpForfeiture
        );
        send(source, "Decay can destroy block entities: " + PastelCommon.CONFIG.FadingCanDestroyBlockEntities + ", " +
                     PastelCommon.CONFIG.FailingCanDestroyBlockEntities + ", " +
                     PastelCommon.CONFIG.RuinCanDestroyBlockEntities + ", " +
                     PastelCommon.CONFIG.ForfeitureCanDestroyBlockEntities
        );
        ...
        send(source, "Bedrock Armor Protection: " + PastelCommon.CONFIG.BedrockArmorHelmetProtection + ", " +
                     PastelCommon.CONFIG.BedrockArmorLeggingsProtection + ", " +
                     PastelCommon.CONFIG.BedrockArmorChestplateProtection + ", " +
                     PastelCommon.CONFIG.BedrockArmorBootsProtection + " (Toughness: " +

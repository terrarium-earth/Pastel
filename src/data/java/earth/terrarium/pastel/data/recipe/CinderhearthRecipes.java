...
public class CinderhearthRecipes {
    ...
    private static void vanilla(PrefixHelper pfx) {
        pfx.generateRecipe(
            "bread_from_amaranth",
                CinderhearthRecipeBuilder.of(Ingredient.of(AMARANTH_GRAINS), 2, 200)
                        .experience(0.6f)
        ...
        pfx.generateAutoNamedRecipe(
                CinderhearthRecipeBuilder.of(Ingredient.of(Items.CLAY_BALL), 100)
                        .experience(0.6f)
                        .result(new ItemStack(Items.BRICK, 2))
        );

        pfx.generateAutoNamedRecipe(
                CinderhearthRecipeBuilder.of(Ingredient.of(ItemTags.LOGS_THAT_BURN), 100)
                        .experience(0.3f)
                        .result(new ItemStack(Items.CHARCOAL, 2))
        );

        pfx.generateAutoNamedRecipe(
                CinderhearthRecipeBuilder.of(Ingredient.of(Items.GLASS), 100)
                        .experience(0.2f)
        ...
        pfx.generateRecipe(
                ...
                CinderhearthRecipeBuilder.of(Ingredient.of(FISSURE_PLUM), 2, 50)
                        .experience(1.0f)
    ...
    private static void vanillaOres(PrefixHelper pfx) {
        pfx.generateRecipe(
                "coal",
                CinderhearthRecipeBuilder.of(Ingredient.of(ItemTags.COAL_ORES), 100)
                        .experience(0.2f)
        ...
        pfx.generateRecipe(
                "netherite_scrap",
                CinderhearthRecipeBuilder.of(Ingredient.of(Items.ANCIENT_DEBRIS), 100)
                        .experience(0.2f)
        ...
        pfx.generateRecipe(
                "redstone",
                CinderhearthRecipeBuilder.of(Ingredient.of(ItemTags.REDSTONE_ORES), 100)
                        .experience(0.2f)
    ...
    private static final Map<DeferredBlock<?>, ItemLike> SLABS =
            Map.ofEntries(
    ...
    private static final Map<ResourceLocation, List<ItemLike>> SLAB_ADVANCEMENT =
            Map.of(
                    PastelAdvancements.Midgame.ENTER_DIMENSION, List.of(
                            PastelBlocks.BLACKSLAG,
                            PastelBlocks.BLACKSLAG_BRICKS,
                            PastelBlocks.BLACKSLAG_TILES,
                            PastelBlocks.COBBLED_BLACKSLAG
                    ),
                    PastelAdvancements.BREAK_CRACKED_DRAGONBONE, List.of(
                            PastelBlocks.BONE_ASH_BRICKS,
                            PastelBlocks.BONE_ASH_TILES,
                            PastelBlocks.POLISHED_BONE_ASH
                    ),
                    PastelAdvancements.Hidden.COLLECT_PYRITE, List.of(
                            PastelBlocks.PYRITE,
                            PastelBlocks.PYRITE_TILES
                    ),
                    PastelAdvancements.Hidden.COLLECT_SHALE_CLAY, List.of(
    ...
    private static void slabFusing(PrefixHelper pfx) {
        SLABS.forEach((slab, block) -> {
            var advancement = SLAB_ADVANCEMENT.entrySet()
                    .stream()
                    .filter(it -> it.getValue().contains(block))
                    .findFirst().map(Map.Entry::getKey)
                    .orElse(null);
            pfx.generateAutoNamedRecipe(
                    CinderhearthRecipeBuilder.of(Ingredient.of(slab.asItem()), 2, 100)
                            .experience(0.1f)
    ...
    private static final Map<ItemLike, ItemLike> VANILLA_SLABS =
            Map.ofEntries(
    ...
    private static void vanillaSlabFusing(PrefixHelper pfx) {
        VANILLA_SLABS.forEach((slab, block) -> {
           pfx.generateAutoNamedRecipe(
                   CinderhearthRecipeBuilder.of(Ingredient.of(slab), 2, 100)
                           .experience(0.1f)
                           .result(new ItemStack(block))
           );
        });
    ...
    private static final Map<DeferredItem<?>, ItemLike> STANDARD_PURE =
            Map.of(
                    PURE_COAL, Items.COAL,
                    PURE_COPPER, Items.COPPER_INGOT,
                    PURE_DIAMOND, Items.DIAMOND,
                    PURE_EMERALD, Items.EMERALD,
                    PURE_GOLD, Items.GOLD_INGOT,
                    PURE_IRON, Items.IRON_INGOT,
                    PURE_NETHERITE_SCRAP, Items.NETHERITE_SCRAP
            );
    ...
    private static void pureResources(PrefixHelper pfx) {
        ...
        STANDARD_PURE.forEach((pure, item) -> {
            ...
            pfx.generateRecipe(
                    name,
                    CinderhearthRecipeBuilder.of(Ingredient.of(pure.asItem()), 200)
                            .experience(0.5f)
        ...
        pfx.generateRecipe(
                "echo",
                CinderhearthRecipeBuilder.of(Ingredient.of(PURE_ECHO), 200)
                        .experience(0.5f)
                        .requiredAdvancement(unlock)
        ...
        pfx.generateRecipe(
                "lapis",
                CinderhearthRecipeBuilder.of(Ingredient.of(PURE_LAPIS), 200)
                        .experience(0.5f)
                        .requiredAdvancement(unlock)
        ...
        generateDust(pfx, PURE_GLOWSTONE, Items.GLOWSTONE_DUST);
        generateDust(pfx, PURE_REDSTONE, Items.REDSTONE);
        generateDust(pfx, PURE_PRISMARINE, Items.PRISMARINE_CRYSTALS);
        generateDust(pfx, PURE_QUARTZ, Items.QUARTZ);

        pfx.modIntegration("create").generateRecipe(
                "pure_zinc",
                CinderhearthRecipeBuilder.of(Ingredient.of(CreateCompat.PURE_ZINC), 200)
                        .experience(0.5f)
                        .requiredAdvancement(unlock)
    ...
    private static void root(PrefixHelper pfx) {
        pfx.generateAutoNamedRecipe(
                CinderhearthRecipeBuilder.of(Ingredient.of(PastelBlocks.SLUSH), 20)
                        .experience(4.0f)
                        .requiredAdvancement(PastelAdvancements.Hidden.COLLECT_ASH_AND_SLUSH)
                        .result(new ItemStack(ASH_FLAKES.asItem(), 2))
        );

        pfx.generateAutoNamedRecipe(
                CinderhearthRecipeBuilder.of(Ingredient.of(DRAGONBONE_CHUNK), 6000)
                        .experience(4.0f)
                        .requiredAdvancement(PastelAdvancements.BREAK_CRACKED_DRAGONBONE)
                        .result(new ItemStack(BONE_ASH.asItem(), 45))
        );

        pfx.generateRecipe(
                "bone_ash_unsmelting",
                CinderhearthRecipeBuilder.of(Ingredient.of(PastelItemTags.SMELTS_TO_BONE_ASH), 600)
                        .experience(0.0f)
                        .requiredAdvancement(PastelAdvancements.BREAK_CRACKED_DRAGONBONE)
        ...
        pfx.generateAutoNamedRecipe(
                CinderhearthRecipeBuilder.of(Ingredient.of(JADE_JELLY), 100)
                        .experience(0.2f)
                        .requiredAdvancement(PastelAdvancements.Unlocks.Food.JARAMEL)
                        .result(new ItemStack(JARAMEL.asItem(), 4))
        );

        pfx.generateAutoNamedRecipe(
                CinderhearthRecipeBuilder.of(Ingredient.of(MERMAIDS_GEM), 16, 200)
                        .experience(0.1f)
                        .requiredAdvancement(PastelAdvancements.COLLECT_MERMAIDS_GEM)
                        .result(new ItemStack(MERMAIDS_POPCORN.asItem()))
        );
    ...
    private static void generateDust(PrefixHelper pfx, DeferredItem<?> pure, Item dust) {
        ...
        pfx.generateRecipe(
                ...
                CinderhearthRecipeBuilder.of(Ingredient.of(pure), 200)
                        .experience(0.5f)
                        .requiredAdvancement(unlock)

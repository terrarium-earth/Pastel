...
public class PastelDeathMessageLang {
    public static void addTranslations(PastelLanguageProvider provider) {
        ...
        provider
            .add(
                "death.attack.pastel_midnight_solution.player",
                "%1$s was lost in Translation being chased by %2$s"
            );
        ...
        provider
            .add(
                "death.attack.pastel_whip.item",
                "%2$s used %3$s to show %1$s that power is meaningless without purpose!"
            );

...
public class FluidConvertingRecipes {
    ...
    private static void dragonrot(PrefixHelper pfx) {
        ...
        pfx
            .generateRecipe(
                "ash_from_bone_ash",
                FluidConvertingRecipeBuilder
                    .dragonrot(Ingredient.of(PastelItems.BONE_ASH), new ItemStack(PastelItems.ASH_FLAKES.asItem()))
        ...
        pfx
            .generateRecipe(
                ...
                FluidConvertingRecipeBuilder
                    .dragonrot(Ingredient.of(Items.DEEPSLATE), new ItemStack(PastelBlocks.BLACKSLAG))
            );
    ...
    private static void shaleClayOxidizing(PrefixHelper pfx) {
        Weathering.WEATHERING_LEVEL_INCREASES
            .get()
            .forEach(
                (block, nextBlock) -> pfx
                    .generateAutoNamedRecipe(

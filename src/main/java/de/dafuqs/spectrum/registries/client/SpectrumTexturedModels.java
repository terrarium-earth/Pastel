...
public class SpectrumTexturedModels {
	...
	public static final TexturedModel.Factory BOWL = TexturedModel.makeFactory(b -> new TextureMap().put(SIDE, getSubId(b, "_side")).put(TOP, getSubId(b, "_top")).put(BOTTOM, getSubId(b, "_bottom")).put(INNER, getSubId(b, "_inner")), SpectrumModels.BOWL);

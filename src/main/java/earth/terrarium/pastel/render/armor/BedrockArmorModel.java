    ...
    public static MeshDefinition getModelData() {
        ...
        var head = root.addOrReplaceChild(
            "head", CubeListBuilder.create()
                                   .texOffs(0, 0)
                                   .addBox(-4.5F, -8.625F, -4.5F, 9.0F, 9.0F, 9.0F, new CubeDeformation(.3f)),
            PartPose.ZERO
        );

        var head_plume = head.addOrReplaceChild(
            "head_plume", CubeListBuilder.create()
                                         .texOffs(38, 61)
                                         .addBox(0.0F, -0.0806F, 0.1517F, 0.0F, 11.0F, 7.0F, CubeDeformation.NONE),
            PartPose.offsetAndRotation(0.0F, -11.25F, 2.0F, 0.4363F, 0.0F, 0.0F)
        );

        var visor = head.addOrReplaceChild(
            "visor", CubeListBuilder.create()
                                    .texOffs(30, 11)
        ...
        var visor_frill_left = visor.addOrReplaceChild(
            "visor_frill_left", CubeListBuilder.create()
                                               .texOffs(38, 14)
                                               .addBox(
                                                   1.25F, -4.0F, -4.5F, 0.0F, 8.0F, 9.0F,
                                                   new CubeDeformation(0, 0.125f, 0.125f)
                                               ),
            PartPose.offsetAndRotation(5.1F, -2.0F, 1.2F, 0.5796F, 0.2344F, 0.1939F)
        );

        var visor_frill_right = visor.addOrReplaceChild(
            "visor_frill_right", CubeListBuilder.create()
                                                .texOffs(56, 14)
                                                .addBox(
                                                    -1.25F, -4.0F, -4.5F, 0.0F, 8.0F, 9.0F,
                                                    new CubeDeformation(0, 0.125f, 0.125f)
        ...
        var body_roll = body.addOrReplaceChild(
            "body_roll", CubeListBuilder.create()
                                        .texOffs(28, 31)
                                        .addBox(-5.5F, -3.5F, -1.25F, 12.0F, 5.0F, 5.0F, CubeDeformation.NONE),
        ...
        var right_arm = root.addOrReplaceChild(
        ...
        var right_arm_pauldron_top = right_arm.addOrReplaceChild(
            "right_arm_pauldron_top", CubeListBuilder.create()
                                                     .texOffs(74, 22)
                                                     .addBox(1.0F, -1.0F, -2.5F, 2.0F, 5.0F, 7.0F, CubeDeformation.NONE)
                                                     .texOffs(57, 3)
                                                     .addBox(
                                                         -4.0F, 0.0F, -2.5F, 5.0F, 4.0F, 7.0F,
                                                         CubeDeformation.NONE
                                                     ),
            PartPose.offsetAndRotation(-3.0F, -2.5F, -1.0F, 0.0F, 0.0F, -0.2618F)
        );

        var left_arm = root.addOrReplaceChild(
        ...
        var left_arm_bauldron_top = left_arm.addOrReplaceChild(
            "left_arm_bauldron_top", CubeListBuilder.create()
                                                    .texOffs(74, 0)
                                                    .addBox(-0.5F, -5.0F, -3.0F, 5.0F, 1.0F, 6.0F, CubeDeformation.NONE)
                                                    .texOffs(36, 0)
                                                    .addBox(
                                                        -1.5F, -4.0F, -3.5F, 7.0F, 3.0F, 7.0F,
                                                        CubeDeformation.NONE
        ...
        var left_leg_armor = left_leg.addOrReplaceChild(
            "left_leg_armor", CubeListBuilder.create()
                                             .texOffs(67, 47)
                                             .addBox(-2.5F, -0.5F, -2.5F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.1f)),
            PartPose.ZERO
        );

        var left_boot = left_leg.addOrReplaceChild(
            "left_boot", CubeListBuilder.create()
                                        .texOffs(82, 42)
                                        .addBox(-2.5F, 9.25f, -2.5F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.1f))
                                        .texOffs(32, 80)
                                        .mirror()
                                        .addBox(-2.25F, 5.0F, -1.25F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.125f))
                                        .mirror(false), PartPose.ZERO
        );

        var right_leg = root.addOrReplaceChild(
            "right_leg", CubeListBuilder.create(), PartPose.offset(2.0F, 12.0F, 0.0F));

        var right_leg_armor = right_leg.addOrReplaceChild(
            "right_leg_armor", CubeListBuilder.create()
                                              .texOffs(62, 63)
                                              .addBox(
                                                  -2.5F, -0.5F, -2.5F, 5.0F, 10.0F, 5.0F,
                                                  new CubeDeformation(0.1f)
                                              ), PartPose.ZERO
        );

        var right_boot = right_leg.addOrReplaceChild(
            "right_boot", CubeListBuilder.create()
                                         .texOffs(32, 80)

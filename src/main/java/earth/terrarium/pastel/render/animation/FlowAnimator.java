...
public class FlowAnimator {
    ...
    public static final class Builder<T> {
         ...
         * <p>
         * <b>Exert care when inputting the handle reference. This string will be used to populate a matching field
         * with a {@link FlowData} object
         * upon animator instantiation.</b> The field in question must be of a FlowData with matching type, and its
         * name must be the same as the reference prepended with an underscore.
         *

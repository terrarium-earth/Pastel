...
public record DynamicParticleEffect(
    ...
    public static final MapCodec<DynamicParticleEffect> CODEC = RecordCodecBuilder
        .mapCodec(
            i -> i
                .group(
                    ...
                    Codec.BOOL
                        .fieldOf("glow_in_the_dark")
                        .forGetter(c -> c.glowing),
                    Codec.BOOL
                        .optionalFieldOf("always_show", false)
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, DynamicParticleEffect> STREAM_CODEC = PacketCodecHelper
        .tuple(

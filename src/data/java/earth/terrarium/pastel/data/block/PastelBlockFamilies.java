...
public class PastelBlockFamilies {
    public static final Supplier<BlockFamily> BASAL_MARBLE = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> BASAL_MARBLE_BRICKS = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> BASAL_MARBLE_TILES = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> POLISHED_BASAL_MARBLE = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> COBBLED_BLACKSLAG = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> BLACKSLAG = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> POLISHED_BLACKSLAG = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> BLACKSLAG_BRICKS = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> BLACKSLAG_TILES = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> POLISHED_BASALT = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> SMOOTH_BASALT = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> BASALT_BRICKS = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> BASALT_TILES = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> PLANED_BASALT = Suppliers
        .memoize(
    ...
    public static final Supplier<BalciteMegaFamily> BASALT_ALL = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> POLISHED_CALCITE = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> CALCITE = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> CALCITE_BRICKS = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> CALCITE_TILES = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> PLANED_CALCITE = Suppliers
        .memoize(
    ...
    public static final Supplier<BalciteMegaFamily> CALCITE_ALL = Suppliers
        .memoize(
            () -> new BalciteMegaFamily(
    ...
    public static final Supplier<BlockFamily> POLISHED_SHALE_CLAY = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> WEATHERED_POLISHED_SHALE_CLAY = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> EXPOSED_POLISHED_SHALE_CLAY = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> SHALE_CLAY_BRICKS = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> WEATHERED_SHALE_CLAY_BRICKS = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> EXPOSED_SHALE_CLAY_BRICKS = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> SHALE_CLAY_TILES = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> WEATHERED_SHALE_CLAY_TILES = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> EXPOSED_SHALE_CLAY_TILES = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> POLISHED_BONE_ASH = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> BONE_ASH_BRICKS = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> BONE_ASH_TILES = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> PYRITE = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> PYRITE_TILES = Suppliers
        .memoize(
    ...
    public static final Supplier<BlockFamily> WEEPING_GALA_PLANKS = Suppliers
        .memoize(
    ...
    public static final Supplier<WoodFamily> WEEPING_GALA = Suppliers
        .memoize(
            () -> new WoodFamily(
    ...
    public static final Supplier<PastelInkColorCollection<BlockFamily>> COLORED_PLANKS = Suppliers
        .memoize(
            () -> PastelInkColorCollection
                .unbox(
                    PastelInkColorCollection.Instance.INSTANCE
                        .apply7(
    ...
    public static final Supplier<PastelInkColorCollection<WoodFamily>> COLORED_WOODS = Suppliers
        .memoize(
            () -> PastelInkColorCollection
                .unbox(
                    PastelInkColorCollection.Instance.INSTANCE
    ...
    public static final Supplier<BlockFamily> CHESTNUT_PLANKS = Suppliers
        .memoize(
    ...
    public static final Supplier<WoodFamily> CHESTNUT_NOXWOOD = Suppliers
        .memoize(
            () -> new WoodFamily(
                CHESTNUT_PLANKS.get(),
    ...
    public static final Supplier<BlockFamily> EBONY_PLANKS = Suppliers
        .memoize(
    ...
    public static final Supplier<WoodFamily> EBONY_NOXWOOD = Suppliers
        .memoize(
            () -> new WoodFamily(
                EBONY_PLANKS.get(),
    ...
    public static final Supplier<BlockFamily> IVORY_PLANKS = Suppliers
        .memoize(
    ...
    public static final Supplier<WoodFamily> IVORY_NOXWOOD = Suppliers
        .memoize(
            () -> new WoodFamily(
                IVORY_PLANKS.get(),
    ...
    public static final Supplier<BlockFamily> SLATE_PLANKS = Suppliers
        .memoize(
    ...
    public static final Supplier<WoodFamily> SLATE_NOXWOOD = Suppliers
        .memoize(
            () -> new WoodFamily(
                SLATE_PLANKS.get(),

...
public class PastelBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider lookupProvider) {
        ...
        tag(PastelBlockTags.C_INFESTED_BLOCKS)
        ...
        tag(PastelBlockTags.FLOWING_STAFF_MOVE_BLACKLIST)
            .addTag(PastelBlockTags.UNBREAKABLE)
            .addTag(BlockTags.BEDS);

        tag(PastelBlockTags.WARD_DISRUPTABLE).add(PastelBlocks.AZURE_CRYSTAL.get());
        tag(PastelBlockTags.CRYSTAL_SPIKE_BASES)
        ...
        tag(PastelBlockTags.CRACKED_BLOCKS)
            .add(
        ...
        tag(PastelBlockTags.REALLY_FALLING_BLOCK_BLACKLISTED)
            .addOptionalTag(
                ResourceLocation.fromNamespaceAndPath("c", "relocation_not_supported")
            );
        tag(PastelBlockTags.FALLING_BLOCK_BLACKLISTED)
            .addTag(PastelBlockTags.REALLY_FALLING_BLOCK_BLACKLISTED)
            .add(
                Blocks.SPAWNER,
        ...
        tag(PastelBlockTags.VIRIDIAN_CRYSTAL_PURITY_SOURCES)
            .add(
        ...
        tag(PastelBlockTags.MUTANDIS_BLACKLIST)
            .add(

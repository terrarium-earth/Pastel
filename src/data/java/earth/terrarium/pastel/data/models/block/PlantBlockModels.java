...
public class PlantBlockModels {
    public static void generateBlockModels(BlockModelGenerators generators) {
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.GLISTERING_MELON_STEM.get())
                    .with(
                        PropertyDispatch
                            .property(
                            ...
                            .generate(
                                age -> PastelModelHelper
                                    .createModelVariant(
                                        ModelTemplates.STEMS[age]
                                            .create(
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.ALOE.get())
                    .with(
                        PropertyDispatch
                            .property(
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.SAWBLADE_HOLLY_BUSH.get())
                    .with(
                        PropertyDispatch
                            .property(
                                BlockStateProperties.AGE_7
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.DOOMBLOOM.get())
                    .with(
                        PropertyDispatch
                            .property(
                                BlockStateProperties.AGE_4
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.SNAPPING_IVY.get())
                    .with(
                        PastelModelHelper
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.ABYSSAL_VINES.get())
                    .with(
                        PropertyDispatch
                            .properties(
                            ...
                            .generate((stage, berries) -> {
                                String suffix = (stage == TriStateVineBlock.LifeStage.STALK
                                    ? ""
                                    : "_tip") + (berries
                                        ? "_fruiting"
                                        : "");
                                if (stage == TriStateVineBlock.LifeStage.MATURE)
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.NIGHTDEW.get())
                    .with(
                        PropertyDispatch
                            .property(
                                TriStateVineBlock.LIFE_STAGE
        ...
        variants
            .add(
                PastelModelHelper
                    .createModelVariant(PastelBlocks.MOSS_BALL.get(), "")
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.JADE_VINE_ROOTS.get())
                    .with(
                        PastelModelHelper
                            .createBooleanModelMap(
                                JadeVineBulbBlock.DEAD,
                                PastelModels.JADE_VINE_ROOTS
                                    .createWithSuffix(
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.JADE_VINE_BULB.get())
                    .with(
                        PastelModelHelper
                            .createBooleanModelMap(
                                JadeVineBulbBlock.DEAD,
                                PastelModels.JADE_VINE_BULB
                                    .createWithSuffix(
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.JADE_VINES.get())
                    .with(
                        PropertyDispatch
                            .properties(
                                BlockStateProperties.AGE_7,
                            ...
                            .generate((age, part) -> {
                                ModelTemplate model = PastelModels
                                    .jadeVines(
                                        part
                                    );
                                String suffix = "_" + part.getSerializedName() + (age == 0
                                    ? "_dead"
                                    : age <= 2
                                        ? "_leaves"
                                        : age <= 6
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.NEPHRITE_BLOSSOM_LEAVES.get())
                    .with(
                        PropertyDispatch
                            .property(BlockStateProperties.AGE_2)
                            .generate(age -> {
                                String suffix = age == 0
                                    ? ""
                                    : age == 1
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.AMARANTH.get())
                    .with(
                        PropertyDispatch
                            .properties(
                                BlockStateProperties.AGE_7,
        ...
        PastelModelHelper.BLOCK
            .singletonWithSoup(generators, PastelBlocks.CLOVER, ModelLocationUtils::getModelLocation);
        PastelModelHelper.BLOCK
            .singletonWithSoup(
                generators,
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.BLOOD_ORCHID.get())
                    .with(
                        PropertyDispatch
                            .property(BloodOrchidBlock.AGE)
                            .generate(
                                stage -> PastelModelHelper
                                    .createModelVariant(
                                        PastelTexturedModels
                                            .cross(
                                                b -> b,
        ...
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.POTTED_BLOOD_ORCHID,
    ...
    public static void generateJadeiteLotusStemModel(BlockModelGenerators generators) {
        ResourceLocation bottom = PastelTexturedModels
            .cross(b -> b, "_bottom")
            .createWithSuffix(
        ...
        ResourceLocation top = PastelTexturedModels
            .cross(b -> b, "_top")
            .createWithSuffix(
                PastelBlocks.JADEITE_LOTUS_STEM.get(),
                "_top",
        ...
        generators.blockStateOutput
            .accept(
                MultiPartGenerator
                    .multiPart(PastelBlocks.JADEITE_LOTUS_STEM.get())
                    .with(
                        Condition
                            .condition()
                            .term(
    ...
    public static void generateNephriteBlossomStemModel(BlockModelGenerators generators) {
        ...
        ResourceLocation fronds = ModelLocationUtils
            .getModelLocation(
                PastelBlocks.NEPHRITE_BLOSSOM_STEM.get(),
                "_base"
            );
        generators.blockStateOutput
            .accept(
                MultiPartGenerator
                    .multiPart(PastelBlocks.NEPHRITE_BLOSSOM_STEM.get())
                    .with(
                        Condition
                            .condition()
                            .term(
    ...
    public static void generateMermaidBrushModel(BlockModelGenerators generators) {
        ResourceLocation none = PastelTexturedModels
            .cross(b -> b, "_none")
            .createWithSuffix(
        ...
        ResourceLocation some = PastelTexturedModels
            .cross(b -> b, "_some")
            .createWithSuffix(
                PastelBlocks.MERMAIDS_BRUSH.get(),
                "_some",
        ...
        ResourceLocation full = PastelTexturedModels
            .cross(b -> b, "_full")
            .createWithSuffix(
                PastelBlocks.MERMAIDS_BRUSH.get(),
                "_full",
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.MERMAIDS_BRUSH.get())
                    .with(
                        PropertyDispatch
                            .property(
                                BlockStateProperties.AGE_7
                ...
                MultiVariantGenerator
                    ...
                    .with(
                        PropertyDispatch
                            ...
                            .generate((half, dead) -> {
                                String suffix = (half == DoubleBlockHalf.UPPER
                                    ? "_top"
                                    : "_bottom") + (dead
                                        ? "_dead"
                                        : "");

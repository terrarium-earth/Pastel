...
public class EntityFishingDataLoader extends SimpleJsonResourceReloadListener {
    ...
    public record EntityFishingEntity(Holder<EntityType<?>> entityType, CompoundTag nbt) {
        ...
        public static final MapCodec<EntityFishingEntity> CODEC = RecordCodecBuilder
            .mapCodec(
                i -> i
                    .group(
                        BuiltInRegistries.ENTITY_TYPE
                            .holderByNameCodec()
                            .fieldOf("id")
                            .forGetter(EntityFishingEntity::entityType),
                        CompoundTag.CODEC
                            .optionalFieldOf("nbt", new CompoundTag())
                            .forGetter(EntityFishingEntity::nbt)
                    )
                    .apply(
                        i,
                        EntityFishingEntity::new
                    )
            );

        public static final Codec<WeightedEntry.Wrapper<EntityFishingEntity>> WEIGHTED_CODEC = RecordCodecBuilder
            .create(
                i -> i
                    .group(
                        CODEC.forGetter(WeightedEntry.Wrapper::data),
                        Weight.CODEC
                            .optionalFieldOf("id", Weight.of(1))
                            .forGetter(WeightedEntry.Wrapper::weight)
                    )
    ...
    public record EntityFishingEntry(
        List<WorldConditionsPredicate> predicates,
        float entityChance,
        WeightedRandomList<WeightedEntry.Wrapper<EntityFishingEntity>> weightedEntities
    ) {
                ...
                i -> i
                    .group(
                        CodecHelper
                            ...
                            .fieldOf("location")
                            .forGetter(EntityFishingEntry::predicates),
                        Codec.FLOAT
                            .fieldOf("chance")
                            .forGetter(EntityFishingEntry::entityChance),
                        EntityFishingEntity.WEIGHTED_CODEC
                            .listOf()
                            .xmap(WeightedRandomList::create, WeightedRandomList::unwrap)
                            .fieldOf("entities")
                            .forGetter(EntityFishingEntry::weightedEntities)
                    )
                    .apply(
                        i,
                        EntityFishingEntry::new
                    )
            );
    ...
    protected void apply(
        ...
        prepared
            .forEach(
                (identifier, jsonElement) -> CodecHelper
                    .fromJson(EntityFishingEntry.CODEC, jsonElement.getAsJsonObject())
    ...
    public static Optional<EntityFishingEntity> tryCatchEntity(ServerLevel world, BlockPos pos, int bigCatchLevel) {
        for (
            EntityFishingEntry entry : ENTITY_FISHING_ENTRIES
        ) {
            if (entry.predicates
                .stream()

...
public class PastelSkullModels {
    public static void registerModels(EntityRenderersEvent.CreateSkullModels event) {
        ...
        event
            .registerSkullModel(
                PastelSkullType.ALLAY,
                new AllayHeadModel(modelSet.bakeLayer(PastelModelLayers.ALLAY_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.BLAZE,
                new BlazeHeadModel(modelSet.bakeLayer(PastelModelLayers.BLAZE_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.CAMEL,
                new CamelHeadModel(modelSet.bakeLayer(PastelModelLayers.CAMEL_HEAD))
            );
        event.registerSkullModel(PastelSkullType.CAT, new CatHeadModel(modelSet.bakeLayer(PastelModelLayers.CAT_HEAD)));
        event
            .registerSkullModel(
                PastelSkullType.CAVE_SPIDER,
                new SpiderHeadModel(modelSet.bakeLayer(PastelModelLayers.CAVE_SPIDER_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.CHICKEN,
                new ChickenHeadModel(modelSet.bakeLayer(PastelModelLayers.CHICKEN_HEAD))
            );
        event.registerSkullModel(PastelSkullType.COW, new CowHeadModel(modelSet.bakeLayer(PastelModelLayers.COW_HEAD)));
        event
            .registerSkullModel(
                PastelSkullType.DOLPHIN,
                new DolphinHeadModel(modelSet.bakeLayer(PastelModelLayers.DOLPHIN_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.DONKEY,
                new HorseHeadModel(modelSet.bakeLayer(PastelModelLayers.DONKEY_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.DROWNED,
                new DrownedHeadModel(modelSet.bakeLayer(PastelModelLayers.DROWNED_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.ENDERMAN,
                new EndermanHeadModel(modelSet.bakeLayer(PastelModelLayers.ENDERMAN_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.ENDERMITE,
                new EndermiteHeadModel(modelSet.bakeLayer(PastelModelLayers.ENDERMITE_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.EVOKER,
                new IllagerHeadModel(modelSet.bakeLayer(PastelModelLayers.EVOKER_HEAD))
            );
        event.registerSkullModel(PastelSkullType.FOX, new FoxHeadModel(modelSet.bakeLayer(PastelModelLayers.FOX_HEAD)));
        event
            .registerSkullModel(
                PastelSkullType.FOX_ARCTIC,
                new FoxHeadModel(modelSet.bakeLayer(PastelModelLayers.FOX_ARCTIC_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.FROG_COLD,
                new FrogHeadModel(modelSet.bakeLayer(PastelModelLayers.FROG_COLD_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.FROG_WARM,
                new FrogHeadModel(modelSet.bakeLayer(PastelModelLayers.FROG_WARM_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.GHAST,
                new GhastHeadModel(modelSet.bakeLayer(PastelModelLayers.GHAST_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.GLOW_SQUID,
                new SquidHeadModel(modelSet.bakeLayer(PastelModelLayers.GLOW_SQUID_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.GOAT,
                new GoatHeadModel(modelSet.bakeLayer(PastelModelLayers.GOAT_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.GUARDIAN,
                new GuardianHeadModel(modelSet.bakeLayer(PastelModelLayers.GUARDIAN_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.HOGLIN,
                new HoglinHeadModel(modelSet.bakeLayer(PastelModelLayers.HOGLIN_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.HORSE,
                new HorseHeadModel(modelSet.bakeLayer(PastelModelLayers.HORSE_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.HUSK,
                new ZombieHeadModel(modelSet.bakeLayer(PastelModelLayers.HUSK_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.ILLUSIONER,
                new IllagerHeadModel(modelSet.bakeLayer(PastelModelLayers.ILLUSIONER_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.IRON_GOLEM,
                new IronGolemHeadModel(modelSet.bakeLayer(PastelModelLayers.IRON_GOLEM_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.LLAMA,
                new LlamaHeadModel(modelSet.bakeLayer(PastelModelLayers.LLAMA_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.MAGMA_CUBE,
                new SlimeHeadModel(modelSet.bakeLayer(PastelModelLayers.MAGMA_CUBE_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.MOOSHROOM_RED,
                new CowHeadModel(modelSet.bakeLayer(PastelModelLayers.MOOSHROOM_RED_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.MULE,
                new HorseHeadModel(modelSet.bakeLayer(PastelModelLayers.MULE_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.OCELOT,
                new CatHeadModel(modelSet.bakeLayer(PastelModelLayers.OCELOT_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.PARROT_BLUE,
                new ParrotHeadModel(modelSet.bakeLayer(PastelModelLayers.PARROT_BLUE_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.PARROT_GREEN,
                new ParrotHeadModel(modelSet.bakeLayer(PastelModelLayers.PARROT_GREEN_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.PHANTOM,
                new PhantomHeadModel(modelSet.bakeLayer(PastelModelLayers.PHANTOM_HEAD))
            );
        event.registerSkullModel(PastelSkullType.PIG, new PigHeadModel(modelSet.bakeLayer(PastelModelLayers.PIG_HEAD)));
        event
            .registerSkullModel(
                PastelSkullType.PILLAGER,
                new IllagerHeadModel(modelSet.bakeLayer(PastelModelLayers.PILLAGER_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.POLAR_BEAR,
                new BearHeadModel(modelSet.bakeLayer(PastelModelLayers.POLAR_BEAR_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.RAVAGER,
                new RavagerHeadModel(modelSet.bakeLayer(PastelModelLayers.RAVAGER_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.SHEEP,
                new SheepHeadModel(modelSet.bakeLayer(PastelModelLayers.SHEEP_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.SHULKER,
                new ShulkerHeadModel(modelSet.bakeLayer(PastelModelLayers.SHULKER_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.SHULKER_RED,
                new ShulkerHeadModel(modelSet.bakeLayer(PastelModelLayers.SHULKER_RED_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.SILVERFISH,
                new SilverfishHeadModel(modelSet.bakeLayer(PastelModelLayers.SILVERFISH_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.SLIME,
                new SlimeHeadModel(modelSet.bakeLayer(PastelModelLayers.SLIME_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.SNIFFER,
                new SnifferHeadModel(modelSet.bakeLayer(PastelModelLayers.SNIFFER_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.SNOW_GOLEM,
                new ZombieHeadModel(modelSet.bakeLayer(PastelModelLayers.SNOW_GOLEM_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.SPIDER,
                new SpiderHeadModel(modelSet.bakeLayer(PastelModelLayers.SPIDER_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.SQUID,
                new SquidHeadModel(modelSet.bakeLayer(PastelModelLayers.SQUID_HEAD))
            );

        event
            .registerSkullModel(
                PastelSkullType.STRAY,
                new PastelSkullModel(modelSet.bakeLayer(PastelModelLayers.STRAY_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.STRIDER,
                new StriderHeadModel(modelSet.bakeLayer(PastelModelLayers.STRIDER_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.TADPOLE,
                new TadpoleHeadModel(modelSet.bakeLayer(PastelModelLayers.TADPOLE_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.TURTLE,
                new TurtleHeadModel(modelSet.bakeLayer(PastelModelLayers.TURTLE_HEAD))
            );
        event.registerSkullModel(PastelSkullType.VEX, new VexHeadModel(modelSet.bakeLayer(PastelModelLayers.VEX_HEAD)));
        event
            .registerSkullModel(
                PastelSkullType.VILLAGER,
                new VillagerHeadModel(modelSet.bakeLayer(PastelModelLayers.VILLAGER_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.VINDICATOR,
                new IllagerHeadModel(modelSet.bakeLayer(PastelModelLayers.VINDICATOR_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.WARDEN,
                new WardenHeadModel(modelSet.bakeLayer(PastelModelLayers.WARDEN_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.WITCH,
                new WitchHeadModel(modelSet.bakeLayer(PastelModelLayers.WITCH_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.WITHER,
                new ZombieHeadModel(modelSet.bakeLayer(PastelModelLayers.WITHER_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.WOLF,
                new WolfHeadModel(modelSet.bakeLayer(PastelModelLayers.WOLF_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.ZOGLIN,
                new HoglinHeadModel(modelSet.bakeLayer(PastelModelLayers.ZOGLIN_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.ZOMBIE_HORSE,
                new HorseHeadModel(modelSet.bakeLayer(PastelModelLayers.ZOMBIE_HORSE_HEAD))
            );
        event
            .registerSkullModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.PIGLIN_BRUTE,
                new PiglinHeadModel(modelSet.bakeLayer(PastelModelLayers.PIGLIN_BRUTE_HEAD))
            );

        event
            .registerSkullModel(
                PastelSkullType.ARMADILLO,
                new ArmadilloHeadModel(modelSet.bakeLayer(PastelModelLayers.ARMADILLO_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.BREEZE,
                new BreezeHeadModel(modelSet.bakeLayer(PastelModelLayers.BREEZE_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.BOGGED,
                new BoggedHeadModel(modelSet.bakeLayer(PastelModelLayers.BOGGED_HEAD))
            );
        ...
        event
            .registerSkullModel(
                ...
                new EggLayingWoolyPigHeadModel(
                    modelSet.bakeLayer(PastelModelLayers.EGG_LAYING_WOOLY_PIG_HEAD)
                )
            );
        event
            .registerSkullModel(
                PastelSkullType.ERASER,
                new SpiderHeadModel(modelSet.bakeLayer(PastelModelLayers.ERASER_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.KINDLING,
                new KindlingHeadModel(modelSet.bakeLayer(PastelModelLayers.KINDLING_HEAD))
            );
        event
            .registerSkullModel(
                PastelSkullType.LIZARD_BLACK,
                new LizardHeadModel(
        ...
        event
            .registerSkullModel(
                PastelSkullType.LIZARD_LIGHT_BLUE,
                new LizardHeadModel(
                    modelSet.bakeLayer(PastelModelLayers.LIZARD_HEAD),
                    modelSet
                        .bakeLayer(
        ...
        event
            .registerSkullModel(
                PastelSkullType.LIZARD_LIGHT_GRAY,
                new LizardHeadModel(
                    modelSet.bakeLayer(PastelModelLayers.LIZARD_HEAD),
                    modelSet
                        .bakeLayer(
        ...
        event
            .registerSkullModel(
                PastelSkullType.LIZARD_MAGENTA,
                new LizardHeadModel(
                    modelSet.bakeLayer(PastelModelLayers.LIZARD_HEAD),
                    modelSet
                        .bakeLayer(
        ...
        event
            .registerSkullModel(
                PastelSkullType.PRESERVATION_TURRET,
                new PreservationTurretHeadModel(
    ...
    public static void registerTextures(
        ...
        textures
            .put(
                PastelSkullType.AXOLOTL_LEUCISTIC,
                ResourceLocation.parse("textures/entity/axolotl/axolotl_lucy.png")
            );
        ...
        textures
            .put(
                PastelSkullType.MOOSHROOM_BROWN,
                ResourceLocation.parse("textures/entity/cow/brown_mooshroom.png")
            );
        ...
        textures
            .put(
                PastelSkullType.PANDA,
                ResourceLocation.parse("textures/entity/panda/panda.png")
            ); // pandas have variants
        ...
        textures
            .put(
                PastelSkullType.PUFFERFISH,
                ResourceLocation.parse("textures/entity/fish/pufferfish.png")
            ); // other fish?
        textures
            .put(
                PastelSkullType.RABBIT,
                ResourceLocation.parse("textures/entity/rabbit/brown.png")
            ); // rabbits have variant
        ...
        textures
            .put(
                PastelSkullType.SHULKER_BLACK,
                ResourceLocation.parse("textures/entity/shulker/shulker_black.png")
            );
        textures.put(PastelSkullType.SHULKER_BLUE, ResourceLocation.parse("textures/entity/shulker/shulker_blue.png"));
        textures
            .put(
                PastelSkullType.SHULKER_BROWN,
                ResourceLocation.parse("textures/entity/shulker/shulker_brown.png")
            );
        ...
        textures
            .put(
                PastelSkullType.SHULKER_GREEN,
                ResourceLocation.parse("textures/entity/shulker/shulker_green.png")
            );
        textures
            .put(
                PastelSkullType.SHULKER_LIGHT_BLUE,
        ...
        textures
            .put(
                PastelSkullType.SHULKER_MAGENTA,
                ResourceLocation.parse("textures/entity/shulker/shulker_magenta.png")
            );
        textures
            .put(
                PastelSkullType.SHULKER_ORANGE,
                ResourceLocation.parse("textures/entity/shulker/shulker_orange.png")
            );
        textures.put(PastelSkullType.SHULKER_PINK, ResourceLocation.parse("textures/entity/shulker/shulker_pink.png"));
        textures
            .put(
                PastelSkullType.SHULKER_PURPLE,
                ResourceLocation.parse("textures/entity/shulker/shulker_purple.png")
            );
        textures.put(PastelSkullType.SHULKER_RED, ResourceLocation.parse("textures/entity/shulker/shulker_red.png"));
        textures
            .put(
                PastelSkullType.SHULKER_WHITE,
                ResourceLocation.parse("textures/entity/shulker/shulker_white.png")
            );
        textures
            .put(
                PastelSkullType.SHULKER_YELLOW,
                ResourceLocation.parse("textures/entity/shulker/shulker_yellow.png")
            );
        textures.put(PastelSkullType.SILVERFISH, ResourceLocation.parse("textures/entity/silverfish.png"));
        textures
            .put(
                PastelSkullType.SKELETON_HORSE,
                ResourceLocation.parse("textures/entity/horse/horse_skeleton.png")
            );
        ...
        textures
            .put(
                PastelSkullType.TROPICAL_FISH,
                ResourceLocation.parse("textures/entity/fish/tropical_a.png")
            ); // oof
        ...
        textures
            .put(
                PastelSkullType.ZOMBIFIED_PIGLIN,
                ResourceLocation.parse("textures/entity/piglin/zombified_piglin.png")
            );

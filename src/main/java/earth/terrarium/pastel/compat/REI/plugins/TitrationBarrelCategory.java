...
public class TitrationBarrelCategory extends GatedDisplayCategory<TitrationBarrelDisplay> {
    ...
    public void setupWidgets(
        ...
        Rectangle bounds,
        List<Widget> widgets,
        @NotNull TitrationBarrelDisplay display
    ) {
        ...
        for (
            ...
            widgets
                .add(
                    Widgets
                        .createSlot(new Point(startX + xOffset, startY + yOffset))
                        .markInput()
        ...
        if (display.tappingIngredient.isEmpty()) {
            widgets
                .add(
                    Widgets
                        .createArrow(new Point(startPoint.x + 60, startPoint.y + 11))
            ...
            widgets
                .add(
                    Widgets
                        .createArrow(new Point(startPoint.x + 60, startPoint.y + 3))
                        .animationDurationTicks(display.minFermentationTimeHours * 20)
                );
            widgets
                .add(
                    Widgets
                        .createSlot(new Point(startPoint.x + 64, startPoint.y + 21))
                        .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 95, startPoint.y + 11))
                    .markOutput()
                    .disableBackground()
                    .entries(
                        display
        ...
        // duration text
        MutableComponent text = TitrationBarrelRecipe
            .getDurationText(
                display.minFermentationTimeHours,
                display.fermentationData
            );
        widgets
            .add(
                Widgets
                    .createLabel(new Point(startPoint.x - 10, startPoint.y + 42), text)
                    .leftAligned()
                    .color(0x3f3f3f)
                    .noShadow()
            );

...
public final class ImbriferOreVeinSampler {
    ...
    protected enum VeinType {
        ...
        GOLD(
            ...
            PastelBlocks.BLACKSLAG_GOLD_ORE
                .get()
                .defaultBlockState(),
        ...
        DIAMOND(
            ...
            PastelBlocks.BLACKSLAG_DIAMOND_ORE
                .get()
                .defaultBlockState(),
        ...
        REDSTONE(
            ...
            PastelBlocks.BLACKSLAG_REDSTONE_ORE
                .get()
                .defaultBlockState(),
        ...
        LAPIS(
            ...
            PastelBlocks.BLACKSLAG_LAPIS_ORE
                .get()
                .defaultBlockState(),
        ...
        EMERALD(
            ...
            PastelBlocks.BLACKSLAG_EMERALD_ORE
                .get()
                .defaultBlockState(),
        ...
        public static VeinType getVeinTypeForSample(double veinTypeSample) {
            return veinTypeSample > 0.3
                ? VeinType.REDSTONE
                : veinTypeSample > 0.15
                    ? VeinType.EMERALD
                    : veinTypeSample > 0.0D
                        ? ImbriferOreVeinSampler.VeinType.GOLD
                        : veinTypeSample < -0.45
                            ? ImbriferOreVeinSampler.VeinType.DIAMOND
                            : veinTypeSample < -0.3
                                ? ImbriferOreVeinSampler.VeinType.LAPIS

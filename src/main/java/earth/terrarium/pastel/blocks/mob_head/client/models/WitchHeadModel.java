        ...
        modelPartData
            .addOrReplaceChild(
                ...
                CubeListBuilder
                    ...
                    .texOffs(0, 64)
                    .addBox(-5.0F, -11.0F, -5.0F, 10.0F, 1.0F, 10.0F)
                    .texOffs(0, 76)
                    .addBox(-3.5F, -15.0F, -3.5F, 7.0F, 4.0F, 7.0F)
                    .texOffs(0, 87)
                    .addBox(-2.0F, -19.0F, -2.0F, 4.0F, 4.0F, 4.0F)
                    .texOffs(0, 95)
                    .addBox(0.0F, -20.0F, -1.0F, 1.0F, 1.0F, 1.0F),
                PartPose.ZERO
            );

...
public class TropicalFishHeadModel extends PastelSkullModel {
    ...
    private static final ResourceLocation PATTERN_TEXTURE = ResourceLocation
        .parse(
        ...
        head
            .addOrReplaceChild(
                ...
                CubeListBuilder
                    .create()
                    .texOffs(22, -6)
                    .addBox(0.0F, -3.0F, 3.0F, 0.0F, 3.0F, 6.0F, dilation),
                PartPose.ZERO
            );
        head
            .addOrReplaceChild(
        ...
        head
            .addOrReplaceChild(
                ...
                CubeListBuilder
                    .create()
                    .texOffs(10, -5)
                    .addBox(0.0F, -6.0F, -3.0F, 0.0F, 3.0F, 6.0F, dilation),
                PartPose.ZERO
            );

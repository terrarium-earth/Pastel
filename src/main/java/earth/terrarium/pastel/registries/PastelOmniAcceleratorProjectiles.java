...
public class PastelOmniAcceleratorProjectiles {
    ...
    public static void register() {
        OmniAcceleratorProjectile.register(
            new OmniAcceleratorProjectile() {
                @Override
        ...
        OmniAcceleratorProjectile.register(
            new OmniAcceleratorProjectile() {
                ...
                public Entity createProjectile(ItemStack stack, LivingEntity shooter, Level world, ItemStack shotFrom) {
                    ...
                    OmniAcceleratorProjectile.setVelocity(
                        tntEntity, shooter, shooter.getXRot(), shooter.getYRot(), 0.0F, 2.5F, 1.0F);
		...
		OmniAcceleratorProjectile.register(new OmniAcceleratorProjectile() {
            ...
            public Entity createProjectile(ItemStack stack, LivingEntity shooter, Level world, ItemStack shotFrom) {
                ...
                blockFlooderProjectile.shootFromRotation(shooter, shooter.getXRot(), shooter.getYRot(), 0.0F, 2.5F, 1
                .0F);
        ...
        OmniAcceleratorProjectile.register(
            new OmniAcceleratorProjectile() {
                @Override
                public Entity createProjectile(ItemStack stack, LivingEntity shooter, Level world, ItemStack shotFrom) {
                    ShootingStarEntity shootingStarEntity = ((ShootingStarItem) stack.getItem()).getEntityForStack(
                        world, shooter.getEyePosition(), stack);
                    OmniAcceleratorProjectile.setVelocity(
                        shootingStarEntity, shooter, shooter.getXRot(), shooter.getYRot(), 0, 2.5F, 0F);
                ...
                public Entity createProjectile(ItemStack stack, LivingEntity shooter, Level world, ItemStack shotFrom) {
                    ...
                    if (stack.getItem() instanceof BlockItem blockItem) {
                        FallingBlockEntity fallingBlockEntity = new FallingBlockEntity(
                            world, pos.x() + 0.5, pos.y(), pos.z() + 0.5, blockItem.getBlock()
                                                                                   .defaultBlockState()
                        );
                        OmniAcceleratorProjectile.setVelocity(
                            fallingBlockEntity, shooter, shooter.getXRot(), shooter.getYRot(), 0, 2.5F, 0F);
            ...
            new OmniAcceleratorProjectile() {
                ...
                public Entity createProjectile(ItemStack stack, LivingEntity shooter, Level world, ItemStack shotFrom) {
                    if (shooter instanceof Player player) {
                        WindCharge windChargeEntity = new WindCharge(
                            player, world, shooter.position()
                                                  .x(), shooter.getEyePosition()
                                                               .y(), shooter.position()
                                                                            .z()
                        );

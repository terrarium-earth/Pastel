...
public record CrystallarieumCatalyst(
    Ingredient ingredient, float growthAccelerationMod, float inkConsumptionMod, float consumeChancePerSecond
) {
    ...
    public static final Codec<CrystallarieumCatalyst> CODEC = RecordCodecBuilder.create(i -> i.group(
                                                                                                  ...
                                                                                                  Codec.FLOAT.fieldOf("growth_acceleration_mod")
                                                                                                             .forGetter(CrystallarieumCatalyst::growthAccelerationMod),
                                                                                                  Codec.FLOAT.fieldOf("ink_consumption_mod")
                                                                                                             .forGetter(CrystallarieumCatalyst::inkConsumptionMod),
                                                                                                  Codec.FLOAT.fieldOf("consume_chance_per_second")
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CrystallarieumCatalyst> STREAM_CODEC

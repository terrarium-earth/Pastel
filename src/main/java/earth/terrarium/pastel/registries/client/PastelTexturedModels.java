...
public class PastelTexturedModels {
    ...
    public static final TexturedModel.Provider BASE_TRANS_LIGHT_CORE = TexturedModel
        .createDefault(
            b -> new TextureMapping()
                .put(CASE, getBlockTexture(b))
                ...
                .put(ENDS, getBlockTexture(b, "_ends")),
            PastelModels.BASE_TRANS_LIGHT_CORE
        );

    public static final TexturedModel.Provider BOWL = TexturedModel
        .createDefault(
            b -> new TextureMapping()
                .put(
                    SIDE,
    ...
    public static final TexturedModel.Provider CHIME = TexturedModel
        .createDefault(
            b -> new TextureMapping()
                .put(BASE, PastelTextures.BALCITE_CHIME_BASE)
                .put(GEMSTONE, getBlockTexture(b)),
            PastelModels.CHIME
        );

    public static final TexturedModel.Provider CUBE_COLUMN_MIRRORED = TexturedModel
        .createDefault(
            TextureMapping::logColumn,
            ModelTemplates.CUBE_COLUMN_MIRRORED
        );

    public static final TexturedModel.Provider CUSHION = TexturedModel
        .createDefault(
            b -> PastelTextureMaps.sideTopBottom(b, "_side", b, "_top", b, "_bottom"),
            PastelModels.CUSHION
        );

    public static final TexturedModel.Provider TINTED_CUSHION = TexturedModel
        .createDefault(
            b -> new TextureMapping()
    ...
    public static final TexturedModel.Provider FUSION_SHRINE = TexturedModel
        .createDefault(
            b -> new TextureMapping()
                .put(SHRINE, getBlockTexture(b))
                .put(PARTICLE, getBlockTexture(b, "_breaking")),
            PastelModels.FUSION_SHRINE
        );

    public static final TexturedModel.Provider ROUNDEL = TexturedModel
        .createDefault(
            b -> new TextureMapping().put(ALL, getBlockTexture(b)),
            PastelModels.ROUNDEL
        );

    public static final TexturedModel.Provider SHOOTING_STAR = TexturedModel
        .createDefault(
            b -> new TextureMapping()
                .put(CORE, getBlockTexture(b))
                .put(SIDE, getBlockTexture(b, "_side")),
    ...
    public static TexturedModel.Provider baseTransLantern(boolean diagonal, boolean tall) {
        return TexturedModel
            .createDefault(
                b -> new TextureMapping()
                    .put(GLASS, getBlockTexture(b, "_glass_on"))
    ...
    public static TexturedModel.Provider complexOrientable(
        UnaryOperator<Block> sideBlock,
        String sideSuffix,
        UnaryOperator<Block> topBlock,
        String topSuffix,
        UnaryOperator<Block> bottomBlock,
        String bottomSuffix,
        UnaryOperator<Block> frontBlock,
        String frontSuffix,
        UnaryOperator<Block> backBlock,
        String backSuffix,
        UnaryOperator<Block> particleBlock,
        String particleSuffix
    ) {
        return TexturedModel
            .createDefault(
                b -> new TextureMapping()
                    .put(
                        SIDE,
                        getBlockTexture(sideBlock.apply(b), sideSuffix)
                    )
                    .put(
                        TOP,
                        getBlockTexture(topBlock.apply(b), topSuffix)
                    )
                    .put(
                        BOTTOM,
                        getBlockTexture(bottomBlock.apply(b), bottomSuffix)
                    )
                    .put(
                        FRONT,
                        getBlockTexture(frontBlock.apply(b), frontSuffix)
                    )
                    .put(
                        BACK,
                        getBlockTexture(backBlock.apply(b), backSuffix)
                    )
                    .put(
                        PARTICLE,
                        getBlockTexture(particleBlock.apply(b), particleSuffix)
                    ),
    ...
    public static TexturedModel.Provider cross(UnaryOperator<Block> crossBlock, String crossSuffix) {
        return TexturedModel
            .createDefault(
                b -> PastelTextureMaps.cross(crossBlock.apply(b), crossSuffix),
    ...
    public static TexturedModel.Provider cubeAll(UnaryOperator<Block> allBlock, String allSuffix) {
        return TexturedModel
            .createDefault(
                b -> PastelTextureMaps.all(allBlock.apply(b), allSuffix),
    ...
    public static TexturedModel.Provider farmland(
        ...
        return TexturedModel
            .createDefault(
                b -> new TextureMapping()
                    .put(DIRT, getBlockTexture(dirtBlock.apply(b), dirtSuffix))
                    .put(TOP, getBlockTexture(topBlock.apply(b), topSuffix)),
                ModelTemplates.FARMLAND
            );
    }

    public static TexturedModel.Provider flowerPotCross(
        UnaryOperator<Block> plantBlock,
        String plantSuffix,
        boolean tinted
    ) {
        ...
        return TexturedModel
            .createDefault(
                b -> PastelTextureMaps.plant(plantBlock.apply(b), plantSuffix),
                tintType.getCrossPot()
            );
    }
    ...
    public static TexturedModel.Provider overgrown(
        ...
        UnaryOperator<Block> bottomBlock,
        String bottomSuffix,
        UnaryOperator<Block> frondsBlock,
        String frondsSuffix
    ) {
        return TexturedModel
            .createDefault(
    ...
    public static TexturedModel.Provider parented(ResourceLocation parentModelId) {
        return TexturedModel
            .createDefault(
                b -> new TextureMapping(),
                new ModelTemplate(Optional.of(parentModelId), Optional.empty())
            );
    }
    ...
    public static TexturedModel.Provider sugarStick(int age, UnaryOperator<Block> sugarBlock) {
        return TexturedModel
            .createDefault(
                b -> new TextureMapping()
                    .put(KEY0, getBlockTexture(sugarBlock.apply(b)))
                    .put(KEY1, getBlockTexture(Blocks.OAK_PLANKS))
                    .put(PARTICLE, getBlockTexture(sugarBlock.apply(b))),
                PastelModels.sugarStick(age)
            );
    }

    public static TexturedModel.Provider tintableCross(
        UnaryOperator<Block> crossBlock,
        String crossSuffix,
        boolean tinted
    ) {
        BlockModelGenerators.TintState tintType = tinted

...
public record ShootingStarComponent(int remainingHits, boolean hardened) {
    ...
    public static final Codec<ShootingStarComponent> CODEC = RecordCodecBuilder
        .create(
            i -> i
                .group(
                    Codec.INT
    ...
    public static final StreamCodec<ByteBuf, ShootingStarComponent> STREAM_CODEC = StreamCodec
        .composite(
            ByteBufCodecs.INT,
            c -> c.remainingHits,
            ByteBufCodecs.BOOL,

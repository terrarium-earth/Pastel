...
public class ItemProjectileBehaviorRegistry {
    public static final Codec<ProjectileBehaviorType<?>> TYPE_CODEC = ResourceLocation.CODEC.comapFlatMap(
        ItemProjectileBehaviorRegistry::decode, ProjectileBehaviorType::id);
    public static final Codec<ItemProjectileBehavior> CODEC = TYPE_CODEC.dispatch(
        ItemProjectileBehavior::type, ProjectileBehaviorType::codec);
    ...
    private static DataResult<? extends ProjectileBehaviorType<?>> decode(ResourceLocation id) {
        return Optional.ofNullable(BEHAVIOR_TYPES.get(id))

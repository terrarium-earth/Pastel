...
public class SpectrumLoadConditions {
	...
	public record SpectrumTagsPopulatedResourceCondition(ResourceLocation registry, List<ResourceLocation> tags) implements ICondition {
		...
		public MapCodec<? extends ICondition> codec() {
			return SpectrumTagsPopulatedResourceCondition.CODEC;
		}
	...
	public static void register(IEventBus modEventBus) {
		DeferredRegister<MapCodec<? extends ICondition>> register = DeferredRegister.create(NeoForgeRegistries.CONDITION_SERIALIZERS, SpectrumCommon.MOD_ID);

		register.register("tags_populated", () -> SpectrumTagsPopulatedResourceCondition.CODEC);

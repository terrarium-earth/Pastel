...
public class SpiritInstillingCategory extends GatedDisplayCategory<SpiritInstillingDisplay> {
    ...
    public Component getTitle() {
        return PastelBlocks.SPIRIT_INSTILLER
            .get()
            .getName();
    }
    ...
    public void setupWidgets(
        ...
        Rectangle bounds,
        List<Widget> widgets,
        @NotNull SpiritInstillingDisplay display
    ) {
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + startX, startPoint.y + 1))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + startX + 20, startPoint.y + 1))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + startX + 40, startPoint.y + 1))
                    .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x, startPoint.y + 1 + 17))
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 20, startPoint.y + 1 + 17))
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 40, startPoint.y + 1 + 17))
                    .entries(ITEM_BOWL_CALCITE)
                    .disableBackground()
            );
        ...
        widgets
            .add(
                Widgets
                    .createArrow(new Point(startPoint.x + 60, startPoint.y + 1 + 9))
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 95, startPoint.y + 1 + 9))
                    .markOutput()
                    .disableBackground()
                    .entries(
                        display
        ...
        widgets
            .add(
                Widgets
                    .createLabel(new Point(startPoint.x - 10, startPoint.y + 1 + 39), text)
                    .leftAligned()
                    .color(0x3f3f3f)
                    .noShadow()
            );

...
public class PastelWorldInteractionRecipe extends EmiWorldInteractionRecipe {
	...
	public void addWidgets(WidgetHolder widgets) {
		if (!isUnlocked()) {
			widgets.addText(PastelEmiRecipe.HIDDEN_LINE_1, getDisplayWidth() / 2, getDisplayHeight() / 2 - 9, 0x3f3f3f, false).horizontalAlign(TextWidget.Alignment.CENTER);
			widgets.addText(PastelEmiRecipe.HIDDEN_LINE_2, getDisplayWidth() / 2, getDisplayHeight() / 2 + 1, 0x3f3f3f, false).horizontalAlign(TextWidget.Alignment.CENTER);
		} else {
	...
	public static class Builder {
		...
		public PastelWorldInteractionRecipe.Builder leftInput(EmiIngredient stack, Function<SlotWidget, SlotWidget> mutator) {
		...
		public PastelWorldInteractionRecipe.Builder rightInput(EmiIngredient stack, boolean catalyst, Function<SlotWidget, SlotWidget> mutator) {

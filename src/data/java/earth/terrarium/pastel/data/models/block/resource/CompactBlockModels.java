...
public class CompactBlockModels {
    public static void generateBlockModels(BlockModelGenerators generators) {
        ...
        PastelModelHelper.BLOCK
            .singleton(generators, PastelBlocks.POLISHED_TOPAZ_BLOCK, TexturedModel.TOP_BOTTOM_WITH_WALL);
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.POLISHED_AMETHYST_BLOCK,
                TexturedModel.TOP_BOTTOM_WITH_WALL
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.POLISHED_CITRINE_BLOCK,
                TexturedModel.TOP_BOTTOM_WITH_WALL
            );
        PastelModelHelper.BLOCK
            .singleton(generators, PastelBlocks.POLISHED_ONYX_BLOCK, TexturedModel.TOP_BOTTOM_WITH_WALL);
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.POLISHED_MOONSTONE_BLOCK,
                TexturedModel.TOP_BOTTOM_WITH_WALL
            );

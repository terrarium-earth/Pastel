...
public class GenericPastelContainerScreenHandler extends ChestMenu {
	...
	@Contract("_, _ -> new")
	public static @NotNull GenericPastelContainerScreenHandler createGeneric9x3_Tier1(int syncId, Inventory playerInventory) {
	...
	@Contract("_, _ -> new")
	public static @NotNull GenericPastelContainerScreenHandler createGeneric9x3_Tier2(int syncId, Inventory playerInventory) {
	...
	@Contract("_, _ -> new")
	public static @NotNull GenericPastelContainerScreenHandler createGeneric9x3_Tier3(int syncId, Inventory playerInventory) {
	...
	@Contract("_, _ -> new")
	public static @NotNull GenericPastelContainerScreenHandler createGeneric9x6_Tier1(int syncId, Inventory playerInventory) {
	...
	@Contract("_, _ -> new")
	public static @NotNull GenericPastelContainerScreenHandler createGeneric9x6_Tier2(int syncId, Inventory playerInventory) {
	...
	@Contract("_, _ -> new")
	public static @NotNull GenericPastelContainerScreenHandler createGeneric9x6_Tier3(int syncId, Inventory playerInventory) {
	...
	public static @NotNull GenericPastelContainerScreenHandler createGeneric9x3(int syncId, Inventory playerInventory, Container inventory, @NotNull ScreenBackgroundVariant tier) {
		switch (tier) {
			case EARLYGAME -> {
	...
	@Contract("_, _, _, _ -> new")
	public static @NotNull GenericPastelContainerScreenHandler createGeneric9x6(int syncId, Inventory playerInventory, Container inventory, @NotNull ScreenBackgroundVariant tier) {
		switch (tier) {
			case EARLYGAME -> {

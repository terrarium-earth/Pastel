...
public class WoodLikeBlockModels {
    ...
    public static void generateNoxshroomBlockModel(BlockModelGenerators generators, DeferredBlock<Block> block) {
        generators.blockStateOutput.accept(MultiVariantGenerator.multiVariant(
            ...
            PastelModelHelper.createModelVariant(PastelTexturedModels.cross(b -> b, "_type_2")
                                                                     .createWithSuffix(
                                                                         block.get(), "_type_2",
                                                                         generators.modelOutput
                                                                     )), PastelModelHelper.createModelVariant(
                PastelTexturedModels.cross(b -> b, "_type_3")
    ...
    public static void generateBlockModels(BlockModelGenerators generators) {
        PastelModelHelper.registerBlockFamily(
            generators, new BlockFamily.Builder(PastelBlocks.SLATE_NOXWOOD_PLANKS.get()).stairs(
        ...
        PastelModelHelper.registerBlockFamily(
            generators, new BlockFamily.Builder(PastelBlocks.EBONY_NOXWOOD_PLANKS.get()).stairs(
        ...
        PastelModelHelper.registerBlockFamily(
            generators, new BlockFamily.Builder(PastelBlocks.IVORY_NOXWOOD_PLANKS.get()).stairs(
        ...
        PastelModelHelper.registerBlockFamily(
            generators, new BlockFamily.Builder(PastelBlocks.CHESTNUT_NOXWOOD_PLANKS.get()).stairs(
        ...
        PastelModelHelper.registerBlockFamily(
            generators, new BlockFamily.Builder(PastelBlocks.WEEPING_GALA_PLANKS.get()).stairs(
                                                       ...
                                                       .select(
                                                           ...
                                                           PastelModelHelper.createModelVariant(
                                                               PastelTexturedModels.cross(
                                                                                       b -> PastelBlocks.WEEPING_GALA_FRONDS.get(), "_tip")
                                                                                   .create(

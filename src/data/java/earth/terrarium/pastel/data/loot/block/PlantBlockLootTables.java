...
public class PlantBlockLootTables extends BlockLootSubProvider {
    ...
    private static final Map<Block, Block> tallDragonjagBlocks = Map
        .ofEntries(
            Map.entry(PastelBlocks.TALL_YELLOW_DRAGONJAG.get(), PastelBlocks.SMALL_YELLOW_DRAGONJAG.get()),
            Map.entry(PastelBlocks.TALL_RED_DRAGONJAG.get(), PastelBlocks.SMALL_RED_DRAGONJAG.get()),
            Map.entry(PastelBlocks.TALL_PINK_DRAGONJAG.get(), PastelBlocks.SMALL_PINK_DRAGONJAG.get()),
            Map.entry(PastelBlocks.TALL_PURPLE_DRAGONJAG.get(), PastelBlocks.SMALL_PURPLE_DRAGONJAG.get()),
            Map.entry(PastelBlocks.TALL_BLACK_DRAGONJAG.get(), PastelBlocks.SMALL_BLACK_DRAGONJAG.get())
        );

    private static final List<Block> pottedPlantBlocks = List
        .of(
            PastelBlocks.POTTED_AMARANTH_BUSHEL.get(),
            PastelBlocks.POTTED_RESONANT_LILY.get(),
            PastelBlocks.POTTED_BLOOD_ORCHID.get()
        );
        ...
        add(
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        .lootPool()
                        .add(LootItem.lootTableItem(small))
                        .when(
                            LootItemBlockStatePropertyCondition
                                .hasBlockStateProperties(tall)
                                .setProperties(
                                    StatePropertiesPredicate.Builder
                                        .properties()
                                        .hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER)
                                        .hasProperty(TallDragonjagBlock.DEAD, false)
                                )
                        )
                        .when(
                            LocationCheck
    ...
    protected void generate() {
        ...
        add(
            PastelBlocks.GLISTERING_MELON.get(),
            LootTable
                .lootTable()
                .withPool(
                    LootPool
                        ...
                        .add(
                            AlternativesEntry
                                .alternatives(
                                    LootItem.lootTableItem(PastelBlocks.GLISTERING_MELON.get()).when(hasSilkTouch()),
                                    LootItem
                                        .lootTableItem(Items.GLISTERING_MELON_SLICE)
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelItems.GLISTERING_MELON_SEEDS)
                                .apply(
                                    SetItemCountFunction
                                        .setCount(BinomialDistributionGenerator.binomial(3, 0.03333333f))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.GLISTERING_MELON_STEM.get())
                                                .setProperties(
                                                    StatePropertiesPredicate.Builder
                                                        .properties()
                                                        .hasProperty(StemBlock.AGE, 0)
                                                )
                                        )
                                )
                                .apply(
                                    SetItemCountFunction
                                        .setCount(BinomialDistributionGenerator.binomial(3, 0.6666667f))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.GLISTERING_MELON_STEM.get())
                                                .setProperties(
                                                    StatePropertiesPredicate.Builder
                                                        .properties()
                                                        .hasProperty(StemBlock.AGE, 1)
                                                )
                                        )
                                )
                                .apply(
                                    SetItemCountFunction
                                        .setCount(BinomialDistributionGenerator.binomial(3, 0.1f))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.GLISTERING_MELON_STEM.get())
                                                .setProperties(
                                                    StatePropertiesPredicate.Builder
                                                        .properties()
                                                        .hasProperty(StemBlock.AGE, 2)
                                                )
                                        )
                                )
                                .apply(
                                    SetItemCountFunction
                                        .setCount(BinomialDistributionGenerator.binomial(3, 0.1333333f))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.GLISTERING_MELON_STEM.get())
                                                .setProperties(
                                                    StatePropertiesPredicate.Builder
                                                        .properties()
                                                        .hasProperty(StemBlock.AGE, 3)
                                                )
                                        )
                                )
                                .apply(
                                    SetItemCountFunction
                                        .setCount(BinomialDistributionGenerator.binomial(3, 0.1666666f))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.GLISTERING_MELON_STEM.get())
                                                .setProperties(
                                                    StatePropertiesPredicate.Builder
                                                        .properties()
                                                        .hasProperty(StemBlock.AGE, 4)
                                                )
                                        )
                                )
                                .apply(
                                    SetItemCountFunction
                                        .setCount(BinomialDistributionGenerator.binomial(3, 0.2f))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.GLISTERING_MELON_STEM.get())
                                                .setProperties(
                                                    StatePropertiesPredicate.Builder
                                                        .properties()
                                                        .hasProperty(StemBlock.AGE, 5)
                                                )
                                        )
                                )
                                .apply(
                                    SetItemCountFunction
                                        .setCount(BinomialDistributionGenerator.binomial(3, 0.23333333f))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.GLISTERING_MELON_STEM.get())
                                                .setProperties(
                                                    StatePropertiesPredicate.Builder
                                                        .properties()
                                                        .hasProperty(StemBlock.AGE, 6)
                                                )
                                        )
                                )
                                .apply(
                                    SetItemCountFunction
                                        .setCount(BinomialDistributionGenerator.binomial(3, 0.26666666f))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.GLISTERING_MELON_STEM.get())
                                                .setProperties(
                    ...
                    LootPool
                        ...
                        .add(
                            LootItem
                                ...
                                .apply(
                                    SetItemCountFunction
                                        .setCount(BinomialDistributionGenerator.binomial(2, 0.53333336f))
                                )
                        )
                )
        );
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelBlocks.VARIA_SPROUT.get())
                                .when(
                                    AnyOfCondition
                                        .anyOf(
                                            MatchTool
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelItems.ALOE_LEAF.get())
                                .apply(
                                    SetItemCountFunction
                                        .setCount(ConstantValue.exactly(4))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.ALOE.get())
                                                .setProperties(
                                                    StatePropertiesPredicate.Builder
                                                        .properties()
                                                        .hasProperty(AloeBlock.AGE, 4)
                                                )
                                        )
                                )
                                .apply(
                                    SetItemCountFunction
                                        .setCount(ConstantValue.exactly(3))
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.ALOE.get())
                                                .setProperties(
        ...
        add(
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        .lootPool()
                        .add(LootItem.lootTableItem(PastelItems.SAWBLADE_HOLLY_BERRY))
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0f, 3.0f)))
                        .apply(ApplyBonusCount.addUniformBonusCount(fortune, 1))
                        .when(
                            LootItemBlockStatePropertyCondition
                                .hasBlockStateProperties(PastelBlocks.SAWBLADE_HOLLY_BUSH.get())
                                .setProperties(
                                    StatePropertiesPredicate.Builder
                                        .properties()
                                        .hasProperty(SawbladeHollyBushBlock.AGE, 7)
                                )
                        )
                )
        );
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelBlocks.BRISTLE_SPROUTS.get())
                                .when(
                                    AnyOfCondition
                                        .anyOf(
                                            MatchTool
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelItems.DOOMBLOOM_SEED)
                                .when(
                                    AnyOfCondition
                                        .anyOf(
                                            MatchTool
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .when(
                            LootItemBlockStatePropertyCondition
                                .hasBlockStateProperties(PastelBlocks.ABYSSAL_VINES.get())
                                .setProperties(
                                    StatePropertiesPredicate.Builder
                                        .properties()
                                        .hasProperty(AbyssalVineBlock.BERRIES, true)
                                )
                        )
        ...
        add(
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        .lootPool()
                        .add(LootItem.lootTableItem(PastelItems.NIGHTDEW_SPROUT))
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelBlocks.MOSS_BALL.get())
                                .when(
                                    AnyOfCondition
                                        .anyOf(
                                            MatchTool
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelBlocks.GIANT_MOSS_BALL.get())
                                .when(
                                    AnyOfCondition
                                        .anyOf(
                                            MatchTool
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelItems.GERMINATED_JADE_VINE_BULB)
                                .when(
                                    LootItemBlockStatePropertyCondition
                                        .hasBlockStateProperties(PastelBlocks.JADE_VINE_BULB.get())
                                        .setProperties(
                                            StatePropertiesPredicate.Builder
                                                .properties()
                                                .hasProperty(JadeVineBulbBlock.DEAD, false)
                                        )
                                )
                        )
                )
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelItems.HIBERNATING_JADE_VINE_BULB)
                                .when(
                                    LootItemBlockStatePropertyCondition
                                        .hasBlockStateProperties(PastelBlocks.JADE_VINE_BULB.get())
                                        .setProperties(
                                            StatePropertiesPredicate.Builder
                                                .properties()
                                                .hasProperty(JadeVineBulbBlock.DEAD, true)
                                        )
                                )
                        )
                )
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelItems.JADE_JELLY)
                                    ...
                                    ApplyBonusCount
                                        .addUniformBonusCount(
                                            registries
                                                ...
                                                .getOrThrow(PastelEnchantments.RESONANCE),
                                            2
                                        )
                                )
                        )
        ...
        add(
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        .lootPool()
                        .add(LootItem.lootTableItem(PastelItems.GERMINATED_JADE_VINE_BULB))
                        .when(
                            InvertedLootItemCondition
                                .invert(
                                    LootItemBlockStatePropertyCondition
                                        .hasBlockStateProperties(PastelBlocks.JADE_VINES.get())
                                        .setProperties(
                                            StatePropertiesPredicate.Builder
                                                .properties()
                                                .hasProperty(JadeVinePlantBlock.AGE, 0)
                                        )
                                )
                        )
                )
                    ...
                    LootPool
                        ...
                        .when(
                            LootItemBlockStatePropertyCondition
                                .hasBlockStateProperties(PastelBlocks.JADE_VINES.get())
                                .setProperties(
                                    StatePropertiesPredicate.Builder.properties().hasProperty(JadeVinePlantBlock.AGE, 0)
                                )
                        )
                )
                .withPool(
        ...
        add(
            ...
            createSilkTouchOrShearsDispatchTable(
                PastelBlocks.NEPHRITE_BLOSSOM_LEAVES.get(),
                LootItem
                    .lootTableItem(PastelBlocks.NEPHRITE_BLOSSOM_BULB.get())
                    .when(BonusLevelTableCondition.bonusLevelFlatChance(fortune, 0.1f, 0.15f, 0.2f, 0.25f))
            )
        );
        add(
        ...
        add(
            ...
            createSilkTouchOrShearsDispatchTable(
                PastelBlocks.JADEITE_LOTUS_FLOWER.get(),
                LootItem.lootTableItem(PastelBlocks.JADEITE_LOTUS_BULB.get())
            )
        );
        add(
            ...
            LootTable
                ...
                .withPool(
                    LootPool
                        ...
                        .add(
                            LootItem
                                .lootTableItem(PastelItems.MERMAIDS_GEM)
                                .when(
                                    AnyOfCondition
                                        .anyOf(
                                            MatchTool
                    ...
                    LootPool
                        ...
                        .add(
                            AlternativesEntry
                                .alternatives(
                                    LootItem
                                        .lootTableItem(PastelBlocks.AMARANTH_BUSHEL.get())
                                        .when(
                                            LootItemBlockStatePropertyCondition
                                                .hasBlockStateProperties(PastelBlocks.AMARANTH.get())
                                                .setProperties(
                                                    StatePropertiesPredicate.Builder
                                                        .properties()
                                                        .hasProperty(AmaranthCropBlock.AGE, 7)
                                                )
                                        )
                                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2)))
                                        .apply(
                                            ApplyBonusCount.addBonusBinomialDistributionCount(fortune, 0.5714286f, 1)
                                        ),
                                    LootItem.lootTableItem(PastelItems.AMARANTH_GRAINS)
                                )
                        )
                )
                .apply(ApplyExplosionDecay.explosionDecay())
        ...
        add(
            ...
            createSilkTouchOrShearsDispatchTable(
                PastelBlocks.BLOOD_ORCHID.get(),
                LootItem.lootTableItem(PastelItems.BLOOD_ORCHID_PETAL)
            )
        );
    }
}

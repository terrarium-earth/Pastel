...
public class BookCollectionPage extends BookTextPage {
    ...
    public static BookCollectionPage fromJson(
        ...
        var items = GsonHelper
            .getAsJsonArray(json, "items", new JsonArray())
            .asList()
            .stream()
    ...
    public void build(Level world, BookContentEntry parentEntry, int pageNum) {
        ...
        for (
            String itemString : itemStrings
        ) {
            try {
                CommandBuildContext access = CommandBuildContext
                    .simple(
    ...
    public boolean matchesQuery(String query) {
        return super.matchesQuery(query) || items
            .stream()

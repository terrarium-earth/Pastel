...
public class ColoredFallingSporeBlossomParticleEffect implements ParticleOptions {
    public static final PastelInkColorCollection<ColoredFallingSporeBlossomParticleEffect> VALUES = PastelInkColorCollection.VALUES
        .map(color -> new ColoredFallingSporeBlossomParticleEffect(color.getColorInt()));

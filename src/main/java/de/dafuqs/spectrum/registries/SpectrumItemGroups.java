...
public class SpectrumItemGroups {
	...
	public static final ItemSubGroup EQUIPMENT = new ItemSubGroup.Builder(MAIN, ItemGroupIDs.SUBTAB_EQUIPMENT, Text.translatable("itemGroup.spectrum.equipment"))
			...
			.entries((displayContext, entries) -> {
				...
				entries.add(SpectrumItems.BOTTLE_OF_FORFEITURE);
				entries.add(SpectrumItems.BOTTLE_OF_DECAY_AWAY);
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.MULTITOOL));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.TENDER_PICKAXE));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.LUCKY_PICKAXE));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.RAZOR_FALCHION));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.OBLIVION_PICKAXE));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.RESONANT_PICKAXE));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.DRAGONRENDING_PICKAXE));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.LAGOON_ROD));
				entries.add(SpectrumItems.MOLTEN_ROD);
				entries.add(SpectrumItems.FETCHLING_HELMET);
				entries.add(SpectrumItems.FEROCIOUS_CHESTPLATE);
				entries.add(SpectrumItems.SYLPH_LEGGINGS);
				entries.add(SpectrumItems.OREAD_BOOTS);
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_PICKAXE));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_AXE));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_SHOVEL));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_SWORD));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_HOE));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_BOW));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_CROSSBOW));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_SHEARS));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_FISHING_ROD));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_HELMET));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_CHESTPLATE));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_LEGGINGS));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.BEDROCK_BOOTS));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.MALACHITE_WORKSTAFF));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.MALACHITE_ULTRA_GREATSWORD));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.MALACHITE_CROSSBOW));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.MALACHITE_BIDENT));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.GLASS_CREST_WORKSTAFF));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.GLASS_CREST_ULTRA_GREATSWORD));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.FEROCIOUS_GLASS_CREST_BIDENT));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.FRACTAL_GLASS_CREST_BIDENT));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.GLASS_CREST_CROSSBOW));
				entries.add(SpectrumItems.MALACHITE_GLASS_ARROW);
				entries.add(SpectrumItems.TOPAZ_GLASS_ARROW);
				entries.add(SpectrumItems.AMETHYST_GLASS_ARROW);
				...
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.DRACONIC_TWINSWORD));
				entries.add(Preenchanted.getDefaultEnchantedStack(lookup, SpectrumItems.DRAGON_TALON));
				entries.add(SpectrumItems.KNOTTED_SWORD);
				entries.add(SpectrumItems.NECTAR_LANCE);
				entries.add(SpectrumItems.OMNI_ACCELERATOR);
				entries.add(SpectrumItems.FANCIFUL_TUFF_RING);
				entries.add(SpectrumItems.FANCIFUL_BELT);
				entries.add(SpectrumItems.FANCIFUL_PENDANT);
				entries.add(SpectrumItems.FANCIFUL_CIRCLET);
				entries.add(SpectrumItems.FANCIFUL_GLOVES);
				entries.add(SpectrumItems.FANCIFUL_BISMUTH_RING);
				entries.add(SpectrumItems.GLOW_VISION_GOGGLES);
				entries.add(SpectrumItems.JEOPARDANT);
				entries.add(SpectrumItems.SEVEN_LEAGUE_BOOTS);
				...
				entries.add(SpectrumEnchantmentHelper.getEnchantedStack(lookup, SpectrumItems.TAKE_OFF_BELT, Map.of(Enchantments.POWER, 5, Enchantments.FEATHER_FALLING, 4)));
				...
				entries.add(SpectrumEnchantmentHelper.getEnchantedStack(lookup, SpectrumItems.GLEAMING_PIN, Map.of(SpectrumEnchantments.SNIPING, 2)));
				...
				entries.add(SpectrumEnchantmentHelper.getEnchantedStack(lookup, SpectrumBlocks.BOTTOMLESS_BUNDLE.asItem(), Map.of(Enchantments.POWER, 5, SpectrumEnchantments.VOIDING, 1)));
				...
				entries.add(SpectrumEnchantmentHelper.getEnchantedStack(lookup, SpectrumItems.NATURES_STAFF, Map.of(Enchantments.EFFICIENCY, 5)));
				...
				SpectrumEnchantmentHelper.addOrUpgradeEnchantmentOpt(lookup, SpectrumItems.EXCHANGING_STAFF.getDefaultStack(), Enchantments.FORTUNE, 3, false, false).ifPresent(entries::add);
				SpectrumEnchantmentHelper.addOrUpgradeEnchantmentOpt(lookup, SpectrumItems.EXCHANGING_STAFF.getDefaultStack(), Enchantments.SILK_TOUCH, 1, false, false).ifPresent(entries::add);
				SpectrumEnchantmentHelper.addOrUpgradeEnchantmentOpt(lookup, SpectrumItems.EXCHANGING_STAFF.getDefaultStack(), SpectrumEnchantments.RESONANCE, 1, false, false).ifPresent(entries::add);

...
public class TropicalFishHeadModel extends PastelSkullModel {
    ...
    private static final ResourceLocation PATTERN_TEXTURE = ResourceLocation.parse(
    ...
    public static MeshDefinition getModelData(CubeDeformation dilation) {
        ...
        PartDefinition head = modelPartData.addOrReplaceChild(
            PartNames.HEAD, CubeListBuilder.create()
                                           .texOffs(0, 0)
                                           .addBox(
                                               -1.0F, -3.0F, -3.0F, 2.0F, 3.0F, 6.0F, dilation), PartPose.ZERO
        );
        head.addOrReplaceChild(
            "tail", CubeListBuilder.create()
                                   .texOffs(22, -6)
                                   .addBox(0.0F, -3.0F, 3.0F, 0.0F, 3.0F, 6.0F, dilation), PartPose.ZERO
        );
        head.addOrReplaceChild(
            "right_fin", CubeListBuilder.create()
                                        .texOffs(2, 16)
                                        .addBox(-2.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, dilation),
            PartPose.offsetAndRotation(-1.0F, -1.0F, 0.0F, 0.0F, ((float) Math.PI / 4F), 0.0F)
        );
        head.addOrReplaceChild(
            "left_fin", CubeListBuilder.create()
                                       .texOffs(2, 12)
                                       .addBox(0.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, dilation),
            PartPose.offsetAndRotation(1.0F, -1.0F, 0.0F, 0.0F, (-(float) Math.PI / 4F), 0.0F)
        );
        head.addOrReplaceChild(
            "top_fin", CubeListBuilder.create()
                                      .texOffs(10, -5)
                                      .addBox(0.0F, -6.0F, -3.0F, 0.0F, 3.0F, 6.0F, dilation), PartPose.ZERO
        );
    ...
    public void render(
        ...
        VertexConsumer vertexConsumer = vertexConsumerProvider.getBuffer(
            RenderType.entityCutoutNoCullZOffset(PATTERN_TEXTURE));

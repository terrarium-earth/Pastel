...
public class MidnightAberrationItem extends CloakedItem implements FabricItem {
	...
	public MidnightAberrationItem(Item.Settings settings, Identifier cloakAdvancementIdentifier, Item cloakItem) {
	...
	public boolean allowComponentsUpdateAnimation(PlayerEntity player, Hand hand, ItemStack oldStack, ItemStack newStack) {
		...
		return oldStack.contains(SpectrumDataComponentTypes.TIMESTAMP) != newStack.contains(SpectrumDataComponentTypes.TIMESTAMP);
	}

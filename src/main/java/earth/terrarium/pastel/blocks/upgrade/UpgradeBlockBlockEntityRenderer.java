...
public class UpgradeBlockBlockEntityRenderer<PedestalUpgradeBlockEntity extends BlockEntity>
    implements
    BlockEntityRenderer<PedestalUpgradeBlockEntity> {
    ...
    @Override
    public void render(
        PedestalUpgradeBlockEntity entity,
        float tickDelta,
        PoseStack poseStack,
        ...
        if (entity.getLevel() != null && entity
            .getLevel()
            .getBlockState(
                entity
                    .getBlockPos()
        ...
        switch (upgradeType) {
            case SPEED -> {
                spriteIdentifier = new Material(
                    ...
                    PastelCommon.locate("block/pedestal_upgrade_speed")
                );
            ...
            case YIELD -> {
                spriteIdentifier = new Material(
                    InventoryMenu.BLOCK_ATLAS,
                    PastelCommon.locate("block/pedestal_upgrade_yield")
                );
            ...
            case EFFICIENCY -> {
                spriteIdentifier = new Material(
                    InventoryMenu.BLOCK_ATLAS,
                    PastelCommon.locate("block/pedestal_upgrade_efficiency")
                );
            ...
            default -> {
                spriteIdentifier = new Material(
                    InventoryMenu.BLOCK_ATLAS,
                    PastelCommon.locate("block/pedestal_upgrade_experience")
                );

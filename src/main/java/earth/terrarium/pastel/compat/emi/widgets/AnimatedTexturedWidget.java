...
public class AnimatedTexturedWidget extends Widget implements WidgetTooltipHolder<AnimatedTexturedWidget> {
    ...
    public AnimatedTexturedWidget(
        ResourceLocation texture, int x, int y, int textureWidth, int textureHeight, int animationDurationMS) {
        super();
    ...
    public void render(GuiGraphics draw, int mouseX, int mouseY, float delta) {
        ...
        if (animationDurationMS > 0) {
            ...
            context.drawTexture(
                texture, x, y, 0, textureWidth, index * textureWidth, textureWidth, textureWidth, textureWidth,
                textureHeight
            );
        } else {
            context.drawTexture(
                texture, x, y, 0, textureWidth, textureWidth, textureWidth, textureWidth, textureWidth, textureHeight);
        }
    }

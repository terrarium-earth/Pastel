...
public class BottomlessBundleBlockEntityRenderer implements BlockEntityRenderer<BottomlessBundleBlockEntity> {
    ...
    private static final Material SPRITE = new Material(
        ...
        PastelCommon.locate("block/bottomless_bundle")
    );
    ...
    @Override
    public void render(
        BottomlessBundleBlockEntity bundle,
        float tickDelta,
        PoseStack matrices,
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition side_r1 = pyramid
            .addOrReplaceChild(
                "side_r1",
                CubeListBuilder
                    .create()
        ...
        PartDefinition side_r2 = pyramid
            .addOrReplaceChild(
                "side_r2",
                CubeListBuilder
                    .create()
        ...
        PartDefinition side_r3 = pyramid
            .addOrReplaceChild(
                "side_r3",
                CubeListBuilder
                    .create()
        ...
        PartDefinition locked = modelPartData
            .addOrReplaceChild(
                "locked",
                CubeListBuilder.create(),
                PartPose.offset(-2.1358F, 18.9571F, -2.1077F)
            );

        PartDefinition s_locked_r1 = locked
            .addOrReplaceChild(
                "s_locked_r1",
                CubeListBuilder
                    .create()
        ...
        PartDefinition unlocked = modelPartData
            .addOrReplaceChild(
                "unlocked",
                CubeListBuilder.create(),
                PartPose.offset(-2.1358F, 18.9571F, -2.1077F)
        ...
        PartDefinition s_unlocked_r1 = unlocked
            .addOrReplaceChild(
                "s_unlocked_r1",
                CubeListBuilder
                    .create()

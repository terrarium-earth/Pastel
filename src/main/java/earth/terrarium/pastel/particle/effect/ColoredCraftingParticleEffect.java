...
public class ColoredCraftingParticleEffect implements ParticleOptions {
    ...
    public static final MapCodec<ColoredCraftingParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
        (instance) -> instance.group(
                                  ExtraCodecs.VECTOR3F.fieldOf("color")
                                                      .forGetter((effect) -> effect.color)
                              )
                              .apply(instance, ColoredCraftingParticleEffect::new));
    public static final StreamCodec<RegistryFriendlyByteBuf, ColoredCraftingParticleEffect> STREAM_CODEC

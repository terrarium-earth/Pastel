            ...
            .register(
                new OmniAcceleratorProjectile() {
                    ...
                    public Entity createProjectile(
                        ...
                        enderPearlEntity
                            .shootFromRotation(shooter, shooter.getXRot(), shooter.getYRot(), 0.0F, 2.5F, 1.0F);
                ...
                new OmniAcceleratorProjectile() {
                    ...
                    public Entity createProjectile(
                        ...
                        fireworkRocketEntity
                            .shootFromRotation(shooter, shooter.getXRot(), shooter.getYRot(), 0, 2.5F, 0F);
            ...
            .register(
                new OmniAcceleratorProjectile() {
                    ...
                    public Entity createProjectile(
                        ...
                        ShootingStarEntity shootingStarEntity = ((ShootingStarItem) stack.getItem())
                            .getEntityForStack(
                                world,

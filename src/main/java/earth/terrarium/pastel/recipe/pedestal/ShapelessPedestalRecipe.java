...
public class ShapelessPedestalRecipe extends PedestalRecipe {
    ...
    public ShapelessPedestalRecipe(
        ...
        PedestalRecipeTier tier, List<IngredientStack> craftingInputs, Map<GemstoneColor, Integer> gemstonePowderInputs,
        ItemStack output,
        float experience, int craftingTime, boolean skipRecipeRemainders, boolean noBenefitsFromYieldUpgrades
    ) {
        super(
            group, secret, requiredAdvancementIdentifier, tier, craftingInputs, gemstonePowderInputs, output,
            experience, craftingTime, skipRecipeRemainders, noBenefitsFromYieldUpgrades
        );
    }
    ...
    public boolean matches(PedestalRecipeInput recipeInput, Level world) {
        return matchIngredientStacksExclusively(
            recipeInput, getIngredientStacks(), recipeInput.getCraftingGridSlots()) && super.matches(
            recipeInput, world);
    }
    ...
    public static class Serializer implements RecipeSerializer<ShapelessPedestalRecipe> {
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, ShapelessPedestalRecipe> STREAM_CODEC

...
public class PastelInkNodeBlockEntityRenderer implements BlockEntityRenderer<PastelInkNodeBlockEntity> {
    ...
    public PastelInkNodeBlockEntityRenderer(BlockEntityRendererProvider.Context ctx) {
    ...
    @Override
    public void render(
        PastelInkNodeBlockEntity node, float tickDelta, PoseStack matrices, MultiBufferSource vertexConsumers, int light,
        int overlay
    ) {

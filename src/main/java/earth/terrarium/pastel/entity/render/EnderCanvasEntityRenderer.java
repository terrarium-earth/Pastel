...
public class EnderCanvasEntityRenderer extends EntityRenderer<EnderCanvasEntity> {
    ...
    @Override
    public void render(
        EnderCanvasEntity entity, float entityYaw, float partialTick, PoseStack poseStack,
        ...
        buffer.addVertex(pose, -width / 2f, 1, 0)
        ...
        if (entity.getVariant() == EnderCanvasEntity.EnderCanvasVariant.PORTRAIT && entity.getSpliceData()
                                                                                          .targetGameProfile()
                                                                                          .isPresent() &&
            ...
            poseStack.scale(
                entity.getDirection()
                      .getAxis() == Direction.Axis.Z ? 1f : 0.0625f, 1, entity.getDirection()
                                                                              .getAxis() == Direction.Axis.X ? 1f
                                                                                                             : 0.0625f
            );

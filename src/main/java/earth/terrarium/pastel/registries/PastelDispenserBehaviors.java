...
public class PastelDispenserBehaviors {
	...
	public static void register() {
		DispenserBlock.registerBehavior(PastelBlocks.BOTTOMLESS_BUNDLE.get(), new BottomlessBundleItem.BottomlessBundlePlacementDispenserBehavior());
		...
		DispenserBlock.registerBehavior(PastelBlocks.GLISTERING_SHOOTING_STAR.get(), new ShootingStarDispenserBehavior());

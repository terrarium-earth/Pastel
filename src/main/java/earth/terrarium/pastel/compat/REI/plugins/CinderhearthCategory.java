...
public class CinderhearthCategory extends GatedDisplayCategory<CinderhearthDisplay> {
    ...
    public void setupWidgets(
        ...
        Rectangle bounds,
        List<Widget> widgets,
        @NotNull CinderhearthDisplay display
    ) {
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x - 6, startPoint.y + 2))
                    .markInput()
                    .entries(
                        display
                            .getInputEntries()
        ...
        widgets
            .add(
                Widgets
                    .createBurningFire(new Point(startPoint.x - 6, startPoint.y + 1 + 20))
                    .animationDurationMS(10000)
            );
        widgets
            .add(
                Widgets
                    .createArrow(new Point(startPoint.x - 6 + 18, startPoint.y + 2 + 5))
        ...
        widgets
            .add(
                Widgets
                    .createLabel(new Point(startPoint.x - 6, startPoint.y + 1 + 43), text)
                    .leftAligned()
                    .color(0x3f3f3f)
                    .noShadow()
            );

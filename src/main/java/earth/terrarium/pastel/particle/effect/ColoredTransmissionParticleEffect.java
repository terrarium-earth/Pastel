...
public class ColoredTransmissionParticleEffect extends TransmissionParticleEffect {
    ...
    public static final MapCodec<ColoredTransmissionParticleEffect> CODEC = RecordCodecBuilder
        .mapCodec(
            i -> i
                .group(
                    PositionSource.CODEC
                        .fieldOf("destination")
                        .forGetter((effect) -> effect.destination),
                    Codec.INT
                        .fieldOf("arrival_in_ticks")
                        .forGetter((effect) -> effect.arrivalInTicks),
                    Codec.INT
                        .fieldOf("color")
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ColoredTransmissionParticleEffect> STREAM_CODEC = StreamCodec
        .composite(

...
public class TitrationBarrelDisplay extends PastelDisplay {
            ...
            return EntryIngredients
                .ofItemStacks(
                    titrationBarrelRecipe
                        .getOutputVariations(TitrationBarrelRecipe.FERMENTATION_DURATION_DISPLAY_TIME_MULTIPLIERS)
                );
        } else {
    ...
    public boolean isUnlocked() {
        ...
        return DatabankUtils
            .hasAdvancement(client.player, TitrationBarrelRecipe.UNLOCK_ADVANCEMENT_IDENTIFIER) && super.isUnlocked();
    }

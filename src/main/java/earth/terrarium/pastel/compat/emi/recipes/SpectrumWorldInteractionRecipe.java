...
public class SpectrumWorldInteractionRecipe extends EmiWorldInteractionRecipe {
	...
	protected SpectrumWorldInteractionRecipe(earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder builder) {
		super(builder.superbuilder);
		requiredAdvancementIdentifier.addAll(builder.requiredAdvancementIdentifier);
	}
	
	public static earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder customBuilder() {
		return new earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder();
	}
	...
	public static class Builder {
		...
		public earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder id(ResourceLocation id) {
			superbuilder.id(id);
			return this;
		}
		
		public earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder leftInput(EmiIngredient stack) {
			superbuilder.leftInput(stack);
			return this;
		}
		
		public earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder leftInput(EmiIngredient stack, Function<SlotWidget, SlotWidget> mutator) {
			superbuilder.leftInput(stack, mutator);
			return this;
		}
		
		public earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder rightInput(EmiIngredient stack, boolean catalyst) {
			superbuilder.rightInput(stack, catalyst);
			return this;
		}
		
		public earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder rightInput(EmiIngredient stack, boolean catalyst, Function<SlotWidget, SlotWidget> mutator) {
			superbuilder.rightInput(stack, catalyst, mutator);
			return this;
		}
		
		public earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder output(EmiStack stack) {
			superbuilder.output(stack);
			return this;
		}
		
		public earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder output(EmiStack stack, Function<SlotWidget, SlotWidget> mutator) {
			superbuilder.output(stack, mutator);
			return this;
		}
		
		public earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder supportsRecipeTree(boolean supportsRecipeTree) {
			superbuilder.supportsRecipeTree(supportsRecipeTree);
			return this;
		}
		
		public earth.terrarium.pastel.compat.emi.recipes.SpectrumWorldInteractionRecipe.Builder requiredAdvancement(ResourceLocation advId) {

...
public class PastelItemGroups {
    ...
    public static final List<ResourceLocation> ITEM_GROUP_IDS = List
        .of(
            INSTRUMENTS_ID,
            TOOLS_ID,
            NATURAL_BLOCKS_ID,
    ...
    public static void registerSpawnEggs(BuildCreativeModeTabContentsEvent event) {
        if (event
            ...
            event
                .accept(
                    PastelItems.KINDLING_SPAWN_EGG.toStack(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS
                );
        ...
        if (event
            .getTabKey()
            .equals(CreativeModeTabs.TOOLS_AND_UTILITIES)) event
                .accept(
                    PastelItems.BUCKET_OF_ERASER.toStack(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS
                );
    }

    public static final CreativeModeTab INSTRUMENTS = CreativeModeTab
        .builder()
    ...
    public static final CreativeModeTab TOOLS = CreativeModeTab
        .builder()
        ...
        .displayItems((displayContext, entries) -> {
            ...
            entries
                .accept(
                    Ench
                        .getEnchantedStack(
                            lookup,
                            PastelItems.SEVEN_LEAGUE_BOOTS.get(),
            ...
            entries
                .accept(
                    PastelItems.SHIELDGRASP_AMULET
                        .get()
                        .getFullStack()
                );
            entries
            ...
            entries
                .accept(
                    PastelItems.HEARTSINGERS_REWARD
                        .get()
                        .getFullStack()
                );
            entries
            ...
            entries
                .accept(
                    PastelItems.GLOVES_OF_DAWNS_GRASP
                        .get()
                        .getFullStack()
                );
            ...
            entries
                .accept(
                    PastelItems.RING_OF_DENSER_STEPS
                        .get()
                        .getFullStack()
                );
            entries
            ...
            entries
                .accept(
                    PastelItems.RING_OF_AETHERIAL_GRACE
                        .get()
                        .getFullStack()
                );
            entries
            ...
            entries
                .accept(
                    PastelItems.LAURELS_OF_SERENITY
                        .get()
                        .getFullStack()
                );
            ...
            ItemStack enchantedKnowledgeGemStack = Ench
                .getEnchantedStack(
                    lookup,
                    PastelItems.KNOWLEDGE_GEM
                        .get()
                        .asItem(),
                    Map
                        .of(
            ...
            ItemStack knowledgeGemStack = PastelItems.KNOWLEDGE_GEM
                .get()
                .getDefaultInstance();
            var storage = knowledgeGemStack
                .getCapability(
            ...
            var otherStorage = enchantedKnowledgeGemStack
                .getCapability(
                    PastelCapabilities.Misc.XP,
                    lookup
                );
            ...
            Ench
                .addOrUpgradeEnchantmentOpt(
                    lookup,
                    PastelItems.EXCHANGING_STAFF
                        .get()
                        .getDefaultInstance(),
    ...
    public static final CreativeModeTab NATURAL_BLOCKS = CreativeModeTab
        .builder()
    ...
    public static final CreativeModeTab CUISINE = CreativeModeTab
        .builder()
        ...
        .displayItems((displayContext, entries) -> {
            ...
            if (PastelCommon.getSidedServer() != null) {
                for (
                    RecipeHolder<ITitrationBarrelRecipe> recipe : PastelCommon
                        .getSidedServer()
                        .getRecipeManager()
                        .getAllRecipesFor(
    ...
    public static final CreativeModeTab RESOURCES = CreativeModeTab
        .builder()
        ...
        .displayItems((displayContext, entries) -> {
            ...
            entries
                .accept(
                    PastelItems.MIDNIGHT_ABERRATION
                        .get()
                        .getStableStack()
                );
    ...
    public static final CreativeModeTab DECORATION = CreativeModeTab
        .builder()
        .icon(
    ...
    public static final CreativeModeTab HEADS = CreativeModeTab
        .builder()
        .icon(
            () -> PastelBlocks.MOB_HEADS
                .get(

...
public class PastelMultiblocks {
    ...
    public static final Component PEDESTAL_ADVANCED_TEXT = Component
        .translatable(
    ...
    public static final ResourceLocation PEDESTAL_COMPLEX_WITHOUT_MOONSTONE = PastelCommon
        .locate(

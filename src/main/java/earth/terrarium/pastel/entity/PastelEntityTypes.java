...
public class PastelEntityTypes {
    ...
    public static final DeferredRegister<EntityType<?>> REGISTER = DeferredRegister
        .create(
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SeatEntity>> SEAT = register(
        ...
        10,
        false,
        EntityDimensions.scalable(0.01F, 0.01F),
        true,
        SeatEntity::new
    );
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<FloatBlockEntity>> FLOAT_BLOCK = register(
        ...
        20,
        true,
        EntityDimensions.scalable(0.98F, 0.98F),
        true,
        FloatBlockEntity::new
    );
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<BlockFlooderProjectile>> BLOCK_FLOODER_PROJECTILE = register(
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WireHookEntity>> WIRE_HOOK = register(
        "wire_hook",
        8,
        10,
        true,
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<InkProjectileEntity>> INK_PROJECTILE = register(
        ...
        true,
        InkProjectileEntity::new
    );

    public static final DeferredHolder<EntityType<?>, EntityType<LagoonFishingBobberEntity>> LAGOON_FISHING_BOBBER = register(
        "lagoon_fishing_bobber",
        EntityType.Builder
            .<LagoonFishingBobberEntity>of(
                LagoonFishingBobberEntity::new,
                MobCategory.MISC
            )
            .noSave()
            .noSummon()
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MoltenFishingBobberEntity>> MOLTEN_FISHING_BOBBER = register(
        "molten_fishing_bobber",
        EntityType.Builder
            .<MoltenFishingBobberEntity>of(
                MoltenFishingBobberEntity::new,
                MobCategory.MISC
            )
            .noSave()
            .noSummon()
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<BedrockFishingBobberEntity>> BEDROCK_FISHING_BOBBER = register(
        "bedrock_fishing_bobber",
        EntityType.Builder
            .<BedrockFishingBobberEntity>of(
                BedrockFishingBobberEntity::new,
                MobCategory.MISC
            )
            .noSave()
            .noSummon()
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EggLayingWoolyPigEntity>> EGG_LAYING_WOOLY_PIG = register(
        "egg_laying_wooly_pig",
        EntityType.Builder
            .of(EggLayingWoolyPigEntity::new, MobCategory.CREATURE)
            .sized(0.9F, 1.3F)
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GlassArrowEntity>> GLASS_ARROW = register(
        "glass_arrow",
        EntityType.Builder
            .<GlassArrowEntity>of(GlassArrowEntity::new, MobCategory.MISC)
            .sized(0.5F, 0.5F)
            .clientTrackingRange(4)
            .updateInterval(1)
    );
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<BidentMirrorImageEntity>> BIDENT_MIRROR_IMAGE = register(
        "bident_mirror_image",
        4,
        10,
        true,
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LightSpearEntity>> LIGHT_SPEAR = register(
        "light_spear",
        EntityType.Builder
            .<LightSpearEntity>of(LightSpearEntity::new, MobCategory.MISC)
            .noSave()
            .fireImmune()
            .sized(0.75F, 0.75F)
            .clientTrackingRange(4)
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PreservationTurretEntity>> PRESERVATION_TURRET = register(
        "preservation_turret",
        EntityType.Builder
            .of(PreservationTurretEntity::new, MobCategory.MONSTER)
            .fireImmune()
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<KindlingCoughEntity>> KINDLING_COUGH = register(
        "kindling_cough",
        EntityType.Builder
            .<KindlingCoughEntity>of(KindlingCoughEntity::new, MobCategory.MISC)
            .sized(0.25F, 0.25F)
            .clientTrackingRange(4)
            .updateInterval(10)
            .fireImmune()
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ItemProjectileEntity>> ITEM_PROJECTILE = register(
        "item_projectile",
        EntityType.Builder
            .<ItemProjectileEntity>of(ItemProjectileEntity::new, MobCategory.MISC)
            .sized(0.25F, 0.25F)
            .clientTrackingRange(6)
            .updateInterval(20)
    );
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<DragonTalonEntity>> DRAGON_TALON = register(
        ...
        EntityDimensions.scalable(0.5F, 0.5F),
        true,
        DragonTalonEntity::new
    );

    public static final DeferredHolder<EntityType<?>, EntityType<DraconicTwinswordEntity>> DRACONIC_TWINSWORD = register(
        "draconic_twinsword",
        6,
        2,
        true,
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        event
            .put(
                EGG_LAYING_WOOLY_PIG.get(),
                EggLayingWoolyPigEntity
                    .createEggLayingWoolyPigAttributes()
                    .build()
            );
        event
            .put(
                PRESERVATION_TURRET.get(),
                PreservationTurretEntity
                    .createGuardianTurretAttributes()
                    .build()
            );
        event
            .put(
    ...
    public static <X extends Entity> DeferredHolder<EntityType<?>, EntityType<X>> register(
        ...
        return REGISTER
            .register(
                name,
                () -> {
                    EntityType.Builder<X> builder = EntityType.Builder

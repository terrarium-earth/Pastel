...
public class PastelItems {
    ...
    public static final DeferredItem<Item> TOPAZ_POWDER = register(
        simple(item("topaz_powder", () -> new GemstonePowderItem(IS.of(), BuiltinGemstoneColor.CYAN), InkColors.CYAN)));
    public static final DeferredItem<Item> AMETHYST_POWDER = register(simple(item(
        "amethyst_powder", () -> new GemstonePowderItem(IS.of(), BuiltinGemstoneColor.MAGENTA), InkColors.MAGENTA)));
    public static final DeferredItem<Item> CITRINE_POWDER = register(simple(
        item("citrine_powder", () -> new GemstonePowderItem(IS.of(), BuiltinGemstoneColor.YELLOW), InkColors.YELLOW)));
    public static final DeferredItem<Item> ONYX_POWDER = register(simple(
        item("onyx_powder", () -> new GemstonePowderItem(IS.of(), BuiltinGemstoneColor.BLACK), InkColors.BLACK)));
    public static final DeferredItem<Item> MOONSTONE_POWDER = register(simple(
        item("moonstone_powder", () -> new GemstonePowderItem(IS.of(), BuiltinGemstoneColor.WHITE), InkColors.WHITE)));
    ...
    public static final DeferredItem<Item> VEGETAL = register(simple(burnable(
        item("vegetal", () -> new ItemWithLoomPattern(IS.of(), PastelBannerPatterns.VEGETAL), InkColors.LIME), 800)));

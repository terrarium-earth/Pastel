    ...
    private static ModelPart createCape() {
        ...
        root.addOrReplaceChild(
            "cape", CubeListBuilder.create()
                                   .texOffs(64, 14)
                                   .addBox(-4.5F, 1.4167F, -0.6833F, 10.0F, 5.0F, 3.0F, CubeDeformation.NONE)
                                   .texOffs(0, 49)
                                   .addBox(-4.0F, -1.8333F, 0.1667F, 9.0F, 21.0F, 0.0F, CubeDeformation.NONE)
                                   .texOffs(62, 78)
                                   .addBox(-6.5F, 0.1667F, -0.0833F, 5.0F, 21.0F, 0.0F, CubeDeformation.NONE)
                                   .texOffs(52, 68)
                                   .addBox(2.5F, 0.1667F, -0.0833F, 5.0F, 21.0F, 0.0F, CubeDeformation.NONE),

...
public class ParticleSpawnerScreen extends AbstractContainerScreen<ParticleSpawnerScreenHandler> {
    ...
    protected static final ResourceLocation GUI_TEXTURE = PastelCommon
        .locate(
    ...
    public void renderForeground(GuiGraphics drawContext, int mouseX, int mouseY, float delta) {
        for (
            AbstractWidget widget : selectableWidgets
        ) {
    ...
    protected void renderLabels(GuiGraphics drawContext, int mouseX, int mouseY) {
        ...
        drawContext
            .drawString(
                tr,
                Component.translatable("block.pastel.particle_spawner.particle_count"),
                10,
                53 + offset,
                TEXT_COLOR,
                false
        ...
        drawContext
            .drawString(
                tr,
                Component.translatable("block.pastel.particle_spawner.offset"),
                10,
                78 + offset,
                TEXT_COLOR,
                false
        ...
        drawContext
            .drawString(
                tr,
                Component.translatable("block.pastel.particle_spawner.variance"),
                21,
                97 + offset,
                TEXT_COLOR,
                false
        ...
        drawContext
            .drawString(
                tr,
                Component.translatable("block.pastel.particle_spawner.velocity"),
                10,
                117 + offset,
                TEXT_COLOR,
                false
        ...
        drawContext
            .drawString(
                tr,
                Component.translatable("block.pastel.particle_spawner.scale"),
                10,
                161 + offset,
                TEXT_COLOR,
                false
        ...
        drawContext
            .drawString(
                tr,
                Component.translatable("block.pastel.particle_spawner.duration"),
                10,
                181 + offset,
                TEXT_COLOR,
                false
        ...
        drawContext
            .drawString(
                tr,
                Component.translatable("block.pastel.particle_spawner.gravity"),
                10,
                201 + offset,
                TEXT_COLOR,
                false
        ...
        drawContext
            .drawString(
                tr,
                Component.translatable("block.pastel.particle_spawner.collisions"),
                90,
                201 + offset,
                TEXT_COLOR,
                false
    ...
    protected void renderBg(GuiGraphics drawContext, float delta, int mouseX, int mouseY) {
        ...
        if (particleSelectionIndex / PARTICLES_PER_PAGE == activeParticlePage) {
            drawContext
                .blit(
                    GUI_TEXTURE,
                    x + 27 + (20 * (particleSelectionIndex % PARTICLES_PER_PAGE)),
                    y + 19,
                    192,
                    0,
                    22,
        ...
        for (
            ...
            TextureAtlasSprite particleSprite = spriteAtlasTexture
                .getSprite(
                    displayedParticleEntries
                        .get(spriteIndex)
                        .textureIdentifier()
                );
            ...
            drawContext
                .blit(
                    x + 38 + j * 20 - contents.width() / 2,
                    y + 31 - contents.height() / 2,
                    0,
                    contents.width(),
                    contents.height(),
                    particleSprite
    ...
    protected void setupInputFields(ParticleSpawnerBlockEntity blockEntity) {
        ...
        glowingButton = Button
            .builder(Component.translatable("gui.pastel.button.glowing"), this::glowingButtonPressed)
            .size(16, 16)
        ...
        amountField = addTextFieldWidget(
            startX + 110,
            startY + 50 + offset,
            Component.literal("Particles per Second"),
            String.valueOf(configuration.particlesPerSecond()),
            this::isPositiveDecimalNumberUnderThousand
        );
        positionXField = addTextFieldWidget(
            startX + 61,
            startY + 74 + offset,
            Component.literal("X Position"),
            String.valueOf(configuration.sourcePosition().x),
        ...
        positionYField = addTextFieldWidget(
            ...
            String.valueOf(configuration.sourcePosition().y),
            this::isAbsoluteDecimalNumberThousand
        );
        positionZField = addTextFieldWidget(
            startX + 131,
            startY + 74 + offset,
            Component.literal("Z Position"),
            String.valueOf(configuration.sourcePosition().z),
            this::isAbsoluteDecimalNumberThousand
        );
        positionXVarianceField = addTextFieldWidget(
            startX + 69,
            startY + 94 + offset,
            Component.literal("X Position Variance"),
            String.valueOf(configuration.sourcePositionVariance().x),
            this::isAbsoluteDecimalNumberThousand
        );
        positionYVarianceField = addTextFieldWidget(
            startX + 104,
            startY + 94 + offset,
            Component.literal("Y Position Variance"),
            String.valueOf(configuration.sourcePositionVariance().y),
            this::isAbsoluteDecimalNumberThousand
        );
        positionZVarianceField = addTextFieldWidget(
            startX + 140,
            startY + 94 + offset,
            Component.literal("Z Position Variance"),
            String.valueOf(configuration.sourcePositionVariance().z),
            this::isAbsoluteDecimalNumberThousand
        );
        velocityXField = addTextFieldWidget(
            startX + 61,
            startY + 114 + offset,
            Component.literal("X Velocity"),
            String.valueOf(configuration.velocity().x),
            this::isAbsoluteDecimalNumberThousand
        );
        velocityYField = addTextFieldWidget(
            startX + 96,
            startY + 114 + offset,
            Component.literal("Y Velocity"),
            String.valueOf(configuration.velocity().y),
            this::isAbsoluteDecimalNumberThousand
        );
        velocityZField = addTextFieldWidget(
            startX + 131,
            startY + 114 + offset,
            Component.literal("Z Velocity"),
            String.valueOf(configuration.velocity().z),
            this::isAbsoluteDecimalNumberThousand
        );
        velocityXVarianceField = addTextFieldWidget(
            startX + 69,
            startY + 134 + offset,
            Component.literal("X Velocity Variance"),
            String.valueOf(configuration.velocityVariance().x),
            this::isAbsoluteDecimalNumberThousand
        );
        velocityYVarianceField = addTextFieldWidget(
            startX + 104,
            startY + 134 + offset,
            Component.literal("Y Velocity Variance"),
            String.valueOf(configuration.velocityVariance().y),
            this::isAbsoluteDecimalNumberThousand
        );
        velocityZVarianceField = addTextFieldWidget(
            startX + 140,
            startY + 134 + offset,
            Component.literal("Z Velocity Variance"),
            String.valueOf(configuration.velocityVariance().z),
            this::isAbsoluteDecimalNumberThousand
        );
        scale = addTextFieldWidget(
            ...
            String.valueOf(configuration.scale()),
            this::isPositiveDecimalNumberUnderTen
        );
        scaleVariance = addTextFieldWidget(
            startX + 139,
            startY + 158 + offset,
            Component.literal("Scale Variance"),
            String.valueOf(configuration.scaleVariance()),
            this::isPositiveDecimalNumberUnderTen
        );
        duration = addTextFieldWidget(
            ...
            String.valueOf(configuration.lifetimeTicks()),
            this::isPositiveWholeNumberUnderThousand
        );
        durationVariance = addTextFieldWidget(
            startX + 139,
            startY + 178 + offset,
            Component.literal("Duration Variance"),
            String.valueOf(configuration.lifetimeVariance()),
            this::isPositiveWholeNumberUnderThousand
        );
        gravity = addTextFieldWidget(
            ...
            String.valueOf(configuration.gravity()),
        ...
        backButton = Button
            .builder(Component.translatable("gui.pastel.button.back"), this::navigationButtonPressed)
            .size(12, 14)
        ...
        forwardButton = Button
            .builder(
                Component.translatable("gui.pastel.button.forward"),
        ...
        ListIterator<ParticleSpawnerParticlesDataLoader.ParticleSpawnerEntry> it = displayedParticleEntries
            .listIterator();
        while (it.hasNext()) {
        ...
        if (displayedParticleEntries.isEmpty()) {
            ...
            ParticleSpawnerParticlesDataLoader.ParticleSpawnerEntry entry = displayedParticleEntries
                .get(
    ...
    private @NotNull Button addParticleButton(int x, int y) {
        Button button = Button
            .builder(
                Component.translatable("gui.pastel.button.particles"),
                this::particleButtonPressed
            )
            .size(20, 20)
            .pos(x, y)
            .build();
    ...
    private void onValuesChanged() {
        try {
            ParticleSpawnerConfiguration configuration = new ParticleSpawnerConfiguration(
                displayedParticleEntries
                    .get(particleSelectionIndex)
                    .particleType(),
                selectedParticleSupportsColoring
                    ? new Vec3i(
                ...
                new Vec3(
                    Double.parseDouble(positionXField.getValue()),
                    Double.parseDouble(positionYField.getValue()),
                ...
                new Vec3(
                    Double.parseDouble(velocityXField.getValue()),
                    Double.parseDouble(velocityYField.getValue()),

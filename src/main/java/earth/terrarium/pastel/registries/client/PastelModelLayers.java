...
public class PastelModelLayers {
	 ...
	 * Entities
	 */
	public static final ModelLayerLocation WOOLY_PIG = new ModelLayerLocation(PastelCommon.locate("egg_laying_wooly_pig"), "main");
	public static final ModelLayerLocation WOOLY_PIG_HAT = new ModelLayerLocation(PastelCommon.locate("egg_laying_wooly_pig"), "hat");
	public static final ModelLayerLocation WOOLY_PIG_WOOL = new ModelLayerLocation(PastelCommon.locate("egg_laying_wooly_pig"), "wool");
	
	public static final ModelLayerLocation PRESERVATION_TURRET = new ModelLayerLocation(PastelCommon.locate("preservation_turret"), "main");
	public static final ModelLayerLocation LIZARD_SCALES = new ModelLayerLocation(PastelCommon.locate("lizard"), "main");
	public static final ModelLayerLocation LIZARD_FRILLS = new ModelLayerLocation(PastelCommon.locate("lizard"), "frills");
	public static final ModelLayerLocation LIZARD_HORNS = new ModelLayerLocation(PastelCommon.locate("lizard"), "horns");
	public static final ModelLayerLocation KINDLING = new ModelLayerLocation(PastelCommon.locate("kindling"), "main");
	public static final ModelLayerLocation KINDLING_SADDLE = new ModelLayerLocation(PastelCommon.locate("kindling_saddle"), "main");
	public static final ModelLayerLocation KINDLING_ARMOR = new ModelLayerLocation(PastelCommon.locate("kindling_armor"), "main");
	public static final ModelLayerLocation KINDLING_COUGH = new ModelLayerLocation(PastelCommon.locate("kindling_cough"), "main");
	 ...
	 * Mob Heads
	 */
	public static final ModelLayerLocation ALLAY_HEAD = new ModelLayerLocation(PastelCommon.locate("allay_head"), "main");
	public static final ModelLayerLocation AXOLOTL_BLUE_HEAD = new ModelLayerLocation(PastelCommon.locate("axolotl_blue_head"), "main");
	public static final ModelLayerLocation AXOLOTL_CYAN_HEAD = new ModelLayerLocation(PastelCommon.locate("axolotl_cyan_head"), "main");
	public static final ModelLayerLocation AXOLOTL_GOLD_HEAD = new ModelLayerLocation(PastelCommon.locate("axolotl_gold_head"), "main");
	public static final ModelLayerLocation AXOLOTL_LEUCISTIC_HEAD = new ModelLayerLocation(PastelCommon.locate("axolotl_lucy_head"), "main");
	public static final ModelLayerLocation AXOLOTL_WILD_HEAD = new ModelLayerLocation(PastelCommon.locate("axolotl_wild_head"), "main");
	...
	public static final ModelLayerLocation BLAZE_HEAD = new ModelLayerLocation(PastelCommon.locate("blaze_head"), "main");
	public static final ModelLayerLocation CAMEL_HEAD = new ModelLayerLocation(PastelCommon.locate("camel_head"), "main");
	public static final ModelLayerLocation CAT_HEAD = new ModelLayerLocation(PastelCommon.locate("cat_head"), "main");
	public static final ModelLayerLocation CAVE_SPIDER_HEAD = new ModelLayerLocation(PastelCommon.locate("cave_spider_head"), "main");
	public static final ModelLayerLocation CHICKEN_HEAD = new ModelLayerLocation(PastelCommon.locate("chicken_head"), "main");
	public static final ModelLayerLocation COW_HEAD = new ModelLayerLocation(PastelCommon.locate("cow_head"), "main");
	public static final ModelLayerLocation DOLPHIN_HEAD = new ModelLayerLocation(PastelCommon.locate("dolphin_head"), "main");
	public static final ModelLayerLocation DONKEY_HEAD = new ModelLayerLocation(PastelCommon.locate("donkey_head"), "main");
	public static final ModelLayerLocation DROWNED_HEAD = new ModelLayerLocation(PastelCommon.locate("drowned_head"), "main");
	...
	public static final ModelLayerLocation FROG_COLD_HEAD = new ModelLayerLocation(PastelCommon.locate("frog_cold_head"), "main");
	public static final ModelLayerLocation FROG_TEMPERATE_HEAD = new ModelLayerLocation(PastelCommon.locate("frog_temperate_head"), "main");
	public static final ModelLayerLocation FROG_WARM_HEAD = new ModelLayerLocation(PastelCommon.locate("frog_warm_head"), "main");
	public static final ModelLayerLocation GHAST_HEAD = new ModelLayerLocation(PastelCommon.locate("ghast_head"), "main");
	public static final ModelLayerLocation GLOW_SQUID_HEAD = new ModelLayerLocation(PastelCommon.locate("glow_squid_head"), "main");
	public static final ModelLayerLocation GOAT_HEAD = new ModelLayerLocation(PastelCommon.locate("goat_head"), "main");
	public static final ModelLayerLocation GUARDIAN_HEAD = new ModelLayerLocation(PastelCommon.locate("guardian_head"), "main");
	public static final ModelLayerLocation HOGLIN_HEAD = new ModelLayerLocation(PastelCommon.locate("hoglin_head"), "main");
	public static final ModelLayerLocation HORSE_HEAD = new ModelLayerLocation(PastelCommon.locate("horse_head"), "main");
	public static final ModelLayerLocation HUSK_HEAD = new ModelLayerLocation(PastelCommon.locate("husk_head"), "main");
	public static final ModelLayerLocation ILLUSIONER_HEAD = new ModelLayerLocation(PastelCommon.locate("illusioner_head"), "main");
	public static final ModelLayerLocation IRON_GOLEM_HEAD = new ModelLayerLocation(PastelCommon.locate("iron_golem_head"), "main");
	public static final ModelLayerLocation LLAMA_HEAD = new ModelLayerLocation(PastelCommon.locate("llama_head"), "main");
	public static final ModelLayerLocation MAGMA_CUBE_HEAD = new ModelLayerLocation(PastelCommon.locate("magma_cube_head"), "main");
	public static final ModelLayerLocation MOOSHROOM_BROWN_HEAD = new ModelLayerLocation(PastelCommon.locate("mooshroom_brown_head"), "main");
	public static final ModelLayerLocation MOOSHROOM_RED_HEAD = new ModelLayerLocation(PastelCommon.locate("mooshroom_red_head"), "main");
	public static final ModelLayerLocation MULE_HEAD = new ModelLayerLocation(PastelCommon.locate("mule_head"), "main");
	public static final ModelLayerLocation OCELOT_HEAD = new ModelLayerLocation(PastelCommon.locate("ocelot_head"), "main");
	public static final ModelLayerLocation PANDA_HEAD = new ModelLayerLocation(PastelCommon.locate("panda_head"), "main");
	public static final ModelLayerLocation PARROT_BLUE_HEAD = new ModelLayerLocation(PastelCommon.locate("parrot_blue_head"), "main");
	public static final ModelLayerLocation PARROT_CYAN_HEAD = new ModelLayerLocation(PastelCommon.locate("parrot_cyan_head"), "main");
	public static final ModelLayerLocation PARROT_GRAY_HEAD = new ModelLayerLocation(PastelCommon.locate("parrot_gray_head"), "main");
	public static final ModelLayerLocation PARROT_GREEN_HEAD = new ModelLayerLocation(PastelCommon.locate("parrot_green_head"), "main");
	public static final ModelLayerLocation PARROT_RED_HEAD = new ModelLayerLocation(PastelCommon.locate("parrot_red_head"), "main");
	public static final ModelLayerLocation PHANTOM_HEAD = new ModelLayerLocation(PastelCommon.locate("phantom_head"), "main");
	public static final ModelLayerLocation PIG_HEAD = new ModelLayerLocation(PastelCommon.locate("pig_head"), "main");
	public static final ModelLayerLocation PILLAGER_HEAD = new ModelLayerLocation(PastelCommon.locate("pillager_head"), "main");
	public static final ModelLayerLocation POLAR_BEAR_HEAD = new ModelLayerLocation(PastelCommon.locate("polar_bear_head"), "main");
	public static final ModelLayerLocation PUFFERFISH_HEAD = new ModelLayerLocation(PastelCommon.locate("pufferfish_head"), "main");
	public static final ModelLayerLocation RABBIT_HEAD = new ModelLayerLocation(PastelCommon.locate("rabbit_head"), "main");
	public static final ModelLayerLocation RAVAGER_HEAD = new ModelLayerLocation(PastelCommon.locate("ravager_head"), "main");
	public static final ModelLayerLocation SALMON_HEAD = new ModelLayerLocation(PastelCommon.locate("salmon_head"), "main");
	public static final ModelLayerLocation SHEEP_HEAD = new ModelLayerLocation(PastelCommon.locate("sheep_head"), "main");
	public static final ModelLayerLocation SHULKER_BLACK_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_black_head"), "main");
	public static final ModelLayerLocation SHULKER_BLUE_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_blue_head"), "main");
	public static final ModelLayerLocation SHULKER_BROWN_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_brown_head"), "main");
	public static final ModelLayerLocation SHULKER_CYAN_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_cyan_head"), "main");
	public static final ModelLayerLocation SHULKER_GRAY_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_gray_head"), "main");
	public static final ModelLayerLocation SHULKER_GREEN_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_green_head"), "main");
	public static final ModelLayerLocation SHULKER_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_head"), "main");
	public static final ModelLayerLocation SHULKER_LIGHT_BLUE_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_light_blue_head"), "main");
	public static final ModelLayerLocation SHULKER_LIGHT_GRAY_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_light_gray_head"), "main");
	public static final ModelLayerLocation SHULKER_LIME_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_lime_head"), "main");
	public static final ModelLayerLocation SHULKER_MAGENTA_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_magenta_head"), "main");
	public static final ModelLayerLocation SHULKER_ORANGE_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_orange_head"), "main");
	public static final ModelLayerLocation SHULKER_PINK_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_pink_head"), "main");
	public static final ModelLayerLocation SHULKER_PURPLE_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_purple_head"), "main");
	public static final ModelLayerLocation SHULKER_RED_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_red_head"), "main");
	public static final ModelLayerLocation SHULKER_WHITE_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_white_head"), "main");
	public static final ModelLayerLocation SHULKER_YELLOW_HEAD = new ModelLayerLocation(PastelCommon.locate("shulker_yellow_head"), "main");
	public static final ModelLayerLocation SILVERFISH_HEAD = new ModelLayerLocation(PastelCommon.locate("silverfish_head"), "main");
	public static final ModelLayerLocation SKELETON_HORSE_HEAD = new ModelLayerLocation(PastelCommon.locate("skeleton_horse_head"), "main");
	public static final ModelLayerLocation SLIME_HEAD = new ModelLayerLocation(PastelCommon.locate("slime_head"), "main");
	public static final ModelLayerLocation SNIFFER_HEAD = new ModelLayerLocation(PastelCommon.locate("sniffer_head"), "main");
	public static final ModelLayerLocation SNOW_GOLEM_HEAD = new ModelLayerLocation(PastelCommon.locate("snow_golem_head"), "main");
	...
	public static final ModelLayerLocation TROPICAL_FISH_HEAD_PATTERN = new ModelLayerLocation(PastelCommon.locate("tropical_fish_head"), "pattern");
	public static final ModelLayerLocation TURTLE_HEAD = new ModelLayerLocation(PastelCommon.locate("turtle_head"), "main");
	public static final ModelLayerLocation VEX_HEAD = new ModelLayerLocation(PastelCommon.locate("vex_head"), "main");
	public static final ModelLayerLocation VILLAGER_HEAD = new ModelLayerLocation(PastelCommon.locate("villager_head"), "main");
	...
	public static final ModelLayerLocation ZOGLIN_HEAD = new ModelLayerLocation(PastelCommon.locate("zoglin_head"), "main");
	public static final ModelLayerLocation ZOMBIE_HORSE_HEAD = new ModelLayerLocation(PastelCommon.locate("zombie_horse_head"), "main");
	public static final ModelLayerLocation ZOMBIE_VILLAGER_HEAD = new ModelLayerLocation(PastelCommon.locate("zombie_villager_head"), "main");
	public static final ModelLayerLocation ZOMBIFIED_PIGLIN_HEAD = new ModelLayerLocation(PastelCommon.locate("zombified_piglin_head"), "main");
	...
	public static final ModelLayerLocation ERASER_HEAD = new ModelLayerLocation(PastelCommon.locate("eraser_head"), "body");
	public static final ModelLayerLocation KINDLING_HEAD = new ModelLayerLocation(PastelCommon.locate("kindling_head"), "main");
	public static final ModelLayerLocation LIZARD_HEAD = new ModelLayerLocation(PastelCommon.locate("lizard_head"), "main");
	public static final ModelLayerLocation LIZARD_HEAD_FRILLS = new ModelLayerLocation(PastelCommon.locate("lizard_head"), "frills");
	public static final ModelLayerLocation PRESERVATION_TURRET_HEAD = new ModelLayerLocation(PastelCommon.locate("preservation_turret_head"), "main");

	/**
	 * Armor
	 */
	public static final ModelLayerLocation MAIN_BEDROCK_LAYER = new ModelLayerLocation(PastelCommon.locate("bedrock_armor"), "main");
	public static final ResourceLocation BEDROCK_ARMOR_MAIN_ID = PastelCommon.locate("textures/armor/bedrock_armor_main.png");
	...
	public static void register(FMLClientSetupEvent event) {
		...
		ClientHooks.registerLayerDefinition(MAIN_BEDROCK_LAYER, () -> LayerDefinition.create(BedrockArmorModel.getModelData(), 128, 128));
	}

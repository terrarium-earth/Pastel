...
public class StructureBlockModels {
    public static void generateBlockModels(BlockModelGenerators generators) {
        PastelModelHelper
            .registerBlockFamilyExceptBase(
                generators,
                new BlockFamily.Builder(PastelBlocks.PRESERVATION_STONE.get())
                    .stairs(
        ...
        int[] tops = new int[] {
            0, 3, 1, 1, 2, 2, 0, 3, 1, 2, 3
        };
        modelIds
            .add(
                PastelTexturedModels
                    .cubeBottomTop(b -> b, "", b -> b, "_top_" + tops[0], b -> b, "_bottom")
        ...
        for (
            ...
            modelIds
                .add(
                    PastelTexturedModels
                        .cubeBottomTop(b -> b, "_" + i, b -> b, "_top_" + tops[i], b -> b, "_bottom")
                        .createWithSuffix(
        ...
        for (
            VariantProperties.Rotation rotation : VariantProperties.Rotation.values()
        ) {
            variants
                .add(
                    PastelModelHelper
                        .createModelVariant(modelIds.getFirst())
                        .with(VariantProperties.WEIGHT, 10)
                );
            if (rotation != VariantProperties.Rotation.R0) variants
                .getLast()
        ...
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.POWDER_CHISELED_PRESERVATION_STONE,
                PastelTexturedModels
                    .cubeColumn(
                        b -> b,
                        "",
        ...
        PastelModelHelper.BLOCK
            .simple(
                generators,
                PastelBlocks.DIKE_CHISELED_PRESERVATION_STONE,
                PastelBlocks.DREAM_CHISELED_PRESERVATION_STONE
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
        ...
        PastelModelHelper.BLOCK
            .defaultUpFacing(
                generators,
                PastelBlocks.DIKE_GATE_FOUNTAIN,
                PastelTexturedModels
        ...
        PastelModelHelper.BLOCK
            .simple(
                generators,
                PastelBlocks.PRESERVATION_BRICKS,
                PastelBlocks.SHIMMERING_PRESERVATION_BRICKS
            );

        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.COURIER_STATUE.get())
                    .with(
                        PastelModelHelper.createNorthDefaultHorizontalFacingVariantMap()
                    )
                    .with(
                        PropertyDispatch
                            .property(StatueBlock.HALF)
                            .select(
        ...
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.BLACK_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.BLUE_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.BROWN_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.CYAN_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.GRAY_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.GREEN_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.LIGHT_BLUE_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.LIGHT_GRAY_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.LIME_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.MAGENTA_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.ORANGE_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.PINK_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.PURPLE_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(generators, PastelBlocks.RED_CHISELED_PRESERVATION_STONE, TexturedModel.COLUMN_ALT);
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.WHITE_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );
        PastelModelHelper.BLOCK
            .singleton(
                generators,
                PastelBlocks.YELLOW_CHISELED_PRESERVATION_STONE,
                TexturedModel.COLUMN_ALT
            );

        PastelModelHelper.BLOCK
            .simple(generators, PastelBlocks.PRESERVATION_GLASS, PastelBlocks.TINTED_PRESERVATION_GLASS);

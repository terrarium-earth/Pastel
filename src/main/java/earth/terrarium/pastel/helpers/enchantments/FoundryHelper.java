...
public class FoundryHelper {
    ...
    @Nullable public static ItemStack getSmeltedItemStack(ItemStack inputItemStack, Level world) {
    ...
    @NotNull public static List<ItemStack> applyFoundry(Level world, List<ItemStack> originalStacks) {
        List<ItemStack> returnItemStacks = new ArrayList<>();

        for (
            ItemStack is : originalStacks
        ) {
            ...
            if (smeltedStack == null) {
                ...
                while (!smeltedStack.isEmpty()) {
                    int currentAmount = Math
                        .min(
                            smeltedStack.getCount(),
                            smeltedStack
                                .getItem()

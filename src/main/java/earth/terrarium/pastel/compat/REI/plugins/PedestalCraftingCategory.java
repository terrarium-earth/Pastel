    ...
    public void setupWidgets(
        ...
        for (
            ...
            for (
                ...
                slots
                    .add(
                        Widgets
                            .createSlot(new Point(startPoint.x + 1 + x * 18, startPoint.y + 2 + y * 18))
                            .disableBackground()
                            .markInput()
                            .disableBackground()
        ...
        for (
            ...
            slots
                .add(
                    Widgets
                        .createSlot(new Point(gemstoneSlotStartX + 1 + i * 18, startPoint.y + 61))
                        .disableBackground()
                        .markInput()
        ...
        widgets
            .add(
                Widgets
                    .createLabel(new Point(bounds.getCenterX(), startPoint.y + 82), text)
                    .centered()
                    .color(0x3f3f3f)
                    .noShadow()
            );
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 95, startPoint.y + 20))
                    .entries(result)
                    .disableBackground()
                    .markOutput()
            );

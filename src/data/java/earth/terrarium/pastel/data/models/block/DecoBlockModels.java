...
public class DecoBlockModels {
    ...
    public static void registerShimmerstoneLight(
        ...
        ResourceLocation base = PastelModels.SHIMMERSTONE_LIGHT
            .create(
                block.get(),
                PastelTextureMaps
                    .innerOuterParticle(
                        PastelTextures.SHIMMERSTONE_LIGHT,
                        outer,
                        outer
                    ),
                generators.modelOutput
            );
        ResourceLocation mirrored = PastelModels.SHIMMERSTONE_LIGHT_MIRRORED
            .createWithSuffix(
                block.get(),
                "_mirrored",
                PastelTextureMaps
    ...
    public static void glassPane(
        BlockModelGenerators generators,
        DeferredBlock<Block> block,
        DeferredBlock<Block> glassBlock
    ) {
        generators.blockStateOutput
            .accept(
    ...
    public static void generateBlockModels(BlockModelGenerators generators) {
        ...
        PastelModelHelper.BLOCK
            .defaultEastHorizontalFacing(
                generators,
                PastelBlocks.PRIMORDIAL_WALL_TORCH,
                ModelLocationUtils::getModelLocation
            );
        PastelModelHelper.BLOCK
            .singletonWithSoup(
                generators,
                PastelBlocks.PRIMORDIAL_TORCH,
                ModelLocationUtils::getModelLocation
            );
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.HUMMINGSTONE.get())
                    .with(
                        PastelModelHelper
                            .createBooleanModelMap(
                                HummingstoneBlock.HUMMING,
                                PastelTexturedModels
                                    .cubeAll(b -> b, "_humming")
                                    .createWithSuffix(
        ...
        PastelModelHelper.BLOCK
            .parented(generators, PastelBlocks.WAXED_HUMMINGSTONE.get(), PastelBlocks.HUMMINGSTONE.get());
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.ASH_PILE.get())
                    .with(
                        PropertyDispatch
                            .property(
                            ...
                            .generateList(height -> {
                                ResourceLocation ash = TextureMapping
                                    .getBlockTexture(
                                        PastelBlocks.ASH.get()
                                    );
                                ResourceLocation ash2 = TextureMapping
                                    .getBlockTexture(
                                        PastelBlocks.ASH.get(),
                                        "2"
                                    );
                                ResourceLocation ash3 = TextureMapping
                                    .getBlockTexture(
                                        PastelBlocks.ASH.get(),
                                        "3"
                                    );
                                ResourceLocation ash4 = TextureMapping
                                    .getBlockTexture(
                                        PastelBlocks.ASH.get(),
                                        "4"
                                    );
                                            ...
                                            .createModelVariant(
                                                layerModel
                                                    .create(
                                                        PastelCommon
                                                            .locate(
                                                                "block" + "/ash_pile_height" + height * 2
                                                            ),
                                                        TextureMapping
                                                            .cube(
                                                                ash
                                            ...
                                            .createModelVariant(
                                                layerModel
                                                    .create(
                                                        PastelCommon
                                                            .locate(
                                                                "block" + "/ash2_pile_height" + height * 2
                                                            ),
                                                        TextureMapping
                                                            .cube(
                                                                ash2
                                            ...
                                            .createModelVariant(
                                                layerModel
                                                    .create(
                                                        PastelCommon
                                                            .locate(
                                                                "block" + "/ash3_pile_height" + height * 2
                                                            ),
                                                        TextureMapping
                                                            .cube(
                                                                ash3
                                            ...
                                            .createModelVariant(
                                                layerModel
                                                    .create(
                                                        PastelCommon
                                                            .locate(
                                                                "block" + "/ash4_pile_height" + height * 2
                                                            ),
                                                        TextureMapping
                                                            .cube(
                                                                ash4
        ...
        PastelModelHelper.BLOCK
            .defaultNorthHorizontalFacing(
                generators,
                PastelBlocks.LONGING_CHIMERA,
                ModelLocationUtils::getModelLocation
            );
        PastelModelHelper.BLOCK
            .defaultUpFacing(generators, PastelBlocks.RESPLENDENT_BLOCK, TexturedModel.CUBE_TOP_BOTTOM);
        ...
        generators.blockStateOutput
            .accept(
                MultiVariantGenerator
                    .multiVariant(PastelBlocks.RESPLENDENT_BED.get())
                    .with(
                        PastelModelHelper.createSouthDefaultHorizontalFacingVariantMap()
                    )
                    .with(
                        PropertyDispatch
                            .property(BedBlock.PART)
                            .select(
                                BedPart.HEAD,
                                PastelModelHelper
                                    .createModelVariant(
        ...
        registerShimmerstoneLight(
            generators,
            PastelBlocks.STONE_SHIMMERSTONE_LIGHT,
        ...
        PastelModelHelper.BLOCK
            .singleton(generators, PastelBlocks.FIERY_SHOOTING_STAR, PastelTexturedModels.SHOOTING_STAR);
        PastelModelHelper.BLOCK
            .singleton(
                generators,
        ...
        for (
            var head : PastelBlocks.MOB_HEADS.values()
        ) {
            generators.blockStateOutput
                .accept(
        ...
        for (
            var head : PastelBlocks.WALL_HEADS.values()
        ) {
            generators.blockStateOutput
                .accept(
                    PastelModelHelper.createVariantsSupplier(head.get(), PastelModels.MOB_HEAD)
    ...
    public static void generateItemModels(ItemModelGenerators generators) {
        ...
        PastelModelHelper
            .registerParentedItemModel(generators, PastelBlocks.TOPAZ_PYLON, PastelBlocks.TOPAZ_PYLON.get(), "_head");
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.AMETHYST_PYLON,
        ...
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.CITRINE_PYLON,
                PastelBlocks.CITRINE_PYLON.get(),
                "_head"
            );
        PastelModelHelper
            .registerParentedItemModel(generators, PastelBlocks.ONYX_PYLON, PastelBlocks.ONYX_PYLON.get(), "_head");
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.MOONSTONE_PYLON,
        ...
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.TOPAZ_SEMI_PERMEABLE_GLASS,
                PastelBlocks.TOPAZ_GLASS.get()
            );
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.AMETHYST_SEMI_PERMEABLE_GLASS,
                PastelBlocks.AMETHYST_GLASS.get()
            );
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.CITRINE_SEMI_PERMEABLE_GLASS,
                PastelBlocks.CITRINE_GLASS.get()
            );
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.ONYX_SEMI_PERMEABLE_GLASS,
                PastelBlocks.ONYX_GLASS.get()
            );
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.MOONSTONE_SEMI_PERMEABLE_GLASS,
                PastelBlocks.MOONSTONE_GLASS.get()
            );
        PastelModelHelper
            .registerParentedItemModel(
        ...
        PastelModelHelper
            .registerParentedItemModel(
                generators,
                PastelBlocks.WAXED_HUMMINGSTONE,
                PastelBlocks.HUMMINGSTONE.get()
            );

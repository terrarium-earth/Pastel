...
public class AirExposedOreFeature extends OreFeature {
    ...
    protected boolean doPlace(
        ...
        try (
            BulkSectionAccess $$32 = new BulkSectionAccess(level)
        ) {
            for (
                int $$33 = 0;
                $$33 < $$17;
                            ...
                            for (
                                ...
                                if ($$45 * $$45 + $$47 * $$47 < 1.0) {
                                    for (
                                        ...
                                        if ($$45 * $$45 + $$47 * $$47 + $$49 * $$49 < 1.0 && !level
                                            .isOutsideBuildHeight($$46)) {
            ...
            for (
                ...
                if (level.ensureCanWrite(pos)) {
                    ...
                    if ($$51 != null) {
                        ...
                        for (
                            OreConfiguration.TargetBlockState $$56 : config.targetStates
                        ) {

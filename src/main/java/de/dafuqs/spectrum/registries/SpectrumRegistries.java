...
public class SpectrumRegistries {
	...
	public static final Registry<ResonanceDropProcessor> RESONANCE_DROP = FabricRegistryBuilder.createSimple(SpectrumRegistryKeys.RESONANCE_DROP).buildAndRegister();

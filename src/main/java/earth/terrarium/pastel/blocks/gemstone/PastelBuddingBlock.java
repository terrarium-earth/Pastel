...
public class PastelBuddingBlock extends PastelGemstoneBlock {
	...
	public PastelBuddingBlock(Properties settings, Block smallBlock, Block mediumBlock, Block largeBlock, Block clusterBlock, SoundEvent hitSoundEvent, SoundEvent chimeSoundEvent) {

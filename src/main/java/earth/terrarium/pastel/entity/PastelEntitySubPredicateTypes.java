...
public class PastelEntitySubPredicateTypes {
	...
	private static final DeferredRegister<MapCodec<? extends EntitySubPredicate>> REGISTER = DeferredRegister.create(Registries.ENTITY_SUB_PREDICATE_TYPE, PastelCommon.MOD_ID);

...
public class PastelModelHelper {
    ...
    public static void registerItemModel(ItemModelGenerators ctx, Item item, String suffix) {
        ModelTemplates.FLAT_ITEM
            .create(
                ...
                PastelTextureMaps.layer0(item, suffix),
                ctx.output
            );
    }
    ...
    public static void registerBlockTexturedItemModel(ItemModelGenerators ctx, Block block, String suffix) {
        ModelTemplates.FLAT_ITEM
            .create(
                ...
                PastelTextureMaps.layer0(block, suffix),
                ctx.output
            );
    }
    ...
    public static BlockStateGenerator logBlockModel(BlockModelGenerators ctx, Block logBlock) {
        ...
        ResourceLocation horizonal = ModelTemplates.CUBE_COLUMN_HORIZONTAL
            .create(
                logBlock,
                textureMap,
                ctx.modelOutput
    ...
    public static BlockStateGenerator woodBlockModel(BlockModelGenerators ctx, Block woodBlock, Block logBlock) {
        ...
        return MultiVariantGenerator
            .multiVariant(woodBlock, createModelVariant(model))
            .with(createAxisRotatedVariantMap());
    }

    public static BlockStateGenerator pottedPlantBlockModel(
        BlockModelGenerators ctx,
        FlowerPotBlock block,
        boolean tinted
    ) {
        BlockModelGenerators.TintState tintType = tinted
            ? BlockModelGenerators.TintState.TINTED
            : BlockModelGenerators.TintState.NOT_TINTED;
        TextureMapping textureMap = TextureMapping.plant(block.getPotted());
        ResourceLocation identifier = tintType
            .getCrossPot()
    ...
    public static BlockStateGenerator glassPaneBlockModel(
        ...
        ResourceLocation post = ModelTemplates.STAINED_GLASS_PANE_POST
            .create(
                glassPaneBlock,
                textureMap,
                ctx.modelOutput
            );
        ResourceLocation side = ModelTemplates.STAINED_GLASS_PANE_SIDE
            .create(
                glassPaneBlock,
                textureMap,
                ctx.modelOutput
            );
        ResourceLocation sideAlt = ModelTemplates.STAINED_GLASS_PANE_SIDE_ALT
            .create(
                glassPaneBlock,
                textureMap,
                ctx.modelOutput
            );
        ResourceLocation noside = ModelTemplates.STAINED_GLASS_PANE_NOSIDE
            .create(
                glassPaneBlock,
                textureMap,
                ctx.modelOutput
            );
        ResourceLocation nosideAlt = ModelTemplates.STAINED_GLASS_PANE_NOSIDE_ALT
            .create(
                glassPaneBlock,
                textureMap,
                ctx.modelOutput
        ...
        ModelTemplates.FLAT_ITEM
            .create(
                ModelLocationUtils.getModelLocation(glassPaneBlock.asItem()),
                TextureMapping.layer0(glassBlock),
                ctx.modelOutput
            );
        return MultiPartGenerator
            .multiPart(glassPaneBlock)
            .with(
                Variant
                    .variant()
    ...
    public static void registerBlockFamilyExceptBase(
        ...
        BlockFamily family,
        TexturedModel.Provider variantFactory
    ) {
    ...
    public static MultiVariantGenerator createVariantsSupplier(
        BlockModelGenerators ctx,
        Block block,
        TexturedModel.Provider factory
    ) {
    ...
    public static MultiVariantGenerator createMirroredVariantsSupplier(
        Block block,
        TexturedModel.Provider factory,
        TexturedModel.Provider mirroredFactory,
    ...
    public static PropertyDispatch createBooleanModelMap(
        ...
        ResourceLocation trueModel,
        ResourceLocation falseModel
    ) {
    ...
    public static PropertyDispatch createCardinalFacingVariantMap() {
        return PropertyDispatch
            .property(CardinalFacingBlock.CARDINAL_FACING)
            .select(
                false,
                Variant
                    .variant()
    ...
    public static PropertyDispatch createAxisRotatedVariantMap(
        ...
        return PropertyDispatch
            ...
            .select(
                Direction.Axis.X,
                createModelVariant(horizontalModelId)
                    .with(
                        VariantProperties.X_ROT,
                        VariantProperties.Rotation.R90
                    )
    ...
    public static PropertyDispatch createDownDefaultFacingVariantMap(
        ...
        return PropertyDispatch
            .property(DirectionalBlock.FACING)
            .select(Direction.DOWN, createModelVariant(verticalModelId))
            .select(
                Direction.UP,
                createModelVariant(verticalModelId)
                    .with(
                        VariantProperties.X_ROT,
                        VariantProperties.Rotation.R180
                    )
    ...
    public static PropertyDispatch createUpNorthDefaultOrientationVariantMap() {
        return PropertyDispatch
            .property(BlockStateProperties.ORIENTATION)
            .select(
    ...
    public static class BLOCK {
        ...
        public static void simple(BlockModelGenerators generators, DeferredBlock<Block>... blocks) {
            for (
                DeferredBlock<Block> block : blocks
            ) {
        ...
        public static void simpleMirrored(
            ...
            generators.blockStateOutput
                .accept(
                    PastelModelHelper
                        .createMirroredVariantsSupplier(
                            block.get(),
                            TexturedModel.CUBE,
                            TexturedModel.CUBE_MIRRORED,
        ...
        public static void singleton(
            ...
            generators.blockStateOutput
                .accept(
                    PastelModelHelper
                        .createVariantsSupplier(block.get(), factory.create(block.get(), generators.modelOutput))
                );
        }
        ...
        public static void defaultUpFacingGetter(
            BlockModelGenerators generators,
            DeferredBlock<Block> block,
            Function<Block, ResourceLocation> modelIdGetter
        ) {
            generators.blockStateOutput
                .accept(
                    PastelModelHelper
                        .createVariantsSupplier(block.get(), modelIdGetter.apply(block.get()))
                        .with(PastelModelHelper.createUpDefaultFacingVariantMap())
                );
        }
        ...
        public static void wood(
            ...
            generators.blockStateOutput
                .accept(PastelModelHelper.woodBlockModel(generators, block.get(), logBlock.get()));
        }

        public static void snowy(
            BlockModelGenerators generators,
            DeferredBlock<Block> block,
            TexturedModel.Provider base,
                        ...
                        .with(
                            PropertyDispatch
                                ...
                                .select(
                                    false,
                                    PastelModelHelper
                                        .createHorizontalRotationVariantList(
                                            base
                                                .create(
                                                    block.get(),
                                                    generators.modelOutput
        ...
        public static void redstoneLamp(BlockModelGenerators generators, DeferredBlock<Block> block) {
            ResourceLocation off = PastelTexturedModels
                .cubeAll(b -> b, "_off")
                .createWithSuffix(block.get(), "_off", generators.modelOutput);
            ResourceLocation on = PastelTexturedModels
                .cubeAll(b -> b, "_on")
        ...
        public static void barrellike(
            BlockModelGenerators generators,
            DeferredBlock<Block> block,
            UnaryOperator<Block> bottomBlock,
            String bottomSuffix
        ) {
            generators.blockStateOutput
                .accept(
                ...
                TexturedModel
                    .createDefault(
                        b -> new TextureMapping()
                            .put(PastelTextureKeys.PEDESTAL, TextureMapping.getBlockTexture(b))
                            .put(
                                TextureSlot.PARTICLE,
                                TextureMapping.getBlockTexture(b, "_particle")
                            ),
        ...
        public static void orientable(BlockModelGenerators generators, DeferredBlock<Block> block) {
            ResourceLocation horizontal = ModelTemplates.CUBE_ORIENTABLE
                .create(
                    block.get(),
                    new TextureMapping()
            ...
            ResourceLocation vertical = ModelTemplates.CUBE_ORIENTABLE_VERTICAL
                .create(
                    block.get(),
                    new TextureMapping()
                        .put(
                    ...
                    MultiVariantGenerator
                        .multiVariant(
                            ...
                            PastelModelHelper
                                .createModelVariant(
                                    TexturedModel
                                        .createDefault(TextureMapping::cross, model)
                                        .create(
                                            block.get(),
                                            generators.modelOutput
                                        )
        ...
        public static void moonstoneChiseled(
            ...
            TextureMapping textureMap = PastelTextureMaps
                .sideLine(capTexture, TextureMapping.getBlockTexture(block.get()));
            PastelModels.MOONSTONE_CHISELED.create(block.get(), textureMap, generators.modelOutput);
            PastelModels.MOONSTONE_CHISELED_DOWN
                .createWithSuffix(
                    block.get(),
                    "_down",
                    textureMap,
            ...
            generators.blockStateOutput
                .accept(
                    MultiVariantGenerator
                        ...
                        .with(
                            PastelModelHelper
                                .createDownDefaultFacingVariantMap(
                                    ModelLocationUtils
                                        .getModelLocation(
                                            block.get()
                                        ),
    ...
    public static class ITEM {
        public static void simple(ItemModelGenerators generators, DeferredItem<? extends Item> item) {
            registerItemModel(generators, item.get());
        }

        public static void handheld(ItemModelGenerators generators, DeferredItem<? extends Item> item) {
            registerItemModel(generators, item.asItem(), ModelTemplates.FLAT_HANDHELD_ITEM);
        }
        ...
        public static void layered(
            ...
            registerLayeredItemModel(
                generators,
                item.get(),
                PastelModels.GENERATED_FOUR_LAYERS,
                suffix0,
                suffix1,
                suffix2,
                suffix3
        ...
        public static void parented(
            ...
            registerParentedItemModel(generators, item.get(), parent.asItem());
        }
        ...
        public static void parented(
            ...
            registerParentedItemModel(generators, item.get(), parentModelId);
        }
        ...
        public static void cluster(
            ...
            PastelClusterBlock.GrowthStage stage
        ) {
            switch (stage) {
                case PastelClusterBlock.GrowthStage.SMALL -> PastelModels.SMALL_BUD_ITEM
                    .create(
                        ModelLocationUtils.getModelLocation(block.asItem()),
                        TextureMapping.layer0(block.get()),
                        generators.output
                    );
                case PastelClusterBlock.GrowthStage.MEDIUM -> PastelModels.MEDIUM_BUD_ITEM
                    .create(
                        ModelLocationUtils.getModelLocation(block.asItem()),
                        TextureMapping.layer0(block.get()),
                        generators.output
                    );
                case PastelClusterBlock.GrowthStage.LARGE -> PastelModels.LARGE_BUD_ITEM
                    .create(
                        ModelLocationUtils.getModelLocation(block.asItem()),
                        TextureMapping.layer0(block.get()),
                        generators.output
                    );
                case PastelClusterBlock.GrowthStage.CLUSTER -> PastelModels.CLUSTER_ITEM
                    .create(
                        ModelLocationUtils.getModelLocation(block.asItem()),
                        TextureMapping.layer0(block.get()),
                        generators.output

...
public class ManxiModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition root = modelPartData.addOrReplaceChild(
            "root", CubeListBuilder.create(), PartPose.offsetAndRotation(
                2.5F, 19.75F, -2.0F, 0.0F, -0.1745F, -1.5708F)
        );
        ...
        PartDefinition breasts_r1 = torso.addOrReplaceChild(
            "breasts_r1", CubeListBuilder.create()
                                         .texOffs(27, 0)
                                         .addBox(
                                             -3.99F, -3.5F, -0.5F, 8.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition hairtuff_r1 = head.addOrReplaceChild(
            "hairtuff_r1", CubeListBuilder.create()
                                          .texOffs(49, 0)
                                          .addBox(
                                              -4.0F, -3.0F, 0.0F, 8.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition rightear = head.addOrReplaceChild(
            "rightear", CubeListBuilder.create()
                                       .texOffs(44, 7)
                                       .addBox(
                                           -1.7622F, -1.4363F, 0.0434F, 4.0F, 3.0F, 0.0F,
                                           new CubeDeformation(0.0F)
                                       ), PartPose.offsetAndRotation(
                -4.2116F, -5.7745F, 0.7357F, -0.0456F, 0.1685F,
                -0.2657F
            )
        );

        PartDefinition rightearjoint = rightear.addOrReplaceChild(
            "rightearjoint", CubeListBuilder.create()
                                            .texOffs(42, 66)
                                            .addBox(
                                                -2.0F, -9.0F, 0.0F, 4.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(
                0.2378F, -1.4363F, 0.0434F, 0.2193F, -0.017F, -0.1298F)
        );

        PartDefinition leftear = head.addOrReplaceChild(
            "leftear", CubeListBuilder.create()
                                      .texOffs(0, 23)
                                      .addBox(
                                          -2.2378F, -1.4363F, 0.0434F, 4.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(3.2884F, -5.7745F, 0.7357F, -0.0456F, -0.1685F, 0.2657F)
        );

        PartDefinition leftearjoint = leftear.addOrReplaceChild(
            "leftearjoint", CubeListBuilder.create()
                                           .texOffs(0, 0)
                                           .addBox(
                                               -2.0F, -9.0F, 0.0F, 4.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(
        ...
        PartDefinition tail = torso.addOrReplaceChild(
            "tail", CubeListBuilder.create()
                                   .texOffs(27, 9)
                                   .addBox(
                                       -1.0F, -1.0F, -1.0F, 4.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition tail1 = tail.addOrReplaceChild(
            "tail1", CubeListBuilder.create()
                                    .texOffs(58, 6)
                                    .addBox(
                                        -0.5F, -4.0F, 0.0F, 3.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition tail2 = tail1.addOrReplaceChild(
            "tail2", CubeListBuilder.create()
                                    .texOffs(43, 14)
                                    .addBox(
                                        -1.0F, -3.0F, 0.0F, 2.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(1.0F, 0.0F, 7.0F, -0.3919F, 0.0852F, 0.0189F)
        );

        PartDefinition tail3 = tail2.addOrReplaceChild(
            "tail3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -0.5F, 6.0F, -0.2618F, 0.0F, 0.0F));

        PartDefinition tailtip_r1 = tail3.addOrReplaceChild(
            "tailtip_r1", CubeListBuilder.create()
                                         .texOffs(44, 0)
                                         .addBox(
                                             1.0F, 0.0F, -1.0F, 0.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-1.0F, -1.5F, 1.0F, -0.0436F, 0.0F, 0.0F)
        );

        PartDefinition legs = root.addOrReplaceChild(
            "legs", CubeListBuilder.create(), PartPose.offset(0.0F, 1.0F, 2.0F));

...
public class SpectrumEnchantmentEffectComponentTypes {
	...
	private static <T> ComponentType<T> register(String id, UnaryOperator<ComponentType.Builder<T>> builderOperator) {
		return REGISTRAR.defer(builderOperator.apply(ComponentType.builder()).build(), type -> Registry.register(Registries.ENCHANTMENT_EFFECT_COMPONENT_TYPE, SpectrumCommon.locate(id), type));
	}

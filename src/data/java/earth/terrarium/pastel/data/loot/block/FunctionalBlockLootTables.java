...
public class FunctionalBlockLootTables extends BlockLootSubProvider {
    ...
    private static final List<Block> dropSelfBlocks = List
        .of(
            ...
            PastelBlocks.BUFFER_NODE.get(),
            PastelBlocks.SENDER_NODE.get(),
            PastelBlocks.GATHER_NODE.get(),

            PastelBlocks.AXOLOTL_IDOL.get(),
            PastelBlocks.BAT_IDOL.get(),
            PastelBlocks.BEE_IDOL.get(),
            PastelBlocks.BLAZE_IDOL.get(),
            PastelBlocks.CAT_IDOL.get(),
            PastelBlocks.CHICKEN_IDOL.get(),
            PastelBlocks.COW_IDOL.get(),
            ...
            PastelBlocks.EVOKER_IDOL.get(),
            PastelBlocks.FISH_IDOL.get(),
            PastelBlocks.FOX_IDOL.get(),
            PastelBlocks.GHAST_IDOL.get(),
            PastelBlocks.GLOW_SQUID_IDOL.get(),
            PastelBlocks.GOAT_IDOL.get(),
            PastelBlocks.GUARDIAN_IDOL.get(),
            PastelBlocks.HORSE_IDOL.get(),
            PastelBlocks.ILLUSIONER_IDOL.get(),
            PastelBlocks.OCELOT_IDOL.get(),
            PastelBlocks.PARROT_IDOL.get(),
            PastelBlocks.PHANTOM_IDOL.get(),
            PastelBlocks.PIG_IDOL.get(),
            PastelBlocks.PIGLIN_IDOL.get(),
            PastelBlocks.POLAR_BEAR_IDOL.get(),
            PastelBlocks.PUFFERFISH_IDOL.get(),
            PastelBlocks.RABBIT_IDOL.get(),
            PastelBlocks.SHEEP_IDOL.get(),
            PastelBlocks.SHULKER_IDOL.get(),
            PastelBlocks.SILVERFISH_IDOL.get(),
            PastelBlocks.SKELETON_IDOL.get(),
            PastelBlocks.SLIME_IDOL.get(),
            PastelBlocks.SNOW_GOLEM_IDOL.get(),
            PastelBlocks.SPIDER_IDOL.get(),
            PastelBlocks.SQUID_IDOL.get(),
            PastelBlocks.STRAY_IDOL.get(),
            PastelBlocks.STRIDER_IDOL.get(),
            PastelBlocks.TURTLE_IDOL.get(),
            PastelBlocks.WITCH_IDOL.get(),
            PastelBlocks.WITHER_IDOL.get(),
    ...
    private static final Map<Block, ItemLike> decayBlocks = Map
        .ofEntries(
            entry(PastelBlocks.FADING.get(), PastelItems.VEGETAL),
            entry(PastelBlocks.FAILING.get(), PastelItems.NEOLITH),

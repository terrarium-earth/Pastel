...
public class PastelHiddenProvider extends HiddenDatagenProvider {
    ...
    protected void gather() {
        ...
        allColors((color) -> hideItem(
            ...
            PastelCommon.locate("craft_colored_sapling")
        ));

        hideBlockWithItem(
            PastelBlocks.RADIATING_ENDER.get(), Blocks.COBBLESTONE, PastelAdvancements.REVEAL_RADIATING_ENDER);
        hideBlockWithItem(
            PastelBlocks.FOUR_LEAF_CLOVER.get(), PastelBlocks.CLOVER.get(), PastelAdvancements.REVEAL_FOUR_LEAF_CLOVER);
        hideBlockWithItem(PastelBlocks.AMARANTH_BUSHEL.get(), Blocks.FERN, PastelAdvancements.REVEAL_AMARANTH);
        hideBlockWithItem(
            PastelBlocks.RESONANT_LILY.get(), Blocks.WHITE_TULIP, PastelCommon.locate("midgame/collect_resonant_lily"));
        ...
        hideBlock(
            PastelBlocks.BLOOD_ORCHID.get(), Blocks.RED_TULIP,
            PastelCommon.locate("midgame/collect_blood_orchid_petal")
        );
        hideBlock(
        ...
        hideBlock(
            ...
            PastelCommon.locate("midgame/collect_resonant_lily")
        );
        ...
        hideItem(
            PastelItems.JADE_VINE_PETALS.get(), Items.LIME_DYE, PastelAdvancements.BUILD_SPIRIT_INSTILLER_STRUCTURE);
        ...
        hideItem(
            ...
            PastelAdvancements.COLLECT_HIBERNATING_JADE_VINE_BULB
        );
        ...
        hideItem(
            PastelItems.RESONANCE_SHARD.get(), Items.LIGHT_BLUE_DYE, PastelAdvancements.STRIKE_UP_HUMMINGSTONE_HYMN);
        hideItem(
            PastelItems.NECTARDEW_BURGEON.get(), PastelItems.NIGHTDEW_SPROUT.get(),
            PastelAdvancements.COLLECT_NECTARDEW
        );
        ...
        createQuitoxicReeds(
            PastelBlocks.QUITOXIC_REEDS.get(), Blocks.SUGAR_CANE.asItem(), PastelAdvancements.REVEAL_QUITOXIC_REEDS);

        hideOre(
            PastelBlocks.MALACHITE_ORE.get(), PastelBlocks.DEEPSLATE_MALACHITE_ORE.get(),
            PastelBlocks.BLACKSLAG_MALACHITE_ORE.get(), PastelAdvancements.REVEAL_MALACHITE
        );
        hideOre(
            PastelBlocks.SHIMMERSTONE_ORE.get(), PastelBlocks.DEEPSLATE_SHIMMERSTONE_ORE.get(),
            PastelBlocks.BLACKSLAG_SHIMMERSTONE_ORE.get(), PastelAdvancements.REVEAL_SHIMMERSTONE
        );
        hideOre(
            PastelBlocks.TOPAZ_ORE.get(), PastelBlocks.DEEPSLATE_TOPAZ_ORE.get(),
            PastelBlocks.BLACKSLAG_TOPAZ_ORE.get(), PastelAdvancements.COLLECT_TOPAZ
        );
        hideOre(
            PastelBlocks.AMETHYST_ORE.get(), PastelBlocks.DEEPSLATE_AMETHYST_ORE.get(),
            PastelBlocks.BLACKSLAG_AMETHYST_ORE.get(), PastelAdvancements.COLLECT_AMETHYST
        );
        hideOre(
            PastelBlocks.CITRINE_ORE.get(), PastelBlocks.DEEPSLATE_CITRINE_ORE.get(),
            PastelBlocks.BLACKSLAG_CITRINE_ORE.get(), PastelAdvancements.COLLECT_CITRINE
        );
        hideOre(
            PastelBlocks.ONYX_ORE.get(), PastelBlocks.DEEPSLATE_ONYX_ORE.get(), PastelBlocks.BLACKSLAG_ONYX_ORE.get(),
            PastelAdvancements.CREATE_ONYX
        );
        hideOre(
            PastelBlocks.MOONSTONE_ORE.get(), PastelBlocks.DEEPSLATE_MOONSTONE_ORE.get(),
            PastelBlocks.BLACKSLAG_MOONSTONE_ORE.get(), PastelAdvancements.COLLECT_MOONSTONE
        );

        hideItemWithNameOverride(
            PastelItems.MIDNIGHT_ABERRATION.get(), PastelItems.SPECTRAL_SHARD.get(),
            PastelAdvancements.CREATE_MIDNIGHT_ABERRATION,

...
public abstract class PotionWorkshopCategory<T extends PotionWorkshopRecipeDisplay> extends GatedDisplayCategory<T> {
    ...
    public void setupWidgets(Point startPoint, Rectangle bounds, List<Widget> widgets, @NotNull T display) {
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 15, startPoint.y + 1 + 49))
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 63, startPoint.y + 1))
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 15, startPoint.y + 1))
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x, startPoint.y + 1 + 20))
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 30, startPoint.y + 1 + 20))
        ...
        widgets
            .add(
                Widgets
                    .createSlot(new Point(startPoint.x + 95, startPoint.y + 1 + 19))
                    .entries(result)
                    .markOutput()
            );
        ...
        widgets
            .add(
                Widgets
                    .createLabel(new Point(startPoint.x + 40, startPoint.y + 1 + 54), text)
                    .leftAligned()
                    .color(0x3f3f3f)
                    .noShadow()
            );

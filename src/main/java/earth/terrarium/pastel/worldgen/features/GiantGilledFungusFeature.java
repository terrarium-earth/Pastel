        ...
        for (
            ...
            this
                .generateHat(
                    ...
                    random,
                    config,
                    blockPos.offset(random.nextInt(stemGirth * 3), 0, random.nextInt(stemGirth * 3)),
                    random.nextInt(stemHeight / 5) + 1,
                    (random.nextFloat() / (i + 1) * 0.5F) + 0.5F
                );
        }
        ...
        for (
            ...
            for (
                ...
                if (recursive && !stemPos.equals(blockPos) && random.nextFloat() <= 0.2F) {
                    ...
                    generateStemRing(
                        stemPos.offset(offsetX, 0, offsetZ),
                        config,
                        world,
                        random,
                        stemGirth / 2,
                    ...
                    this
                        .generateHat(
                            ...
                            random,
                            config,
                            stemPos.offset((int) (offsetX * 1.5), 0, (int) (offsetZ * 1.5)),
                            height,

...
public class PastelModelHelper {
	...
	public static void registerItemModel(ItemModelGenerators ctx, Item item, String suffix) {
		ModelTemplates.FLAT_ITEM.create(ModelLocationUtils.getModelLocation(item), PastelTextureMaps.layer0(item, suffix), ctx.output);
	}
	...
	public static void registerLayeredItemModel(ItemModelGenerators ctx, Item item, ModelTemplate model, String suffix0, String suffix1, String suffix2, String suffix3) {
		model.create(ModelLocationUtils.getModelLocation(item), TextureMapping.layered(TextureMapping.getItemTexture(item, suffix0), TextureMapping.getItemTexture(item, suffix1), TextureMapping.getItemTexture(item, suffix2)).put(PastelTextureKeys.LAYER3, TextureMapping.getItemTexture(item, suffix3)), ctx.output);
	}
	...
	public static void registerBlockTexturedItemModel(ItemModelGenerators ctx, Block block, String suffix) {
		ModelTemplates.FLAT_ITEM.create(ModelLocationUtils.getModelLocation(block.asItem()), PastelTextureMaps.layer0(block, suffix), ctx.output);
	}

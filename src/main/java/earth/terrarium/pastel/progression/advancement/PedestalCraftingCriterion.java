...
public class PedestalCraftingCriterion extends SimpleCriterionTrigger<PedestalCraftingCriterion.Conditions> {
    ...
    public record Conditions(
        ...
        public static final Codec<PedestalCraftingCriterion.Conditions> CODEC = RecordCodecBuilder
            .create(
                instance -> instance
                    .group(
                        EntityPredicate.ADVANCEMENT_CODEC
                            .optionalFieldOf("player")
                            .forGetter(PedestalCraftingCriterion.Conditions::player),
                        ContextAwarePredicate.CODEC
                            .optionalFieldOf("location")
                            .forGetter(PedestalCraftingCriterion.Conditions::location),
                        ItemPredicate.CODEC
                            .optionalFieldOf("item")
                            .forGetter(PedestalCraftingCriterion.Conditions::craftedItemPredicate),
                        MinMaxBounds.Ints.CODEC
                            .optionalFieldOf("gained_experience", MinMaxBounds.Ints.ANY)
                            .forGetter(PedestalCraftingCriterion.Conditions::experienceRange),
                        MinMaxBounds.Ints.CODEC
                            .optionalFieldOf(
                                "crafting_duration_ticks",
                                MinMaxBounds.Ints.ANY
                            )
                            .forGetter(PedestalCraftingCriterion.Conditions::craftingDurationTicksRange)
                    )
        ...
        public boolean matches(ItemStack craftedStack, int experience, int durationTicks) {
            if (this.craftedItemPredicate.isPresent() && !this.craftedItemPredicate
                .get()
                .test(craftedStack)) {
                return false;
            }

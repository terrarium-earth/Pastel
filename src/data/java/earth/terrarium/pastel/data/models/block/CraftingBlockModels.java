...
public class CraftingBlockModels {
    public static void generateBlockModels(BlockModelGenerators generators) {
        ...
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.FUSION_SHRINE_BASALT, PastelTexturedModels.FUSION_SHRINE);
        PastelModelHelper.BLOCK.singleton(generators, PastelBlocks.FUSION_SHRINE_CALCITE, PastelTexturedModels.FUSION_SHRINE);
        PastelModelHelper.BLOCK.singletonWithSoup(generators, PastelBlocks.ENCHANTER, ModelLocationUtils::getModelLocation);

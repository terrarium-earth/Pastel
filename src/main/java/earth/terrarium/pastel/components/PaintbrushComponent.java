...
public record PaintbrushComponent(PaintbrushMode mode, Optional<InkColor> color, boolean brown, Optional<BlockPos> greenPos, String greenDim) {
    ...
    public enum PaintbrushMode implements StringRepresentable {
        ...
        public static final Codec<PaintbrushMode> CODEC = StringRepresentable.fromValues(
            PaintbrushMode::values);
        public static final IntFunction<PaintbrushMode> BY_ID = ByIdMap.continuous(
            PaintbrushMode::ordinal, PaintbrushMode.values(), ByIdMap.OutOfBoundsStrategy.ZERO);
        public static final StreamCodec<ByteBuf, PaintbrushMode> STREAM_CODEC = ByteBufCodecs.idMapper(
            BY_ID, PaintbrushMode::ordinal);

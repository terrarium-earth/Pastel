...
public record DynamicParticleEffect(
    ParticleType<?> particleType, float gravity, Vector3f color, float scale,
    int lifetimeTicks, boolean collisions, boolean glowing, boolean alwaysShow
    ...
    public static final MapCodec<DynamicParticleEffect> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
                                                                                                      ...
                                                                                                      Codec.FLOAT.fieldOf("gravity")
                                                                                                                 .forGetter(c -> c.gravity),
                                                                                                      ExtraCodecs.VECTOR3F.fieldOf("color")
                                                                                                                          .forGetter(c -> c.color),
                                                                                                      Codec.FLOAT.fieldOf("scale")
                                                                                                                 .forGetter(c -> c.scale),
                                                                                                      Codec.INT.fieldOf("lifetime_ticks")
                                                                                                               .forGetter(c -> c.lifetimeTicks),
                                                                                                      Codec.BOOL.fieldOf("collisions")
                                                                                                                .forGetter(c -> c.collisions),
                                                                                                      Codec.BOOL.fieldOf("glow_in_the_dark")
                                                                                                                .forGetter(c -> c.glowing),
                                                                                                      Codec.BOOL.optionalFieldOf("always_show", false)
                                                                                                                .forGetter(c -> c.alwaysShow)
                                                                                                  )
                                                                                                  .apply(
                                                                                                      i,
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, DynamicParticleEffect> STREAM_CODEC
    ...
    public DynamicParticleEffect(
        float gravity, Vector3f color, float scale, int lifetimeTicks, boolean collisions, boolean glowing) {
    ...
    public DynamicParticleEffect(
        ParticleType<?> particleType, float gravity, Vector3f color, float scale, int lifetimeTicks, boolean collisions,
        boolean glowing
    ) {

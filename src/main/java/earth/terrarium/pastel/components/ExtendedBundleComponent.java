...
public record ExtendedBundleComponent(Fraction maxOccupancy, int maxStacks, boolean ignoreStacks) {
    ...
    public static final Codec<ExtendedBundleComponent> CODEC = RecordCodecBuilder
        .create(
            i -> i
                .group(
                    CodecHelper.FRACTION
                        .fieldOf("max_occupancy")
                        .forGetter(c -> c.maxOccupancy),
                    Codec.INT
                        .fieldOf(
                            "max_stacks"
                        )
                        .forGetter(c -> c.maxStacks),
                    Codec.BOOL
                        .fieldOf("ignore_stacks")
                        .forGetter(c -> c.ignoreStacks)
                )
                .apply(
                    i,
    ...
    public static final StreamCodec<ByteBuf, ExtendedBundleComponent> STREAM_CODEC = StreamCodec
        .composite(
            PacketCodecHelper.FRACTION,
            c -> c.maxOccupancy,

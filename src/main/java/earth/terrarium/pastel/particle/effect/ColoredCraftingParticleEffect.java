...
public class ColoredCraftingParticleEffect implements ParticleOptions {
    ...
    public static final PastelInkColorCollection<ColoredCraftingParticleEffect> VALUES = PastelInkColorCollection.VALUES
        .map(color -> new ColoredCraftingParticleEffect(color.getColorInt()));
